...
{
    public class VoiceCommandPluginInstanceBehavior
    {
        public VoiceCommandPluginInstanceBehavior()
        {
        }
        ...
        public List<object> AddItemIntoListArg(System.Reflection.Assembly asm)
        {
            ...
            try
            {
                ...
                if (asm.FullName.Contains(ModuleCodeConstantExt.MODULE_CONFIG_APPLICATION))
                {
                    results.Add((Inventec.UC.ConfigApplication.Refesh)RefeshDataConfigApplication);
                }
                else if (asm.FullName.Contains(ModuleCodeConstantExt.MODULE_CHANGE_PASSWORD))
                {
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.MODULE_TRACKING_USER))
                {
                    results.Add(ApiConsumers.AcsConsumer);
                    results.Add(GlobalVariables.APPLICATION_CODE);
                }
                else if (asm.FullName.Contains(ModuleCodeConstantExt.SDA_NOTIFY))
                {
                    results.Add(ApiConsumers.SdaConsumer);
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.MODULE_VVA_VOICE_COMMAND))
                {
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.CONFIG_APP_USER))
                {
                    results.Add(ApiConsumers.SdaConsumer);
                    results.Add(numpageSize);
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.SDA_CONFIG_APP_USER))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.SDA_CONFIG_APP))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_USER))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_APPLICATION_ROLE))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_APPLICATION))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_CONTROL_ROLE))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_CONTROL))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_MODULE_ROLE))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_MODULE_GROUP))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_MODULE))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.ACS_ROLE))
                {
                    List<string> listString = new List<string>();
                    listString.Add(GlobalVariables.APPLICATION_CODE);
                    listString.Add(System.IO.Path.Combine
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.MODULE_EVENT_LOG))
                {
                ...
                else if (asm.FullName.Contains(ModuleCodeConstantExt.MODULE_CHOOSE_ROOM))
                {
                    results.Add((HIS.Desktop.Common.RefeshReference)RefeshReference);
                }
                else if (asm.FullName.Contains(ModuleCodeConstantExt.SDA_HIDE_CONTROL))
                {
                    List<string> listString = new List<string>();
                    listString.Add(System.IO.Path.Combine
                  (HIS.Desktop.LocalStorage.Location.ApplicationStoreLocation.ApplicationDirectory,
        ...
        public static void ShowModule(string moduleLink, long roomId, long roomTypeId, List<object> listArgs)
        {
            ...
            try
            {
                ...
                ShowModule(PluginInstance.GetModuleWithWorkingRoom(moduleData, roomId, roomTypeId), listArgs);
            }
        ...
        public static void ShowModule(Inventec.Desktop.Common.Modules.Module moduleData, long roomId, long roomTypeId, List<object> listArgs)
        {
            ...
            try
            {
                ...
                {
                    moduleShow = PluginInstance.GetModuleWithWorkingRoom(moduleData, roomId, roomTypeId);
                }
                else
                {
                    moduleShow = PluginInstance.GetModuleWithWorkingRoom(moduleData, moduleData.RoomId, moduleData.RoomTypeId);
                }
                ...
                switch (moduleShow.ModuleTypeId)
                {
                    ...
                    case Inventec.Desktop.Common.Modules.Module.MODULE_TYPE_ID__UC:
                        VoiceCommandTabControlProcess.TabCreating(SessionManager.GetTabControlMain(), moduleData.ExtensionInfo.Code, moduleData.text, (System.Windows.Forms.UserControl)extenceInstance, moduleShow);
                        break;
