...
namespace HIS.Desktop.Utilities.Extensions
{
    public class CustomGridView : GridView
    {
        ...
        protected override string ViewName { get { return "HISCustomGridView"; } }
    ...
    public class CustomGridControl : GridControl
    {
        ...
        {
            return CreateView("HISCustomGridView");
        }
    ...
    public class CustomGridInfoRegistrator : GridInfoRegistrator
    {
        ...
        public override string ViewName { get { return "HISCustomGridView"; } }
