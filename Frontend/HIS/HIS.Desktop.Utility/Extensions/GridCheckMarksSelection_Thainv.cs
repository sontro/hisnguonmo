...
{
    public class GridCheckMarksSelection1
    {

        RepositoryItemSearchLookUpEdit _currentRepository;
        ...
        public GridCheckMarksSelection1(RepositoryItemSearchLookUpEdit repository)
            : this()
        {
            CurrentRepository = repository;
        }

        public RepositoryItemSearchLookUpEdit CurrentRepository
        {
        ...
        public GridCheckMarksSelection1()
        {
        ...
        protected virtual void Attach(RepositoryItemSearchLookUpEdit rep)
        {
            if (rep == null) return;
            selection.Clear();
