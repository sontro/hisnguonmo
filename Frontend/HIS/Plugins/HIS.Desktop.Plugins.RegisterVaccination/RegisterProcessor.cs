...
using HIS.Desktop.Plugins.RegisterVaccination.Run3;
using System;
...
namespace Inventec.Desktop.Plugins.Register
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.RegisterVaccination",
       "Đăng ký tiếp đón",
       "Common",
       14,
       "tiep-don.png",
    ...
    public class RegisterProcessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ...
                HIS.Desktop.Plugins.RegisterVaccination.GlobalStore.CurrentModule = moduleData;
                //result = new HIS.Desktop.Plugins.RegisterVaccination.Run.UCRegister(HIS.Desktop.Plugins.RegisterVaccination.GlobalStore.CurrentModule);
                result = new HIS.Desktop.Plugins.RegisterVaccination.Run3.UCRegister(HIS.Desktop.Plugins.RegisterVaccination.GlobalStore.CurrentModule);
            }
            catch (Exception ex)
            {
