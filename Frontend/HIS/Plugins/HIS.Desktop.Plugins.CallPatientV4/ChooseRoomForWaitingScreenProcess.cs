...
namespace HIS.Desktop.Plugins.CallPatientV4
{
    internal class ChooseRoomForWaitingScreenProcess
    {
        ...
        internal static void ShowFormInExtendMonitor(frmWaitingScreen_V4 control)
        {
            try
            {
                Screen[] sc;
        ...
        internal static void ShowFormInExtendMonitor(frmWaitingScreen_V4_SeparateScreen control)
        {
            try
            {
                Screen[] sc;
        ...
        internal static void TurnOffExtendMonitor(frmWaitingScreen_V4 control)
        {
            try
            {
                if (control != null)
        ...
        internal static void TurnOffExtendMonitor(frmWaitingScreen_V4_SeparateScreen control)
        {
            try
            {
                if (control != null)
