...
namespace ACS.Desktop.Plugins.AcsUserImport.Message
{
    class MessImport
    {
        ...
        internal const string MaPhongKhamDaKhoa = "Mã phong khám {0} đã bị khóa|";
        internal const string FileImportDaTonTai = " File import đã tồn tại mã bàn mổ giống nhau {0} |";
    }
}
