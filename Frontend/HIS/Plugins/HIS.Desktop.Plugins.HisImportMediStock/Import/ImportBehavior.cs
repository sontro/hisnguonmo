...
using  HIS.Desktop.Plugins.HisImportMediStock.FormLoad;

namespace  HIS.Desktop.Plugins.HisImportMediStock
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmMediStock(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmMediStock(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
