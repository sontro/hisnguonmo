    ...
    public partial class frmChooseRoomForWaitingScreen : HIS.Desktop.Utility.FormBase
    {
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.CallPatientCLS.Resources.Lang", typeof(HIS.Desktop.Plugins.CallPatientCLS.frmChooseRoomForWaitingScreen).Assembly);
