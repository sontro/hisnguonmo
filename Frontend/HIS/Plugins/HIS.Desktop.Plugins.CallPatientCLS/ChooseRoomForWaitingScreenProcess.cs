...
namespace HIS.Desktop.Plugins.CallPatientCLS
{
    ...
    {
        const string frmWaitingScreen2 = "frmWaitingScreen2";
        const string frmWaitingScreenQy = "frmWaitingScreen_QY2";
        ...
        internal static void ShowFormInExtendMonitor(frmWaitingScreen_QY2 control)
        {
            try
            {
                Screen[] sc;
        ...
        internal static void TurnOffExtendMonitor(frmWaitingScreen_QY2 control)
        {
            try
            {
                if (control != null)
