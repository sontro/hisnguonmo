using HIS.Desktop.Plugins.CallPatientCLS.CallPatientCLS;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.CallPatientCLS
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.CallPatientCLS",
       "Gọi bênh nhân",
       "Common",
       14,
    ...
    public class CallPatientProsessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ICallPatientCLS behavior = CallPatientCLSFactory.MakeICallPatient(param, args);
