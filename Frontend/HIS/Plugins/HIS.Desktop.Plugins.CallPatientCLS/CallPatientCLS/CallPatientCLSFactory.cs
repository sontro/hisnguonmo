...
{
    class CallPatientCLSFactory
    {
        internal static ICallPatientCLS MakeICallPatient(CommonParam param, object[] args)
        {
            ICallPatientCLS result = null;
            try
            {
                result = new CallPatientCLSBehavior(param, args);
