...
{
    class CareTypeListFactory
    {
        internal static ICareTypeList MakeIControl(CommonParam param, object[] data)
        {
            ICareTypeList result = null;

            try{

                result = new CareTypeListBehavior(param,data);
