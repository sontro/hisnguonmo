...
namespace HIS.Desktop.Plugins.AnticipateUpdate.AnticipateUpdate
{
    class AnticipateUpdateBehavior : Tool<IDesktopToolContext>, IAnticipateUpdate
    {
        object[] entity;
        internal AnticipateUpdateBehavior(CommonParam param, object[] filter)
            : base()
        {
            this.entity = filter;
        }

        object IAnticipateUpdate.Run()
        {
            try
            {
                ...
                {
                    return new UCAnticipateUpdate(moduleData);
                }
            }
            catch (Exception ex)
            {
