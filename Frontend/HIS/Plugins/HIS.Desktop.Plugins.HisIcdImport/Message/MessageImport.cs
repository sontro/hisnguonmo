...
namespace HIS.Desktop.Plugins.HisIcdImport.Message
{
    class MessageImport
    {
        ...
        internal const string DaTonTai = " {0} đã tồn tại mã|";
        ...
        internal const string MaDaKhoa = "Mã {0} đã bị khóa| ";
        internal const string TenDaKhoa = "tên {0} đã bị khóa| ";
