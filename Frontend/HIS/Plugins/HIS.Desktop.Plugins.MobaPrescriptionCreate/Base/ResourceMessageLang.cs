...
namespace HIS.Desktop.Plugins.MobaPrescriptionCreate.Base
{
    ...
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.MobaPrescriptionCreate.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string KhoNhapTraLaiKhongPhaiKhoXuat
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugins_MobaImpMestCreate__KhoNhapTraLaiKhongPhaiKhoXuat", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
