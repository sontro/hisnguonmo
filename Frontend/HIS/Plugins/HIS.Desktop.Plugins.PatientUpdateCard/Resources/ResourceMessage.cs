...
namespace HIS.Desktop.Plugins.PatientUpdateCard.Resources
{
    class ResourceMessage
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.PatientUpdateCard.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string ChuaQuetTheKCB
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_HisWorkPlace__ChuaQuetTheKCB", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
