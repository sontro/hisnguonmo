...
namespace HIS.Desktop.Plugins.RegisterV3.ValidationRule
{
    class PatientDob__ValidationRule : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                ...
                {
                    string strError = "";
                    HIS.Desktop.Plugins.RegisterV3.DateUtil.DateValidObject dateValidObject = DateUtil.ValidPatientDob(this.txtDob.Text);
