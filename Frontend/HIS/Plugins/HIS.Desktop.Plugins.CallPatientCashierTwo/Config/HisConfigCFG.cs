...
namespace HIS.Desktop.Plugins.CallPatientCashier.Config
{
    class HisConfigCFG
    {
        ...
        private const string CFG_CALL_PATIENT_NUM_ORDER_BACKGROUND_IMAGE = "HIS.CALL_PATIENT_NUM_ORDER.BACKGROUND_IMAGE";//Tên ảnh background
