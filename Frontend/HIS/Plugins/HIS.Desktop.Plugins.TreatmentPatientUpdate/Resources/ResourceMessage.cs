...
namespace HIS.Desktop.Plugins.TreatmentPatientUpdate.Resources
{
    ...
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.TreatmentPatientUpdate.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string HeThongThongBaoVuiLongChonMotBenhNhan
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("HeThongThongBaoVuiLongChonMotBenhNhan", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string HeThongThongBaoBanCoMuonCapNhatThongTinBenhNhanNay
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("HeThongThongBaoBanCoMuonCapNhatThongTinBenhNhanNay", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string BnNoVienPhiQues
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Mes1", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string BnNoVienPhi
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Mes2", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
