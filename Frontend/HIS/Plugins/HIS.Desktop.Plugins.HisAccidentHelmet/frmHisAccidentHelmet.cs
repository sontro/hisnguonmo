...
using HIS.Desktop.Plugins.HisAccidentHelmet.Properties;
...
{
    public partial class frmHisAccidentHelmet : HIS.Desktop.Utility.FormBase
    {
        public frmHisAccidentHelmet(Inventec.Desktop.Common.Modules.Module moduleData)
		:base(moduleData)
        {
            try
            {
        ...
        MOS.EFMODEL.DataModels.HIS_ACCIDENT_HELMET currentData;
        MOS.EFMODEL.DataModels.HIS_ACCIDENT_HELMET resultData;
        ...
        private void SaveProcess()
        {
            ...
            CommonParam param = new CommonParam();
            bool success = false;
            HIS_ACCIDENT_HELMET updateDTO = new HIS_ACCIDENT_HELMET();
            ...
            {
                HisAccidentHelmetFilter filter = new HisAccidentHelmetFilter();
                filter.ID = currentData.ID;
                updateDTO = new BackendAdapter(param).Get<List<HIS_ACCIDENT_HELMET>>
                    (HisRequestUriStore.HIS_ACCIDENT_HELMET_GET, ApiConsumers.MosConsumer, filter, param).FirstOrDefault();
            }

            updateDTO.ACCIDENT_HELMET_CODE = txtCode.Text.Trim();
            updateDTO.ACCIDENT_HELMET_NAME = txtName.Text.Trim();

            if (ActionType == GlobalVariables.ActionAdd)
            {
                updateDTO.IS_ACTIVE = IS_ACTIVE_TRUE;
                resultData = new BackendAdapter(param).Post<HIS_ACCIDENT_HELMET>
                    (HisRequestUriStore.HIS_ACCIDENT_HELMET_CREATE, ApiConsumers.MosConsumer, updateDTO, param);
                if (resultData != null)
                {
                    success = true;
            ...
            {
                resultData = new BackendAdapter(param).Post<HIS_ACCIDENT_HELMET>
                    (HisRequestUriStore.HIS_ACCIDENT_HELMET_UPDATE, ApiConsumers.MosConsumer, updateDTO, param);
                if (resultData != null)
                {
                    success = true;
                    FillDataToGridControl();
        ...
        {
            currentData = new HIS_ACCIDENT_HELMET();
            currentData = (HIS_ACCIDENT_HELMET)gridviewFormList.GetFocusedRow();
            if (currentData != null)
            {
                txtCode.Text = currentData.ACCIDENT_HELMET_CODE;
                txtName.Text = currentData.ACCIDENT_HELMET_NAME;
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisAccidentHelmet.Resources.Lang", typeof(HIS.Desktop.Plugins.HisAccidentHelmet.frmHisAccidentHelmet).Assembly);
        ...
        private void LoadPaging(object param)
        {
            ...
            MOS.Filter.HisAccidentHelmetFilter filterSearch = new HisAccidentHelmetFilter();
            filterSearch.KEY_WORD = txtSearch.Text.Trim();
            filterSearch.ORDER_DIRECTION = "DESC";
            filterSearch.ORDER_FIELD = "MODIFY_TIME";

            Inventec.Core.ApiResultObject<List<MOS.EFMODEL.DataModels.HIS_ACCIDENT_HELMET>> apiResult = null;
            apiResult = new BackendAdapter(paramCommon).GetRO<List<MOS.EFMODEL.DataModels.HIS_ACCIDENT_HELMET>>
                (HisRequestUriStore.HIS_ACCIDENT_HELMET_GET, ApiConsumers.MosConsumer, filterSearch, paramCommon);
            if (apiResult != null)
            {
                var data = (List<MOS.EFMODEL.DataModels.HIS_ACCIDENT_HELMET>)apiResult.Data;
        ...
        #region event
        private void frmHisAccidentHelmet_Load(object sender, EventArgs e)
        {
            try
            {
                SetCaptionByLanguageKey();
        ...
        private void gridviewFormList_CustomRowCellEdit(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            try
            {
                if (e.RowHandle >= 0)
                {
                    HIS_ACCIDENT_HELMET data = (HIS_ACCIDENT_HELMET)gridviewFormList.GetRow(e.RowHandle);
        ...
        private void gridviewFormList_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
            try
            {
                HIS_ACCIDENT_HELMET data = (HIS_ACCIDENT_HELMET)gridviewFormList.GetRow(e.ListSourceRowIndex);
        ...
        private void btnLock_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                CommonParam param = new CommonParam();
                HIS_ACCIDENT_HELMET resultLock = new HIS_ACCIDENT_HELMET();
                bool notHandler = false;

                HIS_ACCIDENT_HELMET currentLock = (HIS_ACCIDENT_HELMET)gridviewFormList.GetFocusedRow();
                    ...
                    "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    WaitingManager.Show();
                    resultLock = new BackendAdapter(param).Post<HIS_ACCIDENT_HELMET>
                        (HisRequestUriStore.HIS_ACCIDENT_HELMET_CHANGELOCK, ApiConsumers.MosConsumer, resultLock, param);
        ...
        private void btnUnlock_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                CommonParam param = new CommonParam();
                HIS_ACCIDENT_HELMET resultUnlock = new HIS_ACCIDENT_HELMET();
                bool notHandler = false;

                HIS_ACCIDENT_HELMET currentUnlock = (HIS_ACCIDENT_HELMET)gridviewFormList.GetFocusedRow();
                    ...
                    "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    WaitingManager.Show();
                    resultUnlock = new BackendAdapter(param).Post<HIS_ACCIDENT_HELMET>(HisRequestUriStore.HIS_ACCIDENT_HELMET_CHANGELOCK, ApiConsumers.MosConsumer,
                        resultUnlock, param);
        ...
        private void btnDelete_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                HIS_ACCIDENT_HELMET currentDelete = (HIS_ACCIDENT_HELMET)gridviewFormList.GetFocusedRow();
                ...
                if (currentDelete != null)
                {
                        ...
                        "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        (HisRequestUriStore.HIS_ACCIDENT_HELMET_DELETE, ApiConsumers.MosConsumer, currentDelete, param);
                        if (success)
                            FillDataToGridControl();
                        MessageManager.Show(this, param, success);
                    }
