...
namespace HIS.Desktop.Plugins.ListPresBloodConfirm
{
    ...
    {
        MOS.EFMODEL.DataModels.V_HIS_EXP_MEST_2 ImpMestRightClick;
        ...
        internal RightMouseClickProcessor(MOS.EFMODEL.DataModels.V_HIS_EXP_MEST_2 currentImpMest, MouseRight_Click MouseRightClick, BarManager barManager, long _roomId, string loginName)
        {
        ...
        internal void InitMenu()
        {
            try
            {
                ...
                if (this.ImpMestRightClick.EXP_MEST_STT_ID == IMSys.DbConfig.HIS_RS.HIS_EXP_MEST_STT.ID__DONE && this.ImpMestRightClick.EXP_MEST_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_IMP_MEST_TYPE.ID__NCC)
                {
                    menu.AddItem(itemManuExpMestCreate);
                }

                if (this.ImpMestRightClick.EXP_MEST_STT_ID == IMSys.DbConfig.HIS_RS.HIS_EXP_MEST_STT.ID__REQUEST && this.ImpMestRightClick.EXP_MEST_TYPE_ID == IMSys.DbConfig.HIS_RS.HIS_IMP_MEST_TYPE.ID__NCC && this.ImpMestRightClick.CREATOR == loginName)
                {
