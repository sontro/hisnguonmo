...
namespace HIS.Desktop.Plugins.ManuImpMestUpdate.Config
{
    class HisImpMestTypeAuthorziedCFG
    {
        ...
        public static bool ImpMestType_IsAuthorized
        {
            get
            {
                ...
                {
                    impMestType_IsAuthorized = Get(HIS.Desktop.LocalStorage.HisConfig.HisConfigs.Get<string>(CONFIG_KEY__IMP_MEST_TYPE__AUTHORIZED));
                }
