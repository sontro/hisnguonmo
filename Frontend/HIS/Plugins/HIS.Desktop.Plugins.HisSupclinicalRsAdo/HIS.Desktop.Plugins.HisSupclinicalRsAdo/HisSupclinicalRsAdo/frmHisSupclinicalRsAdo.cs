...
using HIS.Desktop.Plugins.HisSupclinicalRsAdo.Validtion;
using HIS.Desktop.LocalStorage.BackendData;

namespace HIS.Desktop.Plugins.HisSupclinicalRsAdo.HisSupclinicalRsAdo
{
    public partial class frmHisSupclinicalRsAdo : HIS.Desktop.Utility.FormBase
    {
        #region Declare
        int rowCount = 0;
        int dataTotal = 0;
        ...
        #region Construct
        public frmHisSupclinicalRsAdo(Inventec.Desktop.Common.Modules.Module moduleData)
            : base(moduleData)
        {
            try
            {
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisSupclinicalRsAdo.Resources.Lang", typeof(HIS.Desktop.Plugins.HisSupclinicalRsAdo.HisSupclinicalRsAdo.frmHisSupclinicalRsAdo).Assembly);
