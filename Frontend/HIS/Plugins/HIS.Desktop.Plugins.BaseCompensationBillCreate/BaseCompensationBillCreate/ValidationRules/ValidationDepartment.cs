...
{
    class ValidationDepartment : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(System.Windows.Forms.Control control, object value)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(txtDepartmentCode.Text) || string.IsNullOrEmpty(cboDepartment.Text)) return valid;
                valid = true;
            }
            catch (Exception ex)
            {
