...
using HIS.Desktop.Plugins.HisImportMaterialType.FormLoad;

namespace HIS.Desktop.Plugins.HisImportMaterialType
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmMaterialType(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmMaterialType(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
