...
namespace HIS.Desktop.Plugins.HisServiceConditionImport.Validation
{
    public class ValidateRequireAndMaxlength : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
