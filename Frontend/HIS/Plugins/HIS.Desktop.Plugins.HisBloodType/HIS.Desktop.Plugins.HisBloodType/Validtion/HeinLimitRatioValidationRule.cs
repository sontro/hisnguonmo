        ...
        public override bool Validate(System.Windows.Forms.Control control, object value)
        {
            ...
            try
            {
                if (txtHeinLimitRatio == null)
                    return valid;
                if (!String.IsNullOrEmpty(txtHeinLimitRatio.Text) && (Inventec.Common.TypeConvert.Parse.ToDecimal(txtHeinLimitRatio.Text) < 0 || Inventec.Common.TypeConvert.Parse.ToDecimal(txtHeinLimitRatio.Text) > 100))
                {
