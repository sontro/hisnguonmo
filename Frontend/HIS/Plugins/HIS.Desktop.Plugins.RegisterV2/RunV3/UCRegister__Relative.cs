        ...
        private void FillDataIntoUCRelativeInfo(object data)
        {
            try
            {
                if (data is HisPatientSDO)
                {
                    ...
                    dataRelative.RelativePhone = dataOldPatient.RELATIVE_PHONE;
                    dataRelative.FatherName = dataOldPatient.FATHER_NAME;
                    dataRelative.MotherName = dataOldPatient.MOTHER_NAME;
