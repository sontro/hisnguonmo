    ...
    public partial class frmChooseRoomForWaitingScreen : HIS.Desktop.Utility.FormBase
    {
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.CallPatientSample.Resources.Lang", typeof(HIS.Desktop.Plugins.CallPatientSample.frmChooseRoomForWaitingScreen).Assembly);
