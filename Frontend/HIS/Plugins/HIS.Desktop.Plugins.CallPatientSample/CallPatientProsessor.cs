using HIS.Desktop.Plugins.CallPatientSample.CallPatientSample;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.CallPatientSample
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.CallPatientSample",
       "Gọi bênh nhân",
       "Common",
       14,
    ...
    public class CallPatientProsessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ICallPatientSample behavior = CallPatientSampleFactory.MakeICallPatient(param, args);
