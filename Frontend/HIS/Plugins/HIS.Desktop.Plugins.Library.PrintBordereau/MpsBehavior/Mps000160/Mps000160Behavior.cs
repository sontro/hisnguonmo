...
using MPS.Processor.Mps000160.PDO.Config;
...
namespace HIS.Desktop.Plugins.Library.PrintBordereau.Mps000160
{
    public class Mps000160Behavior : MpsDataBase, ILoad
    {
        private string documentName;
        public Mps000160Behavior(long? roomId, List<HIS_SERE_SERV> _sereServs, List<V_HIS_DEPARTMENT_TRAN> _departmentTrans, List<V_HIS_TREATMENT_FEE> _treamentFees, V_HIS_TREATMENT _treatment, List<V_HIS_ROOM> _rooms, List<V_HIS_SERVICE> _services, List<HIS_HEIN_SERVICE_TYPE> _heinServiceTypes, long _totalDayTreatment, string _statusTreatmentOut, string _departmentName, string _userNameReturnResult, string documentname)
        ...
        bool ILoad.Load(string printTypeCode, string fileName, Inventec.Common.FlexCelPrint.DelegateReturnEventPrint returnEventPrint)
        {
            ...
            try
            {
                MPS.Processor.Mps000160.PDO.Config.HeinServiceTypeCFG heinServiceType = new MPS.Processor.Mps000160.PDO.Config.HeinServiceTypeCFG();
                ...
                MPS.Processor.Mps000160.PDO.Config.PatientTypeCFG patientTypeCFG = new MPS.Processor.Mps000160.PDO.Config.PatientTypeCFG();
                ...
                MPS.Processor.Mps000160.PDO.Mps000160PDO rdo = new MPS.Processor.Mps000160.PDO.Mps000160PDO(DepartmentTrans, TreatmentFees, heinServiceType, patientTypeCFG, transactionTypeCFG, SereServs, transactions, Treatment, HeinServiceTypes, Rooms, Services, materialTypes, singleValue);

                PrintCustomShow<Mps000160PDO> printShow = new PrintCustomShow<Mps000160PDO>(printTypeCode, fileName, rdo, returnEventPrint, this.isPreview);
