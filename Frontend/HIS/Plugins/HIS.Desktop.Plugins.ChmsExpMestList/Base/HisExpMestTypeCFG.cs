...
namespace HIS.Desktop.Plugins.ChmsExpMestList.Base
{
    class HisExpMestTypeCFG
    {
        ...
        private static long GetId(string code)
        {
            ...
            try
            {
                ...
                var data = HIS.Desktop.Plugins.ChmsExpMestList.Base.GlobalStore.HisExpMestTypes.FirstOrDefault(o => o.EXP_MEST_TYPE_CODE == value);
