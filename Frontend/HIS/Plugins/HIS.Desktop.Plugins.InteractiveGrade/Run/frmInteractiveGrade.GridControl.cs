    ...
    partial class frmInteractiveGrade
    {
        ...
        private void LoadPaging(object param)
        {
            try
            {
                ...
                Inventec.Core.ApiResultObject<List<MOS.EFMODEL.DataModels.HIS_INTERACTIVE_GRADE>> apiResult = null;
                MOS.Filter.HisInteractiveGradeFilter filter = new HisInteractiveGradeFilter();
                ...
                apiResult = new BackendAdapter(paramCommon).GetRO<List<MOS.EFMODEL.DataModels.HIS_INTERACTIVE_GRADE>>(HisRequestUriStore.MOS_HIS_INTERACTIVE_GRADE_GET, ApiConsumers.MosConsumer, filter, paramCommon);
                ...
                if (apiResult != null)
                {
                    var data = (List<MOS.EFMODEL.DataModels.HIS_INTERACTIVE_GRADE>)apiResult.Data;
                    if (data != null)
                    {
        ...
        private void SetFilterNavBar(ref MOS.Filter.HisInteractiveGradeFilter filter)
        {
            try
            {
