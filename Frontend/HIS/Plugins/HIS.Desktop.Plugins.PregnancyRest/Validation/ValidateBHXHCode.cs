...
namespace HIS.Desktop.Plugins.PregnancyRest.Validation
{
    class ValidateBHXHCode : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(System.Windows.Forms.Control control, object value)
        {
            ...
            try
            {
                if(isRequired && string.IsNullOrEmpty(txtControl.Text))
                {
                    base.ErrorText = MessageUtil.GetMessage(Inventec.Desktop.Common.LibraryMessage.Message.Enum.TruongDuLieuBatBuoc);
