    ...
    partial class frmHisMrCheckItemType
    {
        ...
        private void LoadPaging(object param)
        {
            try
            {
                ...
                Inventec.Core.ApiResultObject<List<MOS.EFMODEL.DataModels.HIS_MR_CHECK_ITEM_TYPE>> apiResult = null;
                MOS.Filter.HisMrCheckItemTypeFilter filter = new HisMrCheckItemTypeFilter();
                ...
                apiResult = new BackendAdapter(paramCommon).GetRO<List<MOS.EFMODEL.DataModels.HIS_MR_CHECK_ITEM_TYPE>>(HisRequestUriStore.MOS_HIS_MR_CHECK_ITEM_TYPE_GET, ApiConsumers.MosConsumer, filter, paramCommon);
                ...
                if (apiResult != null)
                {
                    var data = (List<MOS.EFMODEL.DataModels.HIS_MR_CHECK_ITEM_TYPE>)apiResult.Data;
                    if (data != null)
                    {
        ...
        private void SetFilterNavBar(ref MOS.Filter.HisMrCheckItemTypeFilter filter)
        {
            try
            {
