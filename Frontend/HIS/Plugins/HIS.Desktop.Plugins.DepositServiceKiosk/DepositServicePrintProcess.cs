    ...
    public static class DepositServicePrintProcess
    {
        ...
        public static void LoadPhieuThuPhiDichVu(string printTypeCode, string fileName, bool isExpand, List<MOS.EFMODEL.DataModels.V_HIS_SERE_SERV_12> SereServAlls, MOS.EFMODEL.DataModels.V_HIS_TREATMENT_FEE currentHisTreatment, List<long> sereServIds, MOS.EFMODEL.DataModels.V_HIS_TRANSACTION deposit, List<MOS.EFMODEL.DataModels.HIS_SERE_SERV_DEPOSIT> dereDetails, V_HIS_SERVICE_REQ hisServiceReq, bool isPrintNow, Inventec.Desktop.Common.Modules.Module moduleData)
        {
            ...
            try
            {
                ...
                //Thông tin bệnh nhân
                MPS.Processor.Mps000375.PDO.PatientADO patient = new MPS.Processor.Mps000375.PDO.PatientADO();
                ...
                {
                    patient = new MPS.Processor.Mps000375.PDO.PatientADO(patients.FirstOrDefault());
                }
                ...
                {
                    List<MPS.Processor.Mps000375.PDO.SereServGroupPlusADO> sereServVTTTInKtcADOs = new List<MPS.Processor.Mps000375.PDO.SereServGroupPlusADO>();
                ...
                //
                var sereServDeleteADOs = new List<MPS.Processor.Mps000375.PDO.SereServGroupPlusADO>();
                ...
                MPS.Processor.Mps000375.PDO.Mps000375PDO pdo = new MPS.Processor.Mps000375.PDO.Mps000375PDO(
                        patient,
                        patientTypeAlter,
                        departmentName,
        ...
        static List<MPS.Processor.Mps000375.PDO.SereServGroupPlusADO> PriceBHYTSereServAdoProcess(List<V_HIS_SERE_SERV_12> sereServs)
        {
            List<MPS.Processor.Mps000375.PDO.SereServGroupPlusADO> sereServADOs = new List<MPS.Processor.Mps000375.PDO.SereServGroupPlusADO>();
            ...
            try
            {
                foreach (var item in sereServs)
                {
                    ...
                    MPS.Processor.Mps000375.PDO.SereServGroupPlusADO sereServADO = new MPS.Processor.Mps000375.PDO.SereServGroupPlusADO();
                    AutoMapper.Mapper.CreateMap<MOS.EFMODEL.DataModels.V_HIS_SERE_SERV_12, MPS.Processor.Mps000375.PDO.SereServGroupPlusADO>();
                    sereServADO = AutoMapper.Mapper.Map<MOS.EFMODEL.DataModels.V_HIS_SERE_SERV_12, MPS.Processor.Mps000375.PDO.SereServGroupPlusADO>(item);
                    var patientTypeCFG = HIS.Desktop.LocalStorage.HisConfig.HisConfigs.Get<string>("MOS.HIS_PATIENT_TYPE.PATIENT_TYPE_CODE.BHYT");
