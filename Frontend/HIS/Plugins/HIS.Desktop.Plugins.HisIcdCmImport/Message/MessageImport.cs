...
namespace HIS.Desktop.Plugins.HisIcdCmImport.Message
{
    class MessageImport
    {
        ...
        internal const string DaTonTaiLoaiIcdCm = " {0} đã tồn tại trong loại IcdCm|";
        ...
        internal const string FileImportDaTonTai = "Tồn tại mã ICD_CM giống nhau {0} | ";
    }
