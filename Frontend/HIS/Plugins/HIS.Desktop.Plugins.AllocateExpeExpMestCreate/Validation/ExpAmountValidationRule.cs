...
namespace HIS.Desktop.Plugins.AllocateExpeExpMestCreate.Validation
{
    class ExpAmountValidationRule : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(System.Windows.Forms.Control control, object value)
        {
            ...
            try
            {
                ...
                {
                    ErrorText = LibraryMessage.MessageUtil.GetMessage(LibraryMessage.Message.Enum.Common__SoLuongPhaiLonHonKhong);
