...
namespace HIS.Desktop.Plugins.Library.PrintOtherForm.MpsBehavior.Mps000413
{
    public partial class Mps000413Behavior : MpsDataBase, ILoad
    {
        ...
        public Mps000413Behavior(PrintOtherInputADO _InAdo)
            : base()
        {
