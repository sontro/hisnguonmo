...
namespace HIS.Desktop.Plugins.Library.PrintOtherForm.MpsBehavior.Mps000409
{
    public partial class Mps000409Behavior : MpsDataBase, ILoad
    {
        ...
        public Mps000409Behavior(long _treatmentId, long _deartmentId)
            : base()
        {
        ...
        bool ILoad.Load(string printTypeCode, UpdateType.TYPE updateType)
        {
            ...
            try
            {
                ...
                if (this.treatment != null)
                {
                    ...
                    dicParamPlus.Add("TO_DAY", DateTime.Now.Day);
                    dicParamPlus.Add("TO_MONTH", DateTime.Now.Month);
                    dicParamPlus.Add("TO_YEAR", DateTime.Now.Year);
                }
