...
namespace HIS.Desktop.Plugins.Library.PrintOtherForm.MpsBehavior.Mps000406
{
    public partial class Mps000406Behavior : MpsDataBase, ILoad
    {
        ...
        public Mps000406Behavior(PrintOtherInputADO _InputAdo)
            : base()
        {
        ...
        bool ILoad.Load(string printTypeCode, UpdateType.TYPE updateType)
        {
            ...
            try
            {
                ...
                {
                    dicParamPlus.Add("BED_ROOM_NAME", this.room.ROOM_NAME);
                    dicParamPlus.Add("BED_ROOM_CODE", this.room.ROOM_CODE);
                    dicParamPlus.Add("BED_NAME", "");
                    dicParamPlus.Add("BED_CODE", "");
                }
