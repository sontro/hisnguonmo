...
namespace HIS.Desktop.Plugins.Library.PrintOtherForm.MpsBehavior.Mps000404
{
    public partial class Mps000404Behavior : MpsDataBase, ILoad
    {
        ...
        public Mps000404Behavior(long _treatmentId, long _deartmentId)
            : base()
        {
            this.TreatmentId = _treatmentId;
            this.departmentId = _deartmentId;
        }
