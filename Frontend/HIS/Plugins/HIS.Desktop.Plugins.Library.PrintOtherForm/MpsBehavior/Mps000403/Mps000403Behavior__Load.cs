...
namespace HIS.Desktop.Plugins.Library.PrintOtherForm.MpsBehavior.Mps000403
{
    public partial class Mps000403Behavior : MpsDataBase, ILoad
    {
        private void LoadData()
        {
            try
            {
                ...
                if (this.treatment != null)
                    this.department = BackendDataWorker.Get<V_HIS_DEPARTMENT>().FirstOrDefault(o => o.ID == this.treatment.LAST_DEPARTMENT_ID);
            }
            catch (Exception ex)
            {
