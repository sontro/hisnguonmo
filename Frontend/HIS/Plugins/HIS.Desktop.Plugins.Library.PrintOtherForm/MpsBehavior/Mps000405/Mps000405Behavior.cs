...
namespace HIS.Desktop.Plugins.Library.PrintOtherForm.MpsBehavior.Mps000405
{
    public partial class Mps000405Behavior : MpsDataBase, ILoad
    {
        ...
        private long treatmentBedRoomId;

        public Mps000405Behavior(long _treatmentId, long _deartmentId, long _TreatmentBedRoomId)
            : base()
        {
            this.TreatmentId = _treatmentId;
            this.departmentId = _deartmentId;
            this.treatmentBedRoomId = _TreatmentBedRoomId;
        }
