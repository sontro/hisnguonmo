...
namespace HIS.Desktop.Plugins.BrowseExportTicket.Config
{
    public class HisConfig
    {
        ...
        private const string IS_NOT_ALLOWEDIT = "HIS.Desktop.Plugins.BrowseExportTicket.IsNotAllowEditBloodInformation";
        ...
        internal static bool IsNotAllowEditBloodInformation;
        ...
        internal static void LoadConfig()
        {
            try
            {
                ...
                IsNotAllowEditBloodInformation = HisConfigs.Get<string>(IS_NOT_ALLOWEDIT) == "1";
