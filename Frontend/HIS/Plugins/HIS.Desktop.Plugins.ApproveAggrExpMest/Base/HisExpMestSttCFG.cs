...
namespace HIS.Desktop.Plugins.ApproveAggrExpMest.Base
{
    ...
    {
        private static long expMestSttIdDaExported;
        public static long EXP_MEST_STT_ID__EXPORTED
        {
            get
            {
                if (expMestSttIdDaExported == 0)
                {
                    expMestSttIdDaExported = GetId(ConfigKeys.DBCODE__HIS_RS__HIS_EXP_MEST_STT__EXP_MEST_STT_CODE__EXPORTED);
                }
                return expMestSttIdDaExported;
            }
            set
            {
                expMestSttIdDaExported = value;
            }
        }
