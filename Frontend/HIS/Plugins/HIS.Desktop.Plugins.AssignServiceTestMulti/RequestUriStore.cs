...
namespace HIS.Desktop.Plugins.AssignServiceTestMulti
{
    class RequestUriStore
    {
        ...
        public const string HIS_TEST_SERVICE_REQ_CREATEFORBLOODEXPORT = "/api/HisTestServiceReq/CreateForBloodExport";
        public const string HIS_TEST_SERVICE_REQ_TEST_EXPORT_BLOOD = "/api/HisServiceReq/AssignTestForBlood";
