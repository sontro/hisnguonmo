...
namespace HIS.Desktop.Plugins.AssignServiceTestMulti.Resources
{
    class ResourceMessage
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.AssignServiceTestMulti.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string KhongChonPhongXuLyDichVu
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__KhongChonPhongXuLyDichVu", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
