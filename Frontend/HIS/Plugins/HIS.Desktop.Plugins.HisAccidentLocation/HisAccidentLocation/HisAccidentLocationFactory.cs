...
{
	class HisAccidentLocationFactory
	{
		internal static IHisAccidentLocation makeIControl(CommonParam param, object[] data)
		{
			IHisAccidentLocation result = null;
			try
			{
				result = new HisAccidentLocationBehavior(param, data);
