...
{
    class LisSampleTypeFactory
    {
        internal static ILisSampleType MakeIControl(CommonParam param, object[] data)
        {
            ILisSampleType result = null;

            try{

                result = new LisSampleTypeBehavior(param,data);
