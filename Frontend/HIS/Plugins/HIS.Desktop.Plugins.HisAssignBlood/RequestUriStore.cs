...
namespace HIS.Desktop.Plugins.HisAssignBlood
{
    class RequestUriStore
    {
        ...
        public const string HIS_SERVICE_REQ__ASSIGN_SERVICE = "api/HisServiceReq/AssignService";
        public const string HIS_SERVICE_REQ__BLOODPRESCREATE = "/api/HisServiceReq/BloodPresCreate";
        public const string HIS_EXP_MEST_BLTY_REQ__GETVIEW1 = "/api/HisExpMestBltyReq/GetView1";
        public const string HIS_BLOOD__GETVIEW = "/api/HisBlood/GetView";
        public const string HIS_SERVICE_REQ__BLOOD_UPDATE = "/api/HisServiceReq/BloodPresUpdate";
    }
}
