...
namespace HIS.Desktop.Plugins.HisAssignBlood.Sda.SdaEventLogCreate
{
    internal partial class SdaEventLogCreate : BusinessBase
    {
        ...
        private bool Create(SdaEventLogSDO data)
        {
            ...
            try
            {
                ...
                Inventec.Common.Logging.LogSystem.Info("Du lieu dau vao SdaEventLog/Create:" + Inventec.Common.Logging.LogUtil.TraceData(Inventec.Common.Logging.LogUtil.GetMemberName(() => data), data));
