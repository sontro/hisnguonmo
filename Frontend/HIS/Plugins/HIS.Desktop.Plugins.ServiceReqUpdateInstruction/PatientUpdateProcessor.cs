...
using HIS.Desktop.Plugins.ServiceReqUpdateInstruction.ServiceReqUpdateInstruction;

namespace Inventec.Desktop.Plugins.PatientUpdate
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.ServiceReqUpdateInstruction",
    ...
    public class PatientUpdateProcessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                IServiceReqUpdateInstruction behavior = ServiceReqUpdateInstructionFactory.MakeIControl(param, args);
