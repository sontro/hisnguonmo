...
{
    public partial class frmHisMestMetyDepa : HIS.Desktop.Utility.FormBase
    {
        #region Declare
        int rowCount = 0;
        int dataTotal = 0;
        ...
        MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA currentData;
        ...
        #region Construct
        public frmHisMestMetyDepa(Inventec.Desktop.Common.Modules.Module moduleData)
            : base(moduleData)
        {
            try
            {
        ...
        private void InitComboMedicineTypeId()
        {
            try
            {
                ...
                ControlEditorLoader.Load(lkMedicineTypeId, BackendDataWorker.Get<MOS.EFMODEL.DataModels.HIS_MEDICINE_TYPE>(), controlEditorADO);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        private void LoadPaging(object param)
        {
            try
            {
                ...
                Inventec.Core.ApiResultObject<List<MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA>> apiResult = null;
                HisMestMetyDepaViewFilter filter = new HisMestMetyDepaViewFilter();
                SetFilterNavBar(ref filter);
                gridviewFormList.BeginUpdate();
                apiResult = new BackendAdapter(paramCommon).GetRO<List<MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA>>(HisRequestUriStore.MOSHIS_MEST_METY_DEPA_GETVIEW, ApiConsumers.MosConsumer, filter, paramCommon);
                if (apiResult != null)
                {
                    var data = (List<MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA>)apiResult.Data;
                    if (data != null)
                    {
        ...
        private void SetFilterNavBar(ref HisMestMetyDepaViewFilter filter)
        {
            try
            {
        ...
        private void txtKeyWord_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Down)
                {
                    ...
                    var rowData = (MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA)gridviewFormList.GetFocusedRow();
                    if (rowData != null)
                    {
        ...
        private void gridviewFormList_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
            try
            {
                ...
                {
                    MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA pData = (MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA)((IList)((BaseView)sender).DataSource)[e.ListSourceRowIndex];
        ...
        private void ChangedDataRow(MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA data)
        {
            try
            {
                if (data != null)
        ...
        private void FillDataToEditorControl(MOS.EFMODEL.DataModels.V_HIS_MEST_METY_DEPA data)
        {
            try
            {
                if (data != null)
                {
                    ...
                    lkMedicineTypeId.EditValue = data.MEDICINE_TYPE_ID;
                    txtMaterialTypeCode.Text = data.MEDICINE_TYPE_CODE;
        ...
        private void LoadCurrent(long currentId, ref MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA currentDTO)
        {
            try
            {
                CommonParam param = new CommonParam();
                ...
                filter.ID = currentId;
                currentDTO = new BackendAdapter(param).Get<List<MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA>>(HisRequestUriStore.MOSHIS_MEST_METY_DEPA_GET, ApiConsumers.MosConsumer, filter, param).FirstOrDefault();
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
            ...
            try
            {
                ...
                if (rowData != null)
                {
                    if (MessageBox.Show("Bạn có muốn xóa dữ liệu?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                    {
                        ...
                        if (success)
                        {
                            BackendDataWorker.Reset<HIS_MEST_METY_DEPA>();
                            FillDataToGridControl();
                        }
        ...
        private void SaveProcess()
        {
            ...
            try
            {
                ...
                WaitingManager.Show();
                MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA updateDTO = new MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA();
                ...
                {
                    var resultData = new BackendAdapter(param).Post<MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA>(HisRequestUriStore.MOSHIS_MEST_METY_DEPA_CREATE, ApiConsumers.MosConsumer, updateDTO, param);
                    if (resultData != null)
                    {
                        success = true;
                        FillDataToGridControl();
                ...
                {
                    var resultData = new BackendAdapter(param).Post<MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA>(HisRequestUriStore.MOSHIS_MEST_METY_DEPA_UPDATE, ApiConsumers.MosConsumer, updateDTO, param);
                    if (resultData != null)
                    {
                        success = true;
                        FillDataToGridControl();
        ...
        private void UpdateRowDataAfterEdit(MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA data)
        {
            try
            {
                if (data == null)
                    throw new ArgumentNullException("data(MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA) is null");
                var rowData = (MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA)gridviewFormList.GetFocusedRow();
                if (rowData != null)
                {
                    Inventec.Common.Mapper.DataObjectMapper.Map<MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA>(rowData, data);
        ...
        private void UpdateDTOFromDataForm(ref MOS.EFMODEL.DataModels.HIS_MEST_METY_DEPA currentDTO)
        {
            try
            {
                ...
                if (lkMedicineTypeId.EditValue != null) currentDTO.MEDICINE_TYPE_ID = Inventec.Common.TypeConvert.Parse.ToInt64((lkMedicineTypeId.EditValue ?? "0").ToString());
        ...
        private void lkMedicineTypeId_Closed(object sender, DevExpress.XtraEditors.Controls.ClosedEventArgs e)
        {
            try
            {
                if (e.CloseMode == PopupCloseMode.Normal)
                {
                    ...
                    {
                        var materialType = BackendDataWorker.Get<V_HIS_MEDICINE_TYPE>().FirstOrDefault(o => o.ID == (long)lkMedicineTypeId.EditValue);
                        if (materialType != null)
                        {
                            txtMaterialTypeCode.Text = materialType.MEDICINE_TYPE_CODE;
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisMestMetyDepa.Resources.Lang", typeof(HIS.Desktop.Plugins.HisMestMetyDepa.HisMestMetyDepa.frmHisMestMetyDepa).Assembly);
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            BackendDataWorker.CacheMonitorSyncExecute((typeof(HIS_MEST_METY_DEPA)).ToString(), false);
        ...
        private void txtMaterialTypeCode_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    {
                        var materialType = BackendDataWorker.Get<V_HIS_MEDICINE_TYPE>().FirstOrDefault(o => o.MEDICINE_TYPE_CODE.ToLower() == txtMaterialTypeCode.Text.Trim().ToLower());
                        if (materialType != null)
                        {
