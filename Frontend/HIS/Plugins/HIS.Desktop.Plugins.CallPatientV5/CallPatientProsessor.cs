using HIS.Desktop.Plugins.CallPatientV5.CallPatientV5;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.CallPatientV5
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.CallPatientV5",
       "Gọi bênh nhân",
       "Common",
       14,
    ...
    public class CallPatientProsessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ICallPatientV5 behavior = CallPatientV5Factory.MakeICallPatient(param, args);
