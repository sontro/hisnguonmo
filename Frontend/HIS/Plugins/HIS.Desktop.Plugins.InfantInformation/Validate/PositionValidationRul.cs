...
class PositionValidationRul : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {

    internal DevExpress.XtraEditors.GridLookUpEdit cboInfantPosition;
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                if (cboInfantPosition.EditValue == null) return valid;
