...
class InfantdateValidationRule : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
    internal DevExpress.XtraEditors.TextEdit dtdInfantdate;
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                if (String.IsNullOrEmpty(dtdInfantdate.Text))
                    return valid;
