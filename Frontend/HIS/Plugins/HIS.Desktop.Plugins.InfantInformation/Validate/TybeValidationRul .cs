...
class TybeValidationRul : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {

    internal DevExpress.XtraEditors.GridLookUpEdit cboInfantTybe;
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                if (cboInfantTybe.EditValue == null) return valid;
