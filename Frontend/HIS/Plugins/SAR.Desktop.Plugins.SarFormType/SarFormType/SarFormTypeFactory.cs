using SAR.Desktop.Plugins.SarFormType.Employee;
...
{
    class SarFormTypeFactory
	{
        internal static ISarFormType makeIControl(CommonParam param, object[] data)
		{
            ISarFormType result = null;
			try
			{
                result = new SarFormTypeBehavior(param, data);
