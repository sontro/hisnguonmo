    ...
    public partial class frmChooseRoomForWaitingScreen : HIS.Desktop.Utility.FormBase
    {
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.CallPatientTP.Resources.Lang", typeof(HIS.Desktop.Plugins.CallPatientTP.frmChooseRoomForWaitingScreen).Assembly);
