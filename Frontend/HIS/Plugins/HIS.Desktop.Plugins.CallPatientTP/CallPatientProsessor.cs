using HIS.Desktop.Plugins.CallPatientTP.CallPatientTP;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.CallPatientTP
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.CallPatientTP",
       "Gọi bênh nhân",
       "Common",
       14,
    ...
    public class CallPatientProsessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ICallPatientTP behavior = CallPatientTPFactory.MakeICallPatient(param, args);
