...
namespace HIS.Desktop.Plugins.CallPatientTP
{
    ...
    {
        const string frmWaitingScreen4 = "frmWaitingScreen4";
        ...
        internal static void ShowFormInExtendMonitor(frmWaitingScreen_TP4 control)
        {
            try
            {
                Screen[] sc;
        ...
        internal static void TurnOffExtendMonitor(frmWaitingScreen_TP4 control)
        {
            try
            {
                if (control != null)
