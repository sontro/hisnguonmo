...
using  HIS.Desktop.Plugins.HisImportTestIndexMap.FormLoad;

namespace  HIS.Desktop.Plugins.HisImportTestIndexMap
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmTestIndexMap(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmTestIndexMap(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
