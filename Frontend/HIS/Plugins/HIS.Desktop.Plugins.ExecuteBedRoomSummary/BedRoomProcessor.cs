...
using Inventec.Desktop.Plugins.ExecuteBedRoomSummary.BedRoom;
...
namespace HIS.Desktop.Plugins.ExecuteBedRoomSummary
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
        ...
        true,
        true)]
    public class BedRoomProcessor : ModuleBase, IDesktopRoot
    {
        CommonParam param;
        public BedRoomProcessor()
        {
            param = new CommonParam();
        }
        public BedRoomProcessor(CommonParam paramBusiness)
        {
