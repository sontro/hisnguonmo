...
namespace HIS.Desktop.Plugins.HisSaleExpMestList.Base
{
    class HisExpMestTypeCFG
    {
        ...
        private static long GetId(string code)
        {
            ...
            try
            {
                ...
                var data = HIS.Desktop.Plugins.HisSaleExpMestList.Base.GlobalStore.HisExpMestTypes.FirstOrDefault(o => o.EXP_MEST_TYPE_CODE == value);
