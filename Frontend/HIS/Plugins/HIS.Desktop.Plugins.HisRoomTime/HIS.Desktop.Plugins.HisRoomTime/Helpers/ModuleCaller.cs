...
namespace HIS.Desktop.Plugins.HisRoomTime.Helpers
{
    public class ModuleCaller
    {
        internal const string HisNumOrderBlock = "HIS.Desktop.Plugins.HisNumOrderBlock";

        public ModuleCaller(string _moduleLink, long _roomId, long _roomTypeId, List<object> _listObj)
        {
