...
namespace HIS.Desktop.Plugins.HisBedRoomIn.Resources
{
    class ResourceMessage
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.HisBedRoomIn.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        public static string GiuongVuotQuaSoLuong
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("GiuongVuotQuaSoLuong", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        public static string GiuongDaCoBenhNhanNam
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("GiuongDaCoBenhNhanNam", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        public static string KhongDuocPhepNamGhep
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("KhongDuocPhepNamGhep", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Error(ex);
