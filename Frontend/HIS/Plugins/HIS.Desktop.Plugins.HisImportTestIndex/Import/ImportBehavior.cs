...
using  HIS.Desktop.Plugins.HisImportTestIndex.FormLoad;

namespace  HIS.Desktop.Plugins.HisImportTestIndex
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmTestIndex(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmTestIndex(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
