    ...
    partial class frmHisDebateReason
    {
        ...
        private void LoadPaging(object param)
        {
            try
            {
                ...
                Inventec.Core.ApiResultObject<List<MOS.EFMODEL.DataModels.HIS_DEBATE_REASON>> apiResult = null;
                MOS.Filter.HisDebateReasonFilter filter = new HisDebateReasonFilter();
                ...
                apiResult = new BackendAdapter(paramCommon).GetRO<List<MOS.EFMODEL.DataModels.HIS_DEBATE_REASON>>(HisRequestUriStore.MOS_HIS_DEBATE_REASON_GET, ApiConsumers.MosConsumer, filter, paramCommon);
                ...
                if (apiResult != null)
                {
                    var data = (List<MOS.EFMODEL.DataModels.HIS_DEBATE_REASON>)apiResult.Data;
                    if (data != null)
                    {
        ...
        private void SetFilterNavBar(ref MOS.Filter.HisDebateReasonFilter filter)
        {
            try
            {
