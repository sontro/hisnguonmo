...
namespace LIS.Desktop.Plugins.LisSampleCondition.LisSampleCondition
{
    public partial class frmLisSampleCondition : HIS.Desktop.Utility.FormBase
    {
        ...
        private void SaveProcess()
        {
            ...
            try
            {
                ...
                if (ActionType == GlobalVariables.ActionAdd)
                {
                    ...
                    var resultData = new BackendAdapter(param).Post<LIS.EFMODEL.DataModels.LIS_SAMPLE_CONDITION>(LisSampleCondititonUriStore.SAMPLE_CONDITION_CREATE, ApiConsumers.LisConsumer, updateDTO, param);
                    if (resultData != null)
                    {
                        success = true;
                        FillDataToGridControl();
                ...
                {
                    var resultData = new BackendAdapter(param).Post<LIS.EFMODEL.DataModels.LIS_SAMPLE_CONDITION>(LisSampleCondititonUriStore.SAMPLE_CONDITION_UPDATE, ApiConsumers.LisConsumer, updateDTO, param);
                    if (resultData != null)
                    {
                        success = true;
        ...
        private void frmLisSampleCondition_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Control)
            {
