...
{
	class HisBornResultFactory
	{
		internal static IHisBornResult makeIControl(CommonParam param, object[] data)
		{
			IHisBornResult result = null;
			try
			{
				result = new HisBornResultBehavior(param, data);
