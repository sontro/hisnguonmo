...
namespace  HIS.Desktop.Plugins.HisImportServicePaty.Message
{
    class MessageImport
    {
        ...
        internal const string DaBiKhoa = "{0} đã bị khóa|";
        internal const string TonTaiDaBiKhoa = "Tồn tại {0} đã bị khóa|";
        internal const string PhaiLonHon = "{0} phải lớn hơn hoặc bằng {1}|";
        internal const string PhaiLaLa = "{0} phải là lá|";
