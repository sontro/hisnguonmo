...
using  HIS.Desktop.Plugins.HisImportServicePaty.FormLoad;

namespace  HIS.Desktop.Plugins.HisImportServicePaty
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmServicePaty(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmServicePaty(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
