...
namespace HIS.Desktop.Plugins.AccidentHurt.Validation
{
    class ValidateMaxlengthCMNDCCCD : ValidationRule
    {
        ...
        public override bool Validate(Control control, object value)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(textEdit.Text) && ((textEdit.Text.Length < 9) || ((textEdit.Text.Length >9) && (textEdit.Text.Length <12))))
                {
