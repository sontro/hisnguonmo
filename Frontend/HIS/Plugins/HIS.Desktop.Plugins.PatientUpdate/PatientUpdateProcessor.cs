...
using Inventec.Desktop.Plugins.PatientUpdate.Update;
using System;
...
namespace Inventec.Desktop.Plugins.PatientUpdate
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.PatientUpdate",
    ...
    public class PatientUpdateProcessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
             IPatientUpdate behavior = PatientUpdateFactory.MakeIPatientUpdate(param, args);
