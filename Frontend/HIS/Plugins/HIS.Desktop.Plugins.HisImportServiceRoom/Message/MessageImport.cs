...
namespace  HIS.Desktop.Plugins.HisImportServiceRoom.Message
{
    class MessageImport
    {
        ...
        internal const string DuLieuDaTonTaiTrenTemplate = " Dữ liệu đã tồn tại trên biểu mẫu (mã dịch vụ {0}, mã loại dịch vụ {1}, mã phòng {2})";
        internal const string DuLieuDaTonTaiTrenHeThong = " Dữ liệu đã tồn tại trên hệ thống (mã dịch vụ {0}, mã loại dịch vụ {1}, mã phòng {2}, mã loại phòng {3})";
        internal const string DichVuKhongThuocLoaiDichVu = "Dịch vụ không thuộc loại {0}|";
        internal const string phongKhongThuocLoaiPhong = "Phòng không thuộc loại {0}|";
        internal const string ChiChoPhepNhapVoiLoaiDichVuLaPTTT = "Chỉ cho phép nhập với loại dịch vụ là PTTT|";
        internal const string DaTonTai = "SERVICE_CODE đã tồn tại|";
