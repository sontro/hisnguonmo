...
using  HIS.Desktop.Plugins.HisImportServiceRoom.FormLoad;

namespace  HIS.Desktop.Plugins.HisImportServiceRoom
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmServiceRoom(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmServiceRoom(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
