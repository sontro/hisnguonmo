...
namespace Inventec.Desktop.Plugins.HisImport.Run
{
    public sealed class HisImportBehavior : Tool<IDesktopToolContext>, IHisImport
    {
        object[] entity;
        Inventec.Desktop.Common.Modules.Module currentModule;
        RefeshReference delegateRefresh;
        public HisImportBehavior()
            : base()
        {
        }

        public HisImportBehavior(CommonParam param, object[] filter)
            : base()
        {
            this.entity = filter;
        }

        object IHisImport.Run()
        {
            object result = null;
            try
            {
