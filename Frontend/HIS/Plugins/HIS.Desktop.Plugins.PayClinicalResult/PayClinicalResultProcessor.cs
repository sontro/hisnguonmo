...
namespace Inventec.Desktop.Plugins.ExecuteRoom
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.PayClinicalResult",
       "Phòng xử lý",
       "Common",
       14,
       "phong.png",
    ...
    public class PayClinicalResultProcessor : ModuleBase, IDesktopRoot
    {
        CommonParam param;
        public PayClinicalResultProcessor()
        {
            param = new CommonParam();
        }
        public PayClinicalResultProcessor(CommonParam paramBusiness)
        {
