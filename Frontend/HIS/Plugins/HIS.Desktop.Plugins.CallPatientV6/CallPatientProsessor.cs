using HIS.Desktop.Plugins.CallPatientV6.CallPatientV6;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.CallPatientV6
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.CallPatientV6",
       "Gọi bênh nhân",
       "Common",
       14,
    ...
    public class CallPatientProsessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                ICallPatientV6 behavior = CallPatientV6Factory.MakeICallPatient(param, args);
