...
{
    public partial class frmHisDiseaseRelation : HIS.Desktop.Utility.FormBase
    {
        #region Declare
        int rowCount = 0;
        int dataTotal = 0;
        ...
        MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION currentData;
        ...
        #region Construct
        public frmHisDiseaseRelation(Inventec.Desktop.Common.Modules.Module moduleData)
		:base(moduleData)
        {
            try
            {
        ...
        private void frmHisDiseaseRelation_Load(object sender, EventArgs e)
        {
            try
            {
                MeShow();
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisDiseaseRelation.Resources.Lang", typeof(HIS.Desktop.Plugins.HisDiseaseRelation.frmHisDiseaseRelation).Assembly);
        ...
        private void InitTabIndex()
        {
            try
            {
                dicOrderTabIndexControl.Add("txtDiseaseRelationCode", 0);
                dicOrderTabIndexControl.Add("txtDiseaseRelationName", 1);
        ...
        private void LoadPaging(object param)
        {
            try
            {
                ...
                Inventec.Core.ApiResultObject<List<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>> apiResult = null;
                HisDiseaseRelationFilter filter = new HisDiseaseRelationFilter();
                SetFilterNavBar(ref filter);
                filter.ORDER_DIRECTION = "DESC";
                filter.ORDER_FIELD = "MODIFY_TIME";
                dnNavigation.DataSource = null;
                gridviewFormList.BeginUpdate();
                apiResult = new BackendAdapter(paramCommon).GetRO<List<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>>(HisRequestUriStore.MOSHIS_DISEASE_RELASION_GET, ApiConsumers.MosConsumer, filter, paramCommon);
                if (apiResult != null)
                {
                    var data = (List<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>)apiResult.Data;
                    if (data != null)
                    {
        ...
        private void SetFilterNavBar(ref HisDiseaseRelationFilter filter)
        {
            try
            {
        ...
        private void txtKeyWord_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Down)
                {
                    ...
                    var rowData = (MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION)gridviewFormList.GetFocusedRow();
                    if (rowData != null)
                    {
        ...
        private void gridviewFormList_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
            try
            {
                ...
                {
                    MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION pData = (MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION)((IList)((BaseView)sender).DataSource)[e.ListSourceRowIndex];
        ...
        private void dnNavigation_PositionChanged(object sender, EventArgs e)
        {
            try
            {
                this.currentData = (MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION)(gridControlFormList.DataSource as List<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>)[dnNavigation.Position];
        ...
        private void ChangedDataRow(MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION data)
        {
            try
            {
                if (data != null)
        ...
        private void FillDataToEditorControl(MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION data)
        {
            try
            {
                if (data != null)
                {
                    txtDiseaseRelationCode.Text = data.DISEASE_RELATION_CODE;
                    txtDiseaseRelationName.Text = data.DISEASE_RELATION_NAME;
        ...
        private void LoadCurrent(long currentId, ref MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION currentDTO)
        {
            try
            {
                CommonParam param = new CommonParam();
                HisDiseaseRelationFilter filter = new HisDiseaseRelationFilter();
                filter.ID = currentId;
                currentDTO = new BackendAdapter(param).Get<List<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>>(HisRequestUriStore.MOSHIS_DISEASE_RELASION_GET, ApiConsumers.MosConsumer, filter, param).FirstOrDefault();
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        private void btnGDelete_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                var data = new BackendAdapter(param).Get<List<HIS_DISEASE_RELATION>>(HisRequestUriStore.MOSHIS_DISEASE_RELASION_GET, ApiConsumers.MosConsumer, filter, param).FirstOrDefault();

                if (rowData != null)
                {
                    bool success = false;
                    success = new BackendAdapter(param).Post<bool>(HisRequestUriStore.MOSHIS_DISEASE_RELASION_DELETE, ApiConsumers.MosConsumer, data, param);
                    if (success)
                    {
                        BackendDataWorker.Reset<HIS_DISEASE_RELATION>();
                        FillDataToGridControl();
                        currentData = ((List<HIS_DISEASE_RELATION>)gridControlFormList.DataSource).FirstOrDefault();
                    }
        ...
        private void SaveProcess()
        {
            ...
            try
            {
                ...
                WaitingManager.Show();
                MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION updateDTO = new MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION();
                ...
                if (ActionType == GlobalVariables.ActionAdd)
                {
                    ...
                    var resultData = new BackendAdapter(param).Post<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>(HisRequestUriStore.MOSHIS_DISEASE_RELASION_CREATE, ApiConsumers.MosConsumer, updateDTO, param);
                    if (resultData != null)
                    {
                        success = true;
                        FillDataToGridControl();
                ...
                {
                    var resultData = new BackendAdapter(param).Post<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>(HisRequestUriStore.MOSHIS_DISEASE_RELASION_UPDATE, ApiConsumers.MosConsumer, updateDTO, param);
                    if (resultData != null)
                    {
                        success = true;
                        FillDataToGridControl();
        ...
        private void UpdateRowDataAfterEdit(MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION data)
        {
            try
            {
                if (data == null)
                    throw new ArgumentNullException("data(MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION) is null");
                var rowData = (MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION)gridviewFormList.GetFocusedRow();
                if (rowData != null)
                {
                    Inventec.Common.Mapper.DataObjectMapper.Map<MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION>(rowData, data);
        ...
        private void UpdateDTOFromDataForm(ref MOS.EFMODEL.DataModels.HIS_DISEASE_RELATION currentDTO)
        {
            try
            {
                currentDTO.DISEASE_RELATION_CODE = txtDiseaseRelationCode.Text.Trim();
                currentDTO.DISEASE_RELATION_NAME = txtDiseaseRelationName.Text.Trim();
        ...
        private void ValidateForm()
        {
            try
            {
                ValidationSingleControl(txtDiseaseRelationCode);
                ValidationSingleControl(txtDiseaseRelationName);
        ...
        private void btnGLock_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            CommonParam param = new CommonParam();
            HIS_DISEASE_RELATION success = new HIS_DISEASE_RELATION();
            //bool notHandler = false;
            try
            {

                HIS_DISEASE_RELATION data = (HIS_DISEASE_RELATION)gridviewFormList.GetFocusedRow();
                if (MessageBox.Show(LibraryMessage.MessageUtil.GetMessage(LibraryMessage.Message.Enum.HeThongTBCuaSoThongBaoBanCoMuonBoKhoaDuLieuKhong), "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    HIS_DISEASE_RELATION data1 = new HIS_DISEASE_RELATION();
                    data1.ID = data.ID;
                    WaitingManager.Show();
                    success = new Inventec.Common.Adapter.BackendAdapter(param).Post<HIS_DISEASE_RELATION>(HisRequestUriStore.MOSHIS_DISEASE_RELASION_CHANGE_LOCK, ApiConsumers.MosConsumer, data1, param);
                    WaitingManager.Hide();
                    if (success != null)
                    {
                        BackendDataWorker.Reset<HIS_DISEASE_RELATION>();
        ...
        private void gridviewFormList_CustomRowCellEdit(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            try
            {
                ...
                if (e.RowHandle >= 0)
                {
                    HIS_DISEASE_RELATION data = (HIS_DISEASE_RELATION)((IList)((BaseView)sender).DataSource)[e.RowHandle];
