...
{
    class BillTransferFactory
    {
        internal static IBillTransfer MakeIBillTransfer(CommonParam param, object[] args)
        {
            IBillTransfer result = null;
            try
            {
                result = new BillTransferBehavior(param, args);
