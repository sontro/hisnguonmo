...
namespace HIS.Desktop.Plugins.AssignNutrition.Resources
{
    ...
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.AssignNutrition.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        internal static string KhongCoChinhSachGiaBuaAn
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugin_AssignService__KhongCoChinhSachGiaBuaAn", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
