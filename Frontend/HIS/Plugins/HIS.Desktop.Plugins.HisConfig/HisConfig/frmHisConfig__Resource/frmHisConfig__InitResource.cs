        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisConfig.Resources.Lang", typeof(HIS.Desktop.Plugins.HisConfig.HisConfig.frmHisConfig__Resource).Assembly);
                ...
                this.gridColumn5.Caption = Inventec.Common.Resource.Get.Value("frmHisConfig.gridColumn5.Caption", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                this.gridColumn5.ToolTip = Inventec.Common.Resource.Get.Value("frmHisConfig.gridColumn5.ToolTip", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
                ...
                this.layoutControl1.Text = Inventec.Common.Resource.Get.Value("frmHisConfig.layoutControl1.Text", Resources.ResourceLanguageManager.LanguageResource, LanguageManager.GetCulture());
