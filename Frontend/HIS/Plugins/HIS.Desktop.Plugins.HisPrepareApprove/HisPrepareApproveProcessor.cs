using HIS.Desktop.Plugins.HisPrepareApprove.HisPrepareApprove;
using Inventec.Core;
...
namespace HIS.Desktop.Plugins.HisPrepareApprove
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
        "HIS.Desktop.Plugins.HisPrepareApprove",
        "bệnh nhân lao",
        "Common",
        62,
        "bidList.png",
    ...
    public class HisPrepareApproveProcessor : ModuleBase, IDesktopRoot
    {
        ...
        object IDesktopRoot.Run(object[] args)
        {
            ...
            try
            {
                IHisPrepareApprove behavior = HisPrepareApproveFactory.MakeIHisPrepareApprove(param, args);
