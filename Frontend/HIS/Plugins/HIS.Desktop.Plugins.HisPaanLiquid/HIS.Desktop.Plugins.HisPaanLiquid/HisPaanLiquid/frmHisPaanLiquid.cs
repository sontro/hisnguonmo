...
{
    public partial class frmHisPaanLiquid : HIS.Desktop.Utility.FormBase
    {
        #region Declare
        int rowCount = 0;
        int dataTotal = 0;
        ...
        MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID currentData;
        List<string> arrControlEnableNotChange = new List<string>();
        Dictionary<string, int> dicOrderTabIndexControl = new Dictionary<string, int>();
        Inventec.Desktop.Common.Modules.Module moduleData;
        internal long paanLiquidId;
        #endregion

        #region Construct
        public frmHisPaanLiquid(Inventec.Desktop.Common.Modules.Module moduleData)
		:base(moduleData)
        {
            try
            {
        ...
        private void frmHisPaanLiquid_Load(object sender, EventArgs e)
        {
            try
            {
                MeShow();
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguageResource = new ResourceManager("HIS.Desktop.Plugins.HisPaanLiquid.Resources.Lang", typeof(HIS.Desktop.Plugins.HisPaanLiquid.HisPaanLiquid.frmHisPaanLiquid).Assembly);
        ...
        private void InitTabIndex()
        {
            try
            {
                dicOrderTabIndexControl.Add("txtPaanLiquidCode", 0);
                dicOrderTabIndexControl.Add("txtPaanLiquidName", 1);
        ...
        private void LoadPaging(object param)
        {
            try
            {
                ...
                Inventec.Core.ApiResultObject<List<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>> apiResult = null;
                HisPaanLiquidFilter filter = new HisPaanLiquidFilter();
                SetFilterNavBar(ref filter);
                dnNavigation.DataSource = null;
                gridviewFormList.BeginUpdate();
                apiResult = new BackendAdapter(paramCommon).GetRO<List<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>>(HisRequestUriStore.MOSHIS_PAAN_LIQUID_GET, ApiConsumers.MosConsumer, filter, paramCommon);
                if (apiResult != null)
                {
                    var data = (List<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>)apiResult.Data;
                    if (data != null)
                    {
        ...
        private void SetFilterNavBar(ref HisPaanLiquidFilter filter)
        {
            try
            {
        ...
        private void txtKeyWord_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Down)
                {
                    ...
                    var rowData = (MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID)gridviewFormList.GetFocusedRow();
                    if (rowData != null)
                    {
        ...
        private void gridviewFormList_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
            try
            {
                if (e.IsGetData && e.Column.UnboundType != UnboundColumnType.Bound)
                {
                    ...
                    MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID pData = (MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID)((IList)((BaseView)sender).DataSource)[e.ListSourceRowIndex];
        ...
        private void dnNavigation_PositionChanged(object sender, EventArgs e)
        {
            try
            {
                this.currentData = (MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID)(gridControlFormList.DataSource as List<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>)[dnNavigation.Position];
        ...
        private void ChangedDataRow(MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID data)
        {
            try
            {
                if (data != null)
        ...
        private void FillDataToEditorControl(MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID data)
        {
            try
            {
                if (data != null)
                {
                    paanLiquidId = data.ID;
                    txtPaanLiquidCode.Text = data.PAAN_LIQUID_CODE;
                    txtPaanLiquidName.Text = data.PAAN_LIQUID_NAME;
        ...
        private void LoadCurrent(long currentId, ref MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID currentDTO)
        {
            try
            {
                CommonParam param = new CommonParam();
                HisPaanLiquidFilter filter = new HisPaanLiquidFilter();
                filter.ID = currentId;
                currentDTO = new BackendAdapter(param).Get<List<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>>(HisRequestUriStore.MOSHIS_PAAN_LIQUID_GET, ApiConsumers.MosConsumer, filter, param).FirstOrDefault();
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        private void btnGDelete_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                if (rowData != null)
                {
                    bool success = false;
                    CommonParam param = new CommonParam();
                    success = new BackendAdapter(param).Post<bool>(HisRequestUriStore.MOSHIS_PAAN_LIQUID_DELETE, ApiConsumers.MosConsumer, rowData.ID, param);
                    if (success)
                    {
                        FillDataToGridControl();
                        BackendDataWorker.Reset<HIS_PAAN_LIQUID>();
                    }
        ...
        private void SaveProcess()
        {
            ...
            try
            {
                ...
                WaitingManager.Show();
                MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID updateDTO = new MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID();
                ...
                {
                    var resultData = new BackendAdapter(param).Post<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>(HisRequestUriStore.MOSHIS_PAAN_LIQUID_CREATE, ApiConsumers.MosConsumer, updateDTO, param);
                    if (resultData != null)
                    {
                        success = true;
                        FillDataToGridControl();
                ...
                {
                    if (paanLiquidId != null)
                    {
                        updateDTO.ID = paanLiquidId;
                        var resultData = new BackendAdapter(param).Post<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>(HisRequestUriStore.MOSHIS_PAAN_LIQUID_UPDATE, ApiConsumers.MosConsumer, updateDTO, param);
                        if (resultData != null)
                        {
                            success = true;
                            FillDataToGridControl();
        ...
        private void UpdateRowDataAfterEdit(MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID data)
        {
            try
            {
                if (data == null)
                    throw new ArgumentNullException("data(MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID) is null");
                var rowData = (MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID)gridviewFormList.GetFocusedRow();
                if (rowData != null)
                {
                    Inventec.Common.Mapper.DataObjectMapper.Map<MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID>(rowData, data);
        ...
        private void UpdateDTOFromDataForm(ref MOS.EFMODEL.DataModels.HIS_PAAN_LIQUID currentDTO)
        {
            try
            {
                //currentData.ID = paanLiquidId;
                currentDTO.PAAN_LIQUID_CODE = txtPaanLiquidCode.Text.Trim();
                currentDTO.PAAN_LIQUID_NAME = txtPaanLiquidName.Text.Trim();
        ...
        private void ValidateForm()
        {
            try
            {
                ValidationSingleControl(txtPaanLiquidCode);
                ValidationSingleControl(txtPaanLiquidName);
