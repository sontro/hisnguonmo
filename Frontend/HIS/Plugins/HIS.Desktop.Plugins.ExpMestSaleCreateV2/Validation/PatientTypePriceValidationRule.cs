...
{
    class PatientTypePriceValidationRule : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(System.Windows.Forms.Control control, object value)
        {
            ...
            try
            {
                if (checkImpExpPrice == null || cboPatientType == null) return valid;
                if (!checkImpExpPrice.Checked && cboPatientType.EditValue == null)
                {
