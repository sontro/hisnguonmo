...
using  HIS.Desktop.Plugins.HisImportPtttMethod.FormLoad;

namespace  HIS.Desktop.Plugins.HisImportPtttMethod
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmPtttMethod(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmPtttMethod(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
