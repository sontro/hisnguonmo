    ...
    public partial class frmPatientChoice : HIS.Desktop.Utility.FormBase
    {
        ...
        private void SetCaptionByLanguageKey()
        {
            try
            {
                ...
                Resources.ResourceLanguageManager.LanguagefrmPatientChoice = new ResourceManager("HIS.Desktop.Plugins.HisHoldReturn.Resources.Lang", typeof(HIS.Desktop.Plugins.HisHoldReturn.frmPatientChoice).Assembly);
        ...
        private void ProcessSelectedPatientSdo(ref HisPatientSDO patient)
        {
            try
            {
                ...
                HisPatientWarningSDO patientWarningSDO = new BackendAdapter(param).Get<List<HisPatientWarningSDO>>(RequestUriStore.HIS_PATIENT_GETSPREVIOUSWARNING, ApiConsumers.MosConsumer, patient.ID, HIS.Desktop.Controls.Session.SessionManager.ActionLostToken, param).SingleOrDefault();
