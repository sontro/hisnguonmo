...
namespace HIS.Desktop.Plugins.LisSampleUpdate.Config
{
    class HisConfigCFG
    {
        private const string CONFIG_KEY__AUTO_RETURN_RESULT_BEFORE_PRINT = "HIS.Desktop.Plugins.LisSampleUpdate__AutoReturnResultBeforePrint";
        private const string CONFIG_KEY__RETURN_RESULT_WARNING_TIME = "HIS.Desktop.Plugins.LisSampleUpdate__ReturnResultWarningTime";
        ...
        private const string CONFIG_KEY__KBYT_URL = "HIS.KBYT.URL";

        internal static string KBYT_URL;
        ...
        internal static void LoadConfig()
        {
            try
            {
                KBYT_URL = GetValue(CONFIG_KEY__KBYT_URL);
