...
namespace HIS.Desktop.Plugins.ReturnMicrobiologicalResults.AddSigner
{
    public partial class frmSignerAdd : Form
    {
        ...
        private void GetDataSignParanel()
        {
            try
            {
                var sarPrint341 = BackendDataWorker.Get<SAR.EFMODEL.DataModels.SAR_PRINT_TYPE>().FirstOrDefault(o => o.PRINT_TYPE_CODE == MPS.Processor.Mps000341.PDO.PrintTypeCode.Mps000341);
                if (sarPrint341 != null && !String.IsNullOrWhiteSpace(sarPrint341.EMR_DOCUMENT_TYPE_CODE))
                {
                    var documentType = BackendDataWorker.Get<EMR_DOCUMENT_TYPE>().FirstOrDefault(o => o.DOCUMENT_TYPE_CODE == sarPrint341.EMR_DOCUMENT_TYPE_CODE);
        ...
        //        Resources.ResourceLanguageManager.LanguageResource__frmSignerAdd = new ResourceManager("HIS.Desktop.Plugins.ReturnMicrobiologicalResults.Resources.Lang", typeof(frmSignerAdd).Assembly);
