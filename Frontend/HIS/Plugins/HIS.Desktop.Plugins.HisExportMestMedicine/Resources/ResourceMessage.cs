...
namespace HIS.Desktop.Plugins.HisExportMestMedicine.Resources
{
    class ResourceMessage
    {
        ...
        internal static string PhieuTongHopKhongDuocHuyThucXuat
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("PhieuTongHopKhongDuocHuyThucXuat", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
