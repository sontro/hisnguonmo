...
namespace HIS.Desktop.Plugins.ExpMestAggregate.Resources
{
    class ResourceMessage
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.ExpMestAggregate.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string PhieuCoCacThuocSauCoSoLuongLe
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("PhieuCoCacThuocSauCoSoLuongLe", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string CacThuocSauCoSoLuongLe
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("CacThuocSauCoSoLuongLe", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
        ...
        internal static string Phieu
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Phieu", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
