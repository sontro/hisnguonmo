...
using HIS.Desktop.Plugins.AssignServiceEdit;
...
namespace HIS.Desktop.Plugins.AssignServiceEdit.AssignServiceEdit
{
    public partial class frmWaringConfigIcdService : Form
    {
        ...
        List<HisSereServADO> serviceCheckeds__Send;
        Inventec.Desktop.Common.Modules.Module currentModule;
        DelegateSelectData delegateSelectData;
        bool isYes = false;
        public System.Drawing.Size OldSize { get; set; }
        public frmWaringConfigIcdService(List<HIS_ICD> _icdCodeFromUc, List<HisSereServADO> _serviceCheckeds__Send, Inventec.Desktop.Common.Modules.Module _currentModule, DelegateSelectData _delegateSelectData)
        {
            InitializeComponent();
        ...
        private void frmWaringConfigIcdService_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.serviceCheckeds__Send != null && this.serviceCheckeds__Send.Count > 0)
                {
                    ...
                    {
                        serviceNames += item.SERVICE_CODE + " - " + item.SERVICE_NAME + "; ";
                    }
