...
using HIS.Desktop.Plugins.HisImportMestMedicine.HisImportMestMedicine;
...
namespace HIS.Desktop.Plugins.HisImportMestMedicine
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.HisImportMestMedicine",
       "Danh sách nhập",
       "Common",
       16,
       "nhap-kho.png",     
    ...
    public class HisImportMestMedicineProcessor: ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                IHisImportMestMedicine behavior = HisImportMestMedicineFactory.MakeIHisImportMestMedicine(param, args);
