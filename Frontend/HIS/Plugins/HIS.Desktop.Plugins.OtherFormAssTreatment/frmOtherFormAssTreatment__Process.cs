...
namespace HIS.Desktop.Plugins.OtherFormAssTreatment
{
    public partial class frmOtherFormAssTreatment : HIS.Desktop.Utility.FormBase
    {
        ...
        private void TaoBieuMauBenhAnYHocCoTruyenClick(SarPrintTypeAdo sarPrintType)
        {
            try
            {
                ...
                if (this.Treatment != null)
                {
                    ...
                    TemplateKeyProcessor.SetSingleKey(dicParamPlus,"IN_TIME_STR", Inventec.Common.DateTime.Convert.TimeNumberToTimeStringWithoutSecond(this.Treatment.IN_TIME));
        ...
        private void TaoBieuMauBenhAnYHocCoTruyenClickOld(SarPrintTypeAdo sarPrintType)
        {
            try
            {
                dicParamPlus = new Dictionary<string, object>();
        ...
        private void ProcessWordAndShowWordContentResult(SarPrintTypeAdo sarPrintType)
        {
            try
            {
                ...
                //    + "____" + Inventec.Common.Logging.LogUtil.TraceData(Inventec.Common.Logging.LogUtil.GetMemberName(() => dicParamPlus), dicParamPlus));
