...
namespace SAR.Desktop.Plugins.SarPrintType.Validation
{
    class ValidatespMax : DevExpress.XtraEditors.DXErrorProvider.ValidationRule
    {
        ...
        public override bool Validate(System.Windows.Forms.Control control, object value)
        {
            ...
            try
            {
                ...
                if (spMax.Value < 1)
                {
                    this.ErrorText = SAR.Desktop.Plugins.SarPrintType.Resources.ResourceMessage.InvoiceBook_GiaTriLonHonKhong;
                    return valid;
                }
                valid = true;
            }
