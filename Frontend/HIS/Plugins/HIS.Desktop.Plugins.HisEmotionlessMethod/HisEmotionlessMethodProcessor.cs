...
using HIS.Desktop.Plugins.HisEmotionlessMethod;
using System;
...
namespace HIS.Desktop.Plugins.HisEmotionlessMethod
{
    [ExtensionOf(typeof(DesktopRootExtensionPoint),
       "HIS.Desktop.Plugins.HisEmotionlessMethod",
       "Danh mục",
       "Bussiness",
       4,
       "pttt.png",
    ...
    public class HisProgramProcessor : ModuleBase, IDesktopRoot
    {
        ...
        public object Run(object[] args)
        {
            ...
            try
            {
                IHisEmotionlessMethod behavior = HisEmotionlessMethodFactory.MakeIControl(param, args);
