...
using TYT.Desktop.Plugins.TYTFetusBornList;
        ...
        private void GridPaging(object param)
        {
            try
            {
                ...
                apiResult = new Inventec.Common.Adapter.BackendAdapter
                    ...
                    ("api/TytFetusBorn/Get", HIS.Desktop.ApiConsumer.ApiConsumers.TytConsumer, filter, paramCommon);
                if (apiResult != null)
                {
                    ...
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (row != null)
                    {
                        ...
                        var apiresul = new Inventec.Common.Adapter.BackendAdapter
                            (param).Post<bool>
                            ("/api/TytFetusBorn/Delete", HIS.Desktop.ApiConsumer.ApiConsumers.TytConsumer, row.ID, param);
                        if (apiresul)
                        {
                            success = true;
                            FillDataToGrid();
