...
namespace ACS.Desktop.Plugins.AcsControlRole.AcsControlRole
{
    class AcsControlRoleBehavior : Tool<IDesktopToolContext>, IAcsControlRole
    {
        object[] entity;
        long treatmentId;
        Inventec.Desktop.Common.Modules.Module currentModule;

        internal AcsControlRoleBehavior()
            : base()
        {

        }

        internal AcsControlRoleBehavior(CommonParam param, object[] data)
            : base()
        {
            entity = data;
        }

        object IAcsControlRole.Run()
        {
            object result = null;
            try
            {
                ...
                result = new UCAcsControlRole(moduleData, listApiConsumer[0], listApiConsumer[1], listActionType[0], listLong[0], listString[0], listString[1]);
            }
            catch (Exception ex)
            {
