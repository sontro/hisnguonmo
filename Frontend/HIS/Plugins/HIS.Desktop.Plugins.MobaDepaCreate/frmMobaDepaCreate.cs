...
using HIS.Desktop.Plugins.MobaDepaCreate.ADO;
...
{
    public partial class frmMobaDepaCreate : HIS.Desktop.Utility.FormBase
    {
        long expMestId;
        ...
        public frmMobaDepaCreate(Inventec.Desktop.Common.Modules.Module module, long data)
		:base(module)
        {
            InitializeComponent();
            try
