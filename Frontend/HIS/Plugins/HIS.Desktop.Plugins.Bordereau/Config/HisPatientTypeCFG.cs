    ...
    public class HisPatientTypeCFG
    {
        ...
        public static long PATIENT_TYPE_ID__IS_FEE
        {
            get
            {
                ...
                {
                    patientTypeIdIsFee = GetId(HIS.Desktop.LocalStorage.HisConfig.HisConfigs.Get<string>("MOS.HIS_PATIENT_TYPE.HOSPITAL_FEE"));
                }
        ...
        private static long GetId(string code)
        {
            ...
            try
            {
                var data = BackendDataWorker.Get<HIS_PATIENT_TYPE>(false, true).FirstOrDefault(o => o.PATIENT_TYPE_CODE == code);
