...
{
    class CallPatientFactory
    {
        internal static ICallPatient MakeICallPatient(CommonParam param, object[] args)
        {
            ICallPatient result = null;
            try
            {
                result = new CallPatientBehavior(param, args);
