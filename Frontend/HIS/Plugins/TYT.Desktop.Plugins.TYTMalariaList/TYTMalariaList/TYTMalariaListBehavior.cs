...
namespace TYT.Desktop.Plugins.TYTMalariaList.TYTMalariaList
{
    public sealed class TYTMalariaListBehavior : Tool<IDesktopToolContext>, ITYTMalariaList
    {
        object[] entity;
        public TYTMalariaListBehavior()
            : base()
        {
        }

        public TYTMalariaListBehavior(CommonParam param, object[] filter)
            : base()
        {
            this.entity = filter;
        }

        object ITYTMalariaList.Run()
        {
            try
            {
                ...
                return new UCTYTMalariaList(moduleData);
            }
