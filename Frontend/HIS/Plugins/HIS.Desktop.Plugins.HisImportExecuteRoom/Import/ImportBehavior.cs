...
using  HIS.Desktop.Plugins.HisImportExecuteRoom.FormLoad;

namespace  HIS.Desktop.Plugins.HisImportExecuteRoom
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmExecuteRoom(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmExecuteRoom(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
