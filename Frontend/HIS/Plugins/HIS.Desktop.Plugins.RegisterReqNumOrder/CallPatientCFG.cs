...
namespace HIS.Desktop.Plugins.RegisterReqNumOrder
{
    public class WaitingScreenCFG
    {
        ...
        private const string PATIENT_NOT_CLS = "HIS.Desktop.Plugins.CallPatientVer5.PatientNotCLS"; // lọc bệnh nhân kết luận không quan tâm trạng thái CLS

        private const string CALL_PATIENT_FONT_SIZE__SO_THU_TU_BENH_NHAN_DANG_DUOC_GOI = "EXE.WAITING_SCREEN.FONT_SIZE__SO_THU_TU_BENH_NHAN_DANG_DUOC_GOI"; // lọc bệnh nhân kết luận không quan tâm trạng thái CLS
        private const string CALL_PATIENT_FONT_SIZE__LABEL_SO_THU_TU_BENH_NHAN_DANG_DUOC_GOI = "EXE.WAITING_SCREEN.FONT_SIZE__LABEL_SO_THU_TU_BENH_NHAN_DANG_DUOC_GOI"; // 

        private const string CALL_PATIENT_FONT_SIZE__DANH_SACH_CHO = "EXE.WAITING_SCREEN.FONT_SIZE__DANH_SACH_CHO";//Cỡ chữ "Danh sách chờ khám" và "Danh sách chờ đọc kết quả" 

        private const string CALL_PATIENT_NUM_ODER_DO_CAO_TITTLE = "HIS.CALL_PATIENT_NUM_ORDER.DO_CAO.TITLE";//Chiều cao tiêu đề (STT, Cửa)" 

        private const string CALL_PATIENT_NUM_ODER_DO_CAO_NUM_ORDER = "HIS.CALL_PATIENT_NUM_ORDER.DO_CAO.NUM_ORDER";//Kích thước của từng dòng STT và cửa." 

        private const string CALL_PATIENT_ORGANIZATION_NAME_COLOR_CODES = "EXE.WAITING_SCREEN.ORGANIZATION_NAME.COLOR_CODES";//Thông tin màu chữ tổ chức" 



        private static string patientNotCLS_STR;
        public static string PatientNotCLS
        {
            get
            {
                patientNotCLS_STR = GetName(PATIENT_NOT_CLS);
                return patientNotCLS_STR;
            }
            set
            {
                patientNotCLS_STR = value;
            }
        }
        ...
        private static long fontSizeDanhSachCho;
        public static long FONT_SIZE__DANH_SACH_CHO
        {
            get
            {
                fontSizeDanhSachCho = GetValue(CALL_PATIENT_FONT_SIZE__DANH_SACH_CHO);
                return fontSizeDanhSachCho;
            }
            set
            {
                fontSizeDanhSachCho = value;
            }
        }
        private static long fontSizeLabelSttBenhNhanDangDuocGoi;
        public static long FONT_SIZE__LABEL_SO_THU_TU_BENH_NHAN_DANG_DUOC_GOI
        {
            get
            {
                fontSizeLabelSttBenhNhanDangDuocGoi = GetValue(CALL_PATIENT_FONT_SIZE__LABEL_SO_THU_TU_BENH_NHAN_DANG_DUOC_GOI);
                return fontSizeLabelSttBenhNhanDangDuocGoi;
            }
            set
            {
                fontSizeLabelSttBenhNhanDangDuocGoi = value;
            }
        }
        ...
        public static string CALL_PATIENT_DEN_STR
        {
            get
            {
                callPatientDen = HIS.Desktop.LocalStorage.HisConfig.HisConfigs.Get<string>(PATIENT_NOT_CLS);
        ...
        // minhnq
        private static long? fontSizeTieuDe;
        public static long? NUM_ODER_DO_CAO_TITTLE
        {
            get
            {
                fontSizeTieuDe = (long?)GetValue(CALL_PATIENT_NUM_ODER_DO_CAO_TITTLE);
                return fontSizeTieuDe;
            }
            set
            {
                fontSizeTieuDe = value;
            }
        }

        private static long? fontSizeDoCaoNumOder;
        public static long? NUM_ODER_DO_CAO_NUM_ORDER
        {
            get
            {
                fontSizeDoCaoNumOder = (long?)GetValue(CALL_PATIENT_NUM_ODER_DO_CAO_NUM_ORDER);
                return fontSizeDoCaoNumOder;
            }
            set
            {
                fontSizeDoCaoNumOder = value;
            }
        }

        //emd fontsize mới bổ sung
