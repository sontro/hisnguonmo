...
using HIS.Desktop.Plugins.HisImportService.FormLoad;

namespace HIS.Desktop.Plugins.HisImportService
{
    class ImportBehavior : BusinessBase, IImport
    {
        ...
        object IImport.Run()
        {
            ...
            try
            {
                ...
                {
                    frm = new frmService(moduleData, refeshReference);
                }
                else if (moduleData != null && refeshReference == null)
                {
                    frm = new frmService(moduleData);
                }
                return frm;
            }
            catch (Exception ex)
