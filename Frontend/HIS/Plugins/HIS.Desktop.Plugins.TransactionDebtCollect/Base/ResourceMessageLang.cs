...
namespace HIS.Desktop.Plugins.TransactionDebtCollect.Base
{
    ...
    {
        static System.Resources.ResourceManager languageMessage = new System.Resources.ResourceManager("HIS.Desktop.Plugins.TransactionDebtCollect.Resources.Message.Lang", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        internal static string KhongTimThayMaCongNo
        {
            get
            {
                try
                {
                    return Inventec.Common.Resource.Get.Value("Plugins_TransactionBill__KhongTimThayMaCongNo", languageMessage, Inventec.Desktop.Common.LanguageManager.LanguageManager.GetCulture());
                }
                catch (Exception ex)
                {
                    Inventec.Common.Logging.LogSystem.Warn(ex);
