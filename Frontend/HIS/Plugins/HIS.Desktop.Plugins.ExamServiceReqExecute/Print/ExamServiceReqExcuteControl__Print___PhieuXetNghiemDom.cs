...
namespace HIS.Desktop.Plugins.ExamServiceReqExecute
{
    ...
    {
        private void LoadBieuMauGiayXetNghiemDom(string printTypeCode, string fileName, ref bool result)
        {
            try
            {
                Inventec.Common.Logging.LogSystem.Debug("LoadBieuMauGiayXetNghiemDom.1");
                ...
                otherFormAssTreatmentInputADO.PrintTypeCode = PrintTypeCodeWorker.PRINT_TYPE_CODE__PHIEU_XET_NGHIEM_DOM__MPS000438;
                ...
                Inventec.Common.Logging.LogSystem.Debug("LoadBieuMauGiayXetNghiemDom.2");
            }
            catch (Exception ex)
            {
