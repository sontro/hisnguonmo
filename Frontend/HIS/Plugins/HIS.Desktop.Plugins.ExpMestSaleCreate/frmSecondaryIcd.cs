...
namespace HIS.Desktop.Plugins.ExpMestSaleCreate
{
    public partial class frmSecondaryIcd : FormBase
    {
        ...
        private void Language_secondaryDisease()
        {
            try
            {
                if (ResourceLangManager.LanguageUCExpMestSaleCreate == null)
                {
                    ResourceLangManager.InitResourceLanguageManager();
                }
                grdColCode.Caption = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY_FRM_SECONDARY_DISEASE_GRDCOL_CODE", ResourceLangManager.LanguageUCExpMestSaleCreate, LanguageManager.GetCulture());
                grdColName.Caption = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY_FRM_SECONDARY_DISEASE_GRDCOL_NAME", ResourceLangManager.LanguageUCExpMestSaleCreate, LanguageManager.GetCulture());
                txtIcdNames.Properties.NullValuePrompt = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY_FRM_SECONDARY_DISEASE_ICD_CODE__NULL_TEXT", ResourceLangManager.LanguageUCExpMestSaleCreate, LanguageManager.GetCulture());
                txtIcdCodes.Properties.NullValuePrompt = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY_FRM_SECONDARY_DISEASE_ICD_NAME__NULL_TEXT", ResourceLangManager.LanguageUCExpMestSaleCreate, LanguageManager.GetCulture());
                btnChoose.Text = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY_FRM_SECONDARY_DISEASE_BTN_CHOOSE", ResourceLangManager.LanguageUCExpMestSaleCreate, LanguageManager.GetCulture());
                txtKeyword.Properties.NullValuePrompt = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY_FRM_SECONDARY_GRID_ICD__FIND_NULL_PROMPT_TEXT", ResourceLangManager.LanguageUCExpMestSaleCreate, LanguageManager.GetCulture());
                gridViewSecondaryDisease.OptionsFind.FindNullPrompt = Inventec.Common.Resource.Get.Value("IVT_LANGUAGE_KEY_FRM_SECONDARY_GRID_ICD__FIND_NULL_PROMPT_TEXT", ResourceLangManager.LanguageUCExpMestSaleCreate, LanguageManager.GetCulture());
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Warn(ex);
