...
{
    public class HisServiceReqViewFilter : FilterBase
    {
        public string KEY_WORD__SERVICE_REQ_CODE__PATIENT_CODE__TREATMENT_CODE__PATIENT_NAME { get; set; }
        public string KEY_WORD__SERVICE_REQ_CODE__PATIENT_CODE__TREATMENT_CODE__PATIENT_NAME__SERVICE_REQ_TYPE_CODE { get; set; }
        ...
        public HisServiceReqViewFilter()
            : base()
        {
        }
    }
