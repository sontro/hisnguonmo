...
namespace MOS.MANAGER.HisMediStockPeriod
{
    class HisMediStockPeriodGet : GetBase
    {
        ...
        internal List<V_HIS_MEDI_STOCK_PERIOD> GetView(HisMediStockPeriodViewFilterQuery filter)
        {
            try
            {
                return DAOWorker.HisMediStockPeriodDAO.GetView(filter.Query(), param);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
        ...
        internal HIS_MEDI_STOCK_PERIOD GetById(long id)
        {
            try
            {
                return GetById(id, new HisMediStockPeriodFilterQuery());
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
        ...
        internal V_HIS_MEDI_STOCK_PERIOD GetViewById(long id)
        {
            try
            {
                return GetViewById(id, new HisMediStockPeriodViewFilterQuery());
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
        ...
        internal V_HIS_MEDI_STOCK_PERIOD GetViewById(long id, HisMediStockPeriodViewFilterQuery filter)
        {
            try
            {
                return DAOWorker.HisMediStockPeriodDAO.GetViewById(id, filter.Query());
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
        ...
        internal List<HIS_MEDI_STOCK_PERIOD> GetByMediStockId(long id)
        {
            try
            {
                HisMediStockPeriodFilterQuery filter = new HisMediStockPeriodFilterQuery();
        ...
        internal List<HIS_MEDI_STOCK_PERIOD> GetByPreviousId(long id)
        {
            try
            {
                HisMediStockPeriodFilterQuery filter = new HisMediStockPeriodFilterQuery();
                filter.PREVIOUS_ID = id;
                return this.Get(filter);
            }
            catch (Exception ex)
            {
