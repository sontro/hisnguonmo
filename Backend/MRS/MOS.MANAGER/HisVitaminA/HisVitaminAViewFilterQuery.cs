...
namespace MOS.MANAGER.HisVitaminA
{
    public class HisVitaminAViewFilterQuery : HisVitaminAViewFilter
    {
        ...
        internal List<System.Linq.Expressions.Expression<Func<V_HIS_VITAMIN_A, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_VITAMIN_A, bool>>>();
        ...
        internal HisVitaminASO Query()
        {
            ...
            try
            {
                ...
                search.listVHisVitaminAExpression.AddRange(listExpression);
