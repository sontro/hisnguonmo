    ...
    public class HisServiceReqFilterQuery : HisServiceReqFilter
    {
        ...
        internal HisServiceReqSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisServiceReqExpression.Add(o => !o.IS_NO_EXECUTE.HasValue || o.IS_NO_EXECUTE.Value != ManagerConstant.IS_TRUE);
                }
                if (this.HAS_EXECUTE.HasValue && !this.HAS_EXECUTE.Value)
                {
                    listHisServiceReqExpression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE.Value == ManagerConstant.IS_TRUE);
                ...
                {
                    search.listHisServiceReqExpression.Add(o => o.START_TIME >= this.START_TIME_FROM.Value);
                }
                if (this.START_TIME_TO.HasValue)
                {
                    search.listHisServiceReqExpression.Add(o => o.START_TIME <= this.START_TIME_TO.Value);
                }
