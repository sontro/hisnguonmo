    ...
    public class HisServiceReqView3FilterQuery : HisServiceReqView3Filter
    {
        ...
        internal HisServiceReqSO Query()
        {
            ...
            try
            {
                ...
                {
                    search.listVHisServiceReq3Expression.Add(o => o.SERVICE_REQ_CODE.ToLower().Contains(this.SERVICE_REQ_CODE.ToLower().Trim()));
                }
                ...
                {
                    listVHisServiceReq3Expression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE.Value == ManagerConstant.IS_TRUE);
                }
                if (this.IS_NO_EXECUTE.HasValue && !this.IS_NO_EXECUTE.Value)
                {
                    listVHisServiceReq3Expression.Add(o => !o.IS_NO_EXECUTE.HasValue || o.IS_NO_EXECUTE.Value != ManagerConstant.IS_TRUE);
