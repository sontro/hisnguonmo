    ...
    public class HisServiceReqView9FilterQuery : HisServiceReqView9Filter
    {
        ...
        internal HisServiceReqSO Query()
        {
            ...
            try
            {
                ...
                {
                    search.listVHisServiceReq9Expression.Add(o => o.SERVICE_REQ_CODE.ToLower().Contains(this.SERVICE_REQ_CODE.ToLower().Trim()));
                }
                ...
                //{
                //    search.listVHisServiceReq9Expression.Add(o => this.EXP_MEST_TYPE_IDs.Contains(o.EXP_MEST_TYPE_ID ?? 0));
                //}
                //if (this.NULL_OR_NOT_IN_EXP_MEST_TYPE_IDs != null)
                //{
                //    search.listVHisServiceReq9Expression.Add(o => o.EXP_MEST_TYPE_ID == null || !this.NULL_OR_NOT_IN_EXP_MEST_TYPE_IDs.Contains(o.EXP_MEST_TYPE_ID.Value));
                //}
                ...
                {
                    listVHisServiceReq9Expression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE.Value == ManagerConstant.IS_TRUE);
                }
                if (this.IS_NO_EXECUTE.HasValue && !this.IS_NO_EXECUTE.Value)
                {
                    listVHisServiceReq9Expression.Add(o => !o.IS_NO_EXECUTE.HasValue || o.IS_NO_EXECUTE.Value != ManagerConstant.IS_TRUE);
