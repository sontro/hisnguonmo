    ...
    public class HisImpMestViewFilterQuery : HisImpMestViewFilter
    {
        ...
        internal HisImpMestSO Query()
        {
            ...
            try
            {
                ...
                //if (this.BID_ID != null)
                //{
                //    listVHisImpMestExpression.Add(o => o.BID_ID.HasValue && this.BID_ID.Value == o.BID_ID.Value);
                //}
                ...
                //{
                //    listVHisImpMestExpression.Add(o => o.BID_ID.HasValue && this.BID_IDs.Contains(o.BID_ID.Value));
                //}
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listVHisImpMestExpression.Add(o => o.APPROVAL_LOGINNAME.ToLower().Contains(this.KEY_WORD)
