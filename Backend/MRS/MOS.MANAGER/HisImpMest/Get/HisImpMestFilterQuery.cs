    ...
    public class HisImpMestFilterQuery : HisImpMestFilter
    {
        ...
        internal HisImpMestSO Query()
        {
            ...
            try
            {
                ...
                //if (this.BID_ID != null)
                //{
                //    listHisImpMestExpression.Add(o => o.BID_ID.HasValue && this.BID_ID.Value == o.BID_ID.Value);
                //}
                ...
                //{
                //    listHisImpMestExpression.Add(o => o.BID_ID.HasValue && this.BID_IDs.Contains(o.BID_ID.Value));
                //}
