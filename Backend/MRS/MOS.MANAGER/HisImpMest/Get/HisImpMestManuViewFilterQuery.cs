    ...
    public class HisImpMestManuViewFilterQuery : HisImpMestManuViewFilter
    {
        ...
        internal HisImpMestSO Query()
        {
            ...
            try
            {
                ...
                //if (this.BID_ID != null)
                //{
                //    listVHisImpMestManuExpression.Add(o => o.BID_ID.HasValue && this.BID_ID.Value == o.BID_ID.Value);
                //}
                ...
                //{
                //    listVHisImpMestManuExpression.Add(o => o.BID_ID.HasValue && this.BID_IDs.Contains(o.BID_ID.Value));
                //}
