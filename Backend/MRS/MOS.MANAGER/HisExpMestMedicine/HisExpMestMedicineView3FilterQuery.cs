    ...
    public class HisExpMestMedicineView3FilterQuery : HisExpMestMedicineView3Filter
    {
        ...
        internal HisExpMestMedicineSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisExpMestMedicine3Expression.Add(o => o.EXP_MEST_ID != null && this.EXP_MEST_IDs.Contains(o.EXP_MEST_ID.Value));
                }
                if (this.MEDICINE_IDs != null)
                {
                    listVHisExpMestMedicine3Expression.Add(o => o.MEDICINE_ID != null && this.MEDICINE_IDs.Contains(o.MEDICINE_ID.Value));
                }
                ...
                {
                    listVHisExpMestMedicine3Expression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && this.TDL_SERVICE_REQ_IDs.Contains(o.TDL_SERVICE_REQ_ID.Value));
                }
