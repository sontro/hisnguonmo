...
//  323,326,105,327,379,410,179,185,186,133,531,
namespace MRS.MANAGER.Core.MrsReport.RDO.RDOImpExpMestType
{
    public class RDOImpExpMestTypeContext
    {
        public static void Define(ref Dictionary<string, long> dicImpMestType, ref Dictionary<string, long> dicExpMestType)
        {
            ...
            dicExpMestType.Add("ID__PKTH_EXP_AMOUNT", IMSys.DbConfig.HIS_RS.HIS_EXP_MEST_TYPE.ID__THPK);//15;
            dicExpMestType.Add("ID__VTMA_EXP_AMOUNT", IMSys.DbConfig.HIS_RS.HIS_EXP_MEST_TYPE.ID__VITAMINA);//16;
            dicExpMestType.Add("ID__VACC_EXP_AMOUNT", IMSys.DbConfig.HIS_RS.HIS_EXP_MEST_TYPE.ID__VACCIN);//17;
            ...
            dicImpMestType.Add("ID__DONKTL_IMP_AMOUNT", IMSys.DbConfig.HIS_RS.HIS_IMP_MEST_TYPE.ID__DONKTL); //16;
            dicImpMestType.Add("ID__TSD_IMP_AMOUNT", IMSys.DbConfig.HIS_RS.HIS_IMP_MEST_TYPE.ID__TSD); //17;
        }
    }
}
