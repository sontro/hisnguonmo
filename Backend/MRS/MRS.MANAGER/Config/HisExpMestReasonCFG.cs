...
namespace MRS.MANAGER.Config
{
    public class HisExpMestReasonCFG
    {
        ...
        private static long hisExpMestReasonWARD;
        public static long HIS_EXP_MEST_REASON___05
        {
            get
            {
                if (hisExpMestReasonWARD == 0)
                {
                    hisExpMestReasonWARD = GetId(HIS_EXP_MEST_REASON__05);
                }
                return hisExpMestReasonWARD;
            }
            set
            {
        ...
        public static void Refresh()
        {
            try
            {
                hisExpMestReasonWARD = 0;
                hisExpMestReason04 = 0;
                hisExpMestReason03 = 0;
                hisExpMestReason02 = 0;
                hisExpMestReason01 = 0;
            }
            catch (Exception ex)
            {
