...
namespace MRS.MANAGER.Base
{
    ...
    {
        public static void SetMessage(CommonParam param, MRS.LibraryMessage.Message.Enum en, params string[] extraMessage)
        {
            try
            {
        ...
        public static string GetMessage(MRS.LibraryMessage.Message.Enum en)
        {
            Message message = MRS.LibraryMessage.DatabaseMessage.Get(null, en);
