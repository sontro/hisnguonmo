...
namespace MOS.EFMODEL.DataModels
{
    ...
    public partial class V_HIS_SERE_SERV_3
    {
        ...
        public Nullable<decimal> MEDICINE_IMP_PRICE { get; set; }
        public Nullable<decimal> MEDICINE_IMP_VAT_RATIO { get; set; }
        public Nullable<long> MEDICINE_IMP_TIME { get; set; }
        public Nullable<long> MEDICINE_BID_ID { get; set; }
        ...
        public Nullable<decimal> MATERIAL_IMP_PRICE { get; set; }
        public Nullable<decimal> MATERIAL_IMP_VAT_RATIO { get; set; }
        public Nullable<long> MATERIAL_IMP_TIME { get; set; }
        public Nullable<long> MATERIAL_BID_ID { get; set; }
