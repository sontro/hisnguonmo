...
namespace MOS.EFMODEL.DataModels
{
    ...
    public partial class HIS_EXP_MEST_METY_REQ
    {
        public HIS_EXP_MEST_METY_REQ()
        {
            this.HIS_BCS_METY_REQ_DT = new HashSet<HIS_BCS_METY_REQ_DT>();
            this.HIS_BCS_METY_REQ_REQ = new HashSet<HIS_BCS_METY_REQ_REQ>();
            this.HIS_BCS_METY_REQ_REQ1 = new HashSet<HIS_BCS_METY_REQ_REQ>();
        ...
        public virtual ICollection<HIS_BCS_METY_REQ_REQ> HIS_BCS_METY_REQ_REQ { get; set; }
        public virtual ICollection<HIS_BCS_METY_REQ_REQ> HIS_BCS_METY_REQ_REQ1 { get; set; }
