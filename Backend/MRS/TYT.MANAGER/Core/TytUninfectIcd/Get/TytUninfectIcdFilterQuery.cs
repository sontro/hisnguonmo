...
{
    public class TytUninfectIcdFilterQuery : TytUninfectIcdFilter
    {
        public TytUninfectIcdFilterQuery()
            : base()
        {

        }

        internal List<System.Linq.Expressions.Expression<Func<TYT_UNINFECT_ICD, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<TYT_UNINFECT_ICD, bool>>>();
        ...
        internal TytUninfectIcdSO Query()
        {
            ...
            try
            {
                ...
                search.listTytUninfectIcdExpression.AddRange(listExpression);
                search.OrderField = OrderProcess.GetOrderField<TYT_UNINFECT_ICD>(ORDER_FIELD);
                search.OrderDirection = OrderProcess.GetOrderDirection(ORDER_DIRECTION);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
                search.listTytUninfectIcdExpression.Clear();
                search.listTytUninfectIcdExpression.Add(o => o.ID == NEGATIVE_ID);
            }
            return search;
        }
    }
