...
{
    public class TytGdskViewFilterQuery : TytGdskViewFilter
    {
        public TytGdskViewFilterQuery()
            : base()
        {

        }
        
        internal List<System.Linq.Expressions.Expression<Func<V_TYT_GDSK, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<V_TYT_GDSK, bool>>>();
        ...
        internal TytGdskSO Query()
        {
            ...
            try
            {
                ...
                search.listVTytGdskExpression.AddRange(listExpression);
                search.OrderField = OrderProcess.GetOrderField<V_TYT_GDSK>(ORDER_FIELD);
                search.OrderDirection = OrderProcess.GetOrderDirection(ORDER_DIRECTION);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
                search.listVTytGdskExpression.Clear();
                search.listVTytGdskExpression.Add(o => o.ID == NEGATIVE_ID);
            }
            return search;
        }
    }
