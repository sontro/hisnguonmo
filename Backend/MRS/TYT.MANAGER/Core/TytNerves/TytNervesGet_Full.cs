...
using TYT.MANAGER.Core.TytNerves.Get.ListV;
using TYT.MANAGER.Core.TytNerves.Get.V;
using Inventec.Core;
using System;
    ...
    partial class TytNervesGet : BeanObjectBase, IDelegacyT
    {
        ...
        T IDelegacyT.Execute<T>()
        {
            ...
            try
            {
                ...
                else if (typeof(T) == typeof(List<V_TYT_NERVES>))
                {
                    ITytNervesGetListV behavior = TytNervesGetListVBehaviorFactory.MakeITytNervesGetListV(param, entity);
                    result = behavior != null ? (T)System.Convert.ChangeType(behavior.Run(), typeof(T)) : default(T);
                }
                else if (typeof(T) == typeof(V_TYT_NERVES))
                {
                    ITytNervesGetV behavior = TytNervesGetVBehaviorFactory.MakeITytNervesGetV(param, entity);
                    result = behavior != null ? (T)System.Convert.ChangeType(behavior.Run(), typeof(T)) : default(T);
                }
            }
            catch (Exception ex)
