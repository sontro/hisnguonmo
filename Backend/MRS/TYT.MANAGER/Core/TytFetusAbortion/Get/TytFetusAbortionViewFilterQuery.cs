...
{
    public class TytFetusAbortionViewFilterQuery : TytFetusAbortionViewFilter
    {
        public TytFetusAbortionViewFilterQuery()
            : base()
        {

        }
        
        internal List<System.Linq.Expressions.Expression<Func<V_TYT_FETUS_ABORTION, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<V_TYT_FETUS_ABORTION, bool>>>();
        ...
        internal TytFetusAbortionSO Query()
        {
            ...
            try
            {
                ...
                search.listVTytFetusAbortionExpression.AddRange(listExpression);
                search.OrderField = OrderProcess.GetOrderField<V_TYT_FETUS_ABORTION>(ORDER_FIELD);
                search.OrderDirection = OrderProcess.GetOrderDirection(ORDER_DIRECTION);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
                search.listVTytFetusAbortionExpression.Clear();
                search.listVTytFetusAbortionExpression.Add(o => o.ID == NEGATIVE_ID);
            }
            return search;
        }
    }
