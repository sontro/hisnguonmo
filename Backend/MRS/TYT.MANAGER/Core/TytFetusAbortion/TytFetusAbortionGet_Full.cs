...
using TYT.MANAGER.Core.TytFetusAbortion.Get.ListV;
using TYT.MANAGER.Core.TytFetusAbortion.Get.V;
using Inventec.Core;
using System;
    ...
    partial class TytFetusAbortionGet : BeanObjectBase, IDelegacyT
    {
        ...
        T IDelegacyT.Execute<T>()
        {
            ...
            try
            {
                ...
                else if (typeof(T) == typeof(List<V_TYT_FETUS_ABORTION>))
                {
                    ITytFetusAbortionGetListV behavior = TytFetusAbortionGetListVBehaviorFactory.MakeITytFetusAbortionGetListV(param, entity);
                    result = behavior != null ? (T)System.Convert.ChangeType(behavior.Run(), typeof(T)) : default(T);
                }
                else if (typeof(T) == typeof(V_TYT_FETUS_ABORTION))
                {
                    ITytFetusAbortionGetV behavior = TytFetusAbortionGetVBehaviorFactory.MakeITytFetusAbortionGetV(param, entity);
                    result = behavior != null ? (T)System.Convert.ChangeType(behavior.Run(), typeof(T)) : default(T);
                }
            }
            catch (Exception ex)
