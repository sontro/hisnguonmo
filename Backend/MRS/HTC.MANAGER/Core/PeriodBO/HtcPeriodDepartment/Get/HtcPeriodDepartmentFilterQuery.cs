...
{
    public class HtcPeriodDepartmentFilterQuery : HtcPeriodDepartmentFilter
    {
        public HtcPeriodDepartmentFilterQuery()
            : base()
        {

        }

        internal List<System.Linq.Expressions.Expression<Func<HTC_PERIOD_DEPARTMENT, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<HTC_PERIOD_DEPARTMENT, bool>>>();
        ...
        internal HtcPeriodDepartmentSO Query()
        {
            ...
            try
            {
                ...
                search.listHtcPeriodDepartmentExpression.AddRange(listExpression);
                search.OrderField = OrderProcess.GetOrderField<HTC_PERIOD_DEPARTMENT>(ORDER_FIELD);
