...
{
    public class HtcExpenseFilterQuery : HtcExpenseFilter
    {
        public HtcExpenseFilterQuery()
            : base()
        {

        }

        internal List<System.Linq.Expressions.Expression<Func<HTC_EXPENSE, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<HTC_EXPENSE, bool>>>();
        ...
        internal HtcExpenseSO Query()
        {
            ...
            try
            {
                ...
                search.listHtcExpenseExpression.AddRange(listExpression);
                search.OrderField = OrderProcess.GetOrderField<HTC_EXPENSE>(ORDER_FIELD);
                search.OrderDirection = OrderProcess.GetOrderDirection(ORDER_DIRECTION);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
                search.listHtcExpenseExpression.Clear();
                search.listHtcExpenseExpression.Add(o => o.ID == NEGATIVE_ID);
            }
            return search;
        }
    }
