...
namespace TYT.EFMODEL.DataModels
{
    ...
    public partial class TYT_FETUS_ABORTION
    {
        ...
        public Nullable<long> DIAGNOSE_TEST { get; set; }
        public string ABORTION_METHOD { get; set; }
        public Nullable<long> SM_RESULT { get; set; }
        public string OBSTETRIC_COMPLICATION { get; set; }
        public Nullable<short> IS_DEATH { get; set; }
        public string EXECUTE_NAME { get; set; }
        public Nullable<short> EXAM_AFTER_TWO_WEEK { get; set; }
        public string NOTE { get; set; }
        public Nullable<long> ABORTION_TIME { get; set; }
    }
}
