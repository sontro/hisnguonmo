...
namespace TYT.EFMODEL.DataModels
{
    ...
    public partial class TYT_HIV
    {
        ...
        public Nullable<long> FETUS_TIME { get; set; }
        public Nullable<long> HIV_DIAGNOSIS_TIME { get; set; }
        public string HIV_DIAGNOSIS_PLACE { get; set; }
        public string ARV_PLACE { get; set; }
