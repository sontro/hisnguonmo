...
namespace TYT.EFMODEL.DataModels
{
    ...
    public partial class TYT_MALARIA
    {
        ...
        public Nullable<short> IS_HAS_FETUS { get; set; }
        public Nullable<short> IS_FEVER { get; set; }
        public Nullable<long> TEST_TYPE { get; set; }
        public string TEST_RESULT { get; set; }
        public string DIAGNOSE { get; set; }
        public string TREATMENT_RESULT { get; set; }
        public string MEDICINE { get; set; }
        public string MEDICINE_CTDT { get; set; }
        public Nullable<long> DIAGNOSE_TIME { get; set; }
