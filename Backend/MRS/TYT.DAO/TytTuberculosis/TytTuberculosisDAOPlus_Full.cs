...
namespace TYT.DAO.TytTuberculosis
{
    public partial class TytTuberculosisDAO : EntityBase
    {
        ...
        public TYT_TUBERCULOSIS GetByCode(string code, TytTuberculosisSO search)
        {
        ...
        public V_TYT_TUBERCULOSIS GetViewByCode(string code, TytTuberculosisSO search)
        {
            V_TYT_TUBERCULOSIS result = null;
        ...
        public Dictionary<string, TYT_TUBERCULOSIS> GetDicByCode(TytTuberculosisSO search, CommonParam param)
        {
            Dictionary<string, TYT_TUBERCULOSIS> result = new Dictionary<string, TYT_TUBERCULOSIS>();
            try
            {
