...
namespace TYT.DAO.TytGdsk
{
    public partial class TytGdskDAO : EntityBase
    {
        ...
        public TYT_GDSK GetByCode(string code, TytGdskSO search)
        {
        ...
        public V_TYT_GDSK GetViewByCode(string code, TytGdskSO search)
        {
            V_TYT_GDSK result = null;
        ...
        public Dictionary<string, TYT_GDSK> GetDicByCode(TytGdskSO search, CommonParam param)
        {
            Dictionary<string, TYT_GDSK> result = new Dictionary<string, TYT_GDSK>();
            try
            {
