...
namespace TYT.DAO.StagingObject
{
    public class TytFetusBornSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_TYT_FETUS_BORN, bool>>> listVTytFetusBornExpression = new List<System.Linq.Expressions.Expression<Func<V_TYT_FETUS_BORN, bool>>>();
    }
}
