...
namespace TYT.DAO.StagingObject
{
    public class TytNervesSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_TYT_NERVES, bool>>> listVTytNervesExpression = new List<System.Linq.Expressions.Expression<Func<V_TYT_NERVES, bool>>>();
    }
}
