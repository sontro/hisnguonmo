...
namespace TYT.DAO.StagingObject
{
    public class TytTuberculosisSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_TYT_TUBERCULOSIS, bool>>> listVTytTuberculosisExpression = new List<System.Linq.Expressions.Expression<Func<V_TYT_TUBERCULOSIS, bool>>>();
    }
}
