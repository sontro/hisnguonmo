...
namespace TYT.DAO.StagingObject
{
    public class TytUninfectSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_TYT_UNINFECT, bool>>> listVTytUninfectExpression = new List<System.Linq.Expressions.Expression<Func<V_TYT_UNINFECT, bool>>>();
    }
}
