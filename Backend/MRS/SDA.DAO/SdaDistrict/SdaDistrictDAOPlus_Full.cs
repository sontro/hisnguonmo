...
namespace SDA.DAO.SdaDistrict
{
    public partial class SdaDistrictDAO : EntityBase
    {
        ...
        {
            List<V_SDA_DISTRICT> result = new List<V_SDA_DISTRICT>();
        ...
        public V_SDA_DISTRICT GetViewById(long id, SdaDistrictSO search)
        {
            V_SDA_DISTRICT result = null;
        ...
        public V_SDA_DISTRICT GetViewByCode(string code, SdaDistrictSO search)
        {
            V_SDA_DISTRICT result = null;
