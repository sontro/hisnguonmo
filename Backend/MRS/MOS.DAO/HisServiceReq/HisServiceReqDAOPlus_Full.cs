...
namespace MOS.DAO.HisServiceReq
{
    public partial class HisServiceReqDAO : EntityBase
    {
        ...
        public V_HIS_SERVICE_REQ GetViewById(long id, HisServiceReqSO search)
        {
        ...
        public V_HIS_SERVICE_REQ GetViewByCode(string code, HisServiceReqSO search)
        {
            V_HIS_SERVICE_REQ result = null;
        ...
        public Dictionary<string, HIS_SERVICE_REQ> GetDicByCode(HisServiceReqSO search, CommonParam param)
        {
            Dictionary<string, HIS_SERVICE_REQ> result = new Dictionary<string, HIS_SERVICE_REQ>();
            try
            {
