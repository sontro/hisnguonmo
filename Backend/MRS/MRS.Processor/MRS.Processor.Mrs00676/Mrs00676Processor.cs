...
{
    public class Mrs00676Processor : AbstractProcessor
    {
        Mrs00676Filter filter = new Mrs00676Filter();
        ...
        public Mrs00676Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                filter = (Mrs00676Filter)this.reportFilter;
                //get dữ liệu:
