        ...
        public List<Mrs00296RDO> GetSereServDO(Mrs00287Filter filter,List<V_HIS_ROOM> listRoom)
        {
            ...
            try
            {
                ...
                if (filter.PAY_FORM_ID != null)
                {
                  ...
                  //  query += string.Format("AND (CASE WHEN BI.IS_CANCEL = 1 and BI.PAY_FORM_ID = 8 THEN 1 ELSE BI.PAY_FORM_ID END) ={0} ", filter.PAY_FORM_ID); 
                ...
                if (filter.PAY_FORM_IDs != null)
                {
                  ...
                  //  query += string.Format("AND (CASE WHEN BI.IS_CANCEL = 1 and BI.PAY_FORM_ID = 8 THEN 1 ELSE BI.PAY_FORM_ID END) in({0}) ", string.Join(",", filter.PAY_FORM_IDs));
                ...
                if (filter.PAY_FORM_ID != null)
                {
                  ...
                  //  query += string.Format("AND (CASE WHEN DE.IS_CANCEL = 1 and DE.PAY_FORM_ID = 8 THEN 1 ELSE DE.PAY_FORM_ID END) ={0} ", filter.PAY_FORM_ID);                 

                }
                if (filter.PAY_FORM_IDs != null)
                {
                    query += string.Format("AND DE.PAY_FORM_ID in({0}) ", string.Join(",", filter.PAY_FORM_IDs));
                   // query += string.Format("AND (CASE WHEN DE.IS_CANCEL = 1  and DE.PAY_FORM_ID = 8 THEN 1 ELSE DE.PAY_FORM_ID END) in({0}) ", string.Join(",", filter.PAY_FORM_IDs));
        ...
        public List<Mrs00296RDO> GetBillCancel(Mrs00287Filter filter, List<V_HIS_ROOM> listRoom)
        {
            ...
            try
            {
                ...
                if (filter.PAY_FORM_ID != null)
                {
                    ...
                    // query += string.Format("AND BI.PAY_FORM_ID ={0} ", filter.PAY_FORM_ID);
                    //if (filter.PAY_FORM_ID == 1 || filter.PAY_FORM_ID == 8)
                    //{
                    //    query += string.Format("AND {1} ={0} ", filter.PAY_FORM_ID, IMSys.DbConfig.HIS_RS.HIS_PAY_FORM.ID__TM);
                    //}
                    //else
                    //{
                    //    query += string.Format("AND {1} ={0} ", filter.PAY_FORM_ID, IMSys.DbConfig.HIS_RS.HIS_PAY_FORM.ID__TM);
                ...
                {
                    //query += string.Format("AND BI.PAY_FORM_ID in({0}) ", string.Join(",", filter.PAY_FORM_IDs));
                    //query += string.Format("AND {1} in({0}) ", string.Join(",", filter.PAY_FORM_IDs), IMSys.DbConfig.HIS_RS.HIS_PAY_FORM.ID__TM);
