...
namespace MRS.Processor.Mrs00667
{
    ...
    class Mrs00667Processor : AbstractProcessor
    {
        Mrs00667Filter castFilter = new Mrs00667Filter();

        public Mrs00667Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                ...
                this.castFilter = (Mrs00667Filter)this.reportFilter;
