...
{
    class Mrs00501RDO : V_HIS_HEIN_APPROVAL
    {
        public decimal RIGHT_ROUTE_AMOUNT { get; set; }
        public decimal LEFT_ROUTE_AMOUNT { get; set; }
        public decimal NUM_DAY_AMOUNT { get; set; }
        ...
        public Mrs00501RDO(V_HIS_HEIN_APPROVAL Data)
        {
            try
            {
