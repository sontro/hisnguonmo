...
namespace MRS.Processor.Mrs00593
{
    ...
    public class Mrs00593RDO:V_HIS_DEPARTMENT_TRAN
    {
        ...
        public Mrs00593RDO(V_HIS_DEPARTMENT_TRAN r,HIS_TREATMENT treatment)
        {
        ...
        private void SetExtensionField(Mrs00593RDO r)
        {
