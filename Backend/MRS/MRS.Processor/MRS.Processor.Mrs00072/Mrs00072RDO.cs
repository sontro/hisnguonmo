...
{
    public class Mrs00072RDO : V_HIS_HEIN_APPROVAL
    {
        ...
        public Mrs00072RDO(V_HIS_HEIN_APPROVAL heinApproval, Mrs00072Filter castFilter)
        {
            if (heinApproval != null)
            {
                Inventec.Common.Mapper.DataObjectMapper.Map<Mrs00072RDO>(this, heinApproval);
        ...
        public Mrs00072RDO(List<Mrs00072RDO> Data)
        {
            try
            {
