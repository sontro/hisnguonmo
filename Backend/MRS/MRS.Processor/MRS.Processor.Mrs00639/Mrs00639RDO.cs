...
{
    public class Mrs00639RDO : V_HIS_HEIN_APPROVAL
    {
        ...
        public string CLINICAL_IN_TIME_STR { get; set; }
        public decimal TOTAL_OTHER_SOURCE_PRICE { get; set; }

        public Mrs00639RDO(V_HIS_HEIN_APPROVAL data)
        {
            try
            {
                if (data != null)
        ...
        private void SetExtendField()
        {
            try
            {
                ...
                this.BHYT_TREATMENT_TYPE_CODE = "1";
