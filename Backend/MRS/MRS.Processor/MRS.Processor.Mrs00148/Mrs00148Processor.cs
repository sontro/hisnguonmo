...
{
    public class Mrs00148Processor : AbstractProcessor
    {
        List<Mrs00148RDO> _listSereServRdo = new List<Mrs00148RDO>(); 
        Mrs00148Filter CastFilter; 
        ...
        public Mrs00148Processor(CommonParam param, string reportTypeCode)
            : base(param, reportTypeCode)
        { }

        public override Type FilterType()
        {
            return typeof(Mrs00148Filter); 
        }
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                this.CastFilter = (Mrs00148Filter)this.reportFilter; 
                var paramGet = new CommonParam(); 
                LogSystem.Debug("Bat dau lay du lieu filter MRS00148: " +
                    LogUtil.TraceData(LogUtil.GetMemberName(() => CastFilter), CastFilter)); 
                LogSystem.Info("Bat dau lay du lieu filter MRS00148 ==============================================================="); 
                //--------------------------------------------------------------------------------------------------
                //Tên kho xuất
                ...
                {
                    REPORT_TYPE_CODE__EXACT = "MRS00148"
                }; 
                ...
                //--------------------------------------------------------------------------------------------------
                LogSystem.Info("Ket thuc lay du lieu filter MRS00148 ==============================================================="); 
                if (!paramGet.HasException)
                {
                    ...
                    throw new DataMisalignedException(
                        "Co exception xay ra tai DAOGET trong qua trinh lay du lieu MRS00148." +
                        LogUtil.TraceData(
            ...
            List<V_HIS_SERVICE_RETY_CAT> listServiceRetyCats, List<V_HIS_IMP_MEST_MEDICINE> listImpMestMedicines, List<V_HIS_MEDICINE_TYPE_ACIN> listMedicineTypeAcins)
        {
            try
            {
                LogSystem.Info("Bat dau xu ly du lieu MRS00148 ==============================================================="); 
                ...
                LogSystem.Info("Ket thuc xu ly du lieu MRS00148 ==============================================================="); 
            }
            catch (Exception ex)
            {
