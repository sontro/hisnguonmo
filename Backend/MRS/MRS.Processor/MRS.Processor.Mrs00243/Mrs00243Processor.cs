...
{
    public class Mrs00243Processor : AbstractProcessor
    {
        Mrs00243Filter castFilter = null;

        List<Mrs00243RDO> ListRdoA = new List<Mrs00243RDO>();
        List<Mrs00243RDO> ListRdoB = new List<Mrs00243RDO>();
        List<Mrs00243RDO> ListRdoC = new List<Mrs00243RDO>();

        Dictionary<short, Mrs00243RDO> dicRdoA = new Dictionary<short, Mrs00243RDO>();
        Dictionary<short, Mrs00243RDO> dicRdoB = new Dictionary<short, Mrs00243RDO>();
        Dictionary<short, Mrs00243RDO> dicRdoC = new Dictionary<short, Mrs00243RDO>();

        List<Mrs00243RDO> ListTotalRdoA = new List<Mrs00243RDO>();
        List<Mrs00243RDO> ListTotalRdoB = new List<Mrs00243RDO>();
        List<Mrs00243RDO> ListTotalRdoC = new List<Mrs00243RDO>();
        ...
        public Mrs00243Processor(CommonParam param, string reportTypeCode)
		...
		protected override bool GetData()
		{
            ...
            try
            {
                castFilter = ((Mrs00243Filter)this.reportFilter);
                ...
                Inventec.Common.Logging.LogSystem.Debug("Bat dau lay du lieu V_HIS_HEIN_APPROVAL, Mrs00243, filter: " + Inventec.Common.Logging.LogUtil.TraceData(Inventec.Common.Logging.LogUtil.GetMemberName(() => castFilter), castFilter));
                ...
                {
                    throw new DataMisalignedException("Co loi xay ra trong qua trinh lay du lieu V_HIS_HEIN_APPROVAL, Mrs00243");
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (IsNotNullOrEmpty(ListHeinApproval))
                {
                    ...
                    while (count > 0)
                    {
                        ...
                        if (paramGet.HasException)
                        {
                            throw new DataMisalignedException("Co exception xay ra tai DAOGET trong qua trinh tong hop du lieu MRS00243.");
                        }
                    ...
                    foreach (var heinApproval in hisHeinApprovals)
                    {
                        if (heinApproval.HEIN_TREATMENT_TYPE_CODE == MOS.LibraryHein.Bhyt.HeinTreatmentType.HeinTreatmentTypeCode.EXAM && CheckHeinCardNumberType(heinApproval.HEIN_CARD_NUMBER))
                        {
                            ...
                            if (this._Branch.ACCEPT_HEIN_MEDI_ORG_CODE.Contains(heinApproval.HEIN_MEDI_ORG_CODE))
                            {
                                ...
                                {
                                    rdo = new Mrs00243RDO(heinApproval);
        ...
        private void ProcessTotalPrice(Mrs00243RDO rdo, List<V_HIS_SERE_SERV_3> hisSereServs, V_HIS_HEIN_APPROVAL heinApproval, V_HIS_TREATMENT treatment)
        {
            try
            {
        ...
        private List<Mrs00243RDO> CheckList(List<Mrs00243RDO> listRdo)
        {
            List<Mrs00243RDO> result = new List<Mrs00243RDO>();
            try
            {
            ...
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
                result = new List<Mrs00243RDO>();
            }
            return result;
        }

        private bool CheckPrice(Mrs00243RDO rdo)
        {
            bool result = false;
            try
            {
        ...
        private void ProcessSumTotal()
        {
            try
            {
                Mrs00243RDO rdoA = new Mrs00243RDO();
                ...
                Mrs00243RDO rdoB = new Mrs00243RDO();
                ...
                Mrs00243RDO rdoC = new Mrs00243RDO();
