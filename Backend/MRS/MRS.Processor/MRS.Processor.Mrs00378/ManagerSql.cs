...
namespace MRS.Processor.Mrs00378
{
    public partial class ManagerSql : BusinessBase
    {
        ...
        public List<V_HIS_IMP_MEST_MATERIAL> Get(List<long> ThExpMestMaterialIds)
        {
            ...
            if (paramGet.HasException)
                throw new NullReferenceException("Co exception xay ra tai DAOGET trong qua trinh lay du lieu MRS00378");
            return result;
        }


        //public List<HIS_IMP_MEST_MEDICINE> Get(List<long> ThExpMestMedicineIds)
        //{
        ...
        //    Inventec.Common.Logging.LogSystem.Info("SQL: " + query);
        //    result = new SqlDAO().GetSql<HIS_IMP_MEST_MEDICINE>(paramGet, query);
        //    if (paramGet.HasException)
        //        throw new NullReferenceException("Co exception xay ra tai DAOGET trong qua trinh lay du lieu MRS00378");
        //    return result;
        //}
