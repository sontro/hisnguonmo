...
{
    class Mrs00100Processor : AbstractProcessor
    {
        Mrs00100Filter castFilter = null;

        List<Mrs00100RDO> ListExamRdo_A = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListBedRdo_A = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListTestRdo_A = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListDiimFuexRdo_A = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListSurgMisuRdo_A = new List<Mrs00100RDO>();

        List<Mrs00100RDO> ListExamRdo_B = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListBedRdo_B = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListTestRdo_B = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListDiimFuexRdo_B = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListSurgMisuRdo_B = new List<Mrs00100RDO>();

        List<Mrs00100RDO> ListExamRdo_C = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListBedRdo_C = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListTestRdo_C = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListDiimFuexRdo_C = new List<Mrs00100RDO>();
        List<Mrs00100RDO> ListSurgMisuRdo_C = new List<Mrs00100RDO>();
        ...
        public Mrs00100Processor(CommonParam param, string reportTypeCode)
		...
		protected override bool GetData()
		{
            ...
            try
            {
                this.castFilter = (Mrs00100Filter)this.reportFilter;
            ...
            try
            {
                if (IsNotNullOrEmpty(hisHeinAppBhyts_A))
                {
                    ...
                    while (count > 0)
                    {
                        ...
                        {
                            throw new DataMisalignedException("Co exception xay ra tai DAOGET trong qua trinh tong hop du lieu, MRS00100.");
                        }
            ...
            try
            {
                ...
                if (IsNotNullOrEmpty(ListSereServ))
                {
                    ...
                    foreach (var sere in ListSereServ)
                    {
                        ...
                        bool valid = false;
                        Mrs00100RDO rdo = new Mrs00100RDO();
                        ...
                        rdo.ORIGINAL_PRICE = sere.ORIGINAL_PRICE * (1 + sere.VAT_RATIO);
        ...
        private List<Mrs00100RDO> ProcessListRDO(List<Mrs00100RDO> listRdo)
        {
            List<Mrs00100RDO> listCurrent = new List<Mrs00100RDO>();
            try
            {
                if (IsNotNullOrEmpty(listRdo))
                {
                    ...
                    {
                        List<Mrs00100RDO> listsub = group.ToList<Mrs00100RDO>();
