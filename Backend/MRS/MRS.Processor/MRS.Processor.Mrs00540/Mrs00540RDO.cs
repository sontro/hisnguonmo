...
{
    public class Mrs00540RDO : V_HIS_HEIN_APPROVAL
    {
        ...
        public Dictionary<string, decimal> DIC_OTHER_HSVT_PRICE { get; set; }
        ...
        public Mrs00540RDO(V_HIS_HEIN_APPROVAL data)
        {
            try
            {
                DIC_OTHER_HSVT_PRICE = new Dictionary<string, decimal>();
                if (data != null)
                {
    ...
    public class TREATMENT_PRICE
    {
        public string HEIN_APPROVAL_CODE { get; set; }

        public decimal DIF_PRIMARY_PRICE { get; set; }
