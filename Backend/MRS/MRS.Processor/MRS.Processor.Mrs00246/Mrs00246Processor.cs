...
{
    public class Mrs00246Processor : AbstractProcessor
    {
        Mrs00246Filter castFilter = null;

        List<Mrs00246RDO> ListRdoA = new List<Mrs00246RDO>();
        List<Mrs00246RDO> ListRdoB = new List<Mrs00246RDO>();
        List<Mrs00246RDO> ListRdoC = new List<Mrs00246RDO>();

        Dictionary<short, Mrs00246RDO> dicRdoA = new Dictionary<short, Mrs00246RDO>();
        Dictionary<short, Mrs00246RDO> dicRdoB = new Dictionary<short, Mrs00246RDO>();
        Dictionary<short, Mrs00246RDO> dicRdoC = new Dictionary<short, Mrs00246RDO>();

        List<Mrs00246RDO> ListTotalRdoA = new List<Mrs00246RDO>();
        List<Mrs00246RDO> ListTotalRdoB = new List<Mrs00246RDO>();
        List<Mrs00246RDO> ListTotalRdoC = new List<Mrs00246RDO>();
        ...
        public Mrs00246Processor(CommonParam param, string reportTypeCode)
		...
		protected override bool GetData()
		{
            ...
            try
            {
                ...
                castFilter = ((Mrs00246Filter)this.reportFilter);
                ...
                Inventec.Common.Logging.LogSystem.Debug("Bat dau lay du lieu V_HIS_HEIN_APPROVAL, Mrs00246, filter: " + Inventec.Common.Logging.LogUtil.TraceData(Inventec.Common.Logging.LogUtil.GetMemberName(() => castFilter), castFilter));
                ...
                {
                    throw new DataMisalignedException("Co loi xay ra trong qua trinh lay du lieu V_HIS_HEIN_APPROVAL, Mrs00246");
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (IsNotNullOrEmpty(ListHeinApproval))
                {
                    ...
                    while (count > 0)
                    {
                        ...
                        if (paramGet.HasException)
                        {
                            throw new DataMisalignedException("Co exception xay ra tai DAOGET trong qua trinh tong hop du lieu Mrs00246.");
                        }
                    ...
                    foreach (var heinApproval in hisHeinApprovals)
                    {
                        if (heinApproval.HEIN_TREATMENT_TYPE_CODE == MOS.LibraryHein.Bhyt.HeinTreatmentType.HeinTreatmentTypeCode.TREAT && CheckHeinCardNumberType(heinApproval.HEIN_CARD_NUMBER))
                        {
                            ...
                            if (this._Branch.ACCEPT_HEIN_MEDI_ORG_CODE.Contains(heinApproval.HEIN_MEDI_ORG_CODE))
                            {
                                ...
                                {
                                    rdo = new Mrs00246RDO(heinApproval);
        ...
        private void ProcessTotalPrice(Mrs00246RDO rdo, List<V_HIS_SERE_SERV_3> hisSereServs, V_HIS_HEIN_APPROVAL heinApproval, V_HIS_TREATMENT treatment)
        {
            try
            {
        ...
        private List<Mrs00246RDO> CheckList(List<Mrs00246RDO> listRdo)
        {
            List<Mrs00246RDO> result = new List<Mrs00246RDO>();
            try
            {
            ...
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
                result = new List<Mrs00246RDO>();
            }
            return result;
        }

        private bool CheckPrice(Mrs00246RDO rdo)
        {
            bool result = false;
            try
            {
        ...
        private void ProcessSumTotal()
        {
            try
            {
                Mrs00246RDO rdoA = new Mrs00246RDO();
                ...
                Mrs00246RDO rdoB = new Mrs00246RDO();
                ...
                Mrs00246RDO rdoC = new Mrs00246RDO();
