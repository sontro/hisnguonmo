...
{
    class Mrs00023RDO : MOS.EFMODEL.DataModels.HIS_SERVICE_REQ
    {
        ...
        public Mrs00023RDO(MOS.EFMODEL.DataModels.HIS_SERVICE_REQ data, Dictionary<long, V_HIS_PATIENT_TYPE_ALTER> dicPatientTypeAlter)
        {
            try
            {
