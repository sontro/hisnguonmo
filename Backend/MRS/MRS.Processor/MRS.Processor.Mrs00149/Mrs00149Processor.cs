...
{
    public class Mrs00149Processor : AbstractProcessor
    {
        List<Mrs00149RDO> _listSereServRdo = new List<Mrs00149RDO>(); 
        Mrs00149Filter CastFilter; 
        ...
        public Mrs00149Processor(CommonParam param, string reportTypeCode)
            : base(param, reportTypeCode)
        { }

        public override Type FilterType()
        {
            return typeof(Mrs00149Filter); 
        }
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                this.CastFilter = (Mrs00149Filter)this.reportFilter; 
                var paramGet = new CommonParam(); 
                LogSystem.Debug("Bat dau lay du lieu filter MRS00149: " +
                    LogUtil.TraceData(LogUtil.GetMemberName(() => CastFilter), CastFilter)); 
                LogSystem.Info("Bat dau lay du lieu filter MRS00149 ==============================================================="); 
                ...
                //--------------------------------------------------------------------------------------------------
                LogSystem.Info("Ket thuc lay du lieu filter MRS00149 ==============================================================="); 
                if (!paramGet.HasException)
                {
                    ...
                    throw new DataMisalignedException(
                        "Co exception xay ra tai DAOGET trong qua trinh lay du lieu MRS00149." +
                        LogUtil.TraceData(
            ...
            List<V_HIS_IMP_MEST_MEDICINE> listImpMestMedicines, List<V_HIS_MEDICINE_TYPE_ACIN> listMedicineTypeAcins)
        {
            try
            {
                LogSystem.Info("Bat dau xu ly du lieu MRS00149 ==============================================================="); 
                var listMedicineTypeIds = listMedicineTypes.Where(s => s.NATIONAL_NAME != MRS.MANAGER.Config.HisMedicineTypeCFG.MEDICINE_TYPE_NATIOANL_VN).Select(s => s.ID).ToList(); 
                ...
                LogSystem.Info("Ket thuc xu ly du lieu MRS00149 ==============================================================="); 
            }
            catch (Exception ex)
            {
