...
{
    public class Mrs00276RDO : V_HIS_HEIN_APPROVAL
    {
        ...
        public Mrs00276RDO(V_HIS_HEIN_APPROVAL data)
        {
            try
            {
                if (data != null)
                {
                    Inventec.Common.Mapper.DataObjectMapper.Map<Mrs00276RDO>(this, data);
