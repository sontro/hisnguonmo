...
namespace MRS.Processor.Mrs00672
{
    ...
    class Mrs00672Processor : AbstractProcessor
    {
        Mrs00672Filter castFilter = new Mrs00672Filter();

        protected string BRANCH_NAME = "";

        public Mrs00672Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                ...
                this.castFilter = (Mrs00672Filter)this.reportFilter;
            }
            catch (Exception ex)
            {
