...
{
    public class Mrs00692RDO : V_HIS_TRANSACTION
    {
        ...
        public Mrs00692RDO(V_HIS_TRANSACTION data, List<V_HIS_BILL_FUND> ListBillFund, List<HIS_PATIENT_TYPE_ALTER> listPatientTypeAlter, List<V_HIS_TREATMENT_FEE> listTreatmentFeeView, List<TYPE_PRICE> listTypePrice)
        {
            try
            {
        ...
        private void SetExtendField(Mrs00692RDO rdo, List<V_HIS_BILL_FUND> ListBillFund, List<HIS_PATIENT_TYPE_ALTER> listPatientTypeAlter, List<V_HIS_TREATMENT_FEE> listTreatmentFeeView, List<TYPE_PRICE> listTypePrice)
        {
            try
            {
                Decimal totalFund = 0;
