...
using System.Data;
using MRS.Processor.Mrs00692;

namespace MRS.Processor.Mrs00692
{
    public partial class ManagerSql : BusinessBase
    {
        public DataTable GetBillAndOtherCancel(Mrs00692Filter filter)
        {
        ...
        public DataTable GetSampleCancel(Mrs00692Filter filter)
        {
            DataTable result = null;
            try
            {
        ...
        public DataTable GetCancelOtherDetail(Mrs00692Filter filter)
        {
            DataTable result = null;
            try
            {
        ...
        public DataTable GetCancelSampleDetail(Mrs00692Filter filter)
        {
            DataTable result = null;
            try
            {
        ...
        public DataTable GetBillDetail(Mrs00692Filter filter)
        {
            DataTable result = null;
            try
            {
        ...
        public List<TYPE_PRICE> GetTypePrice(Mrs00692Filter filter)
        {
