...
namespace MRS.Processor.Mrs00267
{
    class Mrs00267RDO
    {
        ...
        public Mrs00267RDO(V_HIS_MEST_PERIOD_MEDI r, List<V_HIS_MEDICINE_TYPE> listMedicineType)
        {
            var medicineType = listMedicineType.FirstOrDefault(o => o.ID == r.MEDICINE_TYPE_ID) ?? new V_HIS_MEDICINE_TYPE();
        ...
        public Mrs00267RDO(V_HIS_IMP_MEST_MEDICINE r, List<V_HIS_MEDICINE_TYPE> listMedicineType, bool before)
        {
            var medicineType = listMedicineType.FirstOrDefault(o => o.ID == r.MEDICINE_TYPE_ID) ?? new V_HIS_MEDICINE_TYPE();
            var parent = listMedicineType.FirstOrDefault(o => o.ID == medicineType.PARENT_ID) ?? new V_HIS_MEDICINE_TYPE();
        ...
        public Mrs00267RDO(V_HIS_EXP_MEST_MEDICINE r, List<V_HIS_MEDICINE_TYPE> listMedicineType, List<ExpMestIdReason> ExpMestIdReasons, bool before)
        {
            var medicineType = listMedicineType.FirstOrDefault(o => o.ID == r.MEDICINE_TYPE_ID) ?? new V_HIS_MEDICINE_TYPE();
            var parent = listMedicineType.FirstOrDefault(o => o.ID == medicineType.PARENT_ID) ?? new V_HIS_MEDICINE_TYPE();
