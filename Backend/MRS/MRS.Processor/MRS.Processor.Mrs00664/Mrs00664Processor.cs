...
namespace MRS.Processor.Mrs00664
{
    ...
    class Mrs00664Processor : AbstractProcessor
    {
        Mrs00664Filter castFilter = new Mrs00664Filter();
        List<Mrs00664RDO> listRdo = new List<Mrs00664RDO>();

        protected string BRANCH_NAME = "";

        public Mrs00664Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                ...
                this.castFilter = (Mrs00664Filter)this.reportFilter;
            }
            catch (Exception ex)
            {
        ...
        protected override void SetTag(Dictionary<string, object> dicSingleTag, Inventec.Common.FlexCellExport.ProcessObjectTag objectTag, Inventec.Common.FlexCellExport.Store store)
        {
            try
            {
                ...
                objectTag.AddObjectData(store, "S1", new ManagerSql().GetSum(castFilter, MRS.MANAGER.Core.MrsReport.Lib.GetCellValue.Get(this.reportTemplate.REPORT_TEMPLATE_URL, 1, 19)));
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
