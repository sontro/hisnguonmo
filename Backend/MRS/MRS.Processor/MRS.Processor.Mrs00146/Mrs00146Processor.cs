...
{
    public class Mrs00146Processor : AbstractProcessor
    {
        List<Mrs00146RDO> _listSereServRdo = new List<Mrs00146RDO>(); 
        Mrs00146Filter CastFilter; 
        ...
        public Mrs00146Processor(CommonParam param, string reportTypeCode)
            : base(param, reportTypeCode)
        { }

        public override Type FilterType()
        {
            return typeof(Mrs00146Filter); 
        }
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                this.CastFilter = (Mrs00146Filter)this.reportFilter; 
                var paramGet = new CommonParam(); 
                LogSystem.Debug("Bat dau lay du lieu filter MRS00146: " +
                    LogUtil.TraceData(LogUtil.GetMemberName(() => CastFilter), CastFilter)); 
                LogSystem.Info("Bat dau lay du lieu filter MRS00146 ==============================================================="); 
                //--------------------------------------------------------------------------------------------------
                //Tên kho xuất
                ...
                {
                    REPORT_TYPE_CODE__EXACT = "MRS00146"
                }; 
                ...
                //--------------------------------------------------------------------------------------------------
                LogSystem.Info("Ket thuc lay du lieu filter MRS00146 ==============================================================="); 
                if (!paramGet.HasException)
                {
                    ...
                    throw new DataMisalignedException(
                        "Co exception xay ra tai DAOGET trong qua trinh lay du lieu MRS00146." +
                        LogUtil.TraceData(
            ...
            List<V_HIS_SERVICE_RETY_CAT> listServiceRetyCats, List<V_HIS_IMP_MEST_MEDICINE> listImpMestMedicines, List<V_HIS_MEDICINE_TYPE_ACIN> listMedicineTypeAcins)
        {
            try
            {
                LogSystem.Info("Bat dau xu ly du lieu MRS00146 ==============================================================="); 
                ...
                LogSystem.Info("Ket thuc xu ly du lieu MRS00146 ==============================================================="); 
            }
            catch (Exception ex)
            {
