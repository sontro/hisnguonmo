...
namespace MRS.Processor.Mrs00689
{
    //báo cáo thanh toán nội trú chuyển khoản

    class Mrs00689Processor : AbstractProcessor
    {
        Mrs00689Filter castFilter = new Mrs00689Filter();
        List<Mrs00689RDO> listRdo = new List<Mrs00689RDO>();

        protected string BRANCH_NAME = "";

        public Mrs00689Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                ...
                this.castFilter = (Mrs00689Filter)this.reportFilter;
            }
            catch (Exception ex)
            {
