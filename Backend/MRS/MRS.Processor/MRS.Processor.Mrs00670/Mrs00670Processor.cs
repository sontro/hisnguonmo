...
namespace MRS.Processor.Mrs00670
{
    ...
    class Mrs00670Processor : AbstractProcessor
    {
        Mrs00670Filter castFilter = new Mrs00670Filter();

        protected string BRANCH_NAME = "";

        public Mrs00670Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                ...
                this.castFilter = (Mrs00670Filter)this.reportFilter;
            }
            catch (Exception ex)
            {
