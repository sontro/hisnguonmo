...
namespace MRS.Processor.Mrs00080
{
    class Mrs00080RDO
    {
        ...
        public string REASON_INPUT_CODE_EXTEND { get; set; }
        ...
        public Mrs00080RDO(MOS.EFMODEL.DataModels.V_HIS_HEIN_APPROVAL heinApproval)
        {
            this.HEIN_APPROVAL = heinApproval;
            this.TREATMENT_CODE = heinApproval.TREATMENT_CODE;
        }

        public void SetExtendField(Mrs00080RDO Data)
        {
        }
