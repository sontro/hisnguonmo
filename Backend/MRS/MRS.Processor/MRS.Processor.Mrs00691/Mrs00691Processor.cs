...
{
    public class Mrs00691Processor : AbstractProcessor
    {
        Mrs00691Filter filter = new Mrs00691Filter();
        ...
        public Mrs00691Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                filter = (Mrs00691Filter)this.reportFilter;
                //get dữ liệu:
