...
namespace MRS.Processor.Mrs00268
{
    public partial class ManagerSql : BusinessBase
    {
        ...
        //public List<Mrs00268RDO> Get(HisExpMestMaterialViewFilterQuery filter)
        //{
        //    List<Mrs00268RDO> result = new List<Mrs00268RDO>();
        ...
        //        result = new SqlDAO().GetSql<Mrs00268RDO>(paramGet, query);
        //        if (paramGet.HasException)
        //            throw new NullReferenceException("Co exception xay ra tai DAOGET trong qua trinh lay du lieu MRS00268");
        //    return result;
        //}

        //public List<Mrs00268RDO> Get(HisExpMestMedicineViewFilterQuery filter)
        //{
        //    List<Mrs00268RDO> result = new List<Mrs00268RDO>();
        //    CommonParam paramGet = new CommonParam();
        //    string query = "";
        ...
        public List<ExpMestIdReason> Get(Mrs00268Filter filter)
        {
