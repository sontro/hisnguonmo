...
namespace MRS.Processor.Mrs00245
{
    public class Mrs00245RDO
    {
        ...
        public Mrs00245RDO(V_HIS_HEIN_APPROVAL data)
        {
            try
            {
                if (data != null)
        ...
        public string IS_70 { get; set; }

        public string IS_146 { get; set; }

        public string BHYT_TYPE { get; set; }

        public string TYPE { get; set; }

        public long TREATMENT_TYPE_ID { get; set; }

        public string BHYT_TYPE_NAME { get; set; }
