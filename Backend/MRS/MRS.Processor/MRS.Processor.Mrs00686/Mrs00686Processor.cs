...
{
    public class Mrs00686Processor : AbstractProcessor
    {
        Mrs00686Filter filter = new Mrs00686Filter();
        ...
        public Mrs00686Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                filter = (Mrs00686Filter)this.reportFilter;
                //get dữ liệu:
