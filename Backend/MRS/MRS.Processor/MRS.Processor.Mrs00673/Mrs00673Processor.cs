...
namespace MRS.Processor.Mrs00673
{
    ...
    class Mrs00673Processor : AbstractProcessor
    {
        Mrs00673Filter castFilter = new Mrs00673Filter();

        protected string BRANCH_NAME = "";

        public Mrs00673Processor(CommonParam param, string reportTypeCode)
        ...
        protected override bool GetData()
        {
            ...
            try
            {
                ...
                this.castFilter = (Mrs00673Filter)this.reportFilter;
            }
            catch (Exception ex)
            {
