...
{
    partial class HisDebateInviteUserLock : BusinessBase
    {
        internal HisDebateInviteUserLock()
            : base()
        {

        }

        internal HisDebateInviteUserLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_DEBATE_INVITE_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_DEBATE_INVITE_USER data = new HisDebateInviteUserGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisDebateInviteUserDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_DEBATE_INVITE_USER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_DEBATE_INVITE_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisDebateInviteUserCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisDebateInviteUserDAO.Update(raw);
