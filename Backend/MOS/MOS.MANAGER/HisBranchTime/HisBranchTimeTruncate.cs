...
{
    partial class HisBranchTimeTruncate : BusinessBase
    {
        internal HisBranchTimeTruncate()
            : base()
        {

        }

        internal HisBranchTimeTruncate(CommonParam paramTruncate)
            : base(paramTruncate)
        {
        ...
        internal bool Truncate(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    result = DAOWorker.HisBranchTimeDAO.Truncate(raw);
                }
            }
            catch (Exception ex)
            {
        ...
        internal bool TruncateList(List<long> ids)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    result = DAOWorker.HisBranchTimeDAO.TruncateList(listRaw);
                }
            }
            catch (Exception ex)
            {
