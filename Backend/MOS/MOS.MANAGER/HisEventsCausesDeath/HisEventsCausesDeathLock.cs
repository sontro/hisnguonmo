...
{
    partial class HisEventsCausesDeathLock : BusinessBase
    {
        internal HisEventsCausesDeathLock()
            : base()
        {

        }

        internal HisEventsCausesDeathLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EVENTS_CAUSES_DEATH resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EVENTS_CAUSES_DEATH data = new HisEventsCausesDeathGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEventsCausesDeathDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EVENTS_CAUSES_DEATH resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EVENTS_CAUSES_DEATH resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEventsCausesDeathCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEventsCausesDeathDAO.Update(raw);
