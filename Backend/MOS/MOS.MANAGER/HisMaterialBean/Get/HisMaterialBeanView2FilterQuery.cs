    ...
    public class HisMaterialBeanView2FilterQuery : HisMaterialBeanView2Filter
    {
        ...
        internal HisMaterialBeanSO Query()
        {
            ...
            try
            {
                ...
                {
                    search.listVHisMaterialBean2Expression.Add(o => o.EXP_MEST_MATERIAL_ID.HasValue && o.EXP_MEST_MATERIAL_ID.Value == this.EXP_MEST_MATERIAL_ID.Value);
                }
                if (this.EXP_MEST_MATERIAL_IDs != null)
                {
                    search.listVHisMaterialBean2Expression.Add(o => o.EXP_MEST_MATERIAL_ID.HasValue && this.EXP_MEST_MATERIAL_IDs.Contains(o.EXP_MEST_MATERIAL_ID.Value));
                }
