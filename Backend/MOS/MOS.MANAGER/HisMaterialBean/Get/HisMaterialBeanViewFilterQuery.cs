    ...
    public class HisMaterialBeanViewFilterQuery : HisMaterialBeanViewFilter
    {
        ...
        internal HisMaterialBeanSO Query()
        {
            ...
            try
            {
                ...
                if (this.MATERIAL_TYPE_IS_ACTIVE.HasValue && this.MATERIAL_TYPE_IS_ACTIVE.Value)
                {
                    listVHisMaterialBeanExpression.Add(o => o.MATERIAL_TYPE_IS_ACTIVE == Constant.IS_TRUE);
                }
                if (this.MATERIAL_TYPE_IS_ACTIVE.HasValue && !this.MATERIAL_TYPE_IS_ACTIVE.Value)
                {
                    listVHisMaterialBeanExpression.Add(o => o.MATERIAL_TYPE_IS_ACTIVE != Constant.IS_TRUE);
                }
                if (this.MATERIAL_IS_ACTIVE.HasValue && this.MATERIAL_IS_ACTIVE.Value)
                {
                    listVHisMaterialBeanExpression.Add(o => o.MATERIAL_IS_ACTIVE == Constant.IS_TRUE);
                }
                if (this.MATERIAL_IS_ACTIVE.HasValue && !this.MATERIAL_IS_ACTIVE.Value)
                {
                    listVHisMaterialBeanExpression.Add(o => o.MATERIAL_IS_ACTIVE != Constant.IS_TRUE);
                ...
                {
                    listVHisMaterialBeanExpression.Add(o => o.IS_GOODS_RESTRICT.HasValue && o.IS_GOODS_RESTRICT.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_GOODS_RESTRICT.HasValue && !this.IS_GOODS_RESTRICT.Value)
                {
                    listVHisMaterialBeanExpression.Add(o => !o.IS_GOODS_RESTRICT.HasValue || o.IS_GOODS_RESTRICT.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    search.listVHisMaterialBeanExpression.Add(o => o.EXP_MEST_MATERIAL_ID.HasValue && o.EXP_MEST_MATERIAL_ID.Value == this.EXP_MEST_MATERIAL_ID.Value);
                }
                if (this.EXP_MEST_MATERIAL_IDs != null)
                {
                    search.listVHisMaterialBeanExpression.Add(o => o.EXP_MEST_MATERIAL_ID.HasValue && this.EXP_MEST_MATERIAL_IDs.Contains(o.EXP_MEST_MATERIAL_ID.Value));
                }

                if (this.IS_REUSABLE.HasValue && this.IS_REUSABLE.Value)
                {
                    listVHisMaterialBeanExpression.Add(o => o.IS_REUSABLE == Constant.IS_TRUE);
                }
                if (this.IS_REUSABLE.HasValue && !this.IS_REUSABLE.Value)
                {
                    listVHisMaterialBeanExpression.Add(o => o.IS_REUSABLE != Constant.IS_TRUE);
                }
                if (this.EXPIRED_DATE__NULL_OR_GREATER_THAN_OR_EQUAL.HasValue)
                {
                    listVHisMaterialBeanExpression.Add(o => !o.TDL_MATERIAL_EXPIRED_DATE.HasValue || o.TDL_MATERIAL_EXPIRED_DATE.Value >= this.EXPIRED_DATE__NULL_OR_GREATER_THAN_OR_EQUAL.Value);
                }
