...
{
    partial class HisOtherPaySourceLock : BusinessBase
    {
        internal HisOtherPaySourceLock()
            : base()
        {

        }

        internal HisOtherPaySourceLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_OTHER_PAY_SOURCE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_OTHER_PAY_SOURCE data = new HisOtherPaySourceGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisOtherPaySourceDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_OTHER_PAY_SOURCE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_OTHER_PAY_SOURCE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisOtherPaySourceCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisOtherPaySourceDAO.Update(raw);
