...
{
    partial class HisIcdServiceLock : BusinessBase
    {
        internal HisIcdServiceLock()
            : base()
        {

        }

        internal HisIcdServiceLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_ICD_SERVICE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_ICD_SERVICE data = new HisIcdServiceGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisIcdServiceDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_ICD_SERVICE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_ICD_SERVICE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisIcdServiceCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisIcdServiceDAO.Update(raw);
