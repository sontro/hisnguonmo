...
{
    class HisPackingUpdateCheck : BusinessBase
    {
        internal HisPackingUpdateCheck()
            : base()
        {

        }

        internal HisPackingUpdateCheck(CommonParam param)
            : base(param)
        {
        ...
        internal bool CheckValidData(HisPackingUpdateSDO data)
        {
            bool valid = true;
            try
            {
                ...
                if (!IsNotNullOrEmpty(data.MaterialPaties)) throw new ArgumentNullException("data.MedicinePaties");
        ...
        internal bool ValidDispense(HisPackingUpdateSDO data, ref HIS_DISPENSE dispense)
        {
            bool valid = true;
            try
            {
                ...
                {
                    MANAGER.Base.MessageUtil.SetMessage(param, LibraryMessage.Message.Enum.HisDispense_PhieuDongGoiDaDuocXacNhan);
        ...
        internal bool CheckWorkPlace(HisPackingUpdateSDO data, HIS_DISPENSE dispense)
        {
            bool valid = true;
            try
            {
