    ...
    partial class HisDispenseUpdate : BusinessBase
    {
        ...
        internal bool Update(HIS_DISPENSE data)
        {
            ...
            try
            {
                ...
                valid = valid && checker.ExistsCode(data.DISPENSE_CODE, data.ID);
                if (valid)
                {
        ...
        internal bool Update(HIS_DISPENSE data, HIS_DISPENSE beforeUpdate)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    ...
                    this.beforeUpdateHisDispenses.Add(beforeUpdate);
