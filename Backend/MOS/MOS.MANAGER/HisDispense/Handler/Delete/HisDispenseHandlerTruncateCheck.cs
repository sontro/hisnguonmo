...
{
    class HisDispenseHandlerTruncateCheck : BusinessBase
    {
        internal HisDispenseHandlerTruncateCheck()
            : base()
        {

        }

        internal HisDispenseHandlerTruncateCheck(CommonParam param)
            : base(param)
        {

        }

        internal bool CheckValidData(HisDispenseDeleteSDO data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool ValidDispense(HisDispenseDeleteSDO data, ref HIS_DISPENSE dispense)
        {
            bool valid = true;
            try
            {
        ...
        internal bool CheckWorkPlace(HisDispenseDeleteSDO data, HIS_DISPENSE dispense)
        {
            bool valid = true;
            try
            {
