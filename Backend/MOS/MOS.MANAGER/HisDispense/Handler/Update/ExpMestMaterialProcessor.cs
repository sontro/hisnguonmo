...
namespace MOS.MANAGER.HisDispense.Handler.Update
{
    class ExpMestMaterialProcessor : BusinessBase
    {
        ...
        internal bool Run(HisDispenseUpdateSDO data, HIS_EXP_MEST expMest, ref List<HIS_EXP_MEST_MATERIAL> expMestMaterials, ref List<string> sqls)
        {
            bool result = false;
            try
            {
        ...
        private List<HIS_EXP_MEST_MATERIAL> MakeDataMaterial(List<HIS_EXP_MEST_MATERIAL> olds, HisDispenseUpdateSDO sdo, HIS_EXP_MEST expMest, ref Dictionary<HIS_EXP_MEST_MATERIAL, List<long>> medicineDic)
        {
