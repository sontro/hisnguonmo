...
{
    partial class HisMemaGroupLock : BusinessBase
    {
        internal HisMemaGroupLock()
            : base()
        {

        }

        internal HisMemaGroupLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_MEMA_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_MEMA_GROUP data = new HisMemaGroupGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisMemaGroupDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_MEMA_GROUP resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_MEMA_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisMemaGroupCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisMemaGroupDAO.Update(raw);
