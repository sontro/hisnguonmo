...
{
    partial class HisImpUserTempDtLock : BusinessBase
    {
        internal HisImpUserTempDtLock()
            : base()
        {

        }

        internal HisImpUserTempDtLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_IMP_USER_TEMP_DT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_IMP_USER_TEMP_DT data = new HisImpUserTempDtGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisImpUserTempDtDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_IMP_USER_TEMP_DT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_IMP_USER_TEMP_DT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisImpUserTempDtCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisImpUserTempDtDAO.Update(raw);
