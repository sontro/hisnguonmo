...
{
    partial class HisFormTypeCfgDataLock : BusinessBase
    {
        internal HisFormTypeCfgDataLock()
            : base()
        {

        }

        internal HisFormTypeCfgDataLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_FORM_TYPE_CFG_DATA resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_FORM_TYPE_CFG_DATA data = new HisFormTypeCfgDataGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisFormTypeCfgDataDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_FORM_TYPE_CFG_DATA resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_FORM_TYPE_CFG_DATA resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisFormTypeCfgDataCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisFormTypeCfgDataDAO.Update(raw);
