...
{
    partial class HisEmployeeScheduleLock : BusinessBase
    {
        internal HisEmployeeScheduleLock()
            : base()
        {

        }

        internal HisEmployeeScheduleLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EMPLOYEE_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EMPLOYEE_SCHEDULE data = new HisEmployeeScheduleGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEmployeeScheduleDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EMPLOYEE_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EMPLOYEE_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEmployeeScheduleCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEmployeeScheduleDAO.Update(raw);
