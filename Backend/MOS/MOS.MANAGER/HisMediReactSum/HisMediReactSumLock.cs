...
{
    partial class HisMediReactSumLock : BusinessBase
    {
        internal HisMediReactSumLock()
            : base()
        {

        }

        internal HisMediReactSumLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_MEDI_REACT_SUM resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_MEDI_REACT_SUM data = new HisMediReactSumGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisMediReactSumDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_MEDI_REACT_SUM resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_MEDI_REACT_SUM resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisMediReactSumCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisMediReactSumDAO.Update(raw);
