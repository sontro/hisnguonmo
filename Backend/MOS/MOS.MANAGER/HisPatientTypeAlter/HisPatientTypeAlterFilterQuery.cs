    ...
    public class HisPatientTypeAlterFilterQuery : HisPatientTypeAlterFilter
    {
        ...
        internal HisPatientTypeAlterSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisPatientTypeAlterExpression.Add(o => this.PATIENT_TYPE_IDs.Contains(o.PATIENT_TYPE_ID));
                }
                if (this.TREATMENT_IDs != null)
                {
                    listHisPatientTypeAlterExpression.Add(o => this.TREATMENT_IDs.Contains(o.TREATMENT_ID));
                }
                ...
                if (!String.IsNullOrEmpty(this.RIGHT_ROUTE_TYPE_CODE__EXACT))
                {
                    listHisPatientTypeAlterExpression.Add(o => o.RIGHT_ROUTE_TYPE_CODE == this.RIGHT_ROUTE_TYPE_CODE__EXACT);
                }
                if (this.HEIN_CARD_NUMBER__EXACTs != null)
                {
                    listHisPatientTypeAlterExpression.Add(o => this.HEIN_CARD_NUMBER__EXACTs.Contains(o.HEIN_CARD_NUMBER));
                }
                ...
                {
                    listHisPatientTypeAlterExpression.Add(o => o.DEPARTMENT_TRAN_ID == this.DEPARTMENT_TRAN_ID.Value);
                }
                if (this.DEPARTMENT_TRAN_IDs != null)
                {
                    listHisPatientTypeAlterExpression.Add(o => this.DEPARTMENT_TRAN_IDs.Contains(o.DEPARTMENT_TRAN_ID));
                }
                if (this.ID__NOT_EQUAL.HasValue)
                {
                    listHisPatientTypeAlterExpression.Add(o => o.ID != this.ID__NOT_EQUAL.Value);
                }
                if (this.TREATMENT_ID__NOT_EQUAL.HasValue)
                {
                    listHisPatientTypeAlterExpression.Add(o => o.TREATMENT_ID != this.TREATMENT_ID__NOT_EQUAL.Value);
                }
                if (this.IS_TEMP_QN.HasValue)
                {
                    if (this.IS_TEMP_QN.Value)
                    {
                        listHisPatientTypeAlterExpression.Add(o => o.IS_TEMP_QN.HasValue && o.IS_TEMP_QN.Value == UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        listHisPatientTypeAlterExpression.Add(o => !o.IS_TEMP_QN.HasValue || o.IS_TEMP_QN.Value != UTILITY.Constant.IS_TRUE);
