    ...
    public class HisPatientTypeAlterViewFilterQuery : HisPatientTypeAlterViewFilter
    {
        ...
        internal HisPatientTypeAlterSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisPatientTypeAlterExpression.Add(o => this.TREATMENT_IDs.Contains(o.TREATMENT_ID));
                }
                ...
                {
                    listVHisPatientTypeAlterExpression.Add(o => this.PATIENT_TYPE_IDs.Contains(o.PATIENT_TYPE_ID));
                }
                if (this.TREATMENT_TYPE_IDs != null)
                {
                    listVHisPatientTypeAlterExpression.Add(o => this.TREATMENT_TYPE_IDs.Contains(o.TREATMENT_TYPE_ID));
                }
                ...
                {
                    listVHisPatientTypeAlterExpression.Add(o => o.DEPARTMENT_TRAN_ID == this.DEPARTMENT_TRAN_ID.Value);
                }
                if (this.DEPARTMENT_TRAN_IDs != null)
                {
                    listVHisPatientTypeAlterExpression.Add(o => this.DEPARTMENT_TRAN_IDs.Contains(o.DEPARTMENT_TRAN_ID));
                }
