    ...
    public class HisBloodTypeFilterQuery : HisBloodTypeFilter
    {
        ...
        internal HisBloodTypeSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisBloodTypeExpression.Add(o => o.BLOOD_VOLUME_ID == this.BLOOD_VOLUME_ID.Value);
                }
                if (this.BLOOD_VOLUME_IDs != null)
                {
                    listHisBloodTypeExpression.Add(o => this.BLOOD_VOLUME_IDs.Contains(o.BLOOD_VOLUME_ID));
                }
