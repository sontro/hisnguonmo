...
{
    partial class HisRationSumSttLock : BusinessBase
    {
        internal HisRationSumSttLock()
            : base()
        {

        }

        internal HisRationSumSttLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_RATION_SUM_STT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_RATION_SUM_STT data = new HisRationSumSttGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisRationSumSttDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_RATION_SUM_STT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_RATION_SUM_STT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisRationSumSttCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisRationSumSttDAO.Update(raw);
