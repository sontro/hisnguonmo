...
{
    partial class HisAntibioticOldRegLock : BusinessBase
    {
        internal HisAntibioticOldRegLock()
            : base()
        {

        }

        internal HisAntibioticOldRegLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_ANTIBIOTIC_OLD_REG resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_ANTIBIOTIC_OLD_REG data = new HisAntibioticOldRegGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisAntibioticOldRegDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_ANTIBIOTIC_OLD_REG resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_ANTIBIOTIC_OLD_REG resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisAntibioticOldRegCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisAntibioticOldRegDAO.Update(raw);
