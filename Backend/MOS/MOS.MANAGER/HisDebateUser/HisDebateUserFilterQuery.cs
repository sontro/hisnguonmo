    ...
    public class HisDebateUserFilterQuery : HisDebateUserFilter
    {
        ...
        internal HisDebateUserSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisDebateUserExpression.Add(o => o.DEBATE_ID.HasValue && o.DEBATE_ID == this.DEBATE_ID.Value);
                }
                if (this.DEBATE_TEMP_ID.HasValue)
                {
                    listHisDebateUserExpression.Add(o => o.DEBATE_TEMP_ID.HasValue && o.DEBATE_TEMP_ID == this.DEBATE_TEMP_ID.Value);
                }
