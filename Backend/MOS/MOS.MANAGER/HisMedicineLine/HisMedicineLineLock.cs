...
{
    partial class HisMedicineLineLock : BusinessBase
    {
        internal HisMedicineLineLock()
            : base()
        {

        }

        internal HisMedicineLineLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_MEDICINE_LINE data)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisMedicineLineCheck().VerifyId(data.ID, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisMedicineLineDAO.Update(raw);
