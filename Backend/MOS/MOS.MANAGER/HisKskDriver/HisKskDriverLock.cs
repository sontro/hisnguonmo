...
{
    partial class HisKskDriverLock : BusinessBase
    {
        internal HisKskDriverLock()
            : base()
        {

        }

        internal HisKskDriverLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_KSK_DRIVER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_KSK_DRIVER data = new HisKskDriverGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisKskDriverDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_KSK_DRIVER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_KSK_DRIVER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisKskDriverCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisKskDriverDAO.Update(raw);
