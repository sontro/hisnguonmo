    ...
    public class HisMedicineTypeAcinViewFilterQuery : HisMedicineTypeAcinViewFilter
    {
        ...
        internal HisMedicineTypeAcinSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisMedicineTypeAcinExpression.Add(o => o.ACTIVE_INGREDIENT_ID == this.ACTIVE_INGREDIENT_ID.Value);
                }
                if (this.ACTIVE_INGREDIENT_IDs != null)
                {
                    listVHisMedicineTypeAcinExpression.Add(o => this.ACTIVE_INGREDIENT_IDs.Contains(o.ACTIVE_INGREDIENT_ID));
                }

                if (!String.IsNullOrWhiteSpace(this.ACTIVE_INGREDIENT_CODE__EXACT))
                {
                    listVHisMedicineTypeAcinExpression.Add(o => o.ACTIVE_INGREDIENT_CODE == this.ACTIVE_INGREDIENT_CODE__EXACT);
                }
                if (!String.IsNullOrWhiteSpace(this.MEDICINE_TYPE_CODE__EXACT))
                {
                    listVHisMedicineTypeAcinExpression.Add(o => o.MEDICINE_TYPE_CODE == this.MEDICINE_TYPE_CODE__EXACT);
                }
                ...
                if (this.IS_APPROVAL_REQUIRED.HasValue && this.IS_APPROVAL_REQUIRED.Value)
                {
                    listVHisMedicineTypeAcinExpression.Add(o => o.IS_APPROVAL_REQUIRED == Constant.IS_TRUE);
                }
                if (this.IS_APPROVAL_REQUIRED.HasValue && !this.IS_APPROVAL_REQUIRED.Value)
                {
                    listVHisMedicineTypeAcinExpression.Add(o => !o.IS_APPROVAL_REQUIRED.HasValue || o.IS_APPROVAL_REQUIRED != Constant.IS_TRUE);
                }
