    ...
    public class HisMedicineTypeAcinFilterQuery : HisMedicineTypeAcinFilter
    {
        ...
        internal HisMedicineTypeAcinSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisMedicineTypeAcinExpression.Add(o => this.ACTIVE_INGREDIENT_IDs.Contains(o.ACTIVE_INGREDIENT_ID));
                }
                if (this.MEDICINE_TYPE_ID.HasValue)
                {
                    listHisMedicineTypeAcinExpression.Add(o => o.MEDICINE_TYPE_ID == this.MEDICINE_TYPE_ID.Value);
                }
                if (this.MEDICINE_TYPE_IDs != null)
                {
                    listHisMedicineTypeAcinExpression.Add(o => this.MEDICINE_TYPE_IDs.Contains(o.MEDICINE_TYPE_ID));
                }
