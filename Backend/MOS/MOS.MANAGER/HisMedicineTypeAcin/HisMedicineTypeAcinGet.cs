...
namespace MOS.MANAGER.HisMedicineTypeAcin
{
    class HisMedicineTypeAcinGet : GetBase
    {
        ...
        internal List<HIS_MEDICINE_TYPE_ACIN> GetByMedicineTypeId(long medicineTypeId)
        {
            try
            {
                HisMedicineTypeAcinFilterQuery filter = new HisMedicineTypeAcinFilterQuery();
        ...
        internal List<V_HIS_MEDICINE_TYPE_ACIN> GetViewByMedicineTypeIds(List<long> medicineTypeIds)
        {
            try
            {
