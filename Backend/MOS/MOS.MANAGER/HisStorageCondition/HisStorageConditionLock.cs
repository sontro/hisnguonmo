...
{
    partial class HisStorageConditionLock : BusinessBase
    {
        internal HisStorageConditionLock()
            : base()
        {

        }

        internal HisStorageConditionLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_STORAGE_CONDITION resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_STORAGE_CONDITION data = new HisStorageConditionGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisStorageConditionDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_STORAGE_CONDITION resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_STORAGE_CONDITION resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisStorageConditionCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisStorageConditionDAO.Update(raw);
