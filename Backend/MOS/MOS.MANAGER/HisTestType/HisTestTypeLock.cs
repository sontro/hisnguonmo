...
{
    partial class HisTestTypeLock : BusinessBase
    {
        internal HisTestTypeLock()
            : base()
        {

        }

        internal HisTestTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_TEST_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_TEST_TYPE data = new HisTestTypeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisTestTypeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_TEST_TYPE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_TEST_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisTestTypeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisTestTypeDAO.Update(raw);
