...
{
    partial class HisFileTypeLock : BusinessBase
    {
        internal HisFileTypeLock()
            : base()
        {

        }

        internal HisFileTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_FILE_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_FILE_TYPE data = new HisFileTypeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisFileTypeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_FILE_TYPE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_FILE_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisFileTypeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisFileTypeDAO.Update(raw);
