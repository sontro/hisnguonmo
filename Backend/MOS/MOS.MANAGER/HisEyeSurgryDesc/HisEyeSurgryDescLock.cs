...
{
    partial class HisEyeSurgryDescLock : BusinessBase
    {
        internal HisEyeSurgryDescLock()
            : base()
        {

        }

        internal HisEyeSurgryDescLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EYE_SURGRY_DESC resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EYE_SURGRY_DESC data = new HisEyeSurgryDescGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEyeSurgryDescDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EYE_SURGRY_DESC resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EYE_SURGRY_DESC resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEyeSurgryDescCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEyeSurgryDescDAO.Update(raw);
