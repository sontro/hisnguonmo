        ...
        internal HisExecuteRoomSO Query()
        {
            ...
            try
            {
                ...
                if (this.IS_EMERGENCY.HasValue)
                {
                    ...
                    {
                        search.listHisExecuteRoomExpression.Add(o => o.IS_EMERGENCY.HasValue && o.IS_EMERGENCY == MOS.UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        search.listHisExecuteRoomExpression.Add(o => !o.IS_EMERGENCY.HasValue || o.IS_EMERGENCY != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listHisExecuteRoomExpression.Add(o => o.IS_EMERGENCY.HasValue && o.IS_EMERGENCY.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EMERGENCY.HasValue && !this.IS_EMERGENCY.Value)
                {
                    listHisExecuteRoomExpression.Add(o => !o.IS_EMERGENCY.HasValue || o.IS_EMERGENCY.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listHisExecuteRoomExpression.Add(o => o.IS_EXAM == MOS.UTILITY.Constant.IS_TRUE);
                }
                ...
                {
                    listHisExecuteRoomExpression.Add(o => o.EXECUTE_ROOM_CODE == this.EXECUTE_ROOM_CODE__EXACT);
                }
