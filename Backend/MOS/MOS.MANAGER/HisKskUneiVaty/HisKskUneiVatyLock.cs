...
{
    partial class HisKskUneiVatyLock : BusinessBase
    {
        internal HisKskUneiVatyLock()
            : base()
        {

        }

        internal HisKskUneiVatyLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_KSK_UNEI_VATY resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_KSK_UNEI_VATY data = new HisKskUneiVatyGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisKskUneiVatyDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_KSK_UNEI_VATY resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_KSK_UNEI_VATY resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisKskUneiVatyCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisKskUneiVatyDAO.Update(raw);
