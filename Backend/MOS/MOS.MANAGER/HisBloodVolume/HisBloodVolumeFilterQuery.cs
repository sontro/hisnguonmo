    ...
    public class HisBloodVolumeFilterQuery : HisBloodVolumeFilter
    {
        ...
        internal HisBloodVolumeSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisBloodVolumeExpression.Add(o => o.ID != this.ID__NOT_EQUAL);
                }
                if (this.VOLUMN__EQUAL.HasValue)
                {
                    listHisBloodVolumeExpression.Add(o => o.VOLUME == this.VOLUMN__EQUAL.Value);
                }
