...
{
    partial class HisBloodGiverLock : BusinessBase
    {
        internal HisBloodGiverLock()
            : base()
        {

        }

        internal HisBloodGiverLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_BLOOD_GIVER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_BLOOD_GIVER data = new HisBloodGiverGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisBloodGiverDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_BLOOD_GIVER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_BLOOD_GIVER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisBloodGiverCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisBloodGiverDAO.Update(raw);
