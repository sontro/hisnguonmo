...
namespace MOS.MANAGER.HisSurgRemuDetail
{
    ...
    {
        internal HisSurgRemuDetailCheck()
            : base()
        {

        }

        internal HisSurgRemuDetailCheck(CommonParam paramCheck)
            : base(paramCheck) 
        {

        }

        internal bool VerifyRequireField(HIS_SURG_REMU_DETAIL data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool VerifyId(long id)
        {
            ...
            try
            {
                if (new HisSurgRemuDetailGet().GetById(id) == null)
                {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool VerifyId(long id, ref HIS_SURG_REMU_DETAIL data)
        {
            bool valid = true;
            try
            {
                data = new HisSurgRemuDetailGet().GetById(id);
                if (data == null)
                {
                    BugUtil.SetBugCode(param, LibraryBug.Bug.Enum.KXDDDuLieuCanXuLy);
                    Logging("Id invalid." + Inventec.Common.Logging.LogUtil.TraceData(Inventec.Common.Logging.LogUtil.GetMemberName(() => id), id), LogType.Error);
        ...
        internal bool VerifyIds(List<long> listId)
        {
            ...
            try
            {
                if (listId != null && listId.Count > 0)
                {
                    ...
                    filter.IDs = listId;
                    List<HIS_SURG_REMU_DETAIL> listData = new HisSurgRemuDetailGet().Get(filter);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool VerifyIds(List<long> listId, List<HIS_SURG_REMU_DETAIL> listObject)
        {
            bool valid = true;
            try
            {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool IsUnLock(HIS_SURG_REMU_DETAIL data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool IsUnLock(long id)
        {
            ...
            try
            {
                if (!DAOWorker.HisSurgRemuDetailDAO.IsUnLock(id))
                {
                    valid = false;
                    MessageUtil.SetMessage(param, LibraryMessage.Message.Enum.DuLieuDangBiKhoa);
                }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool IsUnLock(List<HIS_SURG_REMU_DETAIL> listData)
        {
            bool valid = true;
            try
            {
        ...
        internal bool CheckConstraint(long id)
        {
            ...
            try
            {
                /*List<XXX> hisXXXs = new HisXXXGet().GetByHisSurgRemuDetailId(id);
        ...
        internal bool IsNotExist(HIS_SURG_REMU_DETAIL data)
        {
            bool valid = true;
            try
            {
                ...
                filter.SURG_REMUNERATION_ID = data.SURG_REMUNERATION_ID;
                filter.ID_NOT_EQUAL = data.ID;

                List<HIS_SURG_REMU_DETAIL> rs = new HisSurgRemuDetailGet().Get(filter);
                if (IsNotNullOrEmpty(rs))
                {
                    HIS_EXECUTE_ROLE executeRole = new HisExecuteRoleGet().GetById(data.EXECUTE_ROLE_ID);
                    MOS.MANAGER.Base.MessageUtil.SetMessage(param, MOS.LibraryMessage.Message.Enum.HisSurgRemuDetail_TonTaiDuLieu, executeRole.EXECUTE_ROLE_NAME);
                    return false;
                }
            }
            catch (Exception ex)
