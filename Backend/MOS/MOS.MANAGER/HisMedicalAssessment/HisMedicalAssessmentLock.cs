...
{
    partial class HisMedicalAssessmentLock : BusinessBase
    {
        internal HisMedicalAssessmentLock()
            : base()
        {

        }

        internal HisMedicalAssessmentLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_MEDICAL_ASSESSMENT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_MEDICAL_ASSESSMENT data = new HisMedicalAssessmentGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisMedicalAssessmentDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_MEDICAL_ASSESSMENT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_MEDICAL_ASSESSMENT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisMedicalAssessmentCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisMedicalAssessmentDAO.Update(raw);
