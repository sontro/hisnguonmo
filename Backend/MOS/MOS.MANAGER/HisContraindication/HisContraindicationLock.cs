...
{
    partial class HisContraindicationLock : BusinessBase
    {
        internal HisContraindicationLock()
            : base()
        {

        }

        internal HisContraindicationLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_CONTRAINDICATION resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_CONTRAINDICATION data = new HisContraindicationGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisContraindicationDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_CONTRAINDICATION resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_CONTRAINDICATION resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisContraindicationCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisContraindicationDAO.Update(raw);
