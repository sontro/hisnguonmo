...
{
    partial class HisSereServBillLock : BusinessBase
    {
        internal HisSereServBillLock()
            : base()
        {

        }

        internal HisSereServBillLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SERE_SERV_BILL resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SERE_SERV_BILL data = new HisSereServBillGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisSereServBillDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SERE_SERV_BILL resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SERE_SERV_BILL resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisSereServBillCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisSereServBillDAO.Update(raw);
