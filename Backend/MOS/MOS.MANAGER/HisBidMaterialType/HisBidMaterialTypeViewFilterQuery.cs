    ...
    public class HisBidMaterialTypeViewFilterQuery : HisBidMaterialTypeViewFilter
    {
        ...
        internal HisBidMaterialTypeSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisBidMaterialTypeExpression.Add(o => o.MATERIAL_TYPE_ID.HasValue && this.MATERIAL_TYPE_IDs.Contains(o.MATERIAL_TYPE_ID.Value));
                }
                if (this.SUPPLIER_ID.HasValue)
                {
                    listVHisBidMaterialTypeExpression.Add(o => o.SUPPLIER_ID == this.SUPPLIER_ID.Value);
                }
