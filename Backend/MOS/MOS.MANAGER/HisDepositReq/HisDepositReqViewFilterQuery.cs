    ...
    public class HisDepositReqViewFilterQuery : HisDepositReqViewFilter
    {
        ...
        internal HisDepositReqSO Query()
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(this.SYMBOL_CODE))
                {
                    listVHisDepositReqExpression.Add(o => o.SYMBOL_CODE == this.SYMBOL_CODE);
                }
                if (!String.IsNullOrEmpty(this.TEMPLATE_CODE))
                {
                    listVHisDepositReqExpression.Add(o => o.TEMPLATE_CODE == this.TEMPLATE_CODE);
                }
