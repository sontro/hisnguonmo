...
{
    partial class HisDiimTypeLock : BusinessBase
    {
        internal HisDiimTypeLock()
            : base()
        {

        }

        internal HisDiimTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_DIIM_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_DIIM_TYPE data = new HisDiimTypeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisDiimTypeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_DIIM_TYPE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_DIIM_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisDiimTypeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisDiimTypeDAO.Update(raw);
