    ...
    public class HisSereServPtttFilterQuery : HisSereServPtttFilter
    {
        ...
        internal HisSereServPtttSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisSereServPtttExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && o.TDL_TREATMENT_ID.Value == this.TDL_TREATMENT_ID.Value);
                }
                if (this.TDL_TREATMENT_IDs != null)
                {
                    listHisSereServPtttExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && this.TDL_TREATMENT_IDs.Contains(o.TDL_TREATMENT_ID.Value));
                }
                if (this.SERE_SERV_ID.HasValue)
                {
                    listHisSereServPtttExpression.Add(o => o.SERE_SERV_ID == this.SERE_SERV_ID.Value);
                }
