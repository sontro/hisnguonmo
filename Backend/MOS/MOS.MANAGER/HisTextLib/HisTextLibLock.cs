...
{
    class HisTextLibLock : BusinessBase
    {
        internal HisTextLibLock()
            : base()
        {

        }

        internal HisTextLibLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_TEXT_LIB data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisTextLibGet().GetById(data.ID);
                    if (data != null)
                    {
