...
namespace MOS.MANAGER.HisExpMest.BaseAddition.Create
{
    class ExpMestProcessor : BusinessBase
    {
        ...
        internal bool Run(CabinetBaseAdditionSDO data, WorkPlaceSDO workPlace, ref HIS_EXP_MEST expMest)
        {
            bool result = false;
            try
            {
                ...
                exp.MEDI_STOCK_ID = data.ExpMestMediStockId;
                ...
                exp.CHMS_TYPE_ID = IMSys.DbConfig.HIS_RS.HIS_EXP_MEST.CHMS_TYPE__ID__ADDITION;
