...
using MOS.MANAGER.HisExpMest.BaseReduction;
...
{
    class HisExpMestBaseReductionUpdate : BusinessBase
    {
        ...
        internal HisExpMestBaseReductionUpdate()
            : base()
        {
            this.Init();
        }

        internal HisExpMestBaseReductionUpdate(CommonParam param)
            : base(param)
        {
            this.Init();
        }
        ...
        internal bool Run(CabinetBaseReductionSDO data, ref HisExpMestResultSDO resultData)
        {
            ...
            try
            {
                ...
                HisExpMestBaseReductionCheck reducChecker = new HisExpMestBaseReductionCheck(param);
                ...
                valid = valid && reducChecker.ValidData(data, stockMetys, stockMatys);
