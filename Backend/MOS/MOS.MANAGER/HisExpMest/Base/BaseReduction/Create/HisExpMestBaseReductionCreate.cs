...
{
    class HisExpMestBaseReductionCreate : BusinessBase
    {
        ...
        internal HisExpMestBaseReductionCreate()
            : base()
        {
            this.Init();
        }

        internal HisExpMestBaseReductionCreate(CommonParam param)
            : base(param)
        {
            this.Init();
        }
        ...
        internal bool Run(CabinetBaseReductionSDO data, ref HisExpMestResultSDO resultData)
        {
            bool result = false;
            try
            {
                ...
                HisExpMestBaseReductionCheck checker = new HisExpMestBaseReductionCheck(param);
                ...
                valid = valid && mediStockChecker.VerifyId(data.ImpMestMediStockId, ref expStock);
                ...
                valid = valid && checker.IsWorkingInImpOrExpStock(workPlace, data.CabinetMediStockId, data.ImpMestMediStockId);
