...
namespace MOS.MANAGER.HisExpMest.Manu.Update
{
    class MedicineProcessor : BusinessBase
    {
        ...
        internal bool Run(HisExpMestManuSDO sdo, HIS_EXP_MEST expMest, ref List<HIS_EXP_MEST_MEDICINE> resultData, ref List<string> sqls)
        {
            try
            {
                if (expMest != null)
        ...
        private List<HIS_EXP_MEST_MEDICINE> MakeData(List<HIS_EXP_MEST_MEDICINE> olds, HisExpMestManuSDO sdo, HIS_EXP_MEST expMest, ref Dictionary<HIS_EXP_MEST_MEDICINE, List<long>> medicineDic)
        {
