...
namespace MOS.MANAGER.HisExpMest.Manu.Update
{
    class MaterialProcessor : BusinessBase
    {
        ...
        internal bool Run(HisExpMestManuSDO sdo, HIS_EXP_MEST expMest, ref List<HIS_EXP_MEST_MATERIAL> resultData, ref List<string> sqls)
        {
            try
            {
                if (expMest != null)
        ...
        private void SqlUpdateBean(Dictionary<HIS_EXP_MEST_MATERIAL, List<long>> newMaterialDic, List<long> deleteExpMestMaterialIds, ref List<string> sqls)
        {
            ...
            //tranh truong hop bean sau do lai duoc gan vao cac exp_mest_material tao moi
        ...
        private List<HIS_EXP_MEST_MATERIAL> MakeData(List<HIS_EXP_MEST_MATERIAL> olds, HisExpMestManuSDO sdo, HIS_EXP_MEST expMest, ref Dictionary<HIS_EXP_MEST_MATERIAL, List<long>> materialDic)
        {
