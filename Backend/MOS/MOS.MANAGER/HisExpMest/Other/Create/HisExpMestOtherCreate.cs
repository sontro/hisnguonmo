...
namespace MOS.MANAGER.HisExpMest.Other.Create
{
    ...
    partial class HisExpMestOtherCreate : BusinessBase
    {
        ...
        internal HisExpMestOtherCreate()
            : base()
        {
            this.Init();
        }

        internal HisExpMestOtherCreate(CommonParam paramCreate)
            : base(paramCreate)
        {
            this.Init();
        }
        ...
        internal bool Run(HisExpMestOtherSDO data, ref HisExpMestResultSDO resultData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    ...
                    //Tao exp_mest_material
                    if (!this.materialReuseProcessor.Run(data.SerialNumbers, expMest, ref expMestMaterials, ref sqls))
                    {
                    ...
                    //Tao exp_mest_blood
                    if (!this.bloodProcessor.Run(data.Bloods, expMest, ref expMestBloods, ref sqls))
                    {
