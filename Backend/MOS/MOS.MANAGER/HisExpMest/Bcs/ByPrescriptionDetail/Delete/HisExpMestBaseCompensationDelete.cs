...
{
    class HisExpMestBaseCompensationDelete : BusinessBase
    {
        ...
        internal HisExpMestBaseCompensationDelete()
            : base()
        {
            this.Init();
        }

        internal HisExpMestBaseCompensationDelete(CommonParam param)
            : base(param)
        {
            this.Init();
        }
        ...
        internal bool Run(HisExpMestSDO data)
        {
            ...
            try
            {
                ...
                valid = valid && checker.IsCompensationPresDetail(raw);
        ...
        {
            this.metyReqProcessor.Rollback();
            this.matyReqProcessor.Rollback();
        }
    }
}
