...
{
    //Xuat ban
    partial class HisExpMestSaleUpdate : BusinessBase
    {
        ...
        internal HisExpMestSaleUpdate()
            : base()
        {
            this.Init();
        }

        internal HisExpMestSaleUpdate(CommonParam paramUpdate)
            : base(paramUpdate)
        {
            this.Init();
        }
        ...
        internal bool Run(HisExpMestSaleSDO data, ref HisExpMestResultSDO resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && expMestCheck.HasNotBill(expMest);
                valid = valid && expMestCheck.HasNoDebt(expMest);
