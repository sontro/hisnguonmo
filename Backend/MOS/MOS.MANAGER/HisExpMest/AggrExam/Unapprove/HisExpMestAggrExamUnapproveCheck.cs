...
{
    partial class HisExpMestAggrExamUnapproveCheck : BusinessBase
    {
        internal HisExpMestAggrExamUnapproveCheck()
            : base()
        {

        }

        internal HisExpMestAggrExamUnapproveCheck(CommonParam paramCreate)
            : base(paramCreate)
        {
