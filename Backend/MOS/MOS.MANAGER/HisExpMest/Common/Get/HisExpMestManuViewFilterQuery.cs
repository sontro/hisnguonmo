        ...
        internal HisExpMestSO Query()
        {
            ...
            try
            {
                ...
                if (this.DATA_DOMAIN_FILTER)
                {
                    ...
                    {
                        listVHisExpMestManuExpression.Add(o => loginName.Equals(o.CREATOR));
                    }
                    else
                    {
                        ...
                        if (workPlace != null)
                        {
                            listVHisExpMestManuExpression.Add(o => o.MEDI_STOCK_ID == workPlace.MediStockId || o.REQ_ROOM_ID == workPlace.RoomId || loginName.Equals(o.CREATOR));
                        }
                        else
                        {
                            listVHisExpMestManuExpression.Add(o => loginName.Equals(o.CREATOR));
                ...
                {
                    search.listVHisExpMestManuExpression.Add(o => o.IS_NOT_TAKEN.HasValue && o.IS_NOT_TAKEN.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_NOT_TAKEN.HasValue && !this.IS_NOT_TAKEN.Value)
                {
                    search.listVHisExpMestManuExpression.Add(o => !o.IS_NOT_TAKEN.HasValue || o.IS_NOT_TAKEN.Value != MOS.UTILITY.Constant.IS_TRUE);
