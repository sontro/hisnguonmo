    ...
    public class HisExpMestChmsViewFilterQuery : HisExpMestChmsViewFilter
    {
        ...
        internal HisExpMestSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisExpMestChmsExpression.Add(o => this.REQ_DEPARTMENT_ID == o.REQ_DEPARTMENT_ID);
                }
                ...
                if (this.DATA_DOMAIN_FILTER)
                {
                    ...
                    {
                        listVHisExpMestChmsExpression.Add(o => loginName.Equals(o.CREATOR));
                    }
                    else
                    {
                        ...
                        if (workPlace != null)
                        {
                            listVHisExpMestChmsExpression.Add(o => o.MEDI_STOCK_ID == workPlace.MediStockId || o.REQ_ROOM_ID == workPlace.RoomId || loginName.Equals(o.CREATOR));
                        }
                        else
                        {
                            listVHisExpMestChmsExpression.Add(o => loginName.Equals(o.CREATOR));
                ...
                {
                    search.listVHisExpMestChmsExpression.Add(o => o.IS_NOT_TAKEN.HasValue && o.IS_NOT_TAKEN.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_NOT_TAKEN.HasValue && !this.IS_NOT_TAKEN.Value)
                {
                    search.listVHisExpMestChmsExpression.Add(o => !o.IS_NOT_TAKEN.HasValue || o.IS_NOT_TAKEN.Value != MOS.UTILITY.Constant.IS_TRUE);
