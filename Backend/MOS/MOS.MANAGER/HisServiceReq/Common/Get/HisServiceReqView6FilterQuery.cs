    ...
    public class HisServiceReqView6FilterQuery : HisServiceReqView6Filter
    {
        ...
        internal HisServiceReqSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisServiceReq6Expression.Add(o => o.SERVICE_REQ_CODE == this.SERVICE_REQ_CODE);
                }
                ...
                {
                    listVHisServiceReq6Expression.Add(o => o.SESSION_CODE == this.SESSION_CODE__EXACT);
                }
                ...
                {
                    listVHisServiceReq6Expression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_NO_EXECUTE.HasValue && !this.IS_NO_EXECUTE.Value)
                {
                    listVHisServiceReq6Expression.Add(o => !o.IS_NO_EXECUTE.HasValue || o.IS_NO_EXECUTE.Value != MOS.UTILITY.Constant.IS_TRUE);
