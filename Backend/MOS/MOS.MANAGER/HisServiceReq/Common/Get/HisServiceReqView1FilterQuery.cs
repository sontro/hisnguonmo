    ...
    public class HisServiceReqView1FilterQuery : HisServiceReqView1Filter
    {
        ...
        internal HisServiceReqSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisServiceReq1Expression.Add(o => o.SERVICE_REQ_CODE == this.SERVICE_REQ_CODE);
                }
                ...
                {
                    listVHisServiceReq1Expression.Add(o => o.SESSION_CODE == this.SESSION_CODE__EXACT);
                }
                ...
                {
                    listVHisServiceReq1Expression.Add(o => !o.IS_NO_EXECUTE.HasValue || o.IS_NO_EXECUTE.Value != MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.HAS_EXECUTE.HasValue && !this.HAS_EXECUTE.Value)
                {
                    listVHisServiceReq1Expression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE.Value == MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisServiceReq1Expression.Add(o => o.RATION_TIME_ID.HasValue && o.RATION_TIME_ID.Value == this.RATION_TIME_ID.Value);
                }
                if (this.RATION_TIME_IDs != null)
                {
                    listVHisServiceReq1Expression.Add(o => o.RATION_TIME_ID.HasValue && this.RATION_TIME_IDs.Contains(o.RATION_TIME_ID.Value));
                }
                if (this.RATION_SUM_ID.HasValue)
                {
                    listVHisServiceReq1Expression.Add(o => o.RATION_SUM_ID.HasValue && o.RATION_SUM_ID.Value == this.RATION_SUM_ID.Value);
                }
                if (this.RATION_SUM_IDs != null)
                {
                    listVHisServiceReq1Expression.Add(o => o.RATION_SUM_ID.HasValue && this.RATION_SUM_IDs.Contains(o.RATION_SUM_ID.Value));
                }
                ...
                if (this.HAS_RATION_SUM_ID.HasValue)
                {
                    ...
                    {
                        listVHisServiceReq1Expression.Add(o => o.RATION_SUM_ID.HasValue);
                    }
                    else
                    {
                        listVHisServiceReq1Expression.Add(o => !o.RATION_SUM_ID.HasValue);
                ...
                {
                    listVHisServiceReq1Expression.Add(o => this.EXECUTE_ROOM_IDs.Contains(o.EXECUTE_ROOM_ID));
                }

                if (this.REQUEST_ROOM_IDs != null)
                {
                    listVHisServiceReq1Expression.Add(o => this.REQUEST_ROOM_IDs.Contains(o.REQUEST_ROOM_ID));
                }
