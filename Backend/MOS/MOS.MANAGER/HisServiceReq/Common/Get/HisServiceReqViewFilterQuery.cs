    ...
    public class HisServiceReqViewFilterQuery : HisServiceReqViewFilter
    {
        ...
        internal HisServiceReqSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisServiceReqExpression.Add(o => o.REQUEST_LOGINNAME == this.REQUEST_LOGINNAME__EXACT);
                }

                if (!String.IsNullOrEmpty(this.PATIENT_CODE))
                {
                    listVHisServiceReqExpression.Add(o => o.TDL_PATIENT_CODE == this.PATIENT_CODE);
                }
                if (!String.IsNullOrEmpty(this.SERVICE_REQ_CODE))
                {
                    listVHisServiceReqExpression.Add(o => o.SERVICE_REQ_CODE == this.SERVICE_REQ_CODE);
                }
                ...
                {
                    listVHisServiceReqExpression.Add(o => o.SESSION_CODE == this.SESSION_CODE__EXACT);
                }
                ...
                {
                    listVHisServiceReqExpression.Add(o => !o.IS_NO_EXECUTE.HasValue || o.IS_NO_EXECUTE.Value != MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.HAS_EXECUTE.HasValue && !this.HAS_EXECUTE.Value)
                {
                    listVHisServiceReqExpression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE.Value == MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisServiceReqExpression.Add(o => o.PARENT_ID == this.PARENT_ID);
                }
