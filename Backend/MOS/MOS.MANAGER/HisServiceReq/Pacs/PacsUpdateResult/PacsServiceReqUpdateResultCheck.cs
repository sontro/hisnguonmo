...
namespace MOS.MANAGER.HisServiceReq.Pacs.PacsUpdateResult
{
    class PacsServiceReqUpdateResultCheck: BusinessBase
    {
        ...
        internal bool IsValidAccessionNumber(string accessionNumber, ref HIS_SERE_SERV sereServ, ref HIS_SERE_SERV_EXT ssExt, ref HIS_SERVICE_REQ serviceReq, ref HIS_TREATMENT treatment)
        {
            bool valid = true;
            try
            {
                ...
                ssExt = new HisSereServExtGet().GetBySereServId(sereServ.ID);
