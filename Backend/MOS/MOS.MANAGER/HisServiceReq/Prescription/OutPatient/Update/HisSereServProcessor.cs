...
namespace MOS.MANAGER.HisServiceReq.Prescription.OutPatient.Update
{
    class HisSereServProcessor : BusinessBase
    {
        ...
        internal bool Run(HIS_TREATMENT treatment, List<HIS_PATIENT_TYPE_ALTER> ptas, HIS_SERVICE_REQ serviceReq, HIS_EXP_MEST expMest, List<HIS_EXP_MEST_MEDICINE> insertMedicines, List<HIS_EXP_MEST_MEDICINE> deleteMedicines, List<HIS_EXP_MEST_MATERIAL> insertMaterials, List<HIS_EXP_MEST_MATERIAL> deleteMaterials, List<HIS_SERE_SERV> existSereServs, List<V_HIS_MEDICINE_2> newsMedicines, ref List<HIS_SERE_SERV> resultData)
        {
            try
            {
