...
namespace MOS.MANAGER.HisServiceReq.Prescription.OutPatient.Update
{
    class MaterialProcessor : BusinessBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        internal bool Run(OutPatientPresSDO sdo, HisSereServPackage37 processPackage37, HisSereServPackageBirth processPackageBirth, HisSereServPackagePttm processPackagePttm, HIS_EXP_MEST expMest, ref List<HIS_EXP_MEST_MATERIAL> inserts, ref List<HIS_EXP_MEST_MATERIAL> deletes, ref List<HIS_EXP_MEST_MATERIAL> resultData, ref List<string> sqls)
        {
            try
            {
                if (expMest != null)
        ...
        private List<HIS_EXP_MEST_MATERIAL> MakeData(OutPatientPresSDO sdo, HIS_EXP_MEST expMest, List<HIS_EXP_MEST_MATERIAL> olds, string sessionKey, ref Dictionary<HIS_EXP_MEST_MATERIAL, List<long>> materialDic)
        {
