...
namespace MOS.MANAGER.HisServiceReq.Prescription.InPatient.Update
{
    class HisServiceReqMatyProcessor : BusinessBase
    {
        ...
        internal bool Run(List<PresOutStockMatySDO> serviceReqMaties, long serviceReqId, long treatmentId, ref List<HIS_SERVICE_REQ_MATY> resultData, ref List<string> sqls)
        {
            try
            {
                ...
                List<HIS_SERVICE_REQ_MATY> olds = new HisServiceReqMatyGet().GetByServiceReqId(serviceReqId);
