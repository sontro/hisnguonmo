...
{
    class HisAcinInteractiveLock : BusinessBase
    {
        internal HisAcinInteractiveLock()
            : base()
        {

        }

        internal HisAcinInteractiveLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_ACIN_INTERACTIVE data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisAcinInteractiveGet().GetById(data.ID);
                    if (data != null)
                    {
                        ...
                        result = DAOWorker.HisAcinInteractiveDAO.Update(data);
                    }
                    else
                    {
