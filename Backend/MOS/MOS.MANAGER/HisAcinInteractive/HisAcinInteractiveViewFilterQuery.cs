    ...
    public class HisAcinInteractiveViewFilterQuery : HisAcinInteractiveViewFilter
    {
        ...
        internal HisAcinInteractiveSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisAcinInteractiveExpression.Add(o => o.INTERACTIVE_GRADE_ID == this.INTERACTIVE_GRADE_ID.Value);
                }
                if (this.INTERACTIVE_GRADE_IDs != null)
                {
                    listVHisAcinInteractiveExpression.Add(o => o.INTERACTIVE_GRADE_ID.HasValue && this.INTERACTIVE_GRADE_IDs.Contains(o.INTERACTIVE_GRADE_ID.Value));
                }
