...
{
    class HisEmteMedicineTypeLock : BusinessBase
    {
        internal HisEmteMedicineTypeLock()
            : base()
        {

        }

        internal HisEmteMedicineTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_EMTE_MEDICINE_TYPE data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisEmteMedicineTypeGet().GetById(data.ID);
                    if (data != null)
                    {
