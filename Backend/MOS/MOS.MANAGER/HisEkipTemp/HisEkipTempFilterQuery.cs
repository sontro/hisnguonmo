        ...
        internal HisEkipTempSO Query()
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listHisEkipTempExpression.Add(o =>
                        o.CREATOR.ToLower().Contains(this.KEY_WORD) ||
                        o.MODIFIER.ToLower().Contains(this.KEY_WORD) ||
                        o.EKIP_TEMP_NAME.ToLower().Contains(this.KEY_WORD)
                        );
                }
                ...
                if (this.CAN_VIEW.HasValue && this.CAN_VIEW.Value)
                {
                    ...
                    listHisEkipTempExpression.Add(o => o.CREATOR == loginName || o.IS_PUBLIC.HasValue && o.IS_PUBLIC.Value == Constant.IS_TRUE);
                }
