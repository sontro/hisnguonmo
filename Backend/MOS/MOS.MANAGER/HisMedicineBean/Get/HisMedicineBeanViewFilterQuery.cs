    ...
    public class HisMedicineBeanViewFilterQuery : HisMedicineBeanViewFilter
    {
        ...
        internal HisMedicineBeanSO Query()
        {
            ...
            try
            {
                ...
                if (this.MEDICINE_TYPE_IS_ACTIVE.HasValue && this.MEDICINE_TYPE_IS_ACTIVE.Value)
                {
                    listVHisMedicineBeanExpression.Add(o => o.MEDICINE_TYPE_IS_ACTIVE == Constant.IS_TRUE );
                }
                if (this.MEDICINE_TYPE_IS_ACTIVE.HasValue && !this.MEDICINE_TYPE_IS_ACTIVE.Value)
                {
                    listVHisMedicineBeanExpression.Add(o => o.MEDICINE_TYPE_IS_ACTIVE != Constant.IS_TRUE);
                ...
                if (this.MEDICINE_IS_ACTIVE.HasValue && this.MEDICINE_IS_ACTIVE.Value)
                {
                    listVHisMedicineBeanExpression.Add(o => o.MEDICINE_IS_ACTIVE == Constant.IS_TRUE);
                }
                if (this.MEDICINE_IS_ACTIVE.HasValue && !this.MEDICINE_IS_ACTIVE.Value)
                {
                    listVHisMedicineBeanExpression.Add(o => o.MEDICINE_IS_ACTIVE != Constant.IS_TRUE);
                ...
                {
                    listVHisMedicineBeanExpression.Add(o => o.IS_GOODS_RESTRICT.HasValue && o.IS_GOODS_RESTRICT.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_GOODS_RESTRICT.HasValue && !this.IS_GOODS_RESTRICT.Value)
                {
                    listVHisMedicineBeanExpression.Add(o => !o.IS_GOODS_RESTRICT.HasValue || o.IS_GOODS_RESTRICT.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    search.listVHisMedicineBeanExpression.Add(o => o.EXP_MEST_MEDICINE_ID.HasValue && o.EXP_MEST_MEDICINE_ID.Value == this.EXP_MEST_MEDICINE_ID.Value);
                }
                if (this.EXP_MEST_MEDICINE_IDs != null)
                {
                    search.listVHisMedicineBeanExpression.Add(o => o.EXP_MEST_MEDICINE_ID.HasValue && this.EXP_MEST_MEDICINE_IDs.Contains(o.EXP_MEST_MEDICINE_ID.Value));
                }
                if (this.EXPIRED_DATE_NULl__OR__GREATER_THAN__OR__EQUAL.HasValue)
                {
                    listVHisMedicineBeanExpression.Add(o => !o.TDL_MEDICINE_EXPIRED_DATE.HasValue || o.TDL_MEDICINE_EXPIRED_DATE.Value >= this.EXPIRED_DATE_NULl__OR__GREATER_THAN__OR__EQUAL.Value);
                }
