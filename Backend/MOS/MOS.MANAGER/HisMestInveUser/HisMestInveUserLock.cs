...
{
    partial class HisMestInveUserLock : BusinessBase
    {
        internal HisMestInveUserLock()
            : base()
        {

        }

        internal HisMestInveUserLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_MEST_INVE_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_MEST_INVE_USER data = new HisMestInveUserGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisMestInveUserDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_MEST_INVE_USER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_MEST_INVE_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisMestInveUserCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisMestInveUserDAO.Update(raw);
