...
{
    partial class HisUnlimitTypeLock : BusinessBase
    {
        internal HisUnlimitTypeLock()
            : base()
        {

        }

        internal HisUnlimitTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_UNLIMIT_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_UNLIMIT_TYPE data = new HisUnlimitTypeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisUnlimitTypeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_UNLIMIT_TYPE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_UNLIMIT_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisUnlimitTypeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisUnlimitTypeDAO.Update(raw);
