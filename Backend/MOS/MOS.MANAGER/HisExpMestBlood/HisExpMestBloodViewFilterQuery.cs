        ...
        internal HisExpMestBloodSO Query()
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listVHisExpMestBloodExpression.Add(o => o.DESCRIPTION.ToLower().Contains(this.KEY_WORD) ||
                ...
                {
                    listVHisExpMestBloodExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && o.TDL_SERVICE_REQ_ID.Value == this.TDL_SERVICE_REQ_ID.Value);
                }
                if (this.TDL_TREATMENT_ID.HasValue)
                {
                    listVHisExpMestBloodExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && o.TDL_TREATMENT_ID.Value == this.TDL_TREATMENT_ID.Value);
                }
                ...
                {
                    listVHisExpMestBloodExpression.Add(o => o.IS_EXPORT.HasValue && o.IS_EXPORT.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPORT.HasValue && !this.IS_EXPORT.Value)
                {
                    listVHisExpMestBloodExpression.Add(o => !o.IS_EXPORT.HasValue || o.IS_EXPORT.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisExpMestBloodExpression.Add(o => o.PATIENT_TYPE_ID.HasValue && o.PATIENT_TYPE_ID.Value == this.PATIENT_TYPE_ID.Value);
                }
                if (this.PATIENT_TYPE_IDs != null)
                {
                    listVHisExpMestBloodExpression.Add(o => o.PATIENT_TYPE_ID.HasValue && this.PATIENT_TYPE_IDs.Contains(o.PATIENT_TYPE_ID.Value));
                }
                if (!string.IsNullOrEmpty(this.TDL_TREATMENT_CODE__EXACT))
                {
                    listVHisExpMestBloodExpression.Add(o => o.TDL_TREATMENT_CODE == this.TDL_TREATMENT_CODE__EXACT);
                }
                if (!string.IsNullOrEmpty(this.TDL_PATIENT_CODE__EXACT))
                {
                    listVHisExpMestBloodExpression.Add(o => o.TDL_PATIENT_CODE == this.TDL_PATIENT_CODE__EXACT);
                }
