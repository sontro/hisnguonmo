    ...
    public class HisExpMestBloodFilterQuery : HisExpMestBloodFilter
    {
        ...
        internal HisExpMestBloodSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisExpMestBloodExpression.Add(o => o.TDL_MEDI_STOCK_ID == this.TDL_MEDI_STOCK_ID.Value);
                }
                if (this.TDL_SERVICE_REQ_ID.HasValue)
                {
                    listHisExpMestBloodExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && o.TDL_SERVICE_REQ_ID.Value == this.TDL_SERVICE_REQ_ID.Value);
                }
                if (this.TDL_TREATMENT_ID.HasValue)
                {
                    listHisExpMestBloodExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && o.TDL_TREATMENT_ID.Value == this.TDL_TREATMENT_ID.Value);
                }
                if (this.IS_EXPORT != null && this.IS_EXPORT.Value)
                {
                    listHisExpMestBloodExpression.Add(o => o.IS_EXPORT.HasValue && o.IS_EXPORT.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPORT != null && !this.IS_EXPORT.Value)
                {
                    listHisExpMestBloodExpression.Add(o => !o.IS_EXPORT.HasValue || o.IS_EXPORT.Value != MOS.UTILITY.Constant.IS_TRUE);
