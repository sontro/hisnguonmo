...
{
    partial class HisImpMestProposeLock : BusinessBase
    {
        internal HisImpMestProposeLock()
            : base()
        {

        }

        internal HisImpMestProposeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_IMP_MEST_PROPOSE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_IMP_MEST_PROPOSE data = new HisImpMestProposeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisImpMestProposeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_IMP_MEST_PROPOSE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_IMP_MEST_PROPOSE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisImpMestProposeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisImpMestProposeDAO.Update(raw);
