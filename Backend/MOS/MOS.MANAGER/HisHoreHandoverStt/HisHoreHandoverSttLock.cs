...
{
    partial class HisHoreHandoverSttLock : BusinessBase
    {
        internal HisHoreHandoverSttLock()
            : base()
        {

        }

        internal HisHoreHandoverSttLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_HORE_HANDOVER_STT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_HORE_HANDOVER_STT data = new HisHoreHandoverSttGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisHoreHandoverSttDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_HORE_HANDOVER_STT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_HORE_HANDOVER_STT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisHoreHandoverSttCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisHoreHandoverSttDAO.Update(raw);
