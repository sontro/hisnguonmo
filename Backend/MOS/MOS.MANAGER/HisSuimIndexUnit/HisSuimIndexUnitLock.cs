...
{
    class HisSuimIndexUnitLock : BusinessBase
    {
        internal HisSuimIndexUnitLock()
            : base()
        {

        }

        internal HisSuimIndexUnitLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_SUIM_INDEX_UNIT data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisSuimIndexUnitGet().GetById(data.ID);
                    if (data != null)
                    {
