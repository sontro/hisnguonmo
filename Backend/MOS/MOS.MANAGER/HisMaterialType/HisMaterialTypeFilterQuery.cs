        ...
        internal HisMaterialTypeSO Query()
        {
            ...
            try
            {
                ...
                if (this.IS_LEAF.HasValue)
                {
                    ...
                    {
                        search.listHisMaterialTypeExpression.Add(o => o.IS_LEAF.HasValue && o.IS_LEAF.Value == MOS.UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        search.listHisMaterialTypeExpression.Add(o => !o.IS_LEAF.HasValue || o.IS_LEAF.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                if (this.IS_STOP_IMP.HasValue)
                {
                    ...
                    {
                        search.listHisMaterialTypeExpression.Add(o => o.IS_STOP_IMP.HasValue && o.IS_STOP_IMP.Value == MOS.UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        search.listHisMaterialTypeExpression.Add(o => !o.IS_STOP_IMP.HasValue || o.IS_STOP_IMP.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listHisMaterialTypeExpression.Add(o => o.IS_STENT.HasValue && o.IS_STENT == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_STENT.HasValue && !this.IS_STENT.Value)
                {
                    listHisMaterialTypeExpression.Add(o => !o.IS_STENT.HasValue || o.IS_STENT != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listHisMaterialTypeExpression.Add(o => o.MATERIAL_TYPE_MAP_ID.HasValue && o.MATERIAL_TYPE_MAP_ID.Value == this.MATERIAL_TYPE_MAP_ID.Value);
                }
                if (this.IS_RAW_MATERIAL.HasValue && this.IS_RAW_MATERIAL.Value)
                {
                    listHisMaterialTypeExpression.Add(o => o.IS_RAW_MATERIAL.HasValue && o.IS_RAW_MATERIAL.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_RAW_MATERIAL.HasValue && !this.IS_RAW_MATERIAL.Value)
                {
                    listHisMaterialTypeExpression.Add(o => !o.IS_RAW_MATERIAL.HasValue || o.IS_RAW_MATERIAL.Value != MOS.UTILITY.Constant.IS_TRUE);
