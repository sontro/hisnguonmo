    ...
    public class HisAccidentHurtFilterQuery : HisAccidentHurtFilter
    {
        ...
        internal HisAccidentHurtSO Query()
        {
            ...
            try
            {
                ...
                if (this.ACCIDENT_BODY_PART_ID.HasValue)
                {
                    listHisAccidentHurtExpression.Add(o => o.ACCIDENT_BODY_PART_ID.HasValue && o.ACCIDENT_BODY_PART_ID.Value == this.ACCIDENT_BODY_PART_ID.Value);
                }
                if (this.ACCIDENT_BODY_PART_IDs != null)
                {
                    listHisAccidentHurtExpression.Add(o => o.ACCIDENT_BODY_PART_ID.HasValue && this.ACCIDENT_BODY_PART_IDs.Contains(o.ACCIDENT_BODY_PART_ID.Value));
                }
