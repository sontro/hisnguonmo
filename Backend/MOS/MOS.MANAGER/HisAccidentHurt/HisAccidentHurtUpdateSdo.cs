...
{
    partial class HisAccidentHurtUpdateSdo : BusinessBase
    {
        ...
        internal HisAccidentHurtUpdateSdo()
            : base()
        {
            this.Init();
        }

        internal HisAccidentHurtUpdateSdo(CommonParam paramCreate)
            : base(paramCreate)
        {
            this.Init();
        }
        ...
        internal bool Update(HisAccidentHurtSDO data, ref HIS_ACCIDENT_HURT resultData)
        {
            bool result = false;
            try
            {
                ...
                HIS_ACCIDENT_HURT accidentHurt = null;
                bool valid = true;
                ...
                valid = valid && data.Id.HasValue && checker.VerifyId(data.Id.Value, ref accidentHurt);
                ...
                if (valid)
                {
                    ...
                    if (!DAOWorker.HisAccidentHurtDAO.Update(accidentHurt))
                    {
