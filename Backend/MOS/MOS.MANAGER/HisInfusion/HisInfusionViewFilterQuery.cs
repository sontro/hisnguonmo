    ...
    public class HisInfusionViewFilterQuery : HisInfusionViewFilter
    {
        ...
        internal HisInfusionSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisInfusionExpression.Add(o => this.TREATMENT_IDs.Contains(o.TREATMENT_ID));
                }
                if (this.TREATMENT_ID.HasValue)
                {
                    listVHisInfusionExpression.Add(o => o.TREATMENT_ID == this.TREATMENT_ID.Value);
                }
                if (this.DEPARTMENT_IDs != null)
                {
                    listVHisInfusionExpression.Add(o => o.DEPARTMENT_ID.HasValue && this.DEPARTMENT_IDs.Contains(o.DEPARTMENT_ID.Value));
                }
                if (this.DEPARTMENT_ID.HasValue)
                {
                    listVHisInfusionExpression.Add(o => o.DEPARTMENT_ID.HasValue && o.DEPARTMENT_ID.Value == this.DEPARTMENT_ID.Value);
                }
                if (this.ROOM_IDs != null)
                {
                    listVHisInfusionExpression.Add(o => o.ROOM_ID.HasValue && this.ROOM_IDs.Contains(o.ROOM_ID.Value));
                }
                if (this.ROOM_ID.HasValue)
                {
                    listVHisInfusionExpression.Add(o => o.ROOM_ID.HasValue && o.ROOM_ID.Value == this.ROOM_ID.Value);
                }
                if (this.START_TIME_FROM.HasValue)
                {
                    listVHisInfusionExpression.Add(o => o.START_TIME.HasValue && o.START_TIME.Value >= this.START_TIME_FROM.Value);
                }
                if (this.START_TIME_TO.HasValue)
                {
                    listVHisInfusionExpression.Add(o => o.START_TIME.HasValue && o.START_TIME.Value <= this.START_TIME_TO.Value);
                }
