...
{
    partial class HisEkipPlanUserLock : BusinessBase
    {
        internal HisEkipPlanUserLock()
            : base()
        {

        }

        internal HisEkipPlanUserLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EKIP_PLAN_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EKIP_PLAN_USER data = new HisEkipPlanUserGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEkipPlanUserDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EKIP_PLAN_USER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EKIP_PLAN_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEkipPlanUserCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEkipPlanUserDAO.Update(raw);
