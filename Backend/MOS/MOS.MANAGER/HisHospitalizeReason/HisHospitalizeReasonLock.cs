...
{
    partial class HisHospitalizeReasonLock : BusinessBase
    {
        internal HisHospitalizeReasonLock()
            : base()
        {

        }

        internal HisHospitalizeReasonLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_HOSPITALIZE_REASON resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_HOSPITALIZE_REASON data = new HisHospitalizeReasonGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisHospitalizeReasonDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_HOSPITALIZE_REASON resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_HOSPITALIZE_REASON resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisHospitalizeReasonCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisHospitalizeReasonDAO.Update(raw);
