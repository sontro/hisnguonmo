...
{
    partial class HisEmrCoverConfigLock : BusinessBase
    {
        internal HisEmrCoverConfigLock()
            : base()
        {

        }

        internal HisEmrCoverConfigLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EMR_COVER_CONFIG resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EMR_COVER_CONFIG data = new HisEmrCoverConfigGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEmrCoverConfigDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EMR_COVER_CONFIG resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EMR_COVER_CONFIG resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEmrCoverConfigCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEmrCoverConfigDAO.Update(raw);
