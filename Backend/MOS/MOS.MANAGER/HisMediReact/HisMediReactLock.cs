...
{
    class HisMediReactLock : BusinessBase
    {
        internal HisMediReactLock()
            : base()
        {

        }

        internal HisMediReactLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_MEDI_REACT data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisMediReactGet().GetById(data.ID);
                    if (data != null)
                    {
