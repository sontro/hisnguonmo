...
{
    partial class HisEkipTempUserLock : BusinessBase
    {
        internal HisEkipTempUserLock()
            : base()
        {

        }

        internal HisEkipTempUserLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EKIP_TEMP_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EKIP_TEMP_USER data = new HisEkipTempUserGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEkipTempUserDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EKIP_TEMP_USER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EKIP_TEMP_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEkipTempUserCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEkipTempUserDAO.Update(raw);
