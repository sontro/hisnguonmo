...
{
    partial class HisTreatmentEndTypeExtLock : BusinessBase
    {
        internal HisTreatmentEndTypeExtLock()
            : base()
        {

        }

        internal HisTreatmentEndTypeExtLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_TREATMENT_END_TYPE_EXT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_TREATMENT_END_TYPE_EXT data = new HisTreatmentEndTypeExtGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisTreatmentEndTypeExtDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_TREATMENT_END_TYPE_EXT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_TREATMENT_END_TYPE_EXT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisTreatmentEndTypeExtCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisTreatmentEndTypeExtDAO.Update(raw);
