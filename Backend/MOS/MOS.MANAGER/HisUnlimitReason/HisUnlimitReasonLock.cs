...
{
    partial class HisUnlimitReasonLock : BusinessBase
    {
        internal HisUnlimitReasonLock()
            : base()
        {

        }

        internal HisUnlimitReasonLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_UNLIMIT_REASON resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_UNLIMIT_REASON data = new HisUnlimitReasonGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisUnlimitReasonDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_UNLIMIT_REASON resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_UNLIMIT_REASON resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisUnlimitReasonCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisUnlimitReasonDAO.Update(raw);
