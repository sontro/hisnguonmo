...
{
    partial class HisNextTreaIntrLock : BusinessBase
    {
        internal HisNextTreaIntrLock()
            : base()
        {

        }

        internal HisNextTreaIntrLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_NEXT_TREA_INTR resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_NEXT_TREA_INTR data = new HisNextTreaIntrGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisNextTreaIntrDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_NEXT_TREA_INTR resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_NEXT_TREA_INTR resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisNextTreaIntrCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisNextTreaIntrDAO.Update(raw);
