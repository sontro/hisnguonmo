...
{
    partial class HisEmployeeTruncate : BusinessBase
    {
        internal HisEmployeeTruncate()
            : base()
        {

        }

        internal HisEmployeeTruncate(CommonParam paramTruncate)
            : base(paramTruncate)
        {
        ...
        internal bool Truncate(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    result = DAOWorker.HisEmployeeDAO.Truncate(raw);
                }
            }
            catch (Exception ex)
            {
        ...
        internal bool TruncateList(List<HIS_EMPLOYEE> listData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    result = DAOWorker.HisEmployeeDAO.TruncateList(listData);
                }
            }
            catch (Exception ex)
            {
