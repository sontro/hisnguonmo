...
{
    class HisDeathCauseLock : BusinessBase
    {
        internal HisDeathCauseLock()
            : base()
        {

        }

        internal HisDeathCauseLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_DEATH_CAUSE data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisDeathCauseGet().GetById(data.ID);
                    if (data != null)
                    {
