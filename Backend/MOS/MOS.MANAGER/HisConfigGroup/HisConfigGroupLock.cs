...
{
    partial class HisConfigGroupLock : BusinessBase
    {
        internal HisConfigGroupLock()
            : base()
        {

        }

        internal HisConfigGroupLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_CONFIG_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_CONFIG_GROUP data = new HisConfigGroupGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisConfigGroupDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_CONFIG_GROUP resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_CONFIG_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisConfigGroupCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisConfigGroupDAO.Update(raw);
