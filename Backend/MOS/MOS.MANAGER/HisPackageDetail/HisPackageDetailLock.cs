...
{
    partial class HisPackageDetailLock : BusinessBase
    {
        internal HisPackageDetailLock()
            : base()
        {

        }

        internal HisPackageDetailLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_PACKAGE_DETAIL resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_PACKAGE_DETAIL data = new HisPackageDetailGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisPackageDetailDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_PACKAGE_DETAIL resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_PACKAGE_DETAIL resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisPackageDetailCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisPackageDetailDAO.Update(raw);
