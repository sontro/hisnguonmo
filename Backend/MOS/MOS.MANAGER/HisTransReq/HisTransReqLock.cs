...
{
    partial class HisTransReqLock : BusinessBase
    {
        internal HisTransReqLock()
            : base()
        {

        }

        internal HisTransReqLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_TRANS_REQ resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_TRANS_REQ data = new HisTransReqGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisTransReqDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_TRANS_REQ resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_TRANS_REQ resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisTransReqCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisTransReqDAO.Update(raw);
