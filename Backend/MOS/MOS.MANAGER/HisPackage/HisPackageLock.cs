...
{
    partial class HisPackageLock : BusinessBase
    {
        internal HisPackageLock()
            : base()
        {

        }

        internal HisPackageLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_PACKAGE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_PACKAGE data = new HisPackageGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisPackageDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_PACKAGE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_PACKAGE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisPackageCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisPackageDAO.Update(raw);
