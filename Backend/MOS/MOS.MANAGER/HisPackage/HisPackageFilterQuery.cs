    ...
    public class HisPackageFilterQuery : HisPackageFilter
    {
        ...
        internal HisPackageSO Query()
        {
            ...
            try
            {
                ...
                if (this.IS_NOT_FIXED_SERVICE.HasValue && this.IS_NOT_FIXED_SERVICE.Value)
                {
                    listHisPackageExpression.Add(o => o.IS_NOT_FIXED_SERVICE == Constant.IS_TRUE);
                }
                if (this.IS_NOT_FIXED_SERVICE.HasValue && !this.IS_NOT_FIXED_SERVICE.Value)
                {
                    listHisPackageExpression.Add(o => !o.IS_NOT_FIXED_SERVICE.HasValue || o.IS_NOT_FIXED_SERVICE  != Constant.IS_TRUE);
                }
