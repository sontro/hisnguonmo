...
{
    class HisCarerCardBorrowUnGiveBackCheck : BusinessBase
    {
        internal HisCarerCardBorrowUnGiveBackCheck()
            : base()
        {
        }

        internal HisCarerCardBorrowUnGiveBackCheck(CommonParam paramCheck)
            : base(paramCheck)
        {
        }

        internal bool VerifyRequireField(HisCarerCardBorrowUnGiveBackSDO data)
        {
            bool valid = true;
            try
            {
