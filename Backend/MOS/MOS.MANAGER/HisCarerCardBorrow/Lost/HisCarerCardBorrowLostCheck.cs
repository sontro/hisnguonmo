...
{
    class HisCarerCardBorrowLostCheck : BusinessBase
    {
        internal HisCarerCardBorrowLostCheck()
            : base()
        {
        }

        internal HisCarerCardBorrowLostCheck(CommonParam paramCheck)
            : base(paramCheck)
        {
        }

        internal bool VerifyRequireField(HisCarerCardBorrowLostSDO data)
        {
            bool valid = true;
            try
            {
