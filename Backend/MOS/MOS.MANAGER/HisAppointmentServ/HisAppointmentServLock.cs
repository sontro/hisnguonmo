...
{
    partial class HisAppointmentServLock : BusinessBase
    {
        internal HisAppointmentServLock()
            : base()
        {

        }

        internal HisAppointmentServLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_APPOINTMENT_SERV resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_APPOINTMENT_SERV data = new HisAppointmentServGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisAppointmentServDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_APPOINTMENT_SERV resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_APPOINTMENT_SERV resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisAppointmentServCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisAppointmentServDAO.Update(raw);
