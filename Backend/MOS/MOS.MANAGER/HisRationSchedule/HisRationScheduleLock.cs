...
{
    partial class HisRationScheduleLock : BusinessBase
    {
        internal HisRationScheduleLock()
            : base()
        {

        }

        internal HisRationScheduleLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_RATION_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_RATION_SCHEDULE data = new HisRationScheduleGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisRationScheduleDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_RATION_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_RATION_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisRationScheduleCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisRationScheduleDAO.Update(raw);
