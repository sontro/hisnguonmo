...
{
    class HisRehaSumLock : BusinessBase
    {
        internal HisRehaSumLock()
            : base()
        {

        }

        internal HisRehaSumLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_REHA_SUM data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisRehaSumGet().GetById(data.ID);
                    if (data != null)
                    {
                        ...
                        result = DAOWorker.HisRehaSumDAO.Update(data);
                    }
                    else
                    {
