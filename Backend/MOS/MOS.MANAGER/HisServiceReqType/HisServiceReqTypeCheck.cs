...
{
    class HisServiceReqTypeCheck : BusinessBase
    {
        internal HisServiceReqTypeCheck()
            : base()
        {

        }

        internal HisServiceReqTypeCheck(Inventec.Core.CommonParam paramCheck)
            : base(paramCheck) 
        {

        }

        internal bool VerifyRequireField(HIS_SERVICE_REQ_TYPE data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool ExistsCode(string code, long? id)
        {
            ...
            try
            {
                if (DAOWorker.HisServiceReqTypeDAO.ExistsCode(code, id))
                {
        ...
        internal bool IsUnLock(HIS_SERVICE_REQ_TYPE data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool IsUnLock(long id)
        {
            ...
            try
            {
                if (!DAOWorker.HisServiceReqTypeDAO.IsUnLock(id))
                {
                    valid = false;
        ...
        internal bool CheckConstraint(long id)
        {
            ...
            try
            {
                List<HIS_SERVICE_REQ> hisServiceReqs = new HisServiceReqGet().GetByServiceReqTypeId(id);
