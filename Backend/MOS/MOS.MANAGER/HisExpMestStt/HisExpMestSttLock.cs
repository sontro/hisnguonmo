...
{
    class HisExpMestSttLock : BusinessBase
    {
        internal HisExpMestSttLock()
            : base()
        {

        }

        internal HisExpMestSttLock(CommonParam paramLock)
            : base(paramLock)
        {
        ...
        internal bool ChangeLock(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    HIS_EXP_MEST_STT data = new HisExpMestSttGet().GetById(id);
                    if (data != null)
                    {
