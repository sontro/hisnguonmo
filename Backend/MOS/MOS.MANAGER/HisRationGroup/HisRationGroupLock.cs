...
{
    partial class HisRationGroupLock : BusinessBase
    {
        internal HisRationGroupLock()
            : base()
        {

        }

        internal HisRationGroupLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_RATION_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_RATION_GROUP data = new HisRationGroupGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisRationGroupDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_RATION_GROUP resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_RATION_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisRationGroupCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisRationGroupDAO.Update(raw);
