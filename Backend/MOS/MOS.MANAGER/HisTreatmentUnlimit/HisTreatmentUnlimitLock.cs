...
{
    partial class HisTreatmentUnlimitLock : BusinessBase
    {
        internal HisTreatmentUnlimitLock()
            : base()
        {

        }

        internal HisTreatmentUnlimitLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_TREATMENT_UNLIMIT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_TREATMENT_UNLIMIT data = new HisTreatmentUnlimitGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisTreatmentUnlimitDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_TREATMENT_UNLIMIT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_TREATMENT_UNLIMIT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisTreatmentUnlimitCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisTreatmentUnlimitDAO.Update(raw);
