...
{
    partial class HisPatientCaseLock : BusinessBase
    {
        internal HisPatientCaseLock()
            : base()
        {

        }

        internal HisPatientCaseLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_PATIENT_CASE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_PATIENT_CASE data = new HisPatientCaseGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisPatientCaseDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_PATIENT_CASE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_PATIENT_CASE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisPatientCaseCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisPatientCaseDAO.Update(raw);
