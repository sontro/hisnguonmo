...
{
    partial class HisCareTempDetailLock : BusinessBase
    {
        internal HisCareTempDetailLock()
            : base()
        {

        }

        internal HisCareTempDetailLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_CARE_TEMP_DETAIL resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_CARE_TEMP_DETAIL data = new HisCareTempDetailGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisCareTempDetailDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_CARE_TEMP_DETAIL resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_CARE_TEMP_DETAIL resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisCareTempDetailCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisCareTempDetailDAO.Update(raw);
