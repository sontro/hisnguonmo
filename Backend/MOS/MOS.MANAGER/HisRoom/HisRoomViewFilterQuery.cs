    ...
    public class HisRoomViewFilterQuery : HisRoomViewFilter
    {
        ...
        internal HisRoomSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisRoomExpression.Add(o => o.SPECIALITY_ID.HasValue && o.SPECIALITY_ID.Value == this.SPECIALITY_ID.Value);
                }
                if (this.SPECIALITY_IDs != null)
                {
                    listVHisRoomExpression.Add(o => o.SPECIALITY_ID.HasValue && this.SPECIALITY_IDs.Contains(o.SPECIALITY_ID.Value));
                }
                if (this.ROOM_CODEs != null)
                {
                    listVHisRoomExpression.Add(o => this.ROOM_CODEs.Contains(o.ROOM_CODE));
                }
