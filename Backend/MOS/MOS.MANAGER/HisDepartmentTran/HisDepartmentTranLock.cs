...
{
    class HisDepartmentTranLock : BusinessBase
    {
        internal HisDepartmentTranLock()
            : base()
        {

        }

        internal HisDepartmentTranLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_DEPARTMENT_TRAN data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisDepartmentTranGet().GetById(data.ID);
                    if (data != null)
                    {
                        ...
                        result = DAOWorker.HisDepartmentTranDAO.Update(data);
                    }
                    else
                    {
