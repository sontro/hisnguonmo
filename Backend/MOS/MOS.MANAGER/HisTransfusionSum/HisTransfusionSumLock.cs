...
{
    partial class HisTransfusionSumLock : BusinessBase
    {
        internal HisTransfusionSumLock()
            : base()
        {

        }

        internal HisTransfusionSumLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_TRANSFUSION_SUM resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_TRANSFUSION_SUM data = new HisTransfusionSumGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisTransfusionSumDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_TRANSFUSION_SUM resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_TRANSFUSION_SUM resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisTransfusionSumCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisTransfusionSumDAO.Update(raw);
