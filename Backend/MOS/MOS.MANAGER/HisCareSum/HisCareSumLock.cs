...
{
    class HisCareSumLock : BusinessBase
    {
        internal HisCareSumLock()
            : base()
        {

        }

        internal HisCareSumLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_CARE_SUM data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisCareSumGet().GetById(data.ID);
                    if (data != null)
                    {
                        ...
                        result = DAOWorker.HisCareSumDAO.Update(data);
                    }
                    else
                    {
