...
{
    partial class HisBabyCreateSdo : BusinessBase
    {
        ...
        internal HisBabyCreateSdo()
            : base()
        {
            this.Init();
        }

        internal HisBabyCreateSdo(CommonParam paramCreate)
            : base(paramCreate)
        {
            this.Init();
        }
        ...
        internal bool Run(HisBabySDO data, ref HIS_BABY resultData)
        {
            ...
            try
            {
                ...
                if (this.IsValidData(data, ref treatment))
                {
                    this.ProcessBaby(data, ref baby);
                    ...
                    HisBabyLog.Run(treatment, treatmentEdit, baby, LibraryEventLog.EventLog.Enum.HisBaby_ThemThongTinTreSoSinh);
                }
            }
            catch (Exception ex)
            {
        ...
        private void ProcessTreatment(BabyInfoForTreatmentSDO babyInfoForTreatmentSDO, HIS_BABY baby, HisBabySDO data, ref HIS_TREATMENT treatmentEdit, HIS_PATIENT hisPatient)
        {
            ...
            if (babyInfoForTreatmentSDO != null && treatment != null && data != null)
            {
        ...
        private void ProcessBaby(HisBabySDO data, ref HIS_BABY baby)
        {
            baby = new HIS_BABY();
            ...
            if (!this.hisBabyCreate.Create(baby))
            {
                throw new Exception("Tao thong tin baby that bai");
            }
        }
        ...
        private bool IsValidData(HisBabySDO data, ref HIS_TREATMENT treatment)
        {
            try
            {
