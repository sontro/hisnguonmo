    ...
    public class HisImpMestMedicineViewFilterQuery : HisImpMestMedicineViewFilter
    {
        ...
        internal HisImpMestMedicineSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisImpMestMedicineExpression.Add(o => o.REQ_DEPARTMENT_ID.HasValue && this.REQ_DEPARTMENT_IDs.Contains(o.REQ_DEPARTMENT_ID.Value));
                }
                if (this.MEDI_STOCK_IDs != null)
                {
                    listVHisImpMestMedicineExpression.Add(o => this.MEDI_STOCK_IDs.Contains(o.MEDI_STOCK_ID));
                }
                if (this.IMP_MEST_TYPE_IDs != null)
                {
                    listVHisImpMestMedicineExpression.Add(o => this.IMP_MEST_TYPE_IDs.Contains(o.IMP_MEST_TYPE_ID));
                }
                if (this.DOCUMENT_NUMBER != null)
                {
                    this.DOCUMENT_NUMBER = this.DOCUMENT_NUMBER.ToLower().Trim();
                    listVHisImpMestMedicineExpression.Add(o => o.DOCUMENT_NUMBER.ToLower().Contains(this.DOCUMENT_NUMBER));
                }
                if (!string.IsNullOrWhiteSpace(this.PACKAGE_NUMBER__EXACT))
                {
                    listVHisImpMestMedicineExpression.Add(o => o.PACKAGE_NUMBER == this.PACKAGE_NUMBER__EXACT);
                }
