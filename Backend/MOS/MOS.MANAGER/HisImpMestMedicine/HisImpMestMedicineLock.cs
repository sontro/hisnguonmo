...
{
    class HisImpMestMedicineLock : BusinessBase
    {
        internal HisImpMestMedicineLock()
            : base()
        {

        }

        internal HisImpMestMedicineLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_IMP_MEST_MEDICINE data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisImpMestMedicineGet().GetById(data.ID);
                    if (data != null)
                    {
                        ...
                        result = DAOWorker.HisImpMestMedicineDAO.Update(data);
                    }
                    else
                    {
