...
{
    partial class HisKskOverEighteenLock : BusinessBase
    {
        internal HisKskOverEighteenLock()
            : base()
        {

        }

        internal HisKskOverEighteenLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_KSK_OVER_EIGHTEEN resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_KSK_OVER_EIGHTEEN data = new HisKskOverEighteenGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisKskOverEighteenDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_KSK_OVER_EIGHTEEN resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_KSK_OVER_EIGHTEEN resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisKskOverEighteenCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisKskOverEighteenDAO.Update(raw);
