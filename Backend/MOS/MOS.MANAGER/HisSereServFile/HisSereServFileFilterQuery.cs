    ...
    public class HisSereServFileFilterQuery : HisSereServFileFilter
    {
        ...
        internal HisSereServFileSO Query()
        {
            ...
            try
            {
                ...
                if (this.BODY_PART_ID.HasValue)
                {
                    listHisSereServFileExpression.Add(o => o.BODY_PART_ID.HasValue && o.BODY_PART_ID == this.BODY_PART_ID.Value);
                }
                if (this.BODY_PART_IDs != null)
                {
                    search.listHisSereServFileExpression.Add(o => o.BODY_PART_ID.HasValue && this.BODY_PART_IDs.Contains(o.BODY_PART_ID.Value));
                }
