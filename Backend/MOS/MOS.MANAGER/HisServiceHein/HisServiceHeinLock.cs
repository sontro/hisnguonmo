...
{
    partial class HisServiceHeinLock : BusinessBase
    {
        internal HisServiceHeinLock()
            : base()
        {

        }

        internal HisServiceHeinLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SERVICE_HEIN resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SERVICE_HEIN data = new HisServiceHeinGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisServiceHeinDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SERVICE_HEIN resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SERVICE_HEIN resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisServiceHeinCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisServiceHeinDAO.Update(raw);
