...
{
    partial class HisInteractiveGradeLock : BusinessBase
    {
        internal HisInteractiveGradeLock()
            : base()
        {

        }

        internal HisInteractiveGradeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_INTERACTIVE_GRADE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_INTERACTIVE_GRADE data = new HisInteractiveGradeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisInteractiveGradeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_INTERACTIVE_GRADE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_INTERACTIVE_GRADE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisInteractiveGradeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisInteractiveGradeDAO.Update(raw);
