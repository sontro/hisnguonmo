...
{
    class HisMedicineUseFormLock : BusinessBase
    {
        internal HisMedicineUseFormLock()
            : base()
        {

        }

        internal HisMedicineUseFormLock(CommonParam paramLock)
            : base(paramLock)
        {
        ...
        internal bool ChangeLock(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    HIS_MEDICINE_USE_FORM data = new HisMedicineUseFormGet().GetById(id);
                    if (data != null)
                    {
