...
{
    partial class HisVaccinationLock : BusinessBase
    {
        internal HisVaccinationLock()
            : base()
        {

        }

        internal HisVaccinationLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_VACCINATION resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_VACCINATION data = new HisVaccinationGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisVaccinationDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_VACCINATION resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_VACCINATION resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisVaccinationCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisVaccinationDAO.Update(raw);
