...
{
    partial class HisVaccinationSttLock : BusinessBase
    {
        internal HisVaccinationSttLock()
            : base()
        {

        }

        internal HisVaccinationSttLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_VACCINATION_STT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_VACCINATION_STT data = new HisVaccinationSttGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisVaccinationSttDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_VACCINATION_STT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_VACCINATION_STT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisVaccinationSttCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisVaccinationSttDAO.Update(raw);
