...
{
    partial class HisKskOtherLock : BusinessBase
    {
        internal HisKskOtherLock()
            : base()
        {

        }

        internal HisKskOtherLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_KSK_OTHER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_KSK_OTHER data = new HisKskOtherGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisKskOtherDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_KSK_OTHER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_KSK_OTHER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisKskOtherCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisKskOtherDAO.Update(raw);
