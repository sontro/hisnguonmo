...
{
    class HisMestPeriodMateLock : BusinessBase
    {
        internal HisMestPeriodMateLock()
            : base()
        {

        }

        internal HisMestPeriodMateLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_MEST_PERIOD_MATE data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisMestPeriodMateGet().GetById(data.ID);
                    if (data != null)
                    {
                        ...
                        result = DAOWorker.HisMestPeriodMateDAO.Update(data);
                    }
                    else
                    {
