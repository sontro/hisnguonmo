...
{
    partial class HisRegisterReqLock : BusinessBase
    {
        internal HisRegisterReqLock()
            : base()
        {

        }

        internal HisRegisterReqLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_REGISTER_REQ resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_REGISTER_REQ data = new HisRegisterReqGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisRegisterReqDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_REGISTER_REQ resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_REGISTER_REQ resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisRegisterReqCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisRegisterReqDAO.Update(raw);
