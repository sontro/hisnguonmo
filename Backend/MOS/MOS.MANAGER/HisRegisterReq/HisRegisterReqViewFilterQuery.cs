    ...
    public class HisRegisterReqViewFilterQuery : HisRegisterReqViewFilter
    {
        ...
        internal HisRegisterReqSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisRegisterReqExpression.Add(o => this.REGISTER_GATE_IDs.Contains(o.REGISTER_GATE_ID));
                }
                ...
                {
                    listVHisRegisterReqExpression.Add(o => o.VIR_CALL_DATE == this.CALL_DATE);
                }
