	...
	public class HisBidMedicineTypeFilterQuery : HisBidMedicineTypeFilter
	{
		...
		internal HisBidMedicineTypeSO Query()
		{
			...
			try
			{
                ...
                {
                    listHisBidMedicineTypeExpression.Add(o => o.SUPPLIER_ID == this.SUPPLIER_ID.Value);
                }
                if (this.SUPPLIER_IDs != null)
                {
                    listHisBidMedicineTypeExpression.Add(o => this.SUPPLIER_IDs.Contains(o.SUPPLIER_ID));
                }
