    ...
    public class HisTestIndexViewFilterQuery : HisTestIndexViewFilter
    {
        ...
        internal HisTestIndexSO Query()
        {
            ...
            try
            {
                ...
                {
                    search.listVHisTestIndexExpression.Add(o => this.SERVICE_CODEs.Contains(o.SERVICE_CODE));
                }
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listVHisTestIndexExpression.Add(o =>
                        ...
                        o.BHYT_CODE.ToLower().Contains(this.KEY_WORD) ||
                        o.BHYT_NAME.ToLower().Contains(this.KEY_WORD) ||
