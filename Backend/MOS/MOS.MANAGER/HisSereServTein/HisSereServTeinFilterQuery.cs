    ...
    public class HisSereServTeinFilterQuery : HisSereServTeinFilter
    {
        ...
        internal HisSereServTeinSO Query()
        {
            ...
            try
            {
                ...
                {
                    search.listHisSereServTeinExpression.Add(o => o.SERE_SERV_ID == this.SERE_SERV_ID.Value);
                }
                ...
                {
                    search.listHisSereServTeinExpression.Add(o => o.TEST_INDEX_ID.HasValue && o.TEST_INDEX_ID.Value == this.TEST_INDEX_ID.Value);
                }
                if (this.TEST_INDEX_IDs != null)
                {
                    search.listHisSereServTeinExpression.Add(o => o.TEST_INDEX_ID.HasValue && this.TEST_INDEX_IDs.Contains(o.TEST_INDEX_ID.Value));
                }

                if (this.TDL_TREATMENT_ID.HasValue)
                {
                    search.listHisSereServTeinExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && o.TDL_TREATMENT_ID == this.TDL_TREATMENT_ID.Value);
                }
                if (this.TDL_TREATMENT_IDs != null)
                {
                    search.listHisSereServTeinExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && this.TDL_TREATMENT_IDs.Contains(o.TDL_TREATMENT_ID.Value));
                }
                if (this.TDL_SERVICE_REQ_ID.HasValue)
                {
                    search.listHisSereServTeinExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && o.TDL_SERVICE_REQ_ID == this.TDL_SERVICE_REQ_ID.Value);
                }
                if (this.TDL_SERVICE_REQ_IDs != null)
                {
                    search.listHisSereServTeinExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && this.TDL_SERVICE_REQ_IDs.Contains(o.TDL_SERVICE_REQ_ID.Value));
                }
                if (this.HAS_VALUE.HasValue)
                {
                    if (this.HAS_VALUE.Value)
                    {
                        listHisSereServTeinExpression.Add(o => o.VALUE != null);
                    }
                    else
                    {
                        listHisSereServTeinExpression.Add(o => o.VALUE == null);
