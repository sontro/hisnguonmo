...
{
    class HisSereServTeinLock : BusinessBase
    {
        internal HisSereServTeinLock()
            : base()
        {

        }

        internal HisSereServTeinLock(Inventec.Core.CommonParam paramLock)
            : base(paramLock)
        {
        ...
        internal bool ChangeLock(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    HIS_SERE_SERV_TEIN data = new HisSereServTeinGet().GetById(id);
                    if (data != null)
                    {
