...
{
    partial class HisSereServDepositLock : BusinessBase
    {
        internal HisSereServDepositLock()
            : base()
        {

        }

        internal HisSereServDepositLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SERE_SERV_DEPOSIT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SERE_SERV_DEPOSIT data = new HisSereServDepositGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisSereServDepositDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SERE_SERV_DEPOSIT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SERE_SERV_DEPOSIT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisSereServDepositCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisSereServDepositDAO.Update(raw);
