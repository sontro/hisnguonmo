...
{
    partial class HisImpMestBloodLock : BusinessBase
    {
        internal HisImpMestBloodLock()
            : base()
        {

        }

        internal HisImpMestBloodLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_IMP_MEST_BLOOD resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_IMP_MEST_BLOOD data = new HisImpMestBloodGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisImpMestBloodDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_IMP_MEST_BLOOD resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(HIS_IMP_MEST_BLOOD data)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisImpMestBloodCheck().VerifyId(data.ID, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisImpMestBloodDAO.Update(raw);
