...
{
    partial class HisImpMestTypeUserLock : BusinessBase
    {
        internal HisImpMestTypeUserLock()
            : base()
        {

        }

        internal HisImpMestTypeUserLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_IMP_MEST_TYPE_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_IMP_MEST_TYPE_USER data = new HisImpMestTypeUserGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisImpMestTypeUserDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_IMP_MEST_TYPE_USER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_IMP_MEST_TYPE_USER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisImpMestTypeUserCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisImpMestTypeUserDAO.Update(raw);
