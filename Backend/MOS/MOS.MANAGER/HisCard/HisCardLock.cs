...
{
    class HisCardLock : BusinessBase
    {
        internal HisCardLock()
            : base()
        {

        }

        internal HisCardLock(Inventec.Core.CommonParam paramLock)
            : base(paramLock)
        {
        ...
        internal bool ChangeLock(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    HIS_CARD data = new HisCardGet().GetById(id);
                    if (data != null)
                    {
                        ...
                        result = DAOWorker.HisCardDAO.Update(data);
                    }
                    else
                    {
