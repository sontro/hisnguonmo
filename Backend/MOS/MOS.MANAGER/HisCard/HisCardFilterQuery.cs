    ...
    public class HisCardFilterQuery : HisCardFilter
    {
        ...
        internal HisCardSO Query()
        {
            ...
            try
            {
                ...
                {
                    search.listHisCardExpression.Add(o => o.PATIENT_ID.HasValue && o.PATIENT_ID == this.PATIENT_ID.Value);
                }
                if (this.PATIENT_IDs != null)
                {
                    listHisCardExpression.Add(o => o.PATIENT_ID.HasValue && this.PATIENT_IDs.Contains(o.PATIENT_ID.Value));
                }
                ...
                if (this.HAS_CARD_CODE.HasValue)
                {
                    if (this.HAS_CARD_CODE.Value)
                    {
                        search.listHisCardExpression.Add(o => !string.IsNullOrEmpty(o.CARD_CODE));
                    }
                    else
                    {
                        search.listHisCardExpression.Add(o => string.IsNullOrEmpty(o.CARD_CODE));
