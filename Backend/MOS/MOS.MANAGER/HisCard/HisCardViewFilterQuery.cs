    ...
    public class HisCardViewFilterQuery : HisCardViewFilter
    {
        ...
        internal HisCardSO Query()
        {
            ...
            try
            {
                ...
                {
                    search.listVHisCardExpression.Add(o => o.PATIENT_ID.HasValue && o.PATIENT_ID == this.PATIENT_ID.Value);
                }
                if (this.PATIENT_IDs != null)
                {
                    listVHisCardExpression.Add(o => o.PATIENT_ID.HasValue && this.PATIENT_IDs.Contains(o.PATIENT_ID.Value));
                }
