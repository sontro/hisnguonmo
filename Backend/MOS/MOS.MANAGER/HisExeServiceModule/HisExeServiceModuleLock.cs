...
{
    partial class HisExeServiceModuleLock : BusinessBase
    {
        internal HisExeServiceModuleLock()
            : base()
        {

        }

        internal HisExeServiceModuleLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EXE_SERVICE_MODULE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EXE_SERVICE_MODULE data = new HisExeServiceModuleGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisExeServiceModuleDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EXE_SERVICE_MODULE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EXE_SERVICE_MODULE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisExeServiceModuleCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisExeServiceModuleDAO.Update(raw);
