    ...
    public class HisTrackingFilterQuery : HisTrackingFilter
    {
        ...
        internal HisTrackingSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisTrackingExpression.Add(o => o.DEPARTMENT_ID.HasValue && o.DEPARTMENT_ID == this.DEPARTMENT_ID.Value);
                }
                if (this.DEPARTMENT_IDs != null)
                {
                    listHisTrackingExpression.Add(o => o.DEPARTMENT_ID.HasValue && this.DEPARTMENT_IDs.Contains(o.DEPARTMENT_ID.Value));
                }
