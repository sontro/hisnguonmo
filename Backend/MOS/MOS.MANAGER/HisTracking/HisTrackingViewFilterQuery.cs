    ...
    public class HisTrackingViewFilterQuery : HisTrackingViewFilter
    {
        ...
        internal HisTrackingSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisTrackingExpression.Add(o => this.TREATMENT_IDs.Contains(o.TREATMENT_ID));
                }
                if (this.DEPARTMENT_ID.HasValue)
                {
                    listVHisTrackingExpression.Add(o => o.DEPARTMENT_ID == this.DEPARTMENT_ID.Value);
                }
                if (this.DEPARTMENT_IDs != null)
                {
                    listVHisTrackingExpression.Add(o => o.DEPARTMENT_ID.HasValue && this.DEPARTMENT_IDs.Contains(o.DEPARTMENT_ID.Value));
                }
