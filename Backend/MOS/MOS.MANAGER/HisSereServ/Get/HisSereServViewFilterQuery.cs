    ...
    public class HisSereServViewFilterQuery : HisSereServViewFilter
    {
        ...
        internal HisSereServSO Query()
        {
            ...
            try
            {
                ...
                if (this.HAS_EXECUTE.HasValue && !this.HAS_EXECUTE.Value)
                {
                    listVHisSereServExpression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE == MOS.UTILITY.Constant.IS_TRUE);
                }
                ...
                {
                    listVHisSereServExpression.Add(o => o.IS_SPECIMEN.HasValue && o.IS_SPECIMEN.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_SPECIMEN.HasValue && !this.IS_SPECIMEN.Value)
                {
                    listVHisSereServExpression.Add(o => !o.IS_SPECIMEN.HasValue || o.IS_SPECIMEN.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisSereServExpression.Add(o => o.IS_EXPEND.HasValue && o.IS_EXPEND.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPEND.HasValue && !this.IS_EXPEND.Value)
                {
                    listVHisSereServExpression.Add(o => !o.IS_EXPEND.HasValue || o.IS_EXPEND.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisSereServExpression.Add(o => o.PARENT_ID.HasValue && o.PARENT_ID == this.PARENT_ID.Value);
                }
