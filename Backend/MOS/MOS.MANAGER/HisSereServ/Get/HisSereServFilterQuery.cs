...
namespace MOS.MANAGER.HisSereServ
{
    public class HisSereServFilterQuery : HisSereServFilter
    {
        ...
        {
            HisSereServSO search = new HisSereServSO(IS_INCLUDE_DELETED);
            try
            {
                ...
                {
                    listHisSereServExpression.Add(o => o.IS_EXPEND.HasValue && o.IS_EXPEND.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPEND.HasValue && !this.IS_EXPEND.Value)
                {
                    listHisSereServExpression.Add(o => !o.IS_EXPEND.HasValue || o.IS_EXPEND.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                if (this.HAS_EXECUTE.HasValue && !this.HAS_EXECUTE.Value)
                {
                    listHisSereServExpression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_SPECIMEN.HasValue && this.IS_SPECIMEN.Value)
                {
                    listHisSereServExpression.Add(o => o.IS_SPECIMEN.HasValue && o.IS_SPECIMEN.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_SPECIMEN.HasValue && !this.IS_SPECIMEN.Value)
                {
                    listHisSereServExpression.Add(o => !o.IS_SPECIMEN.HasValue || o.IS_SPECIMEN.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    search.listHisSereServExpression.Add(o => o.EQUIPMENT_SET_ID.HasValue && o.EQUIPMENT_SET_ID.Value == this.EQUIPMENT_SET_ID.Value);
                }
                if (this.EQUIPMENT_SET_IDs != null)
                {
                    search.listHisSereServExpression.Add(o => o.EQUIPMENT_SET_ID.HasValue && this.EQUIPMENT_SET_IDs.Contains(o.EQUIPMENT_SET_ID.Value));
                }
                if (this.TDL_SERVICE_REQ_TYPE_ID.HasValue)
                {
                    search.listHisSereServExpression.Add(o => o.TDL_SERVICE_REQ_TYPE_ID == this.TDL_SERVICE_REQ_TYPE_ID.Value);
                }
                if (this.TDL_SERVICE_REQ_TYPE_IDs != null)
                {
                    search.listHisSereServExpression.Add(o => this.TDL_SERVICE_REQ_TYPE_IDs.Contains(o.TDL_SERVICE_REQ_TYPE_ID));
                }
                ...
                if (this.HAS_SERVICE_REQ_ID.HasValue && !this.HAS_SERVICE_REQ_ID.Value)
                {
                    search.listHisSereServExpression.Add(o => !o.SERVICE_REQ_ID.HasValue);
                }
                if (this.HAS_SERVICE_REQ_ID.HasValue && this.HAS_SERVICE_REQ_ID.Value)
                {
                    search.listHisSereServExpression.Add(o => o.SERVICE_REQ_ID.HasValue);
                }
                if (this.HAS_AMOUNT_TEMP__AND__IS_GREATER_ZERO.HasValue && !this.HAS_AMOUNT_TEMP__AND__IS_GREATER_ZERO.Value)
                {
                    search.listHisSereServExpression.Add(o => !o.AMOUNT_TEMP.HasValue || o.AMOUNT_TEMP.Value == 0);
                }
                if (this.HAS_AMOUNT_TEMP__AND__IS_GREATER_ZERO.HasValue && this.HAS_AMOUNT_TEMP__AND__IS_GREATER_ZERO.Value)
                {
                    search.listHisSereServExpression.Add(o => o.AMOUNT_TEMP.HasValue && o.AMOUNT_TEMP.Value > 0);
                }
                if (!String.IsNullOrEmpty(this.TDL_TREATMENT_CODE_EXACT))
                {
                    search.listHisSereServExpression.Add(o => o.TDL_TREATMENT_CODE == this.TDL_TREATMENT_CODE_EXACT);
                }
                if (!String.IsNullOrEmpty(this.TDL_SERVICE_REQ_CODE_EXACT))
                {
                    search.listHisSereServExpression.Add(o => o.TDL_SERVICE_REQ_CODE == this.TDL_SERVICE_REQ_CODE_EXACT);
                }
                if (this.TDL_EXECUTE_BRANCH_ID.HasValue)
                {
                    search.listHisSereServExpression.Add(o => o.TDL_EXECUTE_BRANCH_ID == this.TDL_EXECUTE_BRANCH_ID.Value);
                }
                if (this.TDL_EXECUTE_BRANCH_IDs != null)
                {
                    search.listHisSereServExpression.Add(o => this.TDL_EXECUTE_BRANCH_IDs.Contains(o.TDL_EXECUTE_BRANCH_ID));
                }
