    ...
    public class HisSereServView5FilterQuery : HisSereServView5Filter
    {
        ...
        internal HisSereServSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisSereServ5Expression.Add(o => o.IS_SPECIMEN.HasValue && o.IS_SPECIMEN.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_SPECIMEN.HasValue && !this.IS_SPECIMEN.Value)
                {
                    listVHisSereServ5Expression.Add(o => !o.IS_SPECIMEN.HasValue || o.IS_SPECIMEN.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisSereServ5Expression.Add(o => o.IS_EXPEND.HasValue && o.IS_EXPEND.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPEND.HasValue && !this.IS_EXPEND.Value)
                {
                    listVHisSereServ5Expression.Add(o => !o.IS_EXPEND.HasValue || o.IS_EXPEND.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisSereServ5Expression.Add(o => o.IS_NO_EXECUTE.HasValue && o.IS_NO_EXECUTE.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.HAS_EXECUTE.HasValue && this.HAS_EXECUTE.Value)
                {
                    listVHisSereServ5Expression.Add(o => !o.IS_NO_EXECUTE.HasValue || o.IS_NO_EXECUTE.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisSereServ5Expression.Add(o => o.TDL_SERVICE_REQ_TYPE_ID == this.TDL_SERVICE_REQ_TYPE_ID.Value);
                }
                if (this.TDL_SERVICE_REQ_TYPE_IDs != null)
                {
                    listVHisSereServ5Expression.Add(o => this.TDL_SERVICE_REQ_TYPE_IDs.Contains(o.TDL_SERVICE_REQ_TYPE_ID));
                }
