...
{
    class HisSereServDeleteConfirmNoExcuteCheck: BusinessBase
    {
        internal HisSereServDeleteConfirmNoExcuteCheck()
            : base()
        {

        }

        internal HisSereServDeleteConfirmNoExcuteCheck(CommonParam param)
            : base(param)
        {
        ...
        /// <returns></returns>
        internal bool IsAllow(HisSereServDeleteConfirmNoExcuteSDO sdo, HIS_SERE_SERV sereServ, WorkPlaceSDO workPlaceSdo)
        {
            bool valid = true;
            try
            {
                ...
                if (sereServ.IS_CONFIRM_NO_EXCUTE != Constant.IS_TRUE)
                {
                    MOS.MANAGER.Base.MessageUtil.SetMessage(param, MOS.LibraryMessage.Message.Enum.HisSereServ_DichVuChuaDuocXacNhanKhongThucHien);
                    return false;
                }
