...
{
    partial class HisRationTimeLock : BusinessBase
    {
        internal HisRationTimeLock()
            : base()
        {

        }

        internal HisRationTimeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_RATION_TIME resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_RATION_TIME data = new HisRationTimeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisRationTimeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_RATION_TIME resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_RATION_TIME resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisRationTimeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisRationTimeDAO.Update(raw);
