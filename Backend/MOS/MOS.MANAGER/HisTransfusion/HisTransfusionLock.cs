...
{
    partial class HisTransfusionLock : BusinessBase
    {
        internal HisTransfusionLock()
            : base()
        {

        }

        internal HisTransfusionLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_TRANSFUSION resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_TRANSFUSION data = new HisTransfusionGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisTransfusionDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_TRANSFUSION resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_TRANSFUSION resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisTransfusionCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisTransfusionDAO.Update(raw);
