...
{
    partial class HisWelfareTypeLock : BusinessBase
    {
        internal HisWelfareTypeLock()
            : base()
        {

        }

        internal HisWelfareTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_WELFARE_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_WELFARE_TYPE data = new HisWelfareTypeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisWelfareTypeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_WELFARE_TYPE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_WELFARE_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisWelfareTypeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisWelfareTypeDAO.Update(raw);
