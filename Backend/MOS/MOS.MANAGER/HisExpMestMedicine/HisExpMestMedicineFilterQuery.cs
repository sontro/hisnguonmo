    ...
    public class HisExpMestMedicineFilterQuery : HisExpMestMedicineFilter
    {
        ...
        internal HisExpMestMedicineSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisExpMestMedicineExpression.Add(o => o.TDL_AGGR_EXP_MEST_ID.HasValue && this.TDL_AGGR_EXP_MEST_ID.Value == o.TDL_AGGR_EXP_MEST_ID);
                }
                if (this.TDL_AGGR_EXP_MEST_IDs != null)
                {
                    listHisExpMestMedicineExpression.Add(o => o.TDL_AGGR_EXP_MEST_ID.HasValue && this.TDL_AGGR_EXP_MEST_IDs.Contains(o.TDL_AGGR_EXP_MEST_ID.Value));
                }
                if (this.TDL_SERVICE_REQ_ID != null)
                {
                    listHisExpMestMedicineExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && this.TDL_SERVICE_REQ_ID.Value == o.TDL_SERVICE_REQ_ID);
                }
                ...
                {
                    listHisExpMestMedicineExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && this.TDL_TREATMENT_ID.Value == o.TDL_TREATMENT_ID);
                }
                if (this.TDL_TREATMENT_IDs != null)
                {
                    listHisExpMestMedicineExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && this.TDL_TREATMENT_IDs.Contains(o.TDL_TREATMENT_ID.Value));
                }
                if (this.EXP_MEST_IDs != null)
                {
                    listHisExpMestMedicineExpression.Add(o => o.EXP_MEST_ID.HasValue && this.EXP_MEST_IDs.Contains(o.EXP_MEST_ID.Value));
                }
                if (this.MEDICINE_IDs != null)
                {
                    listHisExpMestMedicineExpression.Add(o => o.MEDICINE_ID.HasValue && this.MEDICINE_IDs.Contains(o.MEDICINE_ID.Value));
                }
                if (this.TDL_MEDI_STOCK_IDs != null)
                {
                    listHisExpMestMedicineExpression.Add(o => o.TDL_MEDI_STOCK_ID.HasValue && this.TDL_MEDI_STOCK_IDs.Contains(o.TDL_MEDI_STOCK_ID.Value));
                }
                if (this.TDL_MEDICINE_TYPE_IDs != null)
                {
                    listHisExpMestMedicineExpression.Add(o => o.TDL_MEDICINE_TYPE_ID.HasValue && this.TDL_MEDICINE_TYPE_IDs.Contains(o.TDL_MEDICINE_TYPE_ID.Value));
                }
                ...
                {
                    listHisExpMestMedicineExpression.Add(o => o.IS_EXPEND.HasValue && o.IS_EXPEND.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPORT.HasValue && this.IS_EXPORT.Value)
                {
                    listHisExpMestMedicineExpression.Add(o => o.IS_EXPORT.HasValue && o.IS_EXPORT.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPEND.HasValue && !this.IS_EXPEND.Value)
                {
                    listHisExpMestMedicineExpression.Add(o => !o.IS_EXPEND.HasValue || o.IS_EXPEND.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listHisExpMestMedicineExpression.Add(o => o.APPROVAL_TIME.HasValue);
                }
                if (this.IS_APPROVED.HasValue && !this.IS_APPROVED.Value)
                {
                    listHisExpMestMedicineExpression.Add(o => !o.APPROVAL_TIME.HasValue);
                ...
                {
                    listHisExpMestMedicineExpression.Add(o => this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_ID.Value == o.TDL_AGGR_EXP_MEST_ID || this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_ID.Value == o.EXP_MEST_ID);
                }
