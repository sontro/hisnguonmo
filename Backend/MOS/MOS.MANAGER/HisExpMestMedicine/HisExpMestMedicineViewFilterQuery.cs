    ...
    public class HisExpMestMedicineViewFilterQuery : HisExpMestMedicineViewFilter
    {
        ...
        internal HisExpMestMedicineSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_INTRUCTION_TIME.HasValue && o.TDL_INTRUCTION_TIME.Value >= this.TDL_INTRUCTION_TIME_FROM.Value);
                }
                if (this.TDL_INTRUCTION_TIME_TO.HasValue)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_INTRUCTION_TIME.HasValue && o.TDL_INTRUCTION_TIME.Value <= this.TDL_INTRUCTION_TIME_TO.Value);
                }

                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    this.KEY_WORD = this.KEY_WORD.ToLower();
                    listVHisExpMestMedicineExpression.Add(o => 
                ...
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_MEDICINE_TYPE_ID.HasValue && this.TDL_MEDICINE_TYPE_IDs.Contains(o.TDL_MEDICINE_TYPE_ID.Value));
                }
                ...
                {
                    listVHisExpMestMedicineExpression.Add(o => o.EXP_MEST_ID.HasValue && this.EXP_MEST_IDs.Contains(o.EXP_MEST_ID.Value));
                }
                if (this.MEDICINE_IDs != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.MEDICINE_ID.HasValue && this.MEDICINE_IDs.Contains(o.MEDICINE_ID.Value));
                }
                if (this.TDL_MEDI_STOCK_IDs != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_MEDI_STOCK_ID.HasValue && this.TDL_MEDI_STOCK_IDs.Contains(o.TDL_MEDI_STOCK_ID.Value));
                }
                ...
                {
                    listVHisExpMestMedicineExpression.Add(o => o.IS_EXPEND.HasValue && o.IS_EXPEND.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPORT.HasValue && this.IS_EXPORT.Value)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.IS_EXPORT.HasValue && o.IS_EXPORT.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_FUNCTIONAL_FOOD.HasValue && this.IS_FUNCTIONAL_FOOD.Value)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.IS_FUNCTIONAL_FOOD.HasValue && o.IS_FUNCTIONAL_FOOD.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPEND.HasValue && !this.IS_EXPEND.Value)
                {
                    listVHisExpMestMedicineExpression.Add(o => !o.IS_EXPEND.HasValue || o.IS_EXPEND.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && this.TDL_TREATMENT_ID.Value == o.TDL_TREATMENT_ID);
                }
                if (this.TDL_TREATMENT_IDs != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && this.TDL_TREATMENT_IDs.Contains(o.TDL_TREATMENT_ID.Value));
                }

                if (this.VACCINATION_RESULT_ID.HasValue)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.VACCINATION_RESULT_ID.HasValue && this.VACCINATION_RESULT_ID.Value == o.VACCINATION_RESULT_ID);
                }
                if (this.VACCINATION_RESULT_IDs != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.VACCINATION_RESULT_ID.HasValue && this.VACCINATION_RESULT_IDs.Contains(o.VACCINATION_RESULT_ID.Value));
                }

                if (this.TDL_VACCINATION_ID.HasValue)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_VACCINATION_ID.HasValue && this.TDL_VACCINATION_ID.Value == o.TDL_VACCINATION_ID);
                }
                if (this.TDL_VACCINATION_IDs != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_VACCINATION_ID.HasValue && this.TDL_VACCINATION_IDs.Contains(o.TDL_VACCINATION_ID.Value));
                }
                if (this.TDL_SERVICE_REQ_ID.HasValue)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && this.TDL_SERVICE_REQ_ID.Value == o.TDL_SERVICE_REQ_ID);
                }
                ...
                if (this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_ID.HasValue)
                {
                    listVHisExpMestMedicineExpression.Add(o => (o.TDL_AGGR_EXP_MEST_ID.HasValue && o.TDL_AGGR_EXP_MEST_ID.Value == this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_ID.Value) || (o.EXP_MEST_ID.HasValue && o.EXP_MEST_ID.Value == this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_ID.Value));
                }
                if (this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_IDs != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => (o.TDL_AGGR_EXP_MEST_ID.HasValue && this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_IDs.Contains(o.TDL_AGGR_EXP_MEST_ID.Value)) 
                        || (o.EXP_MEST_ID.HasValue && this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_IDs.Contains(o.EXP_MEST_ID.Value)));
                }
                if (this.EXP_MEST_METY_REQ_ID != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => this.EXP_MEST_METY_REQ_ID == o.EXP_MEST_METY_REQ_ID);
                }
                if (this.EXP_MEST_METY_REQ_IDs != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.EXP_MEST_METY_REQ_ID.HasValue && this.EXP_MEST_METY_REQ_IDs.Contains(o.EXP_MEST_METY_REQ_ID.Value));
                }
                if (!string.IsNullOrWhiteSpace(this.PACKAGE_NUMBER__EXACT))
                {
                    listVHisExpMestMedicineExpression.Add(o => o.PACKAGE_NUMBER == this.PACKAGE_NUMBER__EXACT);
                }
                if (this.USE_TIME_TO_FROM.HasValue)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.USE_TIME_TO.HasValue && o.USE_TIME_TO.Value >= this.USE_TIME_TO_FROM.Value);
                }
                if (this.USE_TIME_TO_TO.HasValue)
                {
                    listVHisExpMestMedicineExpression.Add(o => o.USE_TIME_TO.HasValue && o.USE_TIME_TO.Value <= this.USE_TIME_TO_TO.Value);
                }
                if (this.TDL_PATIENT_ID != null)
                {
                    listVHisExpMestMedicineExpression.Add(o => this.TDL_PATIENT_ID == o.TDL_PATIENT_ID);
                }
