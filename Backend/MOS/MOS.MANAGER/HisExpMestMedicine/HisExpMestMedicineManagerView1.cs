...
namespace MOS.MANAGER.HisExpMestMedicine
{
    ...
    {
        [Logger]
        public ApiResultObject<List<V_HIS_EXP_MEST_MEDICINE_1>> GetView1(HisExpMestMedicineView1FilterQuery filter)
        {
            ApiResultObject<List<V_HIS_EXP_MEST_MEDICINE_1>> result = null;
