...
{
    class HisExpMestMedicineIncreaseBcsReqAmount : BusinessBase
    {
        Dictionary<long, decimal> dicIncrease;
        internal HisExpMestMedicineIncreaseBcsReqAmount()
            : base()
        {

        }

        internal HisExpMestMedicineIncreaseBcsReqAmount(CommonParam param)
            : base(param)
        {
