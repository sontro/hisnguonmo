    ...
    public class HisExpMestMedicineView4FilterQuery : HisExpMestMedicineView4Filter
    {
        ...
        internal HisExpMestMedicineSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisExpMestMedicine4Expression.Add(o => o.EXP_MEST_ID.HasValue && this.EXP_MEST_IDs.Contains(o.EXP_MEST_ID.Value));
                }
                if (this.MEDICINE_IDs != null)
                {
                    listVHisExpMestMedicine4Expression.Add(o => o.MEDICINE_ID.HasValue && this.MEDICINE_IDs.Contains(o.MEDICINE_ID.Value));
                }
                ...
                {
                    listVHisExpMestMedicine4Expression.Add(o => o.TDL_MEDICINE_TYPE_ID.HasValue && this.TDL_MEDICINE_TYPE_IDs.Contains(o.TDL_MEDICINE_TYPE_ID.Value));
                }
                ...
                {
                    listVHisExpMestMedicine4Expression.Add(o => o.VACCINATION_RESULT_ID.HasValue && this.VACCINATION_RESULT_ID.Value == o.VACCINATION_RESULT_ID);
                }
                if (this.VACCINATION_RESULT_IDs != null)
                {
                    listVHisExpMestMedicine4Expression.Add(o => o.VACCINATION_RESULT_ID.HasValue && this.VACCINATION_RESULT_IDs.Contains(o.VACCINATION_RESULT_ID.Value));
                }

                if (this.TDL_VACCINATION_ID.HasValue)
                {
                    listVHisExpMestMedicine4Expression.Add(o => o.TDL_VACCINATION_ID.HasValue && this.TDL_VACCINATION_ID.Value == o.TDL_VACCINATION_ID);
                }
                if (this.TDL_VACCINATION_IDs != null)
                {
                    listVHisExpMestMedicine4Expression.Add(o => o.TDL_VACCINATION_ID.HasValue && this.TDL_VACCINATION_IDs.Contains(o.TDL_VACCINATION_ID.Value));
                }
