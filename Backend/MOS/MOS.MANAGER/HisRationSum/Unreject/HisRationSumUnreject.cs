...
namespace MOS.MANAGER.HisRationSum.Unreject
{
    class HisRationSumUnreject : BusinessBase
    {
        private HisRationSumUpdate hisRationSumUpdate;

        internal HisRationSumUnreject()
            : base()
        {
            this.hisRationSumUpdate = new HisRationSumUpdate(param);
        }

        internal HisRationSumUnreject(CommonParam param)
            : base(param)
        {
            this.hisRationSumUpdate = new HisRationSumUpdate(param);
        }
        ...
        internal bool Run(HisRationSumUpdateSDO data, ref HIS_RATION_SUM resultData)
        {
            ...
            try
            {
                ...
                valid = valid && checker.IsSttAllowUnreject(raw);
