...
{
    class HisMestPeriodMediLock : BusinessBase
    {
        internal HisMestPeriodMediLock()
            : base()
        {

        }

        internal HisMestPeriodMediLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_MEST_PERIOD_MEDI data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisMestPeriodMediGet().GetById(data.ID);
                    if (data != null)
                    {
