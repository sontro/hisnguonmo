...
{
    class HisTreatmentResultLock : BusinessBase
    {
        internal HisTreatmentResultLock()
            : base()
        {

        }

        internal HisTreatmentResultLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_TREATMENT_RESULT data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisTreatmentResultGet().GetById(data.ID);
                    if (data != null)
                    {
