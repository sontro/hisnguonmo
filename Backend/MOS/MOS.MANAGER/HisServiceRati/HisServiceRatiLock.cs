...
{
    partial class HisServiceRatiLock : BusinessBase
    {
        internal HisServiceRatiLock()
            : base()
        {

        }

        internal HisServiceRatiLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SERVICE_RATI resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SERVICE_RATI data = new HisServiceRatiGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisServiceRatiDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SERVICE_RATI resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SERVICE_RATI resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisServiceRatiCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisServiceRatiDAO.Update(raw);
