...
{
    partial class HisServiceRatiCheck : BusinessBase
    {
        internal HisServiceRatiCheck()
            : base()
        {

        }

        internal HisServiceRatiCheck(CommonParam paramCheck)
            : base(paramCheck)
        {

        }

        internal bool VerifyRequireField(HIS_SERVICE_RATI data)
        {
            bool valid = true;
            try
            {
                if (data == null) throw new ArgumentNullException("data");
                if (data.RATION_TIME_ID <= 0) throw new ArgumentNullException("data.RATION_TIME_ID");
        ...
        internal bool VerifyRequireField(HisServiceRatiSDO data)
        {
            bool valid = true;
            try
            {
                if (data == null) throw new ArgumentNullException("data");
                if (data.ServiceId <= 0) throw new ArgumentNullException("data.ServiceId");
                if (!IsNotNullOrEmpty(data.RationTimeIds)) throw new ArgumentNullException("data.RationTimeIds");
            }
            catch (ArgumentNullException ex)
            {
                BugUtil.SetBugCode(param, LibraryBug.Bug.Enum.ThieuThongTinBatBuoc);
        ...
        internal bool VerifyId(long id)
        {
            ...
            try
            {
                if (new HisServiceRatiGet().GetById(id) == null)
                {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool VerifyId(long id, ref HIS_SERVICE_RATI data)
        {
            bool valid = true;
            try
            {
                data = new HisServiceRatiGet().GetById(id);
                if (data == null)
                {
                    BugUtil.SetBugCode(param, LibraryBug.Bug.Enum.KXDDDuLieuCanXuLy);
                    Logging("Id invalid." + Inventec.Common.Logging.LogUtil.TraceData(Inventec.Common.Logging.LogUtil.GetMemberName(() => id), id), LogType.Error);
        ...
        internal bool VerifyIds(List<long> listId)
        {
            ...
            try
            {
                if (listId != null && listId.Count > 0)
                {
                    ...
                    filter.IDs = listId;
                    List<HIS_SERVICE_RATI> listData = new HisServiceRatiGet().Get(filter);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool VerifyIds(List<long> listId, List<HIS_SERVICE_RATI> listObject)
        {
            bool valid = true;
            try
            {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool IsUnLock(HIS_SERVICE_RATI data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool IsUnLock(long id)
        {
            ...
            try
            {
                if (!DAOWorker.HisServiceRatiDAO.IsUnLock(id))
                {
                    valid = false;
                    MessageUtil.SetMessage(param, LibraryMessage.Message.Enum.DuLieuDangBiKhoa);
                }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool IsUnLock(List<HIS_SERVICE_RATI> listData)
        {
            bool valid = true;
            try
            {
        ...
        internal bool CheckConstraint(long id)
        {
            ...
            try
            {
                /*List<XXX> hisXXXs = new HisXXXGet().GetByHisServiceRatiId(id);
        ...
        internal bool CheckServiceType(HIS_SERVICE data)
        {
            bool valid = true;
            try
            {
                if (data.SERVICE_TYPE_ID != IMSys.DbConfig.HIS_RS.HIS_SERVICE_TYPE.ID__AN)
                {
                    ...
                    throw new Exception("Loai dich vu khong phai la xuat an");
                }
            }
            catch (Exception ex)
            {
        ...
        internal bool CheckDuplicate(HisServiceRatiSDO data)
        {
            bool valid = true;
            try
            {
                if (data.RationTimeIds.GroupBy(g => g).Any(a => a.Count() > 1))
                {
                    BugUtil.SetBugCode(param, LibraryBug.Bug.Enum.DuLieuDauVaoKhongHopLe);
                    throw new Exception("Ton tai Id trung nhau trong HisServiceRatiSDO.RationTimeIds");
                }
            }
            catch (Exception ex)
            {
