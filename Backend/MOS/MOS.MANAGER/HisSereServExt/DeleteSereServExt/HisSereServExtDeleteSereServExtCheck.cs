...
{
    class HisSereServExtDeleteSereServExtCheck: BusinessBase
    {
        internal HisSereServExtDeleteSereServExtCheck()
            : base()
        {

        }

        internal HisSereServExtDeleteSereServExtCheck(CommonParam param)
            : base(param)
        {
        ...
        /// <returns></returns>
        internal bool IsAllow(HisSereServExtDeleteSereServExtSDO sdo, HIS_SERE_SERV_EXT sereServExt, WorkPlaceSDO workPlaceSdo)
        {
            bool valid = true;
            try
            {
                ...
                if (workPlaceSdo.RoomId != serviceReq.REQUEST_ROOM_ID)
                {
        ...
        internal bool VerifyRequireField(HisSereServExtDeleteSereServExtSDO data)
        {
            bool valid = true;
            try
            {
