...
{
    partial class HisKskUnderEighteenLock : BusinessBase
    {
        internal HisKskUnderEighteenLock()
            : base()
        {

        }

        internal HisKskUnderEighteenLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_KSK_UNDER_EIGHTEEN resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_KSK_UNDER_EIGHTEEN data = new HisKskUnderEighteenGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisKskUnderEighteenDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_KSK_UNDER_EIGHTEEN resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_KSK_UNDER_EIGHTEEN resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisKskUnderEighteenCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisKskUnderEighteenDAO.Update(raw);
