...
namespace MOS.MANAGER.HisExpMestBltyReq
{
    ...
    {
        [Logger]
        public ApiResultObject<List<V_HIS_EXP_MEST_BLTY_REQ_1>> GetView1(HisExpMestBltyReqView1FilterQuery filter)
        {
            ApiResultObject<List<V_HIS_EXP_MEST_BLTY_REQ_1>> result = null;
            try
            {
                bool valid = true;
