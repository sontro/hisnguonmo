...
{
    partial class HisEmrCoverTypeLock : BusinessBase
    {
        internal HisEmrCoverTypeLock()
            : base()
        {

        }

        internal HisEmrCoverTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EMR_COVER_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EMR_COVER_TYPE data = new HisEmrCoverTypeGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEmrCoverTypeDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EMR_COVER_TYPE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EMR_COVER_TYPE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEmrCoverTypeCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEmrCoverTypeDAO.Update(raw);
