...
namespace MOS.MANAGER.HisImpMestMaterial
{
    ...
    {
        [Logger]
        public ApiResultObject<List<V_HIS_IMP_MEST_MATERIAL_2>> GetView2(HisImpMestMaterialView2FilterQuery filter)
        {
            ApiResultObject<List<V_HIS_IMP_MEST_MATERIAL_2>> result = null;
