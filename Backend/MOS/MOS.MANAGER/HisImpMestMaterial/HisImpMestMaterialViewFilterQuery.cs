    ...
    public class HisImpMestMaterialViewFilterQuery : HisImpMestMaterialViewFilter
    {
        ...
        internal HisImpMestMaterialSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisImpMestMaterialExpression.Add(o => o.REQ_DEPARTMENT_ID.HasValue && this.REQ_DEPARTMENT_IDs.Contains(o.REQ_DEPARTMENT_ID.Value));
                }
                if (this.MEDI_STOCK_IDs != null)
                {
                    listVHisImpMestMaterialExpression.Add(o => this.MEDI_STOCK_IDs.Contains(o.MEDI_STOCK_ID));
                }
                if (this.IMP_MEST_TYPE_IDs != null)
                {
                    listVHisImpMestMaterialExpression.Add(o => this.IMP_MEST_TYPE_IDs.Contains(o.IMP_MEST_TYPE_ID));
                }
                if (this.DOCUMENT_NUMBER != null)
                {
                    this.DOCUMENT_NUMBER = this.DOCUMENT_NUMBER.ToLower().Trim();
                    listVHisImpMestMaterialExpression.Add(o => o.DOCUMENT_NUMBER.ToLower().Contains(this.DOCUMENT_NUMBER));
                }
                if (!String.IsNullOrWhiteSpace(this.SERIAL_NUMBER__EXACT))
                {
                    listVHisImpMestMaterialExpression.Add(o => o.SERIAL_NUMBER == this.SERIAL_NUMBER__EXACT);
                }
                if (!string.IsNullOrWhiteSpace(this.PACKAGE_NUMBER__EXACT))
                {
                    listVHisImpMestMaterialExpression.Add(o => o.PACKAGE_NUMBER == this.PACKAGE_NUMBER__EXACT);
                }
                if (this.SERIAL_NUMBERs != null)
                {
                    listVHisImpMestMaterialExpression.Add(o => this.SERIAL_NUMBERs.Contains(o.SERIAL_NUMBER));
                }
