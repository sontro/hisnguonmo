    ...
    public class HisExpMestTypeFilterQuery : HisExpMestTypeFilter
    {
        ...
        internal HisExpMestTypeSO Query()
        {
            ...
            try
            {
                ...
                if (this.EXP_MEST_TYPE_CODEs != null)
                {
                    this.EXP_MEST_TYPE_CODEs.ForEach(f => f.Trim().ToLower());
                    search.listHisExpMestTypeExpression.Add(o => this.EXP_MEST_TYPE_CODEs.Contains(o.EXP_MEST_TYPE_CODE.ToLower()));
                }
                #endregion
