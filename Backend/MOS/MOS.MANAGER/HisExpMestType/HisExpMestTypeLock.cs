...
{
    class HisExpMestTypeLock : BusinessBase
    {
        internal HisExpMestTypeLock()
            : base()
        {

        }

        internal HisExpMestTypeLock(CommonParam paramLock)
            : base(paramLock)
        {
        ...
        internal bool ChangeLock(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    HIS_EXP_MEST_TYPE data = new HisExpMestTypeGet().GetById(id);
                    if (data != null)
                    {
