        ...
        internal HisExamServiceTempSO Query()
        {
            ...
            try
            {
                ...
                if (this.DATA_DOMAIN_FILTER)
                {
                    ...
                    listHisExamServiceTempExpression.Add(o => o.CREATOR == loginName || o.IS_PUBLIC.HasValue && o.IS_PUBLIC.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listHisExamServiceTempExpression.Add(o =>
                        ...
                        o.EXAM_SERVICE_TEMP_CODE.ToLower().Contains(this.KEY_WORD) ||
                        o.EXAM_SERVICE_TEMP_NAME.ToLower().Contains(this.KEY_WORD) ||
                        o.FULL_EXAM.ToLower().Contains(this.KEY_WORD) ||
                        o.HOSPITALIZATION_REASON.ToLower().Contains(this.KEY_WORD) ||
                        o.MODIFIER.ToLower().Contains(this.KEY_WORD) ||
                        o.NOTE.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_CIRCULATION.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_DIGESTION.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_ENT.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_EYE.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_KIDNEY_UROLOGY.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_MENTAL.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_MOTION.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_MUSCLE_BONE.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_NEUROLOGICAL.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_NUTRITION.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_OBSTETRIC.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_OEND.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_RESPIRATORY.ToLower().Contains(this.KEY_WORD) ||
                        o.PART_EXAM_STOMATOLOGY.ToLower().Contains(this.KEY_WORD) ||
                        o.PATHOLOGICAL_HISTORY.ToLower().Contains(this.KEY_WORD) ||
                        o.PATHOLOGICAL_HISTORY_FAMILY.ToLower().Contains(this.KEY_WORD) ||
                        o.PATHOLOGICAL_PROCESS.ToLower().Contains(this.KEY_WORD)
                        );
                }
