...
{
    partial class HisServiceChangeReqLock : BusinessBase
    {
        internal HisServiceChangeReqLock()
            : base()
        {

        }

        internal HisServiceChangeReqLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SERVICE_CHANGE_REQ resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SERVICE_CHANGE_REQ data = new HisServiceChangeReqGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisServiceChangeReqDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SERVICE_CHANGE_REQ resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SERVICE_CHANGE_REQ resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisServiceChangeReqCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisServiceChangeReqDAO.Update(raw);
