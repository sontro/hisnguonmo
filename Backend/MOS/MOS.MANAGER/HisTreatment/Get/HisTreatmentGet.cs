...
namespace MOS.MANAGER.HisTreatment
{
    partial class HisTreatmentGet : GetBase
    {
        ...
        internal List<HIS_TREATMENT> GetByMediRecordTypeId(long mediRecordTypeId)
        {
            HisTreatmentFilterQuery filter = new HisTreatmentFilterQuery();
            filter.MEDI_RECORD_TYPE_ID = mediRecordTypeId;
            return this.Get(filter);
        }

        internal List<HIS_TREATMENT> GetByKskContractId(long kskContractId)
        {
            HisTreatmentFilterQuery filter = new HisTreatmentFilterQuery();
        ...
        internal List<HIS_TREATMENT> GetByMediRecordId(long mediRecordId)
        {
            HisTreatmentFilterQuery filter = new HisTreatmentFilterQuery();
            filter.MEDI_RECORD_ID = mediRecordId;
            return this.Get(filter);
        }

        internal List<HIS_TREATMENT> GetByAppointmentPeriodId(long id)
        {
            HisTreatmentFilterQuery filter = new HisTreatmentFilterQuery();
            filter.APPOINTMENT_PERIOD_ID = id;
            return this.Get(filter);
        }

        internal List<HIS_TREATMENT> GetByDocumentBookId(long id)
        {
            HisTreatmentFilterQuery filter = new HisTreatmentFilterQuery();
            filter.DOCUMENT_BOOK_ID = id;
            return this.Get(filter);
        }

        internal List<HIS_TREATMENT> GetByPatientClassifyId(long id)
        {
            HisTreatmentFilterQuery filter = new HisTreatmentFilterQuery();
