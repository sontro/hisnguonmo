    ...
    public class HisTreatmentView2FilterQuery : HisTreatmentView2Filter
    {
        ...
        internal HisTreatmentSO Query()
        {
            ...
            try
            {
                ...
                if (this.IDs != null)
                {
                    listVHisTreatment2Expression.Add(o => this.IDs.Contains(o.ID));
                }
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listVHisTreatment2Expression.Add(o =>
                ...
                {
                    listVHisTreatment2Expression.Add(o => o.IS_LOCK_HEIN.HasValue && o.IS_LOCK_HEIN.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_LOCK_HEIN.HasValue && !this.IS_LOCK_HEIN.Value)
                {
                    listVHisTreatment2Expression.Add(o => !o.IS_LOCK_HEIN.HasValue || o.IS_LOCK_HEIN.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisTreatment2Expression.Add(o => o.IS_PAUSE.HasValue && o.IS_PAUSE.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_PAUSE.HasValue && !this.IS_PAUSE.Value)
                {
                    listVHisTreatment2Expression.Add(o => !o.IS_PAUSE.HasValue || o.IS_PAUSE.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisTreatment2Expression.Add(o => TDL_TREATMENT_TYPE_ID.HasValue && o.TDL_TREATMENT_TYPE_ID.Value == this.TDL_TREATMENT_TYPE_ID.Value);
                }
                if (this.TDL_TREATMENT_TYPE_IDs != null)
                {
                    listVHisTreatment2Expression.Add(o => o.TDL_TREATMENT_TYPE_ID.HasValue && this.TDL_TREATMENT_TYPE_IDs.Contains(o.TDL_TREATMENT_TYPE_ID.Value));
                }
                if (this.END_DEPARTMENT_ID.HasValue)
                {
                    listVHisTreatment2Expression.Add(o => o.END_DEPARTMENT_ID.HasValue && o.END_DEPARTMENT_ID.Value == this.END_DEPARTMENT_ID.Value);
                }
                if (this.END_DEPARTMENT_IDs != null)
                {
                    listVHisTreatment2Expression.Add(o => o.END_DEPARTMENT_ID.HasValue && this.END_DEPARTMENT_IDs.Contains(o.END_DEPARTMENT_ID.Value));
                }
                ...
                {
                    listVHisTreatment2Expression.Add(o => !o.DATA_STORE_ID.HasValue || this.DATA_STORE_ID_NULL__OR__INs.Contains(o.DATA_STORE_ID.Value));
                }
                if (this.TDL_PATIENT_TYPE_IDs != null)
                {
                    listVHisTreatment2Expression.Add(o => o.TDL_PATIENT_TYPE_ID.HasValue && this.TDL_PATIENT_TYPE_IDs.Contains(o.TDL_PATIENT_TYPE_ID.Value));
                }
