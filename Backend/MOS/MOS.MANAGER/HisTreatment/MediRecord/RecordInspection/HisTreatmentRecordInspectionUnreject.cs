...
{
    internal class HisTreatmentRecordInspectionUnreject : BusinessBase
    {
        private HisTreatmentUpdate hisTreatmentUpdate;

        internal HisTreatmentRecordInspectionUnreject()
            : base()
        {
            this.hisTreatmentUpdate = new HisTreatmentUpdate(param);
        }

        internal HisTreatmentRecordInspectionUnreject(CommonParam param)
            : base(param)
        {
            this.hisTreatmentUpdate = new HisTreatmentUpdate(param);
        }
        ...
        internal bool Run(long treatmentId, ref HIS_TREATMENT resultData)
        {
            ...
            try
            {
                ...
                valid = valid && checker.IsRecordInspectionRejected(treatment);
        ...
        private void ProcessTreatment(HIS_TREATMENT treatment)
        {
            ...
            treatment.RECORD_INSPECTION_REJECT_NOTE = null;
