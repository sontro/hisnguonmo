...
{
    partial class HisSubclinicalRsAddLock : BusinessBase
    {
        internal HisSubclinicalRsAddLock()
            : base()
        {

        }

        internal HisSubclinicalRsAddLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SUBCLINICAL_RS_ADD resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SUBCLINICAL_RS_ADD data = new HisSubclinicalRsAddGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisSubclinicalRsAddDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SUBCLINICAL_RS_ADD resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SUBCLINICAL_RS_ADD resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisSubclinicalRsAddCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisSubclinicalRsAddDAO.Update(raw);
