...
{
    class HisEmergencyWtimeLock : BusinessBase
    {
        internal HisEmergencyWtimeLock()
            : base()
        {

        }

        internal HisEmergencyWtimeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_EMERGENCY_WTIME data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisEmergencyWtimeGet().GetById(data.ID);
                    if (data != null)
                    {
