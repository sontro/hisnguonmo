...
{
    partial class HisMediStockExtyLock : BusinessBase
    {
        internal HisMediStockExtyLock()
            : base()
        {

        }

        internal HisMediStockExtyLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_MEDI_STOCK_EXTY resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_MEDI_STOCK_EXTY data = new HisMediStockExtyGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisMediStockExtyDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_MEDI_STOCK_EXTY resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_MEDI_STOCK_EXTY resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisMediStockExtyCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisMediStockExtyDAO.Update(raw);
