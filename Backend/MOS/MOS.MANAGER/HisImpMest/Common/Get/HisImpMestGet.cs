...
namespace MOS.MANAGER.HisImpMest
{
    partial class HisImpMestGet : GetBase
    {
        ...
        internal List<HIS_IMP_MEST> GetByApprovalImpMestId(long aggrImpMestId)
        {
            try
            {
                HisImpMestFilterQuery filter = new HisImpMestFilterQuery();
                filter.APPROVAL_IMP_MEST_ID = aggrImpMestId;
                return this.Get(filter);
            }
            catch (Exception ex)
            {
        ...
        internal List<HIS_IMP_MEST> GetByReqRoomId(long roomId)
        {
            try
            {
                HisImpMestFilterQuery filter = new HisImpMestFilterQuery();
        ...
        internal List<HIS_IMP_MEST> GetByChmsExpMestIds(List<long> expMestIds)
        {
            try
            {
                HisImpMestFilterQuery filter = new HisImpMestFilterQuery();
                filter.CHMS_EXP_MEST_IDs = expMestIds;
                return this.Get(filter);
            }
            catch (Exception ex)
            {
        ...
        internal List<HIS_IMP_MEST> GetByDispenseId(long dispenseId)
        {
            try
            {
                HisImpMestFilterQuery filter = new HisImpMestFilterQuery();
        ...
        internal List<HIS_IMP_MEST> GetByTreatmentId(long treatmentId)
        {
            HisImpMestFilterQuery filter = new HisImpMestFilterQuery();
        ...
        internal List<V_HIS_IMP_MEST> GetViewByImpMestProposeId(long impMestProposeId)
        {
            try
            {
                HisImpMestViewFilterQuery filter = new HisImpMestViewFilterQuery();
        ...
        internal List<HIS_IMP_MEST> GetByImpMestProposeId(long impMestProposeId)
        {
            try
            {
                HisImpMestFilterQuery filter = new HisImpMestFilterQuery();
        ...
        internal List<HIS_IMP_MEST> GetBySourceMestPeriodId(long sourceMestPeriodId)
        {
            try
            {
                HisImpMestFilterQuery filter = new HisImpMestFilterQuery();
