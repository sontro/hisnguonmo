    ...
    public class HisImpMestView1FilterQuery : HisImpMestView1Filter
    {
        ...
        internal HisImpMestSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisImpMest1Expression.Add(o => o.IMP_MEST_SUB_CODE == this.IMP_MEST_SUB_CODE__EXACT);
                }
                if (this.DATA_DOMAIN_FILTER)
                {
                    ...
                    {
                        listVHisImpMest1Expression.Add(o => loginName.Equals(o.CREATOR));
                    }
                    else
                    {
                        ...
                        if (workPlace != null)
                        {
                            listVHisImpMest1Expression.Add(o => o.MEDI_STOCK_ID == workPlace.MediStockId || o.REQ_ROOM_ID == workPlace.RoomId || loginName.Equals(o.CREATOR) || o.REQ_DEPARTMENT_ID == workPlace.DepartmentId);
                        }
                        else
                        {
                            listVHisImpMest1Expression.Add(o => loginName.Equals(o.CREATOR));
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listVHisImpMest1Expression.Add(o => o.DOCUMENT_NUMBER.ToLower().Contains(this.KEY_WORD)
                ...
                {
                    listVHisImpMest1Expression.Add(o => o.MEDICAL_CONTRACT_ID.HasValue && o.MEDICAL_CONTRACT_ID == this.MEDICAL_CONTRACT_ID.Value);
                }
                if (this.MEDICAL_CONTRACT_IDs != null)
                {
                    listVHisImpMest1Expression.Add(o => o.MEDICAL_CONTRACT_ID.HasValue && this.MEDICAL_CONTRACT_IDs.Contains(o.MEDICAL_CONTRACT_ID.Value));
                }
