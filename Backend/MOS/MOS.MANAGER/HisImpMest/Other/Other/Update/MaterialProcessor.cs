...
namespace MOS.MANAGER.HisImpMest.Other.Other.Update
{
    class MaterialProcessor : BusinessBase
    {
        ...
        //private List<HIS_MATERIAL> hisMaterials;
        ...
        private void ProcessMaterial(HIS_IMP_MEST impMest, List<HisMaterialWithPatySDO> otherMaterials, List<HIS_MATERIAL> hisMaterials, List<HIS_MATERIAL_TYPE> hisMaterialTypes, ref List<string> sqls)
        {
            ...
            foreach (var imp in otherMaterials)
            {
