...
namespace MOS.MANAGER.HisImpMest.Other.Other.Update
{
    class MedicineProcessor : BusinessBase
    {
        ...
        internal bool Run(HIS_IMP_MEST impMest, List<HisMedicineWithPatySDO> otherMedicines, ref List<HisMedicineWithPatySDO> impMedicineSDOs, ref List<string> sqls)
        {
            bool result = false;
            try
            {
                ...
                this.ProcessMedicine(impMest, otherMedicines, ref sqls);
        ...
        private void ProcessMedicine(HIS_IMP_MEST impMest, List<HisMedicineWithPatySDO> otherMedicines, ref List<string> sqls)
        {
            ...
            foreach (var imp in otherMedicines)
            {
