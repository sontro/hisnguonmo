...
namespace MOS.MANAGER.HisImpMest.Other.Init.Update
{
    class MedicineProcessor : BusinessBase
    {
        ...
        internal bool Run(HIS_IMP_MEST impMest, List<HisMedicineWithPatySDO> initMedicines, ref List<HisMedicineWithPatySDO> impMedicineSDOs, ref List<string> sqls)
        {
            bool result = false;
            try
            {
                ...
                this.ProcessMedicine(impMest, initMedicines, ref sqls);
        ...
        private void ProcessMedicine(HIS_IMP_MEST impMest, List<HisMedicineWithPatySDO> initMedicines, ref List<string> sqls)
        {
            ...
            foreach (var imp in initMedicines)
            {
