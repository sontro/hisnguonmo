...
namespace MOS.MANAGER.HisImpMest.Other.Init.Update
{
    class MaterialProcessor : BusinessBase
    {
        ...
        private void ProcessMaterial(HIS_IMP_MEST impMest, List<HisMaterialWithPatySDO> initMaterials, List<HIS_MATERIAL> hisMaterials, List<HIS_MATERIAL_TYPE> hisMaterialTypes, ref List<string> sqls)
        {
            ...
            foreach (var imp in initMaterials)
            {
