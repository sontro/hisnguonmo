...
namespace MOS.MANAGER.HisImpMest.Manu.Update
{
    class BloodProcessor : BusinessBase
    {
        ...
        internal bool Run(HIS_IMP_MEST impMest, List<HIS_BLOOD> manuBloods, ref List<HIS_BLOOD> outBloods, ref List<string> sqls)
        {
            bool result = false;
            try
            {
                ...
                this.ProcessBlood(impMest, manuBloods);
        ...
        private void ProcessBlood(HIS_IMP_MEST impMest, List<HIS_BLOOD> manuBloods)
        {
