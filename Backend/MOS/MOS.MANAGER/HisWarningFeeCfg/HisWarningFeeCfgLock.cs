...
{
    partial class HisWarningFeeCfgLock : BusinessBase
    {
        internal HisWarningFeeCfgLock()
            : base()
        {

        }

        internal HisWarningFeeCfgLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_WARNING_FEE_CFG resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_WARNING_FEE_CFG data = new HisWarningFeeCfgGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisWarningFeeCfgDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_WARNING_FEE_CFG resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_WARNING_FEE_CFG resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisWarningFeeCfgCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisWarningFeeCfgDAO.Update(raw);
