...
{
    partial class HisCareDetailLock : BusinessBase
    {
        internal HisCareDetailLock()
            : base()
        {

        }

        internal HisCareDetailLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_CARE_DETAIL data)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisCareDetailCheck().VerifyId(data.ID, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisCareDetailDAO.Update(raw);
