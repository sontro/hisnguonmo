...
{
    partial class HisSkinSurgeryDescLock : BusinessBase
    {
        internal HisSkinSurgeryDescLock()
            : base()
        {

        }

        internal HisSkinSurgeryDescLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SKIN_SURGERY_DESC resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SKIN_SURGERY_DESC data = new HisSkinSurgeryDescGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisSkinSurgeryDescDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SKIN_SURGERY_DESC resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SKIN_SURGERY_DESC resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisSkinSurgeryDescCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisSkinSurgeryDescDAO.Update(raw);
