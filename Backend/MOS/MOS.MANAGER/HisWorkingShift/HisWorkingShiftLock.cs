...
{
    partial class HisWorkingShiftLock : BusinessBase
    {
        internal HisWorkingShiftLock()
            : base()
        {

        }

        internal HisWorkingShiftLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_WORKING_SHIFT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_WORKING_SHIFT data = new HisWorkingShiftGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisWorkingShiftDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_WORKING_SHIFT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_WORKING_SHIFT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisWorkingShiftCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisWorkingShiftDAO.Update(raw);
