    ...
    public class HisSereServDebtViewFilterQuery : HisSereServDebtViewFilter
    {
        ...
        internal HisSereServDebtSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisSereServDebtExpression.Add(o => o.TDL_SERVICE_REQ_ID == this.TDL_SERVICE_REQ_ID.Value);
                }
                if (this.TDL_SERVICE_REQ_IDs != null)
                {
                    listVHisSereServDebtExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && this.TDL_SERVICE_REQ_IDs.Contains(o.TDL_SERVICE_REQ_ID.Value));
                }
