    ...
    public class HisSereServDebtFilterQuery : HisSereServDebtFilter
    {
        ...
        internal HisSereServDebtSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisSereServDebtExpression.Add(o => o.TDL_SERVICE_REQ_ID == this.TDL_SERVICE_REQ_ID.Value);
                }
                if (this.TDL_SERVICE_REQ_IDs != null)
                {
                    listHisSereServDebtExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && this.TDL_SERVICE_REQ_IDs.Contains(o.TDL_SERVICE_REQ_ID.Value));
                }
                ...
                if (this.IS_CANCEL.HasValue)
                {
                    ...
                    {
                        listHisSereServDebtExpression.Add(o => o.IS_CANCEL.HasValue && o.IS_CANCEL.Value == MOS.UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        listHisSereServDebtExpression.Add(o => !o.IS_CANCEL.HasValue || o.IS_CANCEL.Value != MOS.UTILITY.Constant.IS_TRUE);
