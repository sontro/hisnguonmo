...
{
    partial class HisDocumentBookLock : BusinessBase
    {
        internal HisDocumentBookLock()
            : base()
        {

        }

        internal HisDocumentBookLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_DOCUMENT_BOOK resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_DOCUMENT_BOOK data = new HisDocumentBookGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisDocumentBookDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_DOCUMENT_BOOK resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_DOCUMENT_BOOK resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisDocumentBookCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisDocumentBookDAO.Update(raw);
