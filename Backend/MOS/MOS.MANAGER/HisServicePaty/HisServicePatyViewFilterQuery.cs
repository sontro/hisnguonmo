    ...
    public class HisServicePatyViewFilterQuery : HisServicePatyViewFilter
    {
        ...
        internal HisServicePatySO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisServicePatyExpression.Add(o => o.BRANCH_ID == this.BRANCH_ID.Value);
                }

                if (this.SERVICE_TYPE_IDs != null)
                {
                    listVHisServicePatyExpression.Add(o => this.SERVICE_TYPE_IDs.Contains(o.SERVICE_TYPE_ID));
                }

                if (this.PATIENT_TYPE_IDs != null)
                {
                    listVHisServicePatyExpression.Add(o => this.PATIENT_TYPE_IDs.Contains(o.PATIENT_TYPE_ID));
                }

                if (this.SERVICE_IS_ACTIVE.HasValue && this.SERVICE_IS_ACTIVE.Value)
                {
                    listVHisServicePatyExpression.Add(o => o.SERVICE_IS_ACTIVE.HasValue && o.SERVICE_IS_ACTIVE == Constant.IS_TRUE);
                }
                if (this.SERVICE_IS_ACTIVE.HasValue && !this.SERVICE_IS_ACTIVE.Value)
                {
                    listVHisServicePatyExpression.Add(o => !o.SERVICE_IS_ACTIVE.HasValue || o.SERVICE_IS_ACTIVE != Constant.IS_TRUE);
                ...
                {
                    listVHisServicePatyExpression.Add(o => o.PACKAGE_ID == this.PACKAGE_ID.Value);
                }
                if (this.PACKAGE_IDs != null)
                {
                    listVHisServicePatyExpression.Add(o => o.PACKAGE_ID.HasValue && this.PACKAGE_IDs.Contains(o.PACKAGE_ID.Value));
                }
