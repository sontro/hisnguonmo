    ...
    public class HisServicePatyFilterQuery : HisServicePatyFilter
    {
        ...
        internal HisServicePatySO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisServicePatyExpression.Add(o => o.PACKAGE_ID == this.PACKAGE_ID.Value);
                }
                if (this.PACKAGE_IDs != null)
                {
                    listHisServicePatyExpression.Add(o => o.PACKAGE_ID.HasValue && this.PACKAGE_IDs.Contains(o.PACKAGE_ID.Value));
                }
                if (this.PATIENT_TYPE_IDs != null)
                {
                    listHisServicePatyExpression.Add(o => this.PATIENT_TYPE_IDs.Contains(o.PATIENT_TYPE_ID));
                }
