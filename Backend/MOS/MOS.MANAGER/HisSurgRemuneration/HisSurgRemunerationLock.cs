...
{
    partial class HisSurgRemunerationLock : BusinessBase
    {
        internal HisSurgRemunerationLock()
            : base()
        {

        }

        internal HisSurgRemunerationLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SURG_REMUNERATION resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SURG_REMUNERATION data = new HisSurgRemunerationGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisSurgRemunerationDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SURG_REMUNERATION resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SURG_REMUNERATION resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisSurgRemunerationCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisSurgRemunerationDAO.Update(raw);
