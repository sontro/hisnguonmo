...
{
    class HisManufacturerLock : BusinessBase
    {
        internal HisManufacturerLock()
            : base()
        {

        }

        internal HisManufacturerLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_MANUFACTURER data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisManufacturerGet().GetById(data.ID);
                    if (data != null)
                    {
