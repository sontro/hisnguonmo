...
{
    class HisDepartmentLock : BusinessBase
    {
        internal HisDepartmentLock()
            : base()
        {

        }

        internal HisDepartmentLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_DEPARTMENT data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisDepartmentGet().GetById(data.ID);
                    if (data != null)
                    {
