    ...
    public class HisPatientFilterQuery : HisPatientFilter
    {
        ...
        internal HisPatientSO Query()
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(this.PATIENT_STORE_CODE__EXACT))
                {
                    search.listHisPatientExpression.Add(o => o.PATIENT_STORE_CODE == this.PATIENT_STORE_CODE__EXACT);
                }
                if (!String.IsNullOrEmpty(this.HRM_EMPLOYEE_CODE__EXACT))
                {
                    search.listHisPatientExpression.Add(o => o.HRM_EMPLOYEE_CODE == this.HRM_EMPLOYEE_CODE__EXACT);
                }
                if (this.ID__NOT_EQUAL.HasValue)
                {
                    listHisPatientExpression.Add(o => o.ID != this.ID__NOT_EQUAL.Value);
                }
                if (this.HEIN_CARD_NUMBER__OR__IDs != null)
                {
                    List<string> heinCardNumbers = this.HEIN_CARD_NUMBER__OR__IDs.HeinCardNumbers;
                    List<long> ids = this.HEIN_CARD_NUMBER__OR__IDs.Ids;
                    listHisPatientExpression.Add(o => (heinCardNumbers != null && heinCardNumbers.Contains(o.TDL_HEIN_CARD_NUMBER)) 
                        || (ids != null && ids.Contains(o.ID)));
                }
                if (this.BRANCH_ID.HasValue)
                {
                    listHisPatientExpression.Add(o => o.BRANCH_ID == this.BRANCH_ID.Value);
                }
                if (this.PATIENT_CLASSIFY_ID.HasValue)
                {
                    search.listHisPatientExpression.Add(o => o.PATIENT_CLASSIFY_ID == this.PATIENT_CLASSIFY_ID.Value);
                }
                if (this.PATIENT_CLASSIFY_IDs != null)
                {
                    search.listHisPatientExpression.Add(o => o.PATIENT_CLASSIFY_ID.HasValue && this.PATIENT_CLASSIFY_IDs.Contains(o.PATIENT_CLASSIFY_ID.Value));
                }
                if (!String.IsNullOrEmpty(this.REGISTER_CODE__EXACT))
                {
                    search.listHisPatientExpression.Add(o => o.REGISTER_CODE == this.REGISTER_CODE__EXACT);
                }
