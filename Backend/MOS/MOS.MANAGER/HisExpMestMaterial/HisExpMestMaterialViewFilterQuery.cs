        ...
        internal HisExpMestMaterialSO Query()
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listVHisExpMestMaterialExpression.Add(o =>
                ...
                {
                    listVHisExpMestMaterialExpression.Add(o => o.TDL_SERVICE_REQ_ID.HasValue && this.TDL_SERVICE_REQ_IDs.Contains(o.TDL_SERVICE_REQ_ID.Value));
                }
                
                if (this.TDL_INTRUCTION_TIME_FROM.HasValue)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.TDL_INTRUCTION_TIME.HasValue && o.TDL_INTRUCTION_TIME.Value >= this.TDL_INTRUCTION_TIME_FROM.Value);
                }
                if (this.TDL_INTRUCTION_TIME_TO.HasValue)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.TDL_INTRUCTION_TIME.HasValue && o.TDL_INTRUCTION_TIME.Value <= this.TDL_INTRUCTION_TIME_TO.Value);
                }
                ...
                {
                    listVHisExpMestMaterialExpression.Add(o => o.TDL_MATERIAL_TYPE_ID.HasValue && this.TDL_MATERIAL_TYPE_IDs.Contains(o.TDL_MATERIAL_TYPE_ID.Value));
                }
                ...
                {
                    listVHisExpMestMaterialExpression.Add(o => o.EXP_MEST_ID.HasValue && this.EXP_MEST_IDs.Contains(o.EXP_MEST_ID.Value));
                }
                if (this.MATERIAL_IDs != null)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.MATERIAL_ID.HasValue && this.MATERIAL_IDs.Contains(o.MATERIAL_ID.Value));
                }
                if (this.TDL_MEDI_STOCK_IDs != null)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.TDL_MEDI_STOCK_ID.HasValue && this.TDL_MEDI_STOCK_IDs.Contains(o.TDL_MEDI_STOCK_ID.Value));
                }
                ...
                {
                    listVHisExpMestMaterialExpression.Add(o => o.IS_EXPEND.HasValue && o.IS_EXPEND.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPORT.HasValue && this.IS_EXPORT.Value)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.IS_EXPORT.HasValue && o.IS_EXPORT.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_CHEMICAL_SUBSTANCE.HasValue && this.IS_CHEMICAL_SUBSTANCE.Value)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.IS_CHEMICAL_SUBSTANCE.HasValue && o.IS_CHEMICAL_SUBSTANCE.Value == MOS.UTILITY.Constant.IS_TRUE);
                }
                if (this.IS_EXPEND.HasValue && !this.IS_EXPEND.Value)
                {
                    listVHisExpMestMaterialExpression.Add(o => !o.IS_EXPEND.HasValue || o.IS_EXPEND.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listVHisExpMestMaterialExpression.Add(o => o.SERIAL_NUMBER == this.SERIAL_NUMBER__EXACT);
                }
                ...
                {
                    listVHisExpMestMaterialExpression.Add(o => (o.TDL_AGGR_EXP_MEST_ID.HasValue && o.TDL_AGGR_EXP_MEST_ID.Value == this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_ID.Value) || (o.EXP_MEST_ID.HasValue && o.EXP_MEST_ID.Value == this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_ID.Value));
                }
                if (this.TDL_TREATMENT_ID.HasValue)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && o.TDL_TREATMENT_ID.Value == this.TDL_TREATMENT_ID.Value);
                }
                if (this.TDL_TREATMENT_IDs != null)
                {
                    listVHisExpMestMaterialExpression.Add(o => o.TDL_TREATMENT_ID.HasValue && this.TDL_TREATMENT_IDs.Contains(o.TDL_TREATMENT_ID.Value));
                }
                if (this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_IDs != null)
                {
                    listVHisExpMestMaterialExpression.Add(o => (o.TDL_AGGR_EXP_MEST_ID.HasValue && this.TDL_AGGR_EXP_MEST_ID__OR__EXP_MEST_IDs.Contains(o.TDL_AGGR_EXP_MEST_ID.Value))
                ...
                {
                    listVHisExpMestMaterialExpression.Add(o => o.PACKAGE_NUMBER == this.PACKAGE_NUMBER__EXACT);
                }
