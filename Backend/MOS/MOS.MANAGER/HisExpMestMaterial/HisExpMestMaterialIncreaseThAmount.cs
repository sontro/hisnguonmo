...
{
    class HisExpMestMaterialIncreaseThAmount : BusinessBase
    {
        Dictionary<long, decimal> dicIncrease;
        internal HisExpMestMaterialIncreaseThAmount()
            : base()
        {

        }

        internal HisExpMestMaterialIncreaseThAmount(CommonParam param)
            : base(param)
        {
