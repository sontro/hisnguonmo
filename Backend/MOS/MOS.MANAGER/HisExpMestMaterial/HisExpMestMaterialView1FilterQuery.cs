    ...
    public class HisExpMestMaterialView1FilterQuery : HisExpMestMaterialView1Filter
    {
        ...
        internal HisExpMestMaterialSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisExpMestMaterial1Expression.Add(o => o.EXP_MEST_ID.HasValue && this.EXP_MEST_IDs.Contains(o.EXP_MEST_ID.Value));
                }
                ...
                {
                    listVHisExpMestMaterial1Expression.Add(o => o.MATERIAL_ID.HasValue && this.MATERIAL_IDs.Contains(o.MATERIAL_ID.Value));
                }
