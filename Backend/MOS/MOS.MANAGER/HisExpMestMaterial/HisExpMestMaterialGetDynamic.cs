...
namespace MOS.MANAGER.HisExpMestMaterial
{
    ...
    {
        internal List<HisExpMestMaterialDTO> GetDynamic(HisExpMestMaterialFilterQuery filter)
        {
            try
            {
                ...
                return DAOWorker.HisExpMestMaterialDAO.GetDynamic(filter.Query(), param);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
