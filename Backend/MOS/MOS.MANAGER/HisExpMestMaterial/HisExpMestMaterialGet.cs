...
namespace MOS.MANAGER.HisExpMestMaterial
{
    partial class HisExpMestMaterialGet : GetBase
    {
        ...
        private List<HIS_IMP_MEST_MATERIAL> GetMobaImpMestMaterials(List<long> expMestIds)
        {
            if (IsNotNullOrEmpty(expMestIds))
            {
                ...
                if (IsNotNullOrEmpty(mobas))
                {
                    ...
                    return new HisImpMestMaterialGet().GetByImpMestIds(impMestIds);
                }
            }
            return null;
        }
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetHasSerialNumberByExpMestId(long expMestId)
        {
            try
            {
                HisExpMestMaterialFilterQuery filter = new HisExpMestMaterialFilterQuery();
                filter.EXP_MEST_ID = expMestId;
                filter.HAS_SERIAL_NUMBER = true;
                return this.Get(filter);
            }
            catch (Exception ex)
            {
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetHasNotSerialNumberByExpMestId(long expMestId)
        {
            try
            {
                HisExpMestMaterialFilterQuery filter = new HisExpMestMaterialFilterQuery();
                filter.EXP_MEST_ID = expMestId;
                filter.HAS_SERIAL_NUMBER = false;
                return this.Get(filter);
            }
            catch (Exception ex)
            {
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetByAggrExpMestId(long aggrExpMestId)
        {
            HisExpMestMaterialFilterQuery filter = new HisExpMestMaterialFilterQuery();
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetByAggrExpMestIdOrExpMestId(long expMestId)
        {
            HisExpMestMaterialFilterQuery filter = new HisExpMestMaterialFilterQuery();
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetByMaterialIds(List<long> ids)
        {
            try
            {
                HisExpMestMaterialFilterQuery filter = new HisExpMestMaterialFilterQuery();
                filter.MATERIAL_IDs = ids;
                return this.Get(filter);
            }
            catch (Exception ex)
            {
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetBySereServParentIds(List<long> sereServParentIds)
        {
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetByTreatmentId(long treatmentId)
        {
            HisExpMestMaterialFilterQuery filter = new HisExpMestMaterialFilterQuery();
        ...
        internal List<V_HIS_EXP_MEST_MATERIAL> GetViewByMaterialId(long id)
        {
            HisExpMestMaterialViewFilterQuery filter = new HisExpMestMaterialViewFilterQuery();
            filter.MATERIAL_ID = id;
            return this.GetView(filter);
        ...
        internal List<HIS_EXP_MEST_MATERIAL> GetByServiceReqId(long serviceReqId)
        {
            HisExpMestMaterialFilterQuery filter = new HisExpMestMaterialFilterQuery();
