    ...
    public class HisTreatmentBedRoomViewFilterQuery : HisTreatmentBedRoomViewFilter
    {
        ...
        internal HisTreatmentBedRoomSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisTreatmentBedRoomExpression.Add(o => !o.REMOVE_TIME.HasValue && (!o.IS_PAUSE.HasValue || o.IS_PAUSE != Constant.IS_TRUE));
                }
                if (this.IS_IN_ROOM.HasValue && !this.IS_IN_ROOM.Value)
                {
                    listVHisTreatmentBedRoomExpression.Add(o => o.REMOVE_TIME.HasValue || o.IS_PAUSE == Constant.IS_TRUE);
                }
                if (this.HAS_CO_TREATMENT_ID.HasValue)
                {
                    if (this.HAS_CO_TREATMENT_ID.Value)
                    {
                        listVHisTreatmentBedRoomExpression.Add(o => o.CO_TREATMENT_ID.HasValue);
                    }
                    else
                    {
                        listVHisTreatmentBedRoomExpression.Add(o => !o.CO_TREATMENT_ID.HasValue);
                ...
                {
                    listVHisTreatmentBedRoomExpression.Add(o => o.TREATMENT_IS_ACTIVE == Constant.IS_TRUE);
                }
                if (this.TREATMENT_IS_ACTIVE.HasValue && !this.TREATMENT_IS_ACTIVE.Value)
                {
                    listVHisTreatmentBedRoomExpression.Add(o => o.TREATMENT_IS_ACTIVE != Constant.IS_TRUE);
                ...
                {
                    listVHisTreatmentBedRoomExpression.Add(o => o.IS_PAUSE.HasValue && o.IS_PAUSE == Constant.IS_TRUE);
                }
                if (this.IS_PAUSE.HasValue && !this.IS_PAUSE.Value)
                {
                    listVHisTreatmentBedRoomExpression.Add(o => !o.IS_PAUSE.HasValue || o.IS_PAUSE != Constant.IS_TRUE);
                ...
                if (this.IS_APPROVE_FINISH.HasValue)
                {
                    ...
                    {
                        listVHisTreatmentBedRoomExpression.Add(o => o.IS_APPROVE_FINISH.HasValue && o.IS_APPROVE_FINISH.Value == Constant.IS_TRUE);
                    }
                    else
                    {
                        listVHisTreatmentBedRoomExpression.Add(o => !o.IS_APPROVE_FINISH.HasValue || o.IS_APPROVE_FINISH.Value != Constant.IS_TRUE);
