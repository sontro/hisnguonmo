...
{
    class HisMestPatientTypeLock : BusinessBase
    {
        internal HisMestPatientTypeLock()
            : base()
        {

        }

        internal HisMestPatientTypeLock(CommonParam paramLock)
            : base(paramLock)
        {

        }

        internal bool ChangeLock(HIS_MEST_PATIENT_TYPE data)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    data = new HisMestPatientTypeGet().GetById(data.ID);
                    if (data != null)
                    {
