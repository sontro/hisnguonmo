...
{
    partial class HisVitaminALock : BusinessBase
    {
        internal HisVitaminALock()
            : base()
        {

        }

        internal HisVitaminALock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_VITAMIN_A resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_VITAMIN_A data = new HisVitaminAGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisVitaminADAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_VITAMIN_A resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_VITAMIN_A resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisVitaminACheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisVitaminADAO.Update(raw);
