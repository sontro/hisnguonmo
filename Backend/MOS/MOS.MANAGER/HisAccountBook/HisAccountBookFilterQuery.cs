        ...
        internal HisAccountBookSO Query()
        {
            ...
            try
            {
                ...
                if (this.FOR_BILL.HasValue)
                {
                    ...
                    {
                        listHisAccountBookExpression.Add(o => o.IS_FOR_BILL.Value == MOS.UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        listHisAccountBookExpression.Add(o => o.IS_FOR_BILL.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                if (this.FOR_DEPOSIT.HasValue)
                {
                    ...
                    {
                        listHisAccountBookExpression.Add(o => o.IS_FOR_DEPOSIT.Value == MOS.UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        listHisAccountBookExpression.Add(o => o.IS_FOR_DEPOSIT.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                if (this.FOR_REPAY.HasValue)
                {
                    ...
                    {
                        listHisAccountBookExpression.Add(o => o.IS_FOR_REPAY.Value == MOS.UTILITY.Constant.IS_TRUE);
                    }
                    else
                    {
                        listHisAccountBookExpression.Add(o => o.IS_FOR_REPAY.Value != MOS.UTILITY.Constant.IS_TRUE);
                ...
                {
                    listHisAccountBookExpression.Add(o => o.ACCOUNT_BOOK_CODE == this.ACCOUNT_BOOK_CODE__EXACT);
                }
