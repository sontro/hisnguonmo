...
{
    partial class HisVaccinationReactLock : BusinessBase
    {
        internal HisVaccinationReactLock()
            : base()
        {

        }

        internal HisVaccinationReactLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_VACCINATION_REACT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_VACCINATION_REACT data = new HisVaccinationReactGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisVaccinationReactDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_VACCINATION_REACT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_VACCINATION_REACT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisVaccinationReactCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisVaccinationReactDAO.Update(raw);
