...
{
    class HisImpMestSttLock : BusinessBase
    {
        internal HisImpMestSttLock()
            : base()
        {

        }

        internal HisImpMestSttLock(CommonParam paramLock)
            : base(paramLock)
        {
        ...
        internal bool ChangeLock(long id)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    HIS_IMP_MEST_STT data = new HisImpMestSttGet().GetById(id);
                    if (data != null)
                    {
