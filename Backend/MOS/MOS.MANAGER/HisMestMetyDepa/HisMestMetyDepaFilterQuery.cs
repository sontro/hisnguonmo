    ...
    public class HisMestMetyDepaFilterQuery : HisMestMetyDepaFilter
    {
        ...
        internal HisMestMetyDepaSO Query()
        {
            ...
            try
            {
                ...
                {
                    listHisMestMetyDepaExpression.Add(o => o.MEDI_STOCK_ID.HasValue && this.MEDI_STOCK_IDs.Contains(o.MEDI_STOCK_ID.Value));
                }
                ...
                {
                    listHisMestMetyDepaExpression.Add(o => o.ID != this.ID__NOT_EQUAL.Value);
                }
                ...
                if (this.HAS_MEDI_STOCK_ID.HasValue)
                {
                    ...
                    {
                        listHisMestMetyDepaExpression.Add(o => o.MEDI_STOCK_ID.HasValue);
                    }
                    else
                    {
                        listHisMestMetyDepaExpression.Add(o => !o.MEDI_STOCK_ID.HasValue);
