...
{
    partial class HisVaccinationResultLock : BusinessBase
    {
        internal HisVaccinationResultLock()
            : base()
        {

        }

        internal HisVaccinationResultLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_VACCINATION_RESULT resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_VACCINATION_RESULT data = new HisVaccinationResultGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisVaccinationResultDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_VACCINATION_RESULT resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_VACCINATION_RESULT resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisVaccinationResultCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisVaccinationResultDAO.Update(raw);
