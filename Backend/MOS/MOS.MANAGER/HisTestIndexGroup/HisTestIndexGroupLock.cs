...
{
    partial class HisTestIndexGroupLock : BusinessBase
    {
        internal HisTestIndexGroupLock()
            : base()
        {

        }

        internal HisTestIndexGroupLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_TEST_INDEX_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_TEST_INDEX_GROUP data = new HisTestIndexGroupGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisTestIndexGroupDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_TEST_INDEX_GROUP resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_TEST_INDEX_GROUP resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisTestIndexGroupCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisTestIndexGroupDAO.Update(raw);
