...
{
    partial class HisVaexVaerLock : BusinessBase
    {
        internal HisVaexVaerLock()
            : base()
        {

        }

        internal HisVaexVaerLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_VAEX_VAER resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_VAEX_VAER data = new HisVaexVaerGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisVaexVaerDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_VAEX_VAER resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_VAEX_VAER resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisVaexVaerCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisVaexVaerDAO.Update(raw);
