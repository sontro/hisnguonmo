...
{
    partial class HisFormTypeCfgLock : BusinessBase
    {
        internal HisFormTypeCfgLock()
            : base()
        {

        }

        internal HisFormTypeCfgLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_FORM_TYPE_CFG resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_FORM_TYPE_CFG data = new HisFormTypeCfgGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisFormTypeCfgDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_FORM_TYPE_CFG resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_FORM_TYPE_CFG resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisFormTypeCfgCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisFormTypeCfgDAO.Update(raw);
