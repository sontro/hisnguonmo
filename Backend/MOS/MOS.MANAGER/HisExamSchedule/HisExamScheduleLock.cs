...
{
    partial class HisExamScheduleLock : BusinessBase
    {
        internal HisExamScheduleLock()
            : base()
        {

        }

        internal HisExamScheduleLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EXAM_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EXAM_SCHEDULE data = new HisExamScheduleGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisExamScheduleDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EXAM_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EXAM_SCHEDULE resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisExamScheduleCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisExamScheduleDAO.Update(raw);
