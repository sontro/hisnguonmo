...
{
    partial class HisRemunerationLock : BusinessBase
    {
        internal HisRemunerationLock()
            : base()
        {

        }

        internal HisRemunerationLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_REMUNERATION resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_REMUNERATION data = new HisRemunerationGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisRemunerationDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_REMUNERATION resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_REMUNERATION resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisRemunerationCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisRemunerationDAO.Update(raw);
