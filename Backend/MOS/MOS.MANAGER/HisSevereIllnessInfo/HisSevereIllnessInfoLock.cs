...
{
    partial class HisSevereIllnessInfoLock : BusinessBase
    {
        internal HisSevereIllnessInfoLock()
            : base()
        {

        }

        internal HisSevereIllnessInfoLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_SEVERE_ILLNESS_INFO resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_SEVERE_ILLNESS_INFO data = new HisSevereIllnessInfoGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisSevereIllnessInfoDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_SEVERE_ILLNESS_INFO resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_SEVERE_ILLNESS_INFO resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisSevereIllnessInfoCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisSevereIllnessInfoDAO.Update(raw);
