...
{
    partial class HisAntigenMetyLock : BusinessBase
    {
        internal HisAntigenMetyLock()
            : base()
        {

        }

        internal HisAntigenMetyLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_ANTIGEN_METY resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_ANTIGEN_METY data = new HisAntigenMetyGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisAntigenMetyDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_ANTIGEN_METY resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_ANTIGEN_METY resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisAntigenMetyCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisAntigenMetyDAO.Update(raw);
