...
{
    class HisServiceTypeCheck : BusinessBase
    {
        internal HisServiceTypeCheck()
            : base()
        {

        }

        internal HisServiceTypeCheck(Inventec.Core.CommonParam paramCheck)
            : base(paramCheck) 
        {
        ...
        /// <returns></returns>
        internal bool VerifyId(long id, ref HIS_SERVICE_TYPE data)
        {
            bool valid = true;
            try
            {
                data = new HisServiceTypeGet().GetById(id);
                if (data == null)
                {
        ...
        internal bool VerifyRequireField(HIS_SERVICE_TYPE data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool ExistsCode(string code, long? id)
        {
            ...
            try
            {
                if (DAOWorker.HisServiceTypeDAO.ExistsCode(code, id))
                {
        ...
        internal bool IsUnLock(HIS_SERVICE_TYPE data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool IsUnLock(long id)
        {
            ...
            try
            {
                if (!DAOWorker.HisServiceTypeDAO.IsUnLock(id))
                {
                    valid = false;
        ...
        internal bool CheckConstraint(long id)
        {
            ...
            try
            {
                List<HIS_SERVICE> hisServices = new HisServiceGet().GetByServiceTypeId(id);
