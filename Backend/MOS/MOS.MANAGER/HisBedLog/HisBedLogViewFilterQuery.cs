    ...
    public class HisBedLogViewFilterQuery : HisBedLogViewFilter
    {
        ...
        internal HisBedLogSO Query()
        {
            ...
            try
            {
                ...
                {
                    listVHisBedLogExpression.Add(o => !o.FINISH_TIME.HasValue || o.FINISH_TIME.Value >= this.FINISH_TIME_FROM__OR__NULL.Value);
                }
                ...
                {
                    listVHisBedLogExpression.Add(o => this.DEPARTMENT_IDs.Contains(o.DEPARTMENT_ID));
                }
