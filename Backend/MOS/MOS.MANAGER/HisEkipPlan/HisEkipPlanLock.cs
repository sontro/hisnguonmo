...
{
    partial class HisEkipPlanLock : BusinessBase
    {
        internal HisEkipPlanLock()
            : base()
        {

        }

        internal HisEkipPlanLock(CommonParam paramLock)
            : base(paramLock)
        {

        }
		
		internal bool Lock(long id, ref HIS_EKIP_PLAN resultData)
        {
            bool result = false;
            try
            {
                ...
                if (valid)
                {
                    HIS_EKIP_PLAN data = new HisEkipPlanGet().GetById(id);
                    if (data != null)
                    {
                        data.IS_ACTIVE = IMSys.DbConfig.HIS_RS.COMMON.IS_ACTIVE__FALSE;
                        result = DAOWorker.HisEkipPlanDAO.Update(data);
		...
		internal bool Unlock(long id, ref HIS_EKIP_PLAN resultData)
        {
            bool result = false;
            try
            {
        ...
        internal bool ChangeLock(long id, ref HIS_EKIP_PLAN resultData)
        {
            bool result = false;
            try
            {
                ...
                valid = valid && new HisEkipPlanCheck().VerifyId(id, ref raw);
                if (valid && raw != null)
                {
                    ...
                    result = DAOWorker.HisEkipPlanDAO.Update(raw);
