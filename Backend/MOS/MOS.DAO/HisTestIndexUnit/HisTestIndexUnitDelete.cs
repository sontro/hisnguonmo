...
{
    partial class HisTestIndexUnitDelete : EntityBase
    {
        public HisTestIndexUnitDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TEST_INDEX_UNIT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TEST_INDEX_UNIT> listIdNotFound = new List<HIS_TEST_INDEX_UNIT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TEST_INDEX_UNIT> listRaw = ctx.HIS_TEST_INDEX_UNIT.Where(o => listId.Contains(o.ID)).ToList();
