...
{
    partial class HisRationSumSttDelete : EntityBase
    {
        public HisRationSumSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_RATION_SUM_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_RATION_SUM_STT> listIdNotFound = new List<HIS_RATION_SUM_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_RATION_SUM_STT> listRaw = ctx.HIS_RATION_SUM_STT.Where(o => listId.Contains(o.ID)).ToList();
