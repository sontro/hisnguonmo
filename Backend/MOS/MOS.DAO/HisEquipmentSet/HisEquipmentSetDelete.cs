...
{
    partial class HisEquipmentSetDelete : EntityBase
    {
        public HisEquipmentSetDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EQUIPMENT_SET> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EQUIPMENT_SET> listIdNotFound = new List<HIS_EQUIPMENT_SET>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EQUIPMENT_SET> listRaw = ctx.HIS_EQUIPMENT_SET.Where(o => listId.Contains(o.ID)).ToList();
