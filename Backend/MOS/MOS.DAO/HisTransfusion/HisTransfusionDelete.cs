...
{
    partial class HisTransfusionDelete : EntityBase
    {
        public HisTransfusionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRANSFUSION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRANSFUSION> listIdNotFound = new List<HIS_TRANSFUSION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRANSFUSION> listRaw = ctx.HIS_TRANSFUSION.Where(o => listId.Contains(o.ID)).ToList();
