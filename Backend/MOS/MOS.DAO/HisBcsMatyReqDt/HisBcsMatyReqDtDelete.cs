...
{
    partial class HisBcsMatyReqDtDelete : EntityBase
    {
        public HisBcsMatyReqDtDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BCS_MATY_REQ_DT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BCS_MATY_REQ_DT> listIdNotFound = new List<HIS_BCS_MATY_REQ_DT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BCS_MATY_REQ_DT> listRaw = ctx.HIS_BCS_MATY_REQ_DT.Where(o => listId.Contains(o.ID)).ToList();
