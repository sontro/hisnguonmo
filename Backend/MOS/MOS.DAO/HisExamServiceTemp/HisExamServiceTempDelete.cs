...
{
    partial class HisExamServiceTempDelete : EntityBase
    {
        public HisExamServiceTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXAM_SERVICE_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXAM_SERVICE_TEMP> listIdNotFound = new List<HIS_EXAM_SERVICE_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXAM_SERVICE_TEMP> listRaw = ctx.HIS_EXAM_SERVICE_TEMP.Where(o => listId.Contains(o.ID)).ToList();
