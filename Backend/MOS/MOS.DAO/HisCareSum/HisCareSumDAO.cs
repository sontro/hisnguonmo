...
namespace MOS.DAO.HisCareSum
{
    ...
    {
        private HisCareSumCreate CreateWorker
        {
            get
            {
                return (HisCareSumCreate)Worker.Get<HisCareSumCreate>();
            }
        }
        private HisCareSumUpdate UpdateWorker
        {
            get
            {
                return (HisCareSumUpdate)Worker.Get<HisCareSumUpdate>();
            }
        }
        private HisCareSumDelete DeleteWorker
        {
            get
            {
                return (HisCareSumDelete)Worker.Get<HisCareSumDelete>();
            }
        }
        private HisCareSumTruncate TruncateWorker
        {
            get
            {
                return (HisCareSumTruncate)Worker.Get<HisCareSumTruncate>();
            }
        }
        ...
        private HisCareSumCheck CheckWorker
        {
            get
            {
                return (HisCareSumCheck)Worker.Get<HisCareSumCheck>();
            }
        }
