...
{
    partial class HisPtttPriorityDelete : EntityBase
    {
        public HisPtttPriorityDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_PRIORITY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_PRIORITY> listIdNotFound = new List<HIS_PTTT_PRIORITY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_PRIORITY> listRaw = ctx.HIS_PTTT_PRIORITY.Where(o => listId.Contains(o.ID)).ToList();
