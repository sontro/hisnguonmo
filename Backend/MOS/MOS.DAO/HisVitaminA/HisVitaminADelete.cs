...
{
    partial class HisVitaminADelete : EntityBase
    {
        public HisVitaminADelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VITAMIN_A> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VITAMIN_A> listIdNotFound = new List<HIS_VITAMIN_A>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VITAMIN_A> listRaw = ctx.HIS_VITAMIN_A.Where(o => listId.Contains(o.ID)).ToList();
