...
{
    partial class HisAccidentCareDelete : EntityBase
    {
        public HisAccidentCareDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_CARE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_CARE> listIdNotFound = new List<HIS_ACCIDENT_CARE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_CARE> listRaw = ctx.HIS_ACCIDENT_CARE.Where(o => listId.Contains(o.ID)).ToList();
