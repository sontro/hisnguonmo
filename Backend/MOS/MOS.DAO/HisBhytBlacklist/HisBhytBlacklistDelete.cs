...
{
    partial class HisBhytBlacklistDelete : EntityBase
    {
        public HisBhytBlacklistDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BHYT_BLACKLIST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BHYT_BLACKLIST> listIdNotFound = new List<HIS_BHYT_BLACKLIST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BHYT_BLACKLIST> listRaw = ctx.HIS_BHYT_BLACKLIST.Where(o => listId.Contains(o.ID)).ToList();
