...
{
    partial class HisDeathCauseDelete : EntityBase
    {
        public HisDeathCauseDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEATH_CAUSE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEATH_CAUSE> listIdNotFound = new List<HIS_DEATH_CAUSE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEATH_CAUSE> listRaw = ctx.HIS_DEATH_CAUSE.Where(o => listId.Contains(o.ID)).ToList();
