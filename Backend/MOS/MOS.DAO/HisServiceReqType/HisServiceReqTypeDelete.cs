...
{
    partial class HisServiceReqTypeDelete : EntityBase
    {
        public HisServiceReqTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_REQ_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_REQ_TYPE> listIdNotFound = new List<HIS_SERVICE_REQ_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_REQ_TYPE> listRaw = ctx.HIS_SERVICE_REQ_TYPE.Where(o => listId.Contains(o.ID)).ToList();
