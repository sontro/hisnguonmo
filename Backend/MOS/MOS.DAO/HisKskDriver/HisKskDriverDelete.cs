...
{
    partial class HisKskDriverDelete : EntityBase
    {
        public HisKskDriverDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_DRIVER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_DRIVER> listIdNotFound = new List<HIS_KSK_DRIVER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_DRIVER> listRaw = ctx.HIS_KSK_DRIVER.Where(o => listId.Contains(o.ID)).ToList();
