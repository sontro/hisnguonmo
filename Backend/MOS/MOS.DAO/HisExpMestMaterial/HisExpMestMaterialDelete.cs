...
{
    partial class HisExpMestMaterialDelete : EntityBase
    {
        public HisExpMestMaterialDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_MATERIAL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_MATERIAL> listIdNotFound = new List<HIS_EXP_MEST_MATERIAL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_MATERIAL> listRaw = ctx.HIS_EXP_MEST_MATERIAL.Where(o => listId.Contains(o.ID)).ToList();
