...
{
    partial class HisInvoicePrintDelete : EntityBase
    {
        public HisInvoicePrintDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_INVOICE_PRINT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_INVOICE_PRINT> listIdNotFound = new List<HIS_INVOICE_PRINT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_INVOICE_PRINT> listRaw = ctx.HIS_INVOICE_PRINT.Where(o => listId.Contains(o.ID)).ToList();
