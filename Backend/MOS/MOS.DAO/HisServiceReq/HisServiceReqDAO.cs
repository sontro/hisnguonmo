...
namespace MOS.DAO.HisServiceReq
{
    ...
    {
        private HisServiceReqCreate CreateWorker
        {
            get
            {
                return (HisServiceReqCreate)Worker.Get<HisServiceReqCreate>();
            }
        }
        private HisServiceReqUpdate UpdateWorker
        {
            get
            {
                return (HisServiceReqUpdate)Worker.Get<HisServiceReqUpdate>();
            }
        }
        private HisServiceReqDelete DeleteWorker
        {
            get
            {
                return (HisServiceReqDelete)Worker.Get<HisServiceReqDelete>();
            }
        }
        private HisServiceReqTruncate TruncateWorker
        {
            get
            {
                return (HisServiceReqTruncate)Worker.Get<HisServiceReqTruncate>();
            }
        }
        ...
        private HisServiceReqCheck CheckWorker
        {
            get
            {
                return (HisServiceReqCheck)Worker.Get<HisServiceReqCheck>();
            }
        }
        ...
        public bool Delete(HIS_SERVICE_REQ data)
        {
            bool result = false;
            try
            {
        ...
        public bool DeleteList(List<HIS_SERVICE_REQ> listData)
        {
            bool result = false;
