...
{
    partial class HisServiceReqDelete : EntityBase
    {
        public HisServiceReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_REQ> listIdNotFound = new List<HIS_SERVICE_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_REQ> listRaw = ctx.HIS_SERVICE_REQ.Where(o => listId.Contains(o.ID)).ToList();
