...
{
    partial class HisSereServTeinDelete : EntityBase
    {
        public HisSereServTeinDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_TEIN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_TEIN> listIdNotFound = new List<HIS_SERE_SERV_TEIN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_TEIN> listRaw = ctx.HIS_SERE_SERV_TEIN.Where(o => listId.Contains(o.ID)).ToList();
