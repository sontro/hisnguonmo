...
{
    partial class HisAntigenMetyDelete : EntityBase
    {
        public HisAntigenMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTIGEN_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTIGEN_METY> listIdNotFound = new List<HIS_ANTIGEN_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTIGEN_METY> listRaw = ctx.HIS_ANTIGEN_METY.Where(o => listId.Contains(o.ID)).ToList();
