...
{
    partial class HisMediReactSumDelete : EntityBase
    {
        public HisMediReactSumDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_REACT_SUM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_REACT_SUM> listIdNotFound = new List<HIS_MEDI_REACT_SUM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_REACT_SUM> listRaw = ctx.HIS_MEDI_REACT_SUM.Where(o => listId.Contains(o.ID)).ToList();
