...
{
    partial class HisMestPeriodBltyDelete : EntityBase
    {
        public HisMestPeriodBltyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PERIOD_BLTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PERIOD_BLTY> listIdNotFound = new List<HIS_MEST_PERIOD_BLTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PERIOD_BLTY> listRaw = ctx.HIS_MEST_PERIOD_BLTY.Where(o => listId.Contains(o.ID)).ToList();
