...
{
    partial class HisEmrFormDelete : EntityBase
    {
        public HisEmrFormDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMR_FORM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMR_FORM> listIdNotFound = new List<HIS_EMR_FORM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMR_FORM> listRaw = ctx.HIS_EMR_FORM.Where(o => listId.Contains(o.ID)).ToList();
