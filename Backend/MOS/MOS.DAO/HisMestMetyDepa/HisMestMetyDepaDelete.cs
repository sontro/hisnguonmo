...
{
    partial class HisMestMetyDepaDelete : EntityBase
    {
        public HisMestMetyDepaDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_METY_DEPA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_METY_DEPA> listIdNotFound = new List<HIS_MEST_METY_DEPA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_METY_DEPA> listRaw = ctx.HIS_MEST_METY_DEPA.Where(o => listId.Contains(o.ID)).ToList();
