...
{
    partial class HisRehaTrainTypeDelete : EntityBase
    {
        public HisRehaTrainTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REHA_TRAIN_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REHA_TRAIN_TYPE> listIdNotFound = new List<HIS_REHA_TRAIN_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REHA_TRAIN_TYPE> listRaw = ctx.HIS_REHA_TRAIN_TYPE.Where(o => listId.Contains(o.ID)).ToList();
