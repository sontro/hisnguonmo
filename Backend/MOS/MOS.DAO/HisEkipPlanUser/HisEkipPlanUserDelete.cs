...
{
    partial class HisEkipPlanUserDelete : EntityBase
    {
        public HisEkipPlanUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EKIP_PLAN_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EKIP_PLAN_USER> listIdNotFound = new List<HIS_EKIP_PLAN_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EKIP_PLAN_USER> listRaw = ctx.HIS_EKIP_PLAN_USER.Where(o => listId.Contains(o.ID)).ToList();
