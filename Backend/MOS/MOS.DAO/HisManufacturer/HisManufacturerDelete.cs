...
{
    partial class HisManufacturerDelete : EntityBase
    {
        public HisManufacturerDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MANUFACTURER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MANUFACTURER> listIdNotFound = new List<HIS_MANUFACTURER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MANUFACTURER> listRaw = ctx.HIS_MANUFACTURER.Where(o => listId.Contains(o.ID)).ToList();
