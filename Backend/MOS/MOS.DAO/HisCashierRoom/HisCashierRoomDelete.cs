...
{
    partial class HisCashierRoomDelete : EntityBase
    {
        public HisCashierRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CASHIER_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CASHIER_ROOM> listIdNotFound = new List<HIS_CASHIER_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CASHIER_ROOM> listRaw = ctx.HIS_CASHIER_ROOM.Where(o => listId.Contains(o.ID)).ToList();
