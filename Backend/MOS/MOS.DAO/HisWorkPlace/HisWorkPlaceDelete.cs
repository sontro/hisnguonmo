...
{
    partial class HisWorkPlaceDelete : EntityBase
    {
        public HisWorkPlaceDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_WORK_PLACE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_WORK_PLACE> listIdNotFound = new List<HIS_WORK_PLACE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_WORK_PLACE> listRaw = ctx.HIS_WORK_PLACE.Where(o => listId.Contains(o.ID)).ToList();
