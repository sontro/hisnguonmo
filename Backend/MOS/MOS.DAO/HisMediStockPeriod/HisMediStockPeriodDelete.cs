...
{
    partial class HisMediStockPeriodDelete : EntityBase
    {
        public HisMediStockPeriodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_STOCK_PERIOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_STOCK_PERIOD> listIdNotFound = new List<HIS_MEDI_STOCK_PERIOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_STOCK_PERIOD> listRaw = ctx.HIS_MEDI_STOCK_PERIOD.Where(o => listId.Contains(o.ID)).ToList();
