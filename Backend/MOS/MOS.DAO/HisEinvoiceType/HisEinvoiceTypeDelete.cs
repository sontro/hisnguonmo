...
{
    partial class HisEinvoiceTypeDelete : EntityBase
    {
        public HisEinvoiceTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EINVOICE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EINVOICE_TYPE> listIdNotFound = new List<HIS_EINVOICE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EINVOICE_TYPE> listRaw = ctx.HIS_EINVOICE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
