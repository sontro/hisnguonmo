...
{
    partial class HisMediContractMetyDelete : EntityBase
    {
        public HisMediContractMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_CONTRACT_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_CONTRACT_METY> listIdNotFound = new List<HIS_MEDI_CONTRACT_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_CONTRACT_METY> listRaw = ctx.HIS_MEDI_CONTRACT_METY.Where(o => listId.Contains(o.ID)).ToList();
