...
{
    partial class HisVaccReactPlaceDelete : EntityBase
    {
        public HisVaccReactPlaceDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACC_REACT_PLACE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACC_REACT_PLACE> listIdNotFound = new List<HIS_VACC_REACT_PLACE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACC_REACT_PLACE> listRaw = ctx.HIS_VACC_REACT_PLACE.Where(o => listId.Contains(o.ID)).ToList();
