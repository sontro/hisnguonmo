...
{
    partial class HisExamSereDireDelete : EntityBase
    {
        public HisExamSereDireDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXAM_SERE_DIRE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXAM_SERE_DIRE> listIdNotFound = new List<HIS_EXAM_SERE_DIRE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXAM_SERE_DIRE> listRaw = ctx.HIS_EXAM_SERE_DIRE.Where(o => listId.Contains(o.ID)).ToList();
