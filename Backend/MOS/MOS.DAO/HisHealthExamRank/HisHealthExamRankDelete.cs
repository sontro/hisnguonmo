...
{
    partial class HisHealthExamRankDelete : EntityBase
    {
        public HisHealthExamRankDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HEALTH_EXAM_RANK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HEALTH_EXAM_RANK> listIdNotFound = new List<HIS_HEALTH_EXAM_RANK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HEALTH_EXAM_RANK> listRaw = ctx.HIS_HEALTH_EXAM_RANK.Where(o => listId.Contains(o.ID)).ToList();
