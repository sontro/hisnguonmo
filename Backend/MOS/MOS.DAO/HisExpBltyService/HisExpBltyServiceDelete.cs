...
{
    partial class HisExpBltyServiceDelete : EntityBase
    {
        public HisExpBltyServiceDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_BLTY_SERVICE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_BLTY_SERVICE> listIdNotFound = new List<HIS_EXP_BLTY_SERVICE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_BLTY_SERVICE> listRaw = ctx.HIS_EXP_BLTY_SERVICE.Where(o => listId.Contains(o.ID)).ToList();
