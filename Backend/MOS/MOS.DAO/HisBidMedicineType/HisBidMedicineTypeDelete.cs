...
{
    partial class HisBidMedicineTypeDelete : EntityBase
    {
        public HisBidMedicineTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BID_MEDICINE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BID_MEDICINE_TYPE> listIdNotFound = new List<HIS_BID_MEDICINE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BID_MEDICINE_TYPE> listRaw = ctx.HIS_BID_MEDICINE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
