...
{
    partial class HisPatientTypeAlterDelete : EntityBase
    {
        public HisPatientTypeAlterDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PATIENT_TYPE_ALTER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PATIENT_TYPE_ALTER> listIdNotFound = new List<HIS_PATIENT_TYPE_ALTER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PATIENT_TYPE_ALTER> listRaw = ctx.HIS_PATIENT_TYPE_ALTER.Where(o => listId.Contains(o.ID)).ToList();
