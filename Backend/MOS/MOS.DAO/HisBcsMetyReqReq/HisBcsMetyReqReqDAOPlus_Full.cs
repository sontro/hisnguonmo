...
namespace MOS.DAO.HisBcsMetyReqReq
{
    public partial class HisBcsMetyReqReqDAO : EntityBase
    {
        ...
        public HIS_BCS_METY_REQ_REQ GetByCode(string code, HisBcsMetyReqReqSO search)
        {
        ...
        public V_HIS_BCS_METY_REQ_REQ GetViewByCode(string code, HisBcsMetyReqReqSO search)
        {
            V_HIS_BCS_METY_REQ_REQ result = null;
        ...
        public Dictionary<string, HIS_BCS_METY_REQ_REQ> GetDicByCode(HisBcsMetyReqReqSO search, CommonParam param)
        {
            Dictionary<string, HIS_BCS_METY_REQ_REQ> result = new Dictionary<string, HIS_BCS_METY_REQ_REQ>();
            try
            {
