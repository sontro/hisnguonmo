...
{
    partial class HisTransfusionSumDelete : EntityBase
    {
        public HisTransfusionSumDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRANSFUSION_SUM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRANSFUSION_SUM> listIdNotFound = new List<HIS_TRANSFUSION_SUM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRANSFUSION_SUM> listRaw = ctx.HIS_TRANSFUSION_SUM.Where(o => listId.Contains(o.ID)).ToList();
