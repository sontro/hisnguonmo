...
namespace MOS.DAO.StagingObject
{
    public class HisRoomSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<L_HIS_ROOM_COUNTER, bool>>> listLHisRoomCounterExpression = new List<System.Linq.Expressions.Expression<Func<L_HIS_ROOM_COUNTER, bool>>>();
        public List<System.Linq.Expressions.Expression<Func<L_HIS_ROOM_COUNTER_1, bool>>> listLHisRoomCounter1Expression = new List<System.Linq.Expressions.Expression<Func<L_HIS_ROOM_COUNTER_1, bool>>>();
    }
}
