...
namespace MOS.DAO.StagingObject
{
    public class HisKskContractSO : StagingObjectBase
    {
        public HisKskContractSO()
        {
            ...
            listVHisKskContractExpression.Add(o => !o.IS_DELETE.HasValue || o.IS_DELETE.Value != (short)1);
        }
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_KSK_CONTRACT, bool>>> listVHisKskContractExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_KSK_CONTRACT, bool>>>();
    }
}
