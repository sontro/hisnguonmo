...
namespace MOS.DAO.StagingObject
{
    public class HisDebateSO : StagingObjectBase
    {
        public HisDebateSO()
        {
            ...
            listVHisDebateExpression.Add(o => !o.IS_DELETE.HasValue || o.IS_DELETE.Value != (short)1);
        }
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_DEBATE, bool>>> listVHisDebateExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_DEBATE, bool>>>();
    }
}
