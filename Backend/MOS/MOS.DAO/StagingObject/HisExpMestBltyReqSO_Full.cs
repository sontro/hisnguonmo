...
namespace MOS.DAO.StagingObject
{
    public class HisExpMestBltyReqSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_EXP_MEST_BLTY_REQ_2, bool>>> listVHisExpMestBltyReq2Expression = new List<System.Linq.Expressions.Expression<Func<V_HIS_EXP_MEST_BLTY_REQ_2, bool>>>();
    }
}
