...
namespace MOS.DAO.StagingObject
{
    public class HisExpMestMetyReqSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<L_HIS_EXP_MEST_METY_REQ, bool>>> listLHisExpMestMetyReqExpression = new List<System.Linq.Expressions.Expression<Func<L_HIS_EXP_MEST_METY_REQ, bool>>>();
    }
}
