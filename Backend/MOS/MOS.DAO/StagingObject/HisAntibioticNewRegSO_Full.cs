...
namespace MOS.DAO.StagingObject
{
    public class HisAntibioticNewRegSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_ANTIBIOTIC_NEW_REG, bool>>> listVHisAntibioticNewRegExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_ANTIBIOTIC_NEW_REG, bool>>>();
    }
}
