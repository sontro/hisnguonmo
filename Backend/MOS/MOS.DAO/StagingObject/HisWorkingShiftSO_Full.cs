...
namespace MOS.DAO.StagingObject
{
    public class HisWorkingShiftSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_WORKING_SHIFT, bool>>> listVHisWorkingShiftExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_WORKING_SHIFT, bool>>>();
    }
}
