...
namespace MOS.DAO.StagingObject
{
    public class HisRationScheduleSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_RATION_SCHEDULE, bool>>> listVHisRationScheduleExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_RATION_SCHEDULE, bool>>>();
    }
}
