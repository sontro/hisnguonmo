...
namespace MOS.DAO.StagingObject
{
    public class HisExpiredDateCfgSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_EXPIRED_DATE_CFG, bool>>> listVHisExpiredDateCfgExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_EXPIRED_DATE_CFG, bool>>>();
    }
}
