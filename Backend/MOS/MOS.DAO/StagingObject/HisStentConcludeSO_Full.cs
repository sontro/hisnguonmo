...
namespace MOS.DAO.StagingObject
{
    public class HisStentConcludeSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_STENT_CONCLUDE, bool>>> listVHisStentConcludeExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_STENT_CONCLUDE, bool>>>();
    }
}
