...
namespace MOS.DAO.StagingObject
{
    public class HisMedicineBeanSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<L_HIS_MEDICINE_BEAN, bool>>> listLHisMedicineBeanExpression = new List<System.Linq.Expressions.Expression<Func<L_HIS_MEDICINE_BEAN, bool>>>();
    }
}
