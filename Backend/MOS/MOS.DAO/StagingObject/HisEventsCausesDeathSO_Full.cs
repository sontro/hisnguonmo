...
namespace MOS.DAO.StagingObject
{
    public class HisEventsCausesDeathSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_EVENTS_CAUSES_DEATH, bool>>> listVHisEventsCausesDeathExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_EVENTS_CAUSES_DEATH, bool>>>();
    }
}
