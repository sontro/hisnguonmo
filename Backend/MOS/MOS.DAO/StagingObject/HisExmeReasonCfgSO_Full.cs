...
namespace MOS.DAO.StagingObject
{
    public class HisExmeReasonCfgSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_EXME_REASON_CFG, bool>>> listVHisExmeReasonCfgExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_EXME_REASON_CFG, bool>>>();
    }
}
