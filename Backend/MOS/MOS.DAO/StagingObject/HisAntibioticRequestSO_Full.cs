...
namespace MOS.DAO.StagingObject
{
    public class HisAntibioticRequestSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_ANTIBIOTIC_REQUEST, bool>>> listVHisAntibioticRequestExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_ANTIBIOTIC_REQUEST, bool>>>();
    }
}
