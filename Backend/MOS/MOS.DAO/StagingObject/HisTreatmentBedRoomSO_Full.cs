...
namespace MOS.DAO.StagingObject
{
    public class HisTreatmentBedRoomSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_TREATMENT_BED_ROOM_1, bool>>> listVHisTreatmentBedRoom1Expression = new List<System.Linq.Expressions.Expression<Func<V_HIS_TREATMENT_BED_ROOM_1, bool>>>();
        public List<System.Linq.Expressions.Expression<Func<L_HIS_TREATMENT_BED_ROOM, bool>>> listLHisTreatmentBedRoomExpression = new List<System.Linq.Expressions.Expression<Func<L_HIS_TREATMENT_BED_ROOM, bool>>>();
    }
}
