...
namespace MOS.DAO.StagingObject
{
    public class HisImpMestSO : StagingObjectBase
    {
        public HisImpMestSO()
        {
            ...
            listVHisImpMest1Expression.Add(o => !o.IS_DELETE.HasValue || o.IS_DELETE.Value != (short)1);
            listVHisImpMest2Expression.Add(o => !o.IS_DELETE.HasValue || o.IS_DELETE.Value != (short)1);
            listVHisImpMestManuExpression.Add(o => !o.IS_DELETE.HasValue || o.IS_DELETE.Value != (short)1);
        }
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_IMP_MEST_2, bool>>> listVHisImpMest2Expression = new List<System.Linq.Expressions.Expression<Func<V_HIS_IMP_MEST_2, bool>>>();
