...
namespace MOS.DAO.StagingObject
{
    public class HisObeyContraindiSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_OBEY_CONTRAINDI, bool>>> listVHisObeyContraindiExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_OBEY_CONTRAINDI, bool>>>();
    }
}
