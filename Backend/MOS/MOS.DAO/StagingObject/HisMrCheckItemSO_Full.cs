...
namespace MOS.DAO.StagingObject
{
    public class HisMrCheckItemSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_MR_CHECK_ITEM, bool>>> listVHisMrCheckItemExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_MR_CHECK_ITEM, bool>>>();
    }
}
