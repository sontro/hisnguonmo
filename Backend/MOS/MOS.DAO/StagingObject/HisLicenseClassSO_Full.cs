...
namespace MOS.DAO.StagingObject
{
    public class HisLicenseClassSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_LICENSE_CLASS, bool>>> listVHisLicenseClassExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_LICENSE_CLASS, bool>>>();
    }
}
