...
namespace MOS.DAO.StagingObject
{
    public class HisMrCheckSummarySO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_HIS_MR_CHECK_SUMMARY, bool>>> listVHisMrCheckSummaryExpression = new List<System.Linq.Expressions.Expression<Func<V_HIS_MR_CHECK_SUMMARY, bool>>>();
    }
}
