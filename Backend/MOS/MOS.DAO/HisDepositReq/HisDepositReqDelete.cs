...
{
    partial class HisDepositReqDelete : EntityBase
    {
        public HisDepositReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEPOSIT_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEPOSIT_REQ> listIdNotFound = new List<HIS_DEPOSIT_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEPOSIT_REQ> listRaw = ctx.HIS_DEPOSIT_REQ.Where(o => listId.Contains(o.ID)).ToList();
