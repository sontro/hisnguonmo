...
{
    partial class HisPatientTypeAllowDelete : EntityBase
    {
        public HisPatientTypeAllowDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PATIENT_TYPE_ALLOW> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PATIENT_TYPE_ALLOW> listIdNotFound = new List<HIS_PATIENT_TYPE_ALLOW>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PATIENT_TYPE_ALLOW> listRaw = ctx.HIS_PATIENT_TYPE_ALLOW.Where(o => listId.Contains(o.ID)).ToList();
