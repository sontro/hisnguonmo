...
{
    partial class HisPeriodDriverDityDelete : EntityBase
    {
        public HisPeriodDriverDityDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PERIOD_DRIVER_DITY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PERIOD_DRIVER_DITY> listIdNotFound = new List<HIS_PERIOD_DRIVER_DITY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PERIOD_DRIVER_DITY> listRaw = ctx.HIS_PERIOD_DRIVER_DITY.Where(o => listId.Contains(o.ID)).ToList();
