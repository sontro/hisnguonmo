...
{
    partial class HisTreatmentLoggingDelete : EntityBase
    {
        public HisTreatmentLoggingDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_LOGGING> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_LOGGING> listIdNotFound = new List<HIS_TREATMENT_LOGGING>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_LOGGING> listRaw = ctx.HIS_TREATMENT_LOGGING.Where(o => listId.Contains(o.ID)).ToList();
