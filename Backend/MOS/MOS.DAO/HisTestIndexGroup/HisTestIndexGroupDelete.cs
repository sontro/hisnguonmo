...
{
    partial class HisTestIndexGroupDelete : EntityBase
    {
        public HisTestIndexGroupDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TEST_INDEX_GROUP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TEST_INDEX_GROUP> listIdNotFound = new List<HIS_TEST_INDEX_GROUP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TEST_INDEX_GROUP> listRaw = ctx.HIS_TEST_INDEX_GROUP.Where(o => listId.Contains(o.ID)).ToList();
