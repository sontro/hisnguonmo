...
{
    partial class HisLicenseClassDelete : EntityBase
    {
        public HisLicenseClassDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_LICENSE_CLASS> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_LICENSE_CLASS> listIdNotFound = new List<HIS_LICENSE_CLASS>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_LICENSE_CLASS> listRaw = ctx.HIS_LICENSE_CLASS.Where(o => listId.Contains(o.ID)).ToList();
