...
{
    partial class HisImpMestMaterialDelete : EntityBase
    {
        public HisImpMestMaterialDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_MATERIAL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_MATERIAL> listIdNotFound = new List<HIS_IMP_MEST_MATERIAL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_MATERIAL> listRaw = ctx.HIS_IMP_MEST_MATERIAL.Where(o => listId.Contains(o.ID)).ToList();
