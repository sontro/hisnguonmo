...
{
    partial class HisInteractiveGradeDelete : EntityBase
    {
        public HisInteractiveGradeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_INTERACTIVE_GRADE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_INTERACTIVE_GRADE> listIdNotFound = new List<HIS_INTERACTIVE_GRADE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_INTERACTIVE_GRADE> listRaw = ctx.HIS_INTERACTIVE_GRADE.Where(o => listId.Contains(o.ID)).ToList();
