...
{
    partial class HisImpUserTempDtDelete : EntityBase
    {
        public HisImpUserTempDtDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_USER_TEMP_DT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_USER_TEMP_DT> listIdNotFound = new List<HIS_IMP_USER_TEMP_DT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_USER_TEMP_DT> listRaw = ctx.HIS_IMP_USER_TEMP_DT.Where(o => listId.Contains(o.ID)).ToList();
