...
{
    partial class HisWorkingShiftDelete : EntityBase
    {
        public HisWorkingShiftDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_WORKING_SHIFT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_WORKING_SHIFT> listIdNotFound = new List<HIS_WORKING_SHIFT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_WORKING_SHIFT> listRaw = ctx.HIS_WORKING_SHIFT.Where(o => listId.Contains(o.ID)).ToList();
