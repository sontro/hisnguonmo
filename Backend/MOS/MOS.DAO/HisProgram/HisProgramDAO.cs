...
namespace MOS.DAO.HisProgram
{
    ...
    {
        private HisProgramCreate CreateWorker
        {
            get
            {
                return (HisProgramCreate)Worker.Get<HisProgramCreate>();
            }
        }
        private HisProgramUpdate UpdateWorker
        {
            get
            {
                return (HisProgramUpdate)Worker.Get<HisProgramUpdate>();
            }
        }
        private HisProgramDelete DeleteWorker
        {
            get
            {
                return (HisProgramDelete)Worker.Get<HisProgramDelete>();
            }
        }
        private HisProgramTruncate TruncateWorker
        {
            get
            {
                return (HisProgramTruncate)Worker.Get<HisProgramTruncate>();
            }
        }
        ...
        private HisProgramCheck CheckWorker
        {
            get
            {
                return (HisProgramCheck)Worker.Get<HisProgramCheck>();
            }
        }
        ...
        public bool Delete(HIS_PROGRAM data)
        {
            bool result = false;
            try
            {
        ...
        public bool DeleteList(List<HIS_PROGRAM> listData)
        {
            bool result = false;
