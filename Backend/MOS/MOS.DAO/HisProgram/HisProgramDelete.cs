...
{
    partial class HisProgramDelete : EntityBase
    {
        public HisProgramDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PROGRAM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PROGRAM> listIdNotFound = new List<HIS_PROGRAM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PROGRAM> listRaw = ctx.HIS_PROGRAM.Where(o => listId.Contains(o.ID)).ToList();
