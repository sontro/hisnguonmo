...
namespace MOS.DAO.HisProgram
{
    public partial class HisProgramDAO : EntityBase
    {
        ...
        {
            List<V_HIS_PROGRAM> result = new List<V_HIS_PROGRAM>();
        ...
        public V_HIS_PROGRAM GetViewById(long id, HisProgramSO search)
        {
            V_HIS_PROGRAM result = null;
        ...
        public V_HIS_PROGRAM GetViewByCode(string code, HisProgramSO search)
        {
            V_HIS_PROGRAM result = null;
