...
{
    partial class HisMachineServMatyDelete : EntityBase
    {
        public HisMachineServMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MACHINE_SERV_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MACHINE_SERV_MATY> listIdNotFound = new List<HIS_MACHINE_SERV_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MACHINE_SERV_MATY> listRaw = ctx.HIS_MACHINE_SERV_MATY.Where(o => listId.Contains(o.ID)).ToList();
