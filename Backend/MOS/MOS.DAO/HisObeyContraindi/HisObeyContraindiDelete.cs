...
{
    partial class HisObeyContraindiDelete : EntityBase
    {
        public HisObeyContraindiDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_OBEY_CONTRAINDI> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_OBEY_CONTRAINDI> listIdNotFound = new List<HIS_OBEY_CONTRAINDI>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_OBEY_CONTRAINDI> listRaw = ctx.HIS_OBEY_CONTRAINDI.Where(o => listId.Contains(o.ID)).ToList();
