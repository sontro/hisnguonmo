...
namespace MOS.DAO.HisCareer
{
    ...
    {
        private HisCareerCreate CreateWorker
        {
            get
            {
                return (HisCareerCreate)Worker.Get<HisCareerCreate>();
            }
        }
        private HisCareerUpdate UpdateWorker
        {
            get
            {
                return (HisCareerUpdate)Worker.Get<HisCareerUpdate>();
            }
        }
        private HisCareerDelete DeleteWorker
        {
            get
            {
                return (HisCareerDelete)Worker.Get<HisCareerDelete>();
            }
        }
        private HisCareerTruncate TruncateWorker
        {
            get
            {
                return (HisCareerTruncate)Worker.Get<HisCareerTruncate>();
            }
        }
        ...
        private HisCareerCheck CheckWorker
        {
            get
            {
                return (HisCareerCheck)Worker.Get<HisCareerCheck>();
            }
        }
