...
{
    partial class HisContraindicationDelete : EntityBase
    {
        public HisContraindicationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CONTRAINDICATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CONTRAINDICATION> listIdNotFound = new List<HIS_CONTRAINDICATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CONTRAINDICATION> listRaw = ctx.HIS_CONTRAINDICATION.Where(o => listId.Contains(o.ID)).ToList();
