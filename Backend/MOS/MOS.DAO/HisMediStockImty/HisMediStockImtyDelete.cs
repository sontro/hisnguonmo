...
{
    partial class HisMediStockImtyDelete : EntityBase
    {
        public HisMediStockImtyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_STOCK_IMTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_STOCK_IMTY> listIdNotFound = new List<HIS_MEDI_STOCK_IMTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_STOCK_IMTY> listRaw = ctx.HIS_MEDI_STOCK_IMTY.Where(o => listId.Contains(o.ID)).ToList();
