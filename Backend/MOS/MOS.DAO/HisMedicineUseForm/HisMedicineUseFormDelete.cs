...
{
    partial class HisMedicineUseFormDelete : EntityBase
    {
        public HisMedicineUseFormDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_USE_FORM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_USE_FORM> listIdNotFound = new List<HIS_MEDICINE_USE_FORM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_USE_FORM> listRaw = ctx.HIS_MEDICINE_USE_FORM.Where(o => listId.Contains(o.ID)).ToList();
