...
{
    partial class HisReceptionRoomDelete : EntityBase
    {
        public HisReceptionRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_RECEPTION_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_RECEPTION_ROOM> listIdNotFound = new List<HIS_RECEPTION_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_RECEPTION_ROOM> listRaw = ctx.HIS_RECEPTION_ROOM.Where(o => listId.Contains(o.ID)).ToList();
