...
{
    partial class HisDepositReasonDelete : EntityBase
    {
        public HisDepositReasonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEPOSIT_REASON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEPOSIT_REASON> listIdNotFound = new List<HIS_DEPOSIT_REASON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEPOSIT_REASON> listRaw = ctx.HIS_DEPOSIT_REASON.Where(o => listId.Contains(o.ID)).ToList();
