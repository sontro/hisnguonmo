...
{
    partial class HisServiceReqMetyDelete : EntityBase
    {
        public HisServiceReqMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_REQ_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_REQ_METY> listIdNotFound = new List<HIS_SERVICE_REQ_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_REQ_METY> listRaw = ctx.HIS_SERVICE_REQ_METY.Where(o => listId.Contains(o.ID)).ToList();
