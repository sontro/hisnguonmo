...
{
    partial class HisVaccinationSttDelete : EntityBase
    {
        public HisVaccinationSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINATION_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINATION_STT> listIdNotFound = new List<HIS_VACCINATION_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINATION_STT> listRaw = ctx.HIS_VACCINATION_STT.Where(o => listId.Contains(o.ID)).ToList();
