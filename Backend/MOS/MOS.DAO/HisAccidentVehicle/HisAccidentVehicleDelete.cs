...
{
    partial class HisAccidentVehicleDelete : EntityBase
    {
        public HisAccidentVehicleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_VEHICLE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_VEHICLE> listIdNotFound = new List<HIS_ACCIDENT_VEHICLE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_VEHICLE> listRaw = ctx.HIS_ACCIDENT_VEHICLE.Where(o => listId.Contains(o.ID)).ToList();
