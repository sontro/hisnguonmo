...
{
    partial class HisPatientTypeSubDelete : EntityBase
    {
        public HisPatientTypeSubDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PATIENT_TYPE_SUB> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PATIENT_TYPE_SUB> listIdNotFound = new List<HIS_PATIENT_TYPE_SUB>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PATIENT_TYPE_SUB> listRaw = ctx.HIS_PATIENT_TYPE_SUB.Where(o => listId.Contains(o.ID)).ToList();
