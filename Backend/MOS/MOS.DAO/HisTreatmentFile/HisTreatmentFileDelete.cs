...
{
    partial class HisTreatmentFileDelete : EntityBase
    {
        public HisTreatmentFileDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_FILE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_FILE> listIdNotFound = new List<HIS_TREATMENT_FILE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_FILE> listRaw = ctx.HIS_TREATMENT_FILE.Where(o => listId.Contains(o.ID)).ToList();
