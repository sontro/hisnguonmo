...
{
    partial class HisTranPatiFormDelete : EntityBase
    {
        public HisTranPatiFormDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRAN_PATI_FORM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRAN_PATI_FORM> listIdNotFound = new List<HIS_TRAN_PATI_FORM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRAN_PATI_FORM> listRaw = ctx.HIS_TRAN_PATI_FORM.Where(o => listId.Contains(o.ID)).ToList();
