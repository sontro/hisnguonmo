...
{
    partial class HisActiveIngredientDelete : EntityBase
    {
        public HisActiveIngredientDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACTIVE_INGREDIENT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACTIVE_INGREDIENT> listIdNotFound = new List<HIS_ACTIVE_INGREDIENT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACTIVE_INGREDIENT> listRaw = ctx.HIS_ACTIVE_INGREDIENT.Where(o => listId.Contains(o.ID)).ToList();
