...
{
    partial class HisMaterialPatyDelete : EntityBase
    {
        public HisMaterialPatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MATERIAL_PATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MATERIAL_PATY> listIdNotFound = new List<HIS_MATERIAL_PATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MATERIAL_PATY> listRaw = ctx.HIS_MATERIAL_PATY.Where(o => listId.Contains(o.ID)).ToList();
