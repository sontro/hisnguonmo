...
{
    partial class HisSevereIllnessInfoDelete : EntityBase
    {
        public HisSevereIllnessInfoDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SEVERE_ILLNESS_INFO> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SEVERE_ILLNESS_INFO> listIdNotFound = new List<HIS_SEVERE_ILLNESS_INFO>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SEVERE_ILLNESS_INFO> listRaw = ctx.HIS_SEVERE_ILLNESS_INFO.Where(o => listId.Contains(o.ID)).ToList();
