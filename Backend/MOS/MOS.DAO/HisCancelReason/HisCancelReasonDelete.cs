...
{
    partial class HisCancelReasonDelete : EntityBase
    {
        public HisCancelReasonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CANCEL_REASON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CANCEL_REASON> listIdNotFound = new List<HIS_CANCEL_REASON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CANCEL_REASON> listRaw = ctx.HIS_CANCEL_REASON.Where(o => listId.Contains(o.ID)).ToList();
