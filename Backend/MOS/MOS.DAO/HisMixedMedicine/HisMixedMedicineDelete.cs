...
{
    partial class HisMixedMedicineDelete : EntityBase
    {
        public HisMixedMedicineDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MIXED_MEDICINE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MIXED_MEDICINE> listIdNotFound = new List<HIS_MIXED_MEDICINE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MIXED_MEDICINE> listRaw = ctx.HIS_MIXED_MEDICINE.Where(o => listId.Contains(o.ID)).ToList();
