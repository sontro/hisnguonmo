...
{
    partial class HisSampleRoomDelete : EntityBase
    {
        public HisSampleRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SAMPLE_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SAMPLE_ROOM> listIdNotFound = new List<HIS_SAMPLE_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SAMPLE_ROOM> listRaw = ctx.HIS_SAMPLE_ROOM.Where(o => listId.Contains(o.ID)).ToList();
