...
{
    partial class HisMestRoomDelete : EntityBase
    {
        public HisMestRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_ROOM> listIdNotFound = new List<HIS_MEST_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_ROOM> listRaw = ctx.HIS_MEST_ROOM.Where(o => listId.Contains(o.ID)).ToList();
