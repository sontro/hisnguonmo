...
{
    partial class HisExecuteRoleUserDelete : EntityBase
    {
        public HisExecuteRoleUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXECUTE_ROLE_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXECUTE_ROLE_USER> listIdNotFound = new List<HIS_EXECUTE_ROLE_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXECUTE_ROLE_USER> listRaw = ctx.HIS_EXECUTE_ROLE_USER.Where(o => listId.Contains(o.ID)).ToList();
