...
using System.Linq;
using MOS.DAO.HisDepositReq;

namespace MOS.DAO.HisMedicineType
{
    partial class HisMedicineTypeDelete : EntityBase
    {
        public HisMedicineTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_TYPE> listIdNotFound = new List<HIS_MEDICINE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_TYPE> listRaw = ctx.HIS_MEDICINE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
