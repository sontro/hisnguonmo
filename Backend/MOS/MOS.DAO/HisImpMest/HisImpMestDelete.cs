...
{
    partial class HisImpMestDelete : EntityBase
    {
        public HisImpMestDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST> listIdNotFound = new List<HIS_IMP_MEST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST> listRaw = ctx.HIS_IMP_MEST.Where(o => listId.Contains(o.ID)).ToList();
