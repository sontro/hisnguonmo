...
{
    partial class HisVaccHealthSttDelete : EntityBase
    {
        public HisVaccHealthSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACC_HEALTH_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACC_HEALTH_STT> listIdNotFound = new List<HIS_VACC_HEALTH_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACC_HEALTH_STT> listRaw = ctx.HIS_VACC_HEALTH_STT.Where(o => listId.Contains(o.ID)).ToList();
