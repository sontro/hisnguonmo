...
{
    partial class HisCareDetailDelete : EntityBase
    {
        public HisCareDetailDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CARE_DETAIL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CARE_DETAIL> listIdNotFound = new List<HIS_CARE_DETAIL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CARE_DETAIL> listRaw = ctx.HIS_CARE_DETAIL.Where(o => listId.Contains(o.ID)).ToList();
