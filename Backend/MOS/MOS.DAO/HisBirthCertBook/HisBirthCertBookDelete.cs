...
{
    partial class HisBirthCertBookDelete : EntityBase
    {
        public HisBirthCertBookDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BIRTH_CERT_BOOK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BIRTH_CERT_BOOK> listIdNotFound = new List<HIS_BIRTH_CERT_BOOK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BIRTH_CERT_BOOK> listRaw = ctx.HIS_BIRTH_CERT_BOOK.Where(o => listId.Contains(o.ID)).ToList();
