...
{
    partial class HisBornPositionDelete : EntityBase
    {
        public HisBornPositionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BORN_POSITION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BORN_POSITION> listIdNotFound = new List<HIS_BORN_POSITION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BORN_POSITION> listRaw = ctx.HIS_BORN_POSITION.Where(o => listId.Contains(o.ID)).ToList();
