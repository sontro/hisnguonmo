...
{
    partial class HisServSegrDelete : EntityBase
    {
        public HisServSegrDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERV_SEGR> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERV_SEGR> listIdNotFound = new List<HIS_SERV_SEGR>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERV_SEGR> listRaw = ctx.HIS_SERV_SEGR.Where(o => listId.Contains(o.ID)).ToList();
