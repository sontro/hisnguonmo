...
{
    partial class HisAnticipateBltyDelete : EntityBase
    {
        public HisAnticipateBltyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTICIPATE_BLTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTICIPATE_BLTY> listIdNotFound = new List<HIS_ANTICIPATE_BLTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTICIPATE_BLTY> listRaw = ctx.HIS_ANTICIPATE_BLTY.Where(o => listId.Contains(o.ID)).ToList();
