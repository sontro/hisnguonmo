...
{
    partial class HisFuexTypeDelete : EntityBase
    {
        public HisFuexTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_FUEX_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_FUEX_TYPE> listIdNotFound = new List<HIS_FUEX_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_FUEX_TYPE> listRaw = ctx.HIS_FUEX_TYPE.Where(o => listId.Contains(o.ID)).ToList();
