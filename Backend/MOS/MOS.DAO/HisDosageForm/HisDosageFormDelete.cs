...
{
    partial class HisDosageFormDelete : EntityBase
    {
        public HisDosageFormDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DOSAGE_FORM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DOSAGE_FORM> listIdNotFound = new List<HIS_DOSAGE_FORM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DOSAGE_FORM> listRaw = ctx.HIS_DOSAGE_FORM.Where(o => listId.Contains(o.ID)).ToList();
