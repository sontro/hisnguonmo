...
{
    partial class HisBhytParamDelete : EntityBase
    {
        public HisBhytParamDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BHYT_PARAM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BHYT_PARAM> listIdNotFound = new List<HIS_BHYT_PARAM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BHYT_PARAM> listRaw = ctx.HIS_BHYT_PARAM.Where(o => listId.Contains(o.ID)).ToList();
