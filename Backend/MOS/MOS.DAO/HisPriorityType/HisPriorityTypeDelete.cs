...
{
    partial class HisPriorityTypeDelete : EntityBase
    {
        public HisPriorityTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PRIORITY_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PRIORITY_TYPE> listIdNotFound = new List<HIS_PRIORITY_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PRIORITY_TYPE> listRaw = ctx.HIS_PRIORITY_TYPE.Where(o => listId.Contains(o.ID)).ToList();
