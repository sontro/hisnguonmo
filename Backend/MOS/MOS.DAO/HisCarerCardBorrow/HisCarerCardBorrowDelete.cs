...
{
    partial class HisCarerCardBorrowDelete : EntityBase
    {
        public HisCarerCardBorrowDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CARER_CARD_BORROW> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CARER_CARD_BORROW> listIdNotFound = new List<HIS_CARER_CARD_BORROW>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CARER_CARD_BORROW> listRaw = ctx.HIS_CARER_CARD_BORROW.Where(o => listId.Contains(o.ID)).ToList();
