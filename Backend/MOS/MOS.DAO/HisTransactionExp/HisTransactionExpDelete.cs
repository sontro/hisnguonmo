...
{
    partial class HisTransactionExpDelete : EntityBase
    {
        public HisTransactionExpDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRANSACTION_EXP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRANSACTION_EXP> listIdNotFound = new List<HIS_TRANSACTION_EXP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRANSACTION_EXP> listRaw = ctx.HIS_TRANSACTION_EXP.Where(o => listId.Contains(o.ID)).ToList();
