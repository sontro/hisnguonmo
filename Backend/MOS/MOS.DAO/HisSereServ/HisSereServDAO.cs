...
namespace MOS.DAO.HisSereServ
{
    ...
    {
        private HisSereServCreate CreateWorker
        {
            get
            {
                return (HisSereServCreate)Worker.Get<HisSereServCreate>();
            }
        }
        private HisSereServUpdate UpdateWorker
        {
            get
            {
                return (HisSereServUpdate)Worker.Get<HisSereServUpdate>();
            }
        }
        private HisSereServDelete DeleteWorker
        {
            get
            {
                return (HisSereServDelete)Worker.Get<HisSereServDelete>();
            }
        }
        private HisSereServTruncate TruncateWorker
        {
            get
            {
                return (HisSereServTruncate)Worker.Get<HisSereServTruncate>();
            }
        }
        ...
        private HisSereServCheck CheckWorker
        {
            get
            {
                return (HisSereServCheck)Worker.Get<HisSereServCheck>();
            }
        }
        ...
        public bool Delete(HIS_SERE_SERV data)
        {
            bool result = false;
            try
            {
        ...
        public bool DeleteList(List<HIS_SERE_SERV> listData)
        {
            bool result = false;
