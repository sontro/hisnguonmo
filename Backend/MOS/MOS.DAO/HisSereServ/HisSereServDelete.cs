...
{
    partial class HisSereServDelete : EntityBase
    {
        public HisSereServDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV> listIdNotFound = new List<HIS_SERE_SERV>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV> listRaw = ctx.HIS_SERE_SERV.Where(o => listId.Contains(o.ID)).ToList();
