...
namespace MOS.DAO.HisSereServ
{
    public partial class HisSereServDAO : EntityBase
    {
        ...
        {
            List<V_HIS_SERE_SERV_15> result = new List<V_HIS_SERE_SERV_15>();
            ...
            try
            {
                result = GetWorker.GetView15(search, param);
            }
            catch (Exception ex)
            {
        ...
        public V_HIS_SERE_SERV_15 GetView15ById(long id, HisSereServSO search)
        {
            V_HIS_SERE_SERV_15 result = null;
            ...
            try
            {
                result = GetWorker.GetView15ById(id, search);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
