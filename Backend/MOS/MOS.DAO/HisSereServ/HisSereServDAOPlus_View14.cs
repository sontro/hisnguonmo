...
namespace MOS.DAO.HisSereServ
{
    public partial class HisSereServDAO : EntityBase
    {
        ...
        {
            List<V_HIS_SERE_SERV_14> result = new List<V_HIS_SERE_SERV_14>();
            ...
            try
            {
                result = GetWorker.GetView14(search, param);
            }
            catch (Exception ex)
            {
        ...
        public V_HIS_SERE_SERV_14 GetView14ById(long id, HisSereServSO search)
        {
            V_HIS_SERE_SERV_14 result = null;
            ...
            try
            {
                result = GetWorker.GetView14ById(id, search);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
