...
namespace MOS.DAO.HisSereServ
{
    public partial class HisSereServDAO : EntityBase
    {
        ...
        {
            List<V_HIS_SERE_SERV_16> result = new List<V_HIS_SERE_SERV_16>();
            ...
            try
            {
                result = GetWorker.GetView16(search, param);
            }
            catch (Exception ex)
            {
        ...
        public V_HIS_SERE_SERV_16 GetView16ById(long id, HisSereServSO search)
        {
            V_HIS_SERE_SERV_16 result = null;
            ...
            try
            {
                result = GetWorker.GetView16ById(id, search);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
