...
{
    partial class HisRehaTrainUnitDelete : EntityBase
    {
        public HisRehaTrainUnitDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REHA_TRAIN_UNIT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REHA_TRAIN_UNIT> listIdNotFound = new List<HIS_REHA_TRAIN_UNIT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REHA_TRAIN_UNIT> listRaw = ctx.HIS_REHA_TRAIN_UNIT.Where(o => listId.Contains(o.ID)).ToList();
