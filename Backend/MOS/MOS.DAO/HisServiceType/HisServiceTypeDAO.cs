...
namespace MOS.DAO.HisServiceType
{
    ...
    {
        private HisServiceTypeCreate CreateWorker
        {
            get
            {
                return (HisServiceTypeCreate)Worker.Get<HisServiceTypeCreate>();
            }
        }
        private HisServiceTypeUpdate UpdateWorker
        {
            get
            {
                return (HisServiceTypeUpdate)Worker.Get<HisServiceTypeUpdate>();
            }
        }
        private HisServiceTypeDelete DeleteWorker
        {
            get
            {
                return (HisServiceTypeDelete)Worker.Get<HisServiceTypeDelete>();
            }
        }
        private HisServiceTypeTruncate TruncateWorker
        {
            get
            {
                return (HisServiceTypeTruncate)Worker.Get<HisServiceTypeTruncate>();
            }
        }
        ...
        private HisServiceTypeCheck CheckWorker
        {
            get
            {
                return (HisServiceTypeCheck)Worker.Get<HisServiceTypeCheck>();
            }
        }
