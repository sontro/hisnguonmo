...
{
    partial class HisImpMestTypeDelete : EntityBase
    {
        public HisImpMestTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_TYPE> listIdNotFound = new List<HIS_IMP_MEST_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_TYPE> listRaw = ctx.HIS_IMP_MEST_TYPE.Where(o => listId.Contains(o.ID)).ToList();
