...
namespace MOS.DAO.HisBedLog
{
    ...
    {
        private HisBedLogCreate CreateWorker
        {
            get
            {
                return (HisBedLogCreate)Worker.Get<HisBedLogCreate>();
            }
        }
        private HisBedLogUpdate UpdateWorker
        {
            get
            {
                return (HisBedLogUpdate)Worker.Get<HisBedLogUpdate>();
            }
        }
        private HisBedLogDelete DeleteWorker
        {
            get
            {
                return (HisBedLogDelete)Worker.Get<HisBedLogDelete>();
            }
        }
        private HisBedLogTruncate TruncateWorker
        {
            get
            {
                return (HisBedLogTruncate)Worker.Get<HisBedLogTruncate>();
            }
        }
        ...
        private HisBedLogCheck CheckWorker
        {
            get
            {
                return (HisBedLogCheck)Worker.Get<HisBedLogCheck>();
            }
        }
