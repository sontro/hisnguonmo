...
{
    partial class HisImpUserTempDelete : EntityBase
    {
        public HisImpUserTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_USER_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_USER_TEMP> listIdNotFound = new List<HIS_IMP_USER_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_USER_TEMP> listRaw = ctx.HIS_IMP_USER_TEMP.Where(o => listId.Contains(o.ID)).ToList();
