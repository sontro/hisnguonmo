...
{
    partial class HisExroRoomDelete : EntityBase
    {
        public HisExroRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXRO_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXRO_ROOM> listIdNotFound = new List<HIS_EXRO_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXRO_ROOM> listRaw = ctx.HIS_EXRO_ROOM.Where(o => listId.Contains(o.ID)).ToList();
