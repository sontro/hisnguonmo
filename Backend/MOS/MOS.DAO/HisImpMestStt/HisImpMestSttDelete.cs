...
{
    partial class HisImpMestSttDelete : EntityBase
    {
        public HisImpMestSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_STT> listIdNotFound = new List<HIS_IMP_MEST_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_STT> listRaw = ctx.HIS_IMP_MEST_STT.Where(o => listId.Contains(o.ID)).ToList();
