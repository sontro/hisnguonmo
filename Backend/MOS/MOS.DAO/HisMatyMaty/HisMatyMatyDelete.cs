...
{
    partial class HisMatyMatyDelete : EntityBase
    {
        public HisMatyMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MATY_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MATY_MATY> listIdNotFound = new List<HIS_MATY_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MATY_MATY> listRaw = ctx.HIS_MATY_MATY.Where(o => listId.Contains(o.ID)).ToList();
