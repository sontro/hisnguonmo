...
{
    partial class HisTranPatiTempDelete : EntityBase
    {
        public HisTranPatiTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRAN_PATI_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRAN_PATI_TEMP> listIdNotFound = new List<HIS_TRAN_PATI_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRAN_PATI_TEMP> listRaw = ctx.HIS_TRAN_PATI_TEMP.Where(o => listId.Contains(o.ID)).ToList();
