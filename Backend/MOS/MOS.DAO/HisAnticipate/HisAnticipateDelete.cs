...
{
    partial class HisAnticipateDelete : EntityBase
    {
        public HisAnticipateDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTICIPATE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTICIPATE> listIdNotFound = new List<HIS_ANTICIPATE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTICIPATE> listRaw = ctx.HIS_ANTICIPATE.Where(o => listId.Contains(o.ID)).ToList();
