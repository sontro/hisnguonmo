...
{
    partial class HisMestPatientTypeDelete : EntityBase
    {
        public HisMestPatientTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PATIENT_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PATIENT_TYPE> listIdNotFound = new List<HIS_MEST_PATIENT_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PATIENT_TYPE> listRaw = ctx.HIS_MEST_PATIENT_TYPE.Where(o => listId.Contains(o.ID)).ToList();
