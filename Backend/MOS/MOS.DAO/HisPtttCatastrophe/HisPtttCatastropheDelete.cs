...
{
    partial class HisPtttCatastropheDelete : EntityBase
    {
        public HisPtttCatastropheDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_CATASTROPHE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_CATASTROPHE> listIdNotFound = new List<HIS_PTTT_CATASTROPHE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_CATASTROPHE> listRaw = ctx.HIS_PTTT_CATASTROPHE.Where(o => listId.Contains(o.ID)).ToList();
