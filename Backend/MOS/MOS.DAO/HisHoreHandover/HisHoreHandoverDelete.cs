...
{
    partial class HisHoreHandoverDelete : EntityBase
    {
        public HisHoreHandoverDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HORE_HANDOVER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HORE_HANDOVER> listIdNotFound = new List<HIS_HORE_HANDOVER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HORE_HANDOVER> listRaw = ctx.HIS_HORE_HANDOVER.Where(o => listId.Contains(o.ID)).ToList();
