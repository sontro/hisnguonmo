...
{
    partial class HisInvoiceDetailDelete : EntityBase
    {
        public HisInvoiceDetailDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_INVOICE_DETAIL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_INVOICE_DETAIL> listIdNotFound = new List<HIS_INVOICE_DETAIL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_INVOICE_DETAIL> listRaw = ctx.HIS_INVOICE_DETAIL.Where(o => listId.Contains(o.ID)).ToList();
