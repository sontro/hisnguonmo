...
{
    partial class HisIcdGroupDelete : EntityBase
    {
        public HisIcdGroupDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ICD_GROUP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ICD_GROUP> listIdNotFound = new List<HIS_ICD_GROUP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ICD_GROUP> listRaw = ctx.HIS_ICD_GROUP.Where(o => listId.Contains(o.ID)).ToList();
