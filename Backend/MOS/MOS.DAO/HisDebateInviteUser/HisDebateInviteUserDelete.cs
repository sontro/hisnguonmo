...
{
    partial class HisDebateInviteUserDelete : EntityBase
    {
        public HisDebateInviteUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEBATE_INVITE_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEBATE_INVITE_USER> listIdNotFound = new List<HIS_DEBATE_INVITE_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEBATE_INVITE_USER> listRaw = ctx.HIS_DEBATE_INVITE_USER.Where(o => listId.Contains(o.ID)).ToList();
