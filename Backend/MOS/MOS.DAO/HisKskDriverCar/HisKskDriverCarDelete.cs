...
{
    partial class HisKskDriverCarDelete : EntityBase
    {
        public HisKskDriverCarDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_DRIVER_CAR> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_DRIVER_CAR> listIdNotFound = new List<HIS_KSK_DRIVER_CAR>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_DRIVER_CAR> listRaw = ctx.HIS_KSK_DRIVER_CAR.Where(o => listId.Contains(o.ID)).ToList();
