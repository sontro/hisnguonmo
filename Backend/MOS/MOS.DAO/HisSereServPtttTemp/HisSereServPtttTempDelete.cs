...
{
    partial class HisSereServPtttTempDelete : EntityBase
    {
        public HisSereServPtttTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_PTTT_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_PTTT_TEMP> listIdNotFound = new List<HIS_SERE_SERV_PTTT_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_PTTT_TEMP> listRaw = ctx.HIS_SERE_SERV_PTTT_TEMP.Where(o => listId.Contains(o.ID)).ToList();
