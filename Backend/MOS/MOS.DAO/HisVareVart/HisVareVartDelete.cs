...
{
    partial class HisVareVartDelete : EntityBase
    {
        public HisVareVartDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VARE_VART> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VARE_VART> listIdNotFound = new List<HIS_VARE_VART>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VARE_VART> listRaw = ctx.HIS_VARE_VART.Where(o => listId.Contains(o.ID)).ToList();
