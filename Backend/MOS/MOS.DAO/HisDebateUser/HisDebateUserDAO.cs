...
namespace MOS.DAO.HisDebateUser
{
    ...
    {
        private HisDebateUserCreate CreateWorker
        {
            get
            {
                return (HisDebateUserCreate)Worker.Get<HisDebateUserCreate>();
            }
        }
        private HisDebateUserUpdate UpdateWorker
        {
            get
            {
                return (HisDebateUserUpdate)Worker.Get<HisDebateUserUpdate>();
            }
        }
        private HisDebateUserDelete DeleteWorker
        {
            get
            {
                return (HisDebateUserDelete)Worker.Get<HisDebateUserDelete>();
            }
        }
        private HisDebateUserTruncate TruncateWorker
        {
            get
            {
                return (HisDebateUserTruncate)Worker.Get<HisDebateUserTruncate>();
            }
        }
        ...
        private HisDebateUserCheck CheckWorker
        {
            get
            {
                return (HisDebateUserCheck)Worker.Get<HisDebateUserCheck>();
            }
        }
