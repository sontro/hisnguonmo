...
{
    partial class HisVaccExamResultDelete : EntityBase
    {
        public HisVaccExamResultDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACC_EXAM_RESULT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACC_EXAM_RESULT> listIdNotFound = new List<HIS_VACC_EXAM_RESULT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACC_EXAM_RESULT> listRaw = ctx.HIS_VACC_EXAM_RESULT.Where(o => listId.Contains(o.ID)).ToList();
