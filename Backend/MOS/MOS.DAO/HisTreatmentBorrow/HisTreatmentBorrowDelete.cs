...
{
    partial class HisTreatmentBorrowDelete : EntityBase
    {
        public HisTreatmentBorrowDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_BORROW> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_BORROW> listIdNotFound = new List<HIS_TREATMENT_BORROW>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_BORROW> listRaw = ctx.HIS_TREATMENT_BORROW.Where(o => listId.Contains(o.ID)).ToList();
