...
{
    partial class HisAccidentHurtDelete : EntityBase
    {
        public HisAccidentHurtDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_HURT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_HURT> listIdNotFound = new List<HIS_ACCIDENT_HURT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_HURT> listRaw = ctx.HIS_ACCIDENT_HURT.Where(o => listId.Contains(o.ID)).ToList();
