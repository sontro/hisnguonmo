...
{
    partial class HisSeseDepoRepayDelete : EntityBase
    {
        public HisSeseDepoRepayDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SESE_DEPO_REPAY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SESE_DEPO_REPAY> listIdNotFound = new List<HIS_SESE_DEPO_REPAY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SESE_DEPO_REPAY> listRaw = ctx.HIS_SESE_DEPO_REPAY.Where(o => listId.Contains(o.ID)).ToList();
