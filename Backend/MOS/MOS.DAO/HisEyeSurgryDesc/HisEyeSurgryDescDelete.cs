...
{
    partial class HisEyeSurgryDescDelete : EntityBase
    {
        public HisEyeSurgryDescDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EYE_SURGRY_DESC> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EYE_SURGRY_DESC> listIdNotFound = new List<HIS_EYE_SURGRY_DESC>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EYE_SURGRY_DESC> listRaw = ctx.HIS_EYE_SURGRY_DESC.Where(o => listId.Contains(o.ID)).ToList();
