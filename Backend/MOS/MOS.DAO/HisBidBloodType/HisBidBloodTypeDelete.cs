...
{
    partial class HisBidBloodTypeDelete : EntityBase
    {
        public HisBidBloodTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BID_BLOOD_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BID_BLOOD_TYPE> listIdNotFound = new List<HIS_BID_BLOOD_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BID_BLOOD_TYPE> listRaw = ctx.HIS_BID_BLOOD_TYPE.Where(o => listId.Contains(o.ID)).ToList();
