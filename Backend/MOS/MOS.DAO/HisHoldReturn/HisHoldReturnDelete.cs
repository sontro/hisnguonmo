...
{
    partial class HisHoldReturnDelete : EntityBase
    {
        public HisHoldReturnDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HOLD_RETURN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HOLD_RETURN> listIdNotFound = new List<HIS_HOLD_RETURN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HOLD_RETURN> listRaw = ctx.HIS_HOLD_RETURN.Where(o => listId.Contains(o.ID)).ToList();
