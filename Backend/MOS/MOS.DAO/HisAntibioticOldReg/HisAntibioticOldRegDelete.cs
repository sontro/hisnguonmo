...
{
    partial class HisAntibioticOldRegDelete : EntityBase
    {
        public HisAntibioticOldRegDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTIBIOTIC_OLD_REG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTIBIOTIC_OLD_REG> listIdNotFound = new List<HIS_ANTIBIOTIC_OLD_REG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTIBIOTIC_OLD_REG> listRaw = ctx.HIS_ANTIBIOTIC_OLD_REG.Where(o => listId.Contains(o.ID)).ToList();
