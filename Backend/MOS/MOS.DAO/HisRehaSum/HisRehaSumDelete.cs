...
{
    partial class HisRehaSumDelete : EntityBase
    {
        public HisRehaSumDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REHA_SUM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REHA_SUM> listIdNotFound = new List<HIS_REHA_SUM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REHA_SUM> listRaw = ctx.HIS_REHA_SUM.Where(o => listId.Contains(o.ID)).ToList();
