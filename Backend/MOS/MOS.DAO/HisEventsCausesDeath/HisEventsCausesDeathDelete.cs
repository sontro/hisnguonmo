...
{
    partial class HisEventsCausesDeathDelete : EntityBase
    {
        public HisEventsCausesDeathDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EVENTS_CAUSES_DEATH> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EVENTS_CAUSES_DEATH> listIdNotFound = new List<HIS_EVENTS_CAUSES_DEATH>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EVENTS_CAUSES_DEATH> listRaw = ctx.HIS_EVENTS_CAUSES_DEATH.Where(o => listId.Contains(o.ID)).ToList();
