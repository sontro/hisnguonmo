...
{
    partial class HisAnticipateMetyDelete : EntityBase
    {
        public HisAnticipateMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTICIPATE_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTICIPATE_METY> listIdNotFound = new List<HIS_ANTICIPATE_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTICIPATE_METY> listRaw = ctx.HIS_ANTICIPATE_METY.Where(o => listId.Contains(o.ID)).ToList();
