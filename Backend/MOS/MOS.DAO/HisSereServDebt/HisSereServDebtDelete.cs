...
{
    partial class HisSereServDebtDelete : EntityBase
    {
        public HisSereServDebtDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_DEBT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_DEBT> listIdNotFound = new List<HIS_SERE_SERV_DEBT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_DEBT> listRaw = ctx.HIS_SERE_SERV_DEBT.Where(o => listId.Contains(o.ID)).ToList();
