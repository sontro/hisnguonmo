...
{
    partial class HisHospitalizeReasonDelete : EntityBase
    {
        public HisHospitalizeReasonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HOSPITALIZE_REASON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HOSPITALIZE_REASON> listIdNotFound = new List<HIS_HOSPITALIZE_REASON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HOSPITALIZE_REASON> listRaw = ctx.HIS_HOSPITALIZE_REASON.Where(o => listId.Contains(o.ID)).ToList();
