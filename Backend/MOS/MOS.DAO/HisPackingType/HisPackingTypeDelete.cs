...
{
    partial class HisPackingTypeDelete : EntityBase
    {
        public HisPackingTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PACKING_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PACKING_TYPE> listIdNotFound = new List<HIS_PACKING_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PACKING_TYPE> listRaw = ctx.HIS_PACKING_TYPE.Where(o => listId.Contains(o.ID)).ToList();
