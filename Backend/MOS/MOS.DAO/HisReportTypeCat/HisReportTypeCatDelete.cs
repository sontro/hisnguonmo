...
{
    partial class HisReportTypeCatDelete : EntityBase
    {
        public HisReportTypeCatDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REPORT_TYPE_CAT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REPORT_TYPE_CAT> listIdNotFound = new List<HIS_REPORT_TYPE_CAT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REPORT_TYPE_CAT> listRaw = ctx.HIS_REPORT_TYPE_CAT.Where(o => listId.Contains(o.ID)).ToList();
