...
{
    partial class HisRoomSaroDelete : EntityBase
    {
        public HisRoomSaroDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ROOM_SARO> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ROOM_SARO> listIdNotFound = new List<HIS_ROOM_SARO>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ROOM_SARO> listRaw = ctx.HIS_ROOM_SARO.Where(o => listId.Contains(o.ID)).ToList();
