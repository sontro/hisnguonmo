...
{
    partial class HisSereServTempDelete : EntityBase
    {
        public HisSereServTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_TEMP> listIdNotFound = new List<HIS_SERE_SERV_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_TEMP> listRaw = ctx.HIS_SERE_SERV_TEMP.Where(o => listId.Contains(o.ID)).ToList();
