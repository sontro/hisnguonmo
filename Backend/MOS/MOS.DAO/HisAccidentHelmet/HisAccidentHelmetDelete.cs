...
{
    partial class HisAccidentHelmetDelete : EntityBase
    {
        public HisAccidentHelmetDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_HELMET> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_HELMET> listIdNotFound = new List<HIS_ACCIDENT_HELMET>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_HELMET> listRaw = ctx.HIS_ACCIDENT_HELMET.Where(o => listId.Contains(o.ID)).ToList();
