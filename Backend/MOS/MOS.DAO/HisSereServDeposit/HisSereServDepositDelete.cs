...
{
    partial class HisSereServDepositDelete : EntityBase
    {
        public HisSereServDepositDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_DEPOSIT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_DEPOSIT> listIdNotFound = new List<HIS_SERE_SERV_DEPOSIT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_DEPOSIT> listRaw = ctx.HIS_SERE_SERV_DEPOSIT.Where(o => listId.Contains(o.ID)).ToList();
