...
{
    partial class HisMedicalContractDelete : EntityBase
    {
        public HisMedicalContractDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICAL_CONTRACT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICAL_CONTRACT> listIdNotFound = new List<HIS_MEDICAL_CONTRACT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICAL_CONTRACT> listRaw = ctx.HIS_MEDICAL_CONTRACT.Where(o => listId.Contains(o.ID)).ToList();
