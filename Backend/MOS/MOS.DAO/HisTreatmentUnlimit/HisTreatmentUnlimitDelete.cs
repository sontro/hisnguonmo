...
{
    partial class HisTreatmentUnlimitDelete : EntityBase
    {
        public HisTreatmentUnlimitDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_UNLIMIT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_UNLIMIT> listIdNotFound = new List<HIS_TREATMENT_UNLIMIT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_UNLIMIT> listRaw = ctx.HIS_TREATMENT_UNLIMIT.Where(o => listId.Contains(o.ID)).ToList();
