...
namespace MOS.DAO.HisUserRoom
{
    ...
    {
        private HisUserRoomCreate CreateWorker
        {
            get
            {
                return (HisUserRoomCreate)Worker.Get<HisUserRoomCreate>();
            }
        }
        private HisUserRoomUpdate UpdateWorker
        {
            get
            {
                return (HisUserRoomUpdate)Worker.Get<HisUserRoomUpdate>();
            }
        }
        private HisUserRoomDelete DeleteWorker
        {
            get
            {
                return (HisUserRoomDelete)Worker.Get<HisUserRoomDelete>();
            }
        }
        private HisUserRoomTruncate TruncateWorker
        {
            get
            {
                return (HisUserRoomTruncate)Worker.Get<HisUserRoomTruncate>();
            }
        }
        ...
        private HisUserRoomCheck CheckWorker
        {
            get
            {
                return (HisUserRoomCheck)Worker.Get<HisUserRoomCheck>();
            }
        }
