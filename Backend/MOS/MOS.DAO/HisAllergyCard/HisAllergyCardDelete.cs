...
{
    partial class HisAllergyCardDelete : EntityBase
    {
        public HisAllergyCardDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ALLERGY_CARD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ALLERGY_CARD> listIdNotFound = new List<HIS_ALLERGY_CARD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ALLERGY_CARD> listRaw = ctx.HIS_ALLERGY_CARD.Where(o => listId.Contains(o.ID)).ToList();
