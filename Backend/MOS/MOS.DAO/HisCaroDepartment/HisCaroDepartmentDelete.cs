...
{
    partial class HisCaroDepartmentDelete : EntityBase
    {
        public HisCaroDepartmentDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CARO_DEPARTMENT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CARO_DEPARTMENT> listIdNotFound = new List<HIS_CARO_DEPARTMENT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CARO_DEPARTMENT> listRaw = ctx.HIS_CARO_DEPARTMENT.Where(o => listId.Contains(o.ID)).ToList();
