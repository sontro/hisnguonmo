...
{
    partial class HisRepayReasonDelete : EntityBase
    {
        public HisRepayReasonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REPAY_REASON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REPAY_REASON> listIdNotFound = new List<HIS_REPAY_REASON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REPAY_REASON> listRaw = ctx.HIS_REPAY_REASON.Where(o => listId.Contains(o.ID)).ToList();
