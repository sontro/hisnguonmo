...
namespace MOS.DAO.HisPatient
{
    ...
    {
        private HisPatientCreate CreateWorker
        {
            get
            {
                return (HisPatientCreate)Worker.Get<HisPatientCreate>();
            }
        }
        private HisPatientUpdate UpdateWorker
        {
            get
            {
                return (HisPatientUpdate)Worker.Get<HisPatientUpdate>();
            }
        }
        private HisPatientDelete DeleteWorker
        {
            get
            {
                return (HisPatientDelete)Worker.Get<HisPatientDelete>();
            }
        }
        private HisPatientTruncate TruncateWorker
        {
            get
            {
                return (HisPatientTruncate)Worker.Get<HisPatientTruncate>();
            }
        }
        ...
        private HisPatientCheck CheckWorker
        {
            get
            {
                return (HisPatientCheck)Worker.Get<HisPatientCheck>();
            }
        }
