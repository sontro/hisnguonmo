...
{
    partial class HisMaterialTypeMapDelete : EntityBase
    {
        public HisMaterialTypeMapDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MATERIAL_TYPE_MAP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MATERIAL_TYPE_MAP> listIdNotFound = new List<HIS_MATERIAL_TYPE_MAP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MATERIAL_TYPE_MAP> listRaw = ctx.HIS_MATERIAL_TYPE_MAP.Where(o => listId.Contains(o.ID)).ToList();
