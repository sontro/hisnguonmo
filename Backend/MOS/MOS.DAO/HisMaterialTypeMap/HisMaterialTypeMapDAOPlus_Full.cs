...
namespace MOS.DAO.HisMaterialTypeMap
{
    ...
    {
        public List<V_HIS_MATERIAL_TYPE_MAP> GetView(HisMaterialTypeMapSO search, CommonParam param)
        {
            List<V_HIS_MATERIAL_TYPE_MAP> result = new List<V_HIS_MATERIAL_TYPE_MAP>();
        ...
        public V_HIS_MATERIAL_TYPE_MAP GetViewById(long id, HisMaterialTypeMapSO search)
        {
        ...
        {
            Dictionary<string, HIS_MATERIAL_TYPE_MAP> result = new Dictionary<string, HIS_MATERIAL_TYPE_MAP>();
            try
            {
