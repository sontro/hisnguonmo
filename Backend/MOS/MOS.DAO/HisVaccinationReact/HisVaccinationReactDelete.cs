...
{
    partial class HisVaccinationReactDelete : EntityBase
    {
        public HisVaccinationReactDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINATION_REACT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINATION_REACT> listIdNotFound = new List<HIS_VACCINATION_REACT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINATION_REACT> listRaw = ctx.HIS_VACCINATION_REACT.Where(o => listId.Contains(o.ID)).ToList();
