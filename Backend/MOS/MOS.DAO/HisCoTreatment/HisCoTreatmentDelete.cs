...
{
    partial class HisCoTreatmentDelete : EntityBase
    {
        public HisCoTreatmentDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CO_TREATMENT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CO_TREATMENT> listIdNotFound = new List<HIS_CO_TREATMENT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CO_TREATMENT> listRaw = ctx.HIS_CO_TREATMENT.Where(o => listId.Contains(o.ID)).ToList();
