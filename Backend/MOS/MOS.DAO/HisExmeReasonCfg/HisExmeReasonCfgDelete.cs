...
{
    partial class HisExmeReasonCfgDelete : EntityBase
    {
        public HisExmeReasonCfgDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXME_REASON_CFG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXME_REASON_CFG> listIdNotFound = new List<HIS_EXME_REASON_CFG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXME_REASON_CFG> listRaw = ctx.HIS_EXME_REASON_CFG.Where(o => listId.Contains(o.ID)).ToList();
