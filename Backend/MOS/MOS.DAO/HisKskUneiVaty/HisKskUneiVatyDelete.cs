...
{
    partial class HisKskUneiVatyDelete : EntityBase
    {
        public HisKskUneiVatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_UNEI_VATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_UNEI_VATY> listIdNotFound = new List<HIS_KSK_UNEI_VATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_UNEI_VATY> listRaw = ctx.HIS_KSK_UNEI_VATY.Where(o => listId.Contains(o.ID)).ToList();
