...
{
    partial class HisVaccReactTypeDelete : EntityBase
    {
        public HisVaccReactTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACC_REACT_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACC_REACT_TYPE> listIdNotFound = new List<HIS_VACC_REACT_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACC_REACT_TYPE> listRaw = ctx.HIS_VACC_REACT_TYPE.Where(o => listId.Contains(o.ID)).ToList();
