...
namespace MOS.DAO.HisVaccReactType
{
    public partial class HisVaccReactTypeDAO : EntityBase
    {
        ...
        public HIS_VACC_REACT_TYPE GetByCode(string code, HisVaccReactTypeSO search)
        {
        ...
        public V_HIS_VACC_REACT_TYPE GetViewByCode(string code, HisVaccReactTypeSO search)
        {
            V_HIS_VACC_REACT_TYPE result = null;
        ...
        public Dictionary<string, HIS_VACC_REACT_TYPE> GetDicByCode(HisVaccReactTypeSO search, CommonParam param)
        {
            Dictionary<string, HIS_VACC_REACT_TYPE> result = new Dictionary<string, HIS_VACC_REACT_TYPE>();
            try
            {
