...
{
    partial class HisPatientProgramDelete : EntityBase
    {
        public HisPatientProgramDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PATIENT_PROGRAM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PATIENT_PROGRAM> listIdNotFound = new List<HIS_PATIENT_PROGRAM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PATIENT_PROGRAM> listRaw = ctx.HIS_PATIENT_PROGRAM.Where(o => listId.Contains(o.ID)).ToList();
