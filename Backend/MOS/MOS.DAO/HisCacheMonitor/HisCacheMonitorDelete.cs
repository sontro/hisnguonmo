...
{
    partial class HisCacheMonitorDelete : EntityBase
    {
        public HisCacheMonitorDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CACHE_MONITOR> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CACHE_MONITOR> listIdNotFound = new List<HIS_CACHE_MONITOR>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CACHE_MONITOR> listRaw = ctx.HIS_CACHE_MONITOR.Where(o => listId.Contains(o.ID)).ToList();
