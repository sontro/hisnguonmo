...
{
    partial class HisEmrCoverTypeDelete : EntityBase
    {
        public HisEmrCoverTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMR_COVER_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMR_COVER_TYPE> listIdNotFound = new List<HIS_EMR_COVER_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMR_COVER_TYPE> listRaw = ctx.HIS_EMR_COVER_TYPE.Where(o => listId.Contains(o.ID)).ToList();
