...
{
    partial class HisMilitaryRankDelete : EntityBase
    {
        public HisMilitaryRankDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MILITARY_RANK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MILITARY_RANK> listIdNotFound = new List<HIS_MILITARY_RANK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MILITARY_RANK> listRaw = ctx.HIS_MILITARY_RANK.Where(o => listId.Contains(o.ID)).ToList();
