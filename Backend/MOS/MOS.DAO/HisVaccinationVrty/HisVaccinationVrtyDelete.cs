...
{
    partial class HisVaccinationVrtyDelete : EntityBase
    {
        public HisVaccinationVrtyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINATION_VRTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINATION_VRTY> listIdNotFound = new List<HIS_VACCINATION_VRTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINATION_VRTY> listRaw = ctx.HIS_VACCINATION_VRTY.Where(o => listId.Contains(o.ID)).ToList();
