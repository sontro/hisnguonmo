...
{
    partial class HisSourceMedicineDelete : EntityBase
    {
        public HisSourceMedicineDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SOURCE_MEDICINE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SOURCE_MEDICINE> listIdNotFound = new List<HIS_SOURCE_MEDICINE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SOURCE_MEDICINE> listRaw = ctx.HIS_SOURCE_MEDICINE.Where(o => listId.Contains(o.ID)).ToList();
