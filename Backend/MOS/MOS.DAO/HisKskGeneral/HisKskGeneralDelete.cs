...
{
    partial class HisKskGeneralDelete : EntityBase
    {
        public HisKskGeneralDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_GENERAL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_GENERAL> listIdNotFound = new List<HIS_KSK_GENERAL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_GENERAL> listRaw = ctx.HIS_KSK_GENERAL.Where(o => listId.Contains(o.ID)).ToList();
