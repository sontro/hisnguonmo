...
{
    partial class HisVaccineTypeDelete : EntityBase
    {
        public HisVaccineTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINE_TYPE> listIdNotFound = new List<HIS_VACCINE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINE_TYPE> listRaw = ctx.HIS_VACCINE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
