...
{
    partial class HisMestMatyDepaDelete : EntityBase
    {
        public HisMestMatyDepaDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_MATY_DEPA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_MATY_DEPA> listIdNotFound = new List<HIS_MEST_MATY_DEPA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_MATY_DEPA> listRaw = ctx.HIS_MEST_MATY_DEPA.Where(o => listId.Contains(o.ID)).ToList();
