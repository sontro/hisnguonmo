...
{
    partial class HisPtttTableDelete : EntityBase
    {
        public HisPtttTableDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_TABLE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_TABLE> listIdNotFound = new List<HIS_PTTT_TABLE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_TABLE> listRaw = ctx.HIS_PTTT_TABLE.Where(o => listId.Contains(o.ID)).ToList();
