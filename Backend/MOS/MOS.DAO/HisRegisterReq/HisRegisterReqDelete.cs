...
{
    partial class HisRegisterReqDelete : EntityBase
    {
        public HisRegisterReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REGISTER_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REGISTER_REQ> listIdNotFound = new List<HIS_REGISTER_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REGISTER_REQ> listRaw = ctx.HIS_REGISTER_REQ.Where(o => listId.Contains(o.ID)).ToList();
