...
{
    partial class HisSaroExroDelete : EntityBase
    {
        public HisSaroExroDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SARO_EXRO> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SARO_EXRO> listIdNotFound = new List<HIS_SARO_EXRO>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SARO_EXRO> listRaw = ctx.HIS_SARO_EXRO.Where(o => listId.Contains(o.ID)).ToList();
