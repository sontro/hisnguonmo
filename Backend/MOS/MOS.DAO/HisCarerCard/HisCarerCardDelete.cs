...
{
    partial class HisCarerCardDelete : EntityBase
    {
        public HisCarerCardDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CARER_CARD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CARER_CARD> listIdNotFound = new List<HIS_CARER_CARD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CARER_CARD> listRaw = ctx.HIS_CARER_CARD.Where(o => listId.Contains(o.ID)).ToList();
