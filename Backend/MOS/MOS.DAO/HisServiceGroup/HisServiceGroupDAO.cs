...
namespace MOS.DAO.HisServiceGroup
{
    ...
    {
        private HisServiceGroupCreate CreateWorker
        {
            get
            {
                return (HisServiceGroupCreate)Worker.Get<HisServiceGroupCreate>();
            }
        }
        private HisServiceGroupUpdate UpdateWorker
        {
            get
            {
                return (HisServiceGroupUpdate)Worker.Get<HisServiceGroupUpdate>();
            }
        }
        private HisServiceGroupDelete DeleteWorker
        {
            get
            {
                return (HisServiceGroupDelete)Worker.Get<HisServiceGroupDelete>();
            }
        }
        private HisServiceGroupTruncate TruncateWorker
        {
            get
            {
                return (HisServiceGroupTruncate)Worker.Get<HisServiceGroupTruncate>();
            }
        }
        ...
        private HisServiceGroupCheck CheckWorker
        {
            get
            {
                return (HisServiceGroupCheck)Worker.Get<HisServiceGroupCheck>();
            }
        }
        ...
        public bool Delete(HIS_SERVICE_GROUP data)
        {
            bool result = false;
            try
            {
        ...
        public bool DeleteList(List<HIS_SERVICE_GROUP> listData)
        {
            bool result = false;
