...
{
    partial class HisServiceGroupDelete : EntityBase
    {
        public HisServiceGroupDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_GROUP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_GROUP> listIdNotFound = new List<HIS_SERVICE_GROUP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_GROUP> listRaw = ctx.HIS_SERVICE_GROUP.Where(o => listId.Contains(o.ID)).ToList();
