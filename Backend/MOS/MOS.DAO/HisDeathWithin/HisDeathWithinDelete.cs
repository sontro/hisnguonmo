...
{
    partial class HisDeathWithinDelete : EntityBase
    {
        public HisDeathWithinDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEATH_WITHIN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEATH_WITHIN> listIdNotFound = new List<HIS_DEATH_WITHIN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEATH_WITHIN> listRaw = ctx.HIS_DEATH_WITHIN.Where(o => listId.Contains(o.ID)).ToList();
