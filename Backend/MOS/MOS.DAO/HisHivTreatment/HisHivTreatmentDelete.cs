...
{
    partial class HisHivTreatmentDelete : EntityBase
    {
        public HisHivTreatmentDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HIV_TREATMENT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HIV_TREATMENT> listIdNotFound = new List<HIS_HIV_TREATMENT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HIV_TREATMENT> listRaw = ctx.HIS_HIV_TREATMENT.Where(o => listId.Contains(o.ID)).ToList();
