...
{
    partial class HisSurgRemunerationDelete : EntityBase
    {
        public HisSurgRemunerationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SURG_REMUNERATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SURG_REMUNERATION> listIdNotFound = new List<HIS_SURG_REMUNERATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SURG_REMUNERATION> listRaw = ctx.HIS_SURG_REMUNERATION.Where(o => listId.Contains(o.ID)).ToList();
