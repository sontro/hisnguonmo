...
{
    partial class HisMediStockExtyDelete : EntityBase
    {
        public HisMediStockExtyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_STOCK_EXTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_STOCK_EXTY> listIdNotFound = new List<HIS_MEDI_STOCK_EXTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_STOCK_EXTY> listRaw = ctx.HIS_MEDI_STOCK_EXTY.Where(o => listId.Contains(o.ID)).ToList();
