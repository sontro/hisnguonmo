...
{
    partial class HisAppointmentServDelete : EntityBase
    {
        public HisAppointmentServDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_APPOINTMENT_SERV> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_APPOINTMENT_SERV> listIdNotFound = new List<HIS_APPOINTMENT_SERV>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_APPOINTMENT_SERV> listRaw = ctx.HIS_APPOINTMENT_SERV.Where(o => listId.Contains(o.ID)).ToList();
