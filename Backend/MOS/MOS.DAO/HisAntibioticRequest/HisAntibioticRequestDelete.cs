...
{
    partial class HisAntibioticRequestDelete : EntityBase
    {
        public HisAntibioticRequestDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTIBIOTIC_REQUEST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTIBIOTIC_REQUEST> listIdNotFound = new List<HIS_ANTIBIOTIC_REQUEST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTIBIOTIC_REQUEST> listRaw = ctx.HIS_ANTIBIOTIC_REQUEST.Where(o => listId.Contains(o.ID)).ToList();
