...
{
    partial class HisSereServSuinDelete : EntityBase
    {
        public HisSereServSuinDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_SUIN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_SUIN> listIdNotFound = new List<HIS_SERE_SERV_SUIN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_SUIN> listRaw = ctx.HIS_SERE_SERV_SUIN.Where(o => listId.Contains(o.ID)).ToList();
