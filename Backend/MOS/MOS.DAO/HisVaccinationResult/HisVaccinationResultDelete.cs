...
{
    partial class HisVaccinationResultDelete : EntityBase
    {
        public HisVaccinationResultDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINATION_RESULT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINATION_RESULT> listIdNotFound = new List<HIS_VACCINATION_RESULT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINATION_RESULT> listRaw = ctx.HIS_VACCINATION_RESULT.Where(o => listId.Contains(o.ID)).ToList();
