...
{
    partial class HisImpMestPayDelete : EntityBase
    {
        public HisImpMestPayDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_PAY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_PAY> listIdNotFound = new List<HIS_IMP_MEST_PAY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_PAY> listRaw = ctx.HIS_IMP_MEST_PAY.Where(o => listId.Contains(o.ID)).ToList();
