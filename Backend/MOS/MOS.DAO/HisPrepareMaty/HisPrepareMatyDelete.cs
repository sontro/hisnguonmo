...
{
    partial class HisPrepareMatyDelete : EntityBase
    {
        public HisPrepareMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PREPARE_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PREPARE_MATY> listIdNotFound = new List<HIS_PREPARE_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PREPARE_MATY> listRaw = ctx.HIS_PREPARE_MATY.Where(o => listId.Contains(o.ID)).ToList();
