...
{
    partial class HisServiceMachineDelete : EntityBase
    {
        public HisServiceMachineDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_MACHINE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_MACHINE> listIdNotFound = new List<HIS_SERVICE_MACHINE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_MACHINE> listRaw = ctx.HIS_SERVICE_MACHINE.Where(o => listId.Contains(o.ID)).ToList();
