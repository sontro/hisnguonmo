...
{
    partial class HisServiceMatyDelete : EntityBase
    {
        public HisServiceMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_MATY> listIdNotFound = new List<HIS_SERVICE_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_MATY> listRaw = ctx.HIS_SERVICE_MATY.Where(o => listId.Contains(o.ID)).ToList();
