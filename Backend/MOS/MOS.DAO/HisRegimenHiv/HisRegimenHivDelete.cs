...
{
    partial class HisRegimenHivDelete : EntityBase
    {
        public HisRegimenHivDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REGIMEN_HIV> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REGIMEN_HIV> listIdNotFound = new List<HIS_REGIMEN_HIV>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REGIMEN_HIV> listRaw = ctx.HIS_REGIMEN_HIV.Where(o => listId.Contains(o.ID)).ToList();
