...
{
    partial class HisBranchTimeDelete : EntityBase
    {
        public HisBranchTimeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BRANCH_TIME> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BRANCH_TIME> listIdNotFound = new List<HIS_BRANCH_TIME>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BRANCH_TIME> listRaw = ctx.HIS_BRANCH_TIME.Where(o => listId.Contains(o.ID)).ToList();
