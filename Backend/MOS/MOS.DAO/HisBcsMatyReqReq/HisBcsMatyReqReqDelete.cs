...
{
    partial class HisBcsMatyReqReqDelete : EntityBase
    {
        public HisBcsMatyReqReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BCS_MATY_REQ_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BCS_MATY_REQ_REQ> listIdNotFound = new List<HIS_BCS_MATY_REQ_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BCS_MATY_REQ_REQ> listRaw = ctx.HIS_BCS_MATY_REQ_REQ.Where(o => listId.Contains(o.ID)).ToList();
