...
namespace MOS.DAO.HisBcsMatyReqReq
{
    public partial class HisBcsMatyReqReqDAO : EntityBase
    {
        ...
        public HIS_BCS_MATY_REQ_REQ GetByCode(string code, HisBcsMatyReqReqSO search)
        {
        ...
        public V_HIS_BCS_MATY_REQ_REQ GetViewByCode(string code, HisBcsMatyReqReqSO search)
        {
            V_HIS_BCS_MATY_REQ_REQ result = null;
        ...
        public Dictionary<string, HIS_BCS_MATY_REQ_REQ> GetDicByCode(HisBcsMatyReqReqSO search, CommonParam param)
        {
            Dictionary<string, HIS_BCS_MATY_REQ_REQ> result = new Dictionary<string, HIS_BCS_MATY_REQ_REQ>();
            try
            {
