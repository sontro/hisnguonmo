...
{
    partial class HisExpMestBloodDelete : EntityBase
    {
        public HisExpMestBloodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_BLOOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_BLOOD> listIdNotFound = new List<HIS_EXP_MEST_BLOOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_BLOOD> listRaw = ctx.HIS_EXP_MEST_BLOOD.Where(o => listId.Contains(o.ID)).ToList();
