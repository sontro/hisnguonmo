...
{
    partial class HisImpMestTypeUserDelete : EntityBase
    {
        public HisImpMestTypeUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_TYPE_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_TYPE_USER> listIdNotFound = new List<HIS_IMP_MEST_TYPE_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_TYPE_USER> listRaw = ctx.HIS_IMP_MEST_TYPE_USER.Where(o => listId.Contains(o.ID)).ToList();
