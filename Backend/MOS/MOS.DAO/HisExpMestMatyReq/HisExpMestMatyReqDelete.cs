...
{
    partial class HisExpMestMatyReqDelete : EntityBase
    {
        public HisExpMestMatyReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_MATY_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_MATY_REQ> listIdNotFound = new List<HIS_EXP_MEST_MATY_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_MATY_REQ> listRaw = ctx.HIS_EXP_MEST_MATY_REQ.Where(o => listId.Contains(o.ID)).ToList();
