...
{
    partial class HisEkipPlanDelete : EntityBase
    {
        public HisEkipPlanDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EKIP_PLAN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EKIP_PLAN> listIdNotFound = new List<HIS_EKIP_PLAN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EKIP_PLAN> listRaw = ctx.HIS_EKIP_PLAN.Where(o => listId.Contains(o.ID)).ToList();
