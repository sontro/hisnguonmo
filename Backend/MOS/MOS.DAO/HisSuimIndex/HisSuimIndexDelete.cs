...
{
    partial class HisSuimIndexDelete : EntityBase
    {
        public HisSuimIndexDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SUIM_INDEX> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SUIM_INDEX> listIdNotFound = new List<HIS_SUIM_INDEX>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SUIM_INDEX> listRaw = ctx.HIS_SUIM_INDEX.Where(o => listId.Contains(o.ID)).ToList();
