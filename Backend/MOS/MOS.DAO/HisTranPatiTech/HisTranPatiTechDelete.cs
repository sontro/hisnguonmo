...
{
    partial class HisTranPatiTechDelete : EntityBase
    {
        public HisTranPatiTechDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRAN_PATI_TECH> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRAN_PATI_TECH> listIdNotFound = new List<HIS_TRAN_PATI_TECH>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRAN_PATI_TECH> listRaw = ctx.HIS_TRAN_PATI_TECH.Where(o => listId.Contains(o.ID)).ToList();
