...
{
    partial class HisMediOrgDelete : EntityBase
    {
        public HisMediOrgDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_ORG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_ORG> listIdNotFound = new List<HIS_MEDI_ORG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_ORG> listRaw = ctx.HIS_MEDI_ORG.Where(o => listId.Contains(o.ID)).ToList();
