...
{
    partial class HisKskServiceDelete : EntityBase
    {
        public HisKskServiceDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_SERVICE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_SERVICE> listIdNotFound = new List<HIS_KSK_SERVICE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_SERVICE> listRaw = ctx.HIS_KSK_SERVICE.Where(o => listId.Contains(o.ID)).ToList();
