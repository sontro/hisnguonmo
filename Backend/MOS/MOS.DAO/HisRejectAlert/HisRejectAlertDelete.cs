...
{
    partial class HisRejectAlertDelete : EntityBase
    {
        public HisRejectAlertDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REJECT_ALERT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REJECT_ALERT> listIdNotFound = new List<HIS_REJECT_ALERT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REJECT_ALERT> listRaw = ctx.HIS_REJECT_ALERT.Where(o => listId.Contains(o.ID)).ToList();
