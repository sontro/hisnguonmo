...
{
    partial class HisNoneMediServiceDelete : EntityBase
    {
        public HisNoneMediServiceDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_NONE_MEDI_SERVICE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_NONE_MEDI_SERVICE> listIdNotFound = new List<HIS_NONE_MEDI_SERVICE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_NONE_MEDI_SERVICE> listRaw = ctx.HIS_NONE_MEDI_SERVICE.Where(o => listId.Contains(o.ID)).ToList();
