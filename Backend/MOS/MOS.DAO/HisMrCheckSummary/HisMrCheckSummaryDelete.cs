...
{
    partial class HisMrCheckSummaryDelete : EntityBase
    {
        public HisMrCheckSummaryDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MR_CHECK_SUMMARY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MR_CHECK_SUMMARY> listIdNotFound = new List<HIS_MR_CHECK_SUMMARY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MR_CHECK_SUMMARY> listRaw = ctx.HIS_MR_CHECK_SUMMARY.Where(o => listId.Contains(o.ID)).ToList();
