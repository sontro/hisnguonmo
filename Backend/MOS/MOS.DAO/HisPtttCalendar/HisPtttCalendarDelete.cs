...
{
    partial class HisPtttCalendarDelete : EntityBase
    {
        public HisPtttCalendarDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_CALENDAR> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_CALENDAR> listIdNotFound = new List<HIS_PTTT_CALENDAR>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_CALENDAR> listRaw = ctx.HIS_PTTT_CALENDAR.Where(o => listId.Contains(o.ID)).ToList();
