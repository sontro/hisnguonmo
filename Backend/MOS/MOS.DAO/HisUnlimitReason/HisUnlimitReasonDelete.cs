...
{
    partial class HisUnlimitReasonDelete : EntityBase
    {
        public HisUnlimitReasonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_UNLIMIT_REASON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_UNLIMIT_REASON> listIdNotFound = new List<HIS_UNLIMIT_REASON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_UNLIMIT_REASON> listRaw = ctx.HIS_UNLIMIT_REASON.Where(o => listId.Contains(o.ID)).ToList();
