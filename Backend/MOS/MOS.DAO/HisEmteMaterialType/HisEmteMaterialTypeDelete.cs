...
{
    partial class HisEmteMaterialTypeDelete : EntityBase
    {
        public HisEmteMaterialTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMTE_MATERIAL_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMTE_MATERIAL_TYPE> listIdNotFound = new List<HIS_EMTE_MATERIAL_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMTE_MATERIAL_TYPE> listRaw = ctx.HIS_EMTE_MATERIAL_TYPE.Where(o => listId.Contains(o.ID)).ToList();
