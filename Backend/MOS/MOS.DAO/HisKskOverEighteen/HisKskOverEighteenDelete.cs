...
{
    partial class HisKskOverEighteenDelete : EntityBase
    {
        public HisKskOverEighteenDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_OVER_EIGHTEEN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_OVER_EIGHTEEN> listIdNotFound = new List<HIS_KSK_OVER_EIGHTEEN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_OVER_EIGHTEEN> listRaw = ctx.HIS_KSK_OVER_EIGHTEEN.Where(o => listId.Contains(o.ID)).ToList();
