...
{
    partial class HisEmrCoverConfigDelete : EntityBase
    {
        public HisEmrCoverConfigDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMR_COVER_CONFIG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMR_COVER_CONFIG> listIdNotFound = new List<HIS_EMR_COVER_CONFIG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMR_COVER_CONFIG> listRaw = ctx.HIS_EMR_COVER_CONFIG.Where(o => listId.Contains(o.ID)).ToList();
