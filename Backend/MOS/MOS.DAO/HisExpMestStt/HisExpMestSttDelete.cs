...
{
    partial class HisExpMestSttDelete : EntityBase
    {
        public HisExpMestSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_STT> listIdNotFound = new List<HIS_EXP_MEST_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_STT> listRaw = ctx.HIS_EXP_MEST_STT.Where(o => listId.Contains(o.ID)).ToList();
