...
{
    partial class HisBedBstyDelete : EntityBase
    {
        public HisBedBstyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BED_BSTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BED_BSTY> listIdNotFound = new List<HIS_BED_BSTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BED_BSTY> listRaw = ctx.HIS_BED_BSTY.Where(o => listId.Contains(o.ID)).ToList();
