...
{
    partial class HisExecuteRoleDelete : EntityBase
    {
        public HisExecuteRoleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXECUTE_ROLE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXECUTE_ROLE> listIdNotFound = new List<HIS_EXECUTE_ROLE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXECUTE_ROLE> listRaw = ctx.HIS_EXECUTE_ROLE.Where(o => listId.Contains(o.ID)).ToList();
