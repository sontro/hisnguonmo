...
{
    partial class HisMediStockMatyDelete : EntityBase
    {
        public HisMediStockMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_STOCK_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_STOCK_MATY> listIdNotFound = new List<HIS_MEDI_STOCK_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_STOCK_MATY> listRaw = ctx.HIS_MEDI_STOCK_MATY.Where(o => listId.Contains(o.ID)).ToList();
