...
{
    partial class HisMedicinePatyDelete : EntityBase
    {
        public HisMedicinePatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_PATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_PATY> listIdNotFound = new List<HIS_MEDICINE_PATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_PATY> listRaw = ctx.HIS_MEDICINE_PATY.Where(o => listId.Contains(o.ID)).ToList();
