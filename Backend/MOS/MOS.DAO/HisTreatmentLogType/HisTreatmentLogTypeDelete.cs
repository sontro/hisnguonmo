...
{
    partial class HisTreatmentLogTypeDelete : EntityBase
    {
        public HisTreatmentLogTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_LOG_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_LOG_TYPE> listIdNotFound = new List<HIS_TREATMENT_LOG_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_LOG_TYPE> listRaw = ctx.HIS_TREATMENT_LOG_TYPE.Where(o => listId.Contains(o.ID)).ToList();
