...
{
    partial class HisEquipmentSetMatyDelete : EntityBase
    {
        public HisEquipmentSetMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EQUIPMENT_SET_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EQUIPMENT_SET_MATY> listIdNotFound = new List<HIS_EQUIPMENT_SET_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EQUIPMENT_SET_MATY> listRaw = ctx.HIS_EQUIPMENT_SET_MATY.Where(o => listId.Contains(o.ID)).ToList();
