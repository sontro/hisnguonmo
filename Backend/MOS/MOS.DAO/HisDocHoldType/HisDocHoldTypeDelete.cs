...
{
    partial class HisDocHoldTypeDelete : EntityBase
    {
        public HisDocHoldTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DOC_HOLD_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DOC_HOLD_TYPE> listIdNotFound = new List<HIS_DOC_HOLD_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DOC_HOLD_TYPE> listRaw = ctx.HIS_DOC_HOLD_TYPE.Where(o => listId.Contains(o.ID)).ToList();
