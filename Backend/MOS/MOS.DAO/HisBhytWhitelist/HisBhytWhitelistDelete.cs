...
{
    partial class HisBhytWhitelistDelete : EntityBase
    {
        public HisBhytWhitelistDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BHYT_WHITELIST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BHYT_WHITELIST> listIdNotFound = new List<HIS_BHYT_WHITELIST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BHYT_WHITELIST> listRaw = ctx.HIS_BHYT_WHITELIST.Where(o => listId.Contains(o.ID)).ToList();
