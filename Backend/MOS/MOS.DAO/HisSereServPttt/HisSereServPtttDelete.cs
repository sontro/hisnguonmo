...
{
    partial class HisSereServPtttDelete : EntityBase
    {
        public HisSereServPtttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_PTTT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_PTTT> listIdNotFound = new List<HIS_SERE_SERV_PTTT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_PTTT> listRaw = ctx.HIS_SERE_SERV_PTTT.Where(o => listId.Contains(o.ID)).ToList();
