...
{
    partial class HisAppointmentPeriodDelete : EntityBase
    {
        public HisAppointmentPeriodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_APPOINTMENT_PERIOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_APPOINTMENT_PERIOD> listIdNotFound = new List<HIS_APPOINTMENT_PERIOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_APPOINTMENT_PERIOD> listRaw = ctx.HIS_APPOINTMENT_PERIOD.Where(o => listId.Contains(o.ID)).ToList();
