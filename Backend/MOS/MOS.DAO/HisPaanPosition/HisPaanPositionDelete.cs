...
{
    partial class HisPaanPositionDelete : EntityBase
    {
        public HisPaanPositionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PAAN_POSITION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PAAN_POSITION> listIdNotFound = new List<HIS_PAAN_POSITION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PAAN_POSITION> listRaw = ctx.HIS_PAAN_POSITION.Where(o => listId.Contains(o.ID)).ToList();
