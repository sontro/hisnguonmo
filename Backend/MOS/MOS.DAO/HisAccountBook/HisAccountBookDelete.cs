...
{
    partial class HisAccountBookDelete : EntityBase
    {
        public HisAccountBookDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCOUNT_BOOK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCOUNT_BOOK> listIdNotFound = new List<HIS_ACCOUNT_BOOK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCOUNT_BOOK> listRaw = ctx.HIS_ACCOUNT_BOOK.Where(o => listId.Contains(o.ID)).ToList();
