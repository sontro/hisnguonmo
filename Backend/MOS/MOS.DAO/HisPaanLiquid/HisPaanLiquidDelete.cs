...
{
    partial class HisPaanLiquidDelete : EntityBase
    {
        public HisPaanLiquidDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PAAN_LIQUID> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PAAN_LIQUID> listIdNotFound = new List<HIS_PAAN_LIQUID>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PAAN_LIQUID> listRaw = ctx.HIS_PAAN_LIQUID.Where(o => listId.Contains(o.ID)).ToList();
