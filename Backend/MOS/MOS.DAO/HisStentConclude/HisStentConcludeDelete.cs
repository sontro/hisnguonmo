...
{
    partial class HisStentConcludeDelete : EntityBase
    {
        public HisStentConcludeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_STENT_CONCLUDE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_STENT_CONCLUDE> listIdNotFound = new List<HIS_STENT_CONCLUDE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_STENT_CONCLUDE> listRaw = ctx.HIS_STENT_CONCLUDE.Where(o => listId.Contains(o.ID)).ToList();
