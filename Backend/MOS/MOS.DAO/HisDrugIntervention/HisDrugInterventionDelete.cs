...
{
    partial class HisDrugInterventionDelete : EntityBase
    {
        public HisDrugInterventionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DRUG_INTERVENTION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DRUG_INTERVENTION> listIdNotFound = new List<HIS_DRUG_INTERVENTION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DRUG_INTERVENTION> listRaw = ctx.HIS_DRUG_INTERVENTION.Where(o => listId.Contains(o.ID)).ToList();
