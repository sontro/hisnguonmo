...
{
    partial class HisBidMaterialTypeDelete : EntityBase
    {
        public HisBidMaterialTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BID_MATERIAL_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BID_MATERIAL_TYPE> listIdNotFound = new List<HIS_BID_MATERIAL_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BID_MATERIAL_TYPE> listRaw = ctx.HIS_BID_MATERIAL_TYPE.Where(o => listId.Contains(o.ID)).ToList();
