...
{
    partial class HisHoreHohaDelete : EntityBase
    {
        public HisHoreHohaDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HORE_HOHA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HORE_HOHA> listIdNotFound = new List<HIS_HORE_HOHA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HORE_HOHA> listRaw = ctx.HIS_HORE_HOHA.Where(o => listId.Contains(o.ID)).ToList();
