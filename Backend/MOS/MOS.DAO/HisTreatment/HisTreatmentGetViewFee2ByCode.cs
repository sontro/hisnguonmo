...
namespace MOS.DAO.HisTreatment
{
    ...
    {
        public V_HIS_TREATMENT_FEE_2 GetFeeView2ByCode(string code, HisTreatmentSO search)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    ...
                    {
                        var query = ctx.V_HIS_TREATMENT_FEE_2.AsQueryable().Where(p => p.TREATMENT_CODE == code);
