...
namespace MOS.DAO.HisTreatment
{
    ...
    {
        private HisTreatmentCreate CreateWorker
        {
            get
            {
                return (HisTreatmentCreate)Worker.Get<HisTreatmentCreate>();
            }
        }
        private HisTreatmentUpdate UpdateWorker
        {
            get
            {
                return (HisTreatmentUpdate)Worker.Get<HisTreatmentUpdate>();
            }
        }
        private HisTreatmentDelete DeleteWorker
        {
            get
            {
                return (HisTreatmentDelete)Worker.Get<HisTreatmentDelete>();
            }
        }
        private HisTreatmentTruncate TruncateWorker
        {
            get
            {
                return (HisTreatmentTruncate)Worker.Get<HisTreatmentTruncate>();
            }
        }
        ...
        private HisTreatmentCheck CheckWorker
        {
            get
            {
                return (HisTreatmentCheck)Worker.Get<HisTreatmentCheck>();
            }
        }
