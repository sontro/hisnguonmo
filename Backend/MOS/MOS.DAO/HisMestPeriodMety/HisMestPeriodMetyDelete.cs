...
{
    partial class HisMestPeriodMetyDelete : EntityBase
    {
        public HisMestPeriodMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PERIOD_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PERIOD_METY> listIdNotFound = new List<HIS_MEST_PERIOD_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PERIOD_METY> listRaw = ctx.HIS_MEST_PERIOD_METY.Where(o => listId.Contains(o.ID)).ToList();
