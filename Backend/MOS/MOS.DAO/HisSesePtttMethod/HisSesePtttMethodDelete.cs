...
{
    partial class HisSesePtttMethodDelete : EntityBase
    {
        public HisSesePtttMethodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SESE_PTTT_METHOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SESE_PTTT_METHOD> listIdNotFound = new List<HIS_SESE_PTTT_METHOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SESE_PTTT_METHOD> listRaw = ctx.HIS_SESE_PTTT_METHOD.Where(o => listId.Contains(o.ID)).ToList();
