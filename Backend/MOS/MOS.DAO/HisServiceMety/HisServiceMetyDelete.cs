...
{
    partial class HisServiceMetyDelete : EntityBase
    {
        public HisServiceMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_METY> listIdNotFound = new List<HIS_SERVICE_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_METY> listRaw = ctx.HIS_SERVICE_METY.Where(o => listId.Contains(o.ID)).ToList();
