...
{
    partial class HisSubclinicalRsAddDelete : EntityBase
    {
        public HisSubclinicalRsAddDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SUBCLINICAL_RS_ADD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SUBCLINICAL_RS_ADD> listIdNotFound = new List<HIS_SUBCLINICAL_RS_ADD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SUBCLINICAL_RS_ADD> listRaw = ctx.HIS_SUBCLINICAL_RS_ADD.Where(o => listId.Contains(o.ID)).ToList();
