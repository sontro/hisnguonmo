...
{
    partial class HisBidTypeDelete : EntityBase
    {
        public HisBidTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BID_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BID_TYPE> listIdNotFound = new List<HIS_BID_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BID_TYPE> listRaw = ctx.HIS_BID_TYPE.Where(o => listId.Contains(o.ID)).ToList();
