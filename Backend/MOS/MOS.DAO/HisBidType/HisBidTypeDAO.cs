...
namespace MOS.DAO.HisBidType
{
    ...
    {
        private HisBidTypeCreate CreateWorker
        {
            get
            {
                return (HisBidTypeCreate)Worker.Get<HisBidTypeCreate>();
            }
        }
        private HisBidTypeUpdate UpdateWorker
        {
            get
            {
                return (HisBidTypeUpdate)Worker.Get<HisBidTypeUpdate>();
            }
        }
        private HisBidTypeDelete DeleteWorker
        {
            get
            {
                return (HisBidTypeDelete)Worker.Get<HisBidTypeDelete>();
            }
        }
        private HisBidTypeTruncate TruncateWorker
        {
            get
            {
                return (HisBidTypeTruncate)Worker.Get<HisBidTypeTruncate>();
            }
        }
        ...
        private HisBidTypeCheck CheckWorker
        {
            get
            {
                return (HisBidTypeCheck)Worker.Get<HisBidTypeCheck>();
            }
        }
        ...
        public bool Delete(HIS_BID_TYPE data)
        {
            bool result = false;
            try
            {
        ...
        public bool DeleteList(List<HIS_BID_TYPE> listData)
        {
            bool result = false;
