...
{
    partial class HisAccidentBodyPartDelete : EntityBase
    {
        public HisAccidentBodyPartDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_BODY_PART> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_BODY_PART> listIdNotFound = new List<HIS_ACCIDENT_BODY_PART>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_BODY_PART> listRaw = ctx.HIS_ACCIDENT_BODY_PART.Where(o => listId.Contains(o.ID)).ToList();
