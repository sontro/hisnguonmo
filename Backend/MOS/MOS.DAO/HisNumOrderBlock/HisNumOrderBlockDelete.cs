...
{
    partial class HisNumOrderBlockDelete : EntityBase
    {
        public HisNumOrderBlockDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_NUM_ORDER_BLOCK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_NUM_ORDER_BLOCK> listIdNotFound = new List<HIS_NUM_ORDER_BLOCK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_NUM_ORDER_BLOCK> listRaw = ctx.HIS_NUM_ORDER_BLOCK.Where(o => listId.Contains(o.ID)).ToList();
