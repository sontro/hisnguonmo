...
{
    partial class HisRoomTypeModuleDelete : EntityBase
    {
        public HisRoomTypeModuleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ROOM_TYPE_MODULE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ROOM_TYPE_MODULE> listIdNotFound = new List<HIS_ROOM_TYPE_MODULE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ROOM_TYPE_MODULE> listRaw = ctx.HIS_ROOM_TYPE_MODULE.Where(o => listId.Contains(o.ID)).ToList();
