...
{
    partial class HisBloodAboDelete : EntityBase
    {
        public HisBloodAboDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BLOOD_ABO> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BLOOD_ABO> listIdNotFound = new List<HIS_BLOOD_ABO>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BLOOD_ABO> listRaw = ctx.HIS_BLOOD_ABO.Where(o => listId.Contains(o.ID)).ToList();
