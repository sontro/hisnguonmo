...
{
    partial class HisExpMestMedicineDelete : EntityBase
    {
        public HisExpMestMedicineDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_MEDICINE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_MEDICINE> listIdNotFound = new List<HIS_EXP_MEST_MEDICINE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_MEDICINE> listRaw = ctx.HIS_EXP_MEST_MEDICINE.Where(o => listId.Contains(o.ID)).ToList();
