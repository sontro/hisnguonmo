...
{
    partial class HisPayFormDelete : EntityBase
    {
        public HisPayFormDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PAY_FORM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PAY_FORM> listIdNotFound = new List<HIS_PAY_FORM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PAY_FORM> listRaw = ctx.HIS_PAY_FORM.Where(o => listId.Contains(o.ID)).ToList();
