...
{
    partial class HisUserGroupTempDelete : EntityBase
    {
        public HisUserGroupTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_USER_GROUP_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_USER_GROUP_TEMP> listIdNotFound = new List<HIS_USER_GROUP_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_USER_GROUP_TEMP> listRaw = ctx.HIS_USER_GROUP_TEMP.Where(o => listId.Contains(o.ID)).ToList();
