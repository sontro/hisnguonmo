...
{
    partial class HisMedicineTypeRoomDelete : EntityBase
    {
        public HisMedicineTypeRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_TYPE_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_TYPE_ROOM> listIdNotFound = new List<HIS_MEDICINE_TYPE_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_TYPE_ROOM> listRaw = ctx.HIS_MEDICINE_TYPE_ROOM.Where(o => listId.Contains(o.ID)).ToList();
