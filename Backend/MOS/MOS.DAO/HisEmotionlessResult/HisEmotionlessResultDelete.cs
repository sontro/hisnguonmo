...
{
    partial class HisEmotionlessResultDelete : EntityBase
    {
        public HisEmotionlessResultDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMOTIONLESS_RESULT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMOTIONLESS_RESULT> listIdNotFound = new List<HIS_EMOTIONLESS_RESULT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMOTIONLESS_RESULT> listRaw = ctx.HIS_EMOTIONLESS_RESULT.Where(o => listId.Contains(o.ID)).ToList();
