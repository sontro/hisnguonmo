...
{
    partial class HisMediRecordTypeDelete : EntityBase
    {
        public HisMediRecordTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_RECORD_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_RECORD_TYPE> listIdNotFound = new List<HIS_MEDI_RECORD_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_RECORD_TYPE> listRaw = ctx.HIS_MEDI_RECORD_TYPE.Where(o => listId.Contains(o.ID)).ToList();
