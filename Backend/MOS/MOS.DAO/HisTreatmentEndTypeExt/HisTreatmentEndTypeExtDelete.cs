...
{
    partial class HisTreatmentEndTypeExtDelete : EntityBase
    {
        public HisTreatmentEndTypeExtDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_END_TYPE_EXT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_END_TYPE_EXT> listIdNotFound = new List<HIS_TREATMENT_END_TYPE_EXT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_END_TYPE_EXT> listRaw = ctx.HIS_TREATMENT_END_TYPE_EXT.Where(o => listId.Contains(o.ID)).ToList();
