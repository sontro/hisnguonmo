...
{
    partial class HisMedicineTypeTutDelete : EntityBase
    {
        public HisMedicineTypeTutDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_TYPE_TUT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_TYPE_TUT> listIdNotFound = new List<HIS_MEDICINE_TYPE_TUT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_TYPE_TUT> listRaw = ctx.HIS_MEDICINE_TYPE_TUT.Where(o => listId.Contains(o.ID)).ToList();
