...
namespace MOS.DAO.HisMedicineTypeTut
{
    ...
    {
        public List<V_HIS_MEDICINE_TYPE_TUT> GetView(HisMedicineTypeTutSO search, CommonParam param)
        {
            List<V_HIS_MEDICINE_TYPE_TUT> result = new List<V_HIS_MEDICINE_TYPE_TUT>();
        ...
        public V_HIS_MEDICINE_TYPE_TUT GetViewByCode(string code, HisMedicineTypeTutSO search)
        {
            V_HIS_MEDICINE_TYPE_TUT result = null;
