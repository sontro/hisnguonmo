...
{
    partial class HisExpMestReasonDelete : EntityBase
    {
        public HisExpMestReasonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_REASON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_REASON> listIdNotFound = new List<HIS_EXP_MEST_REASON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_REASON> listRaw = ctx.HIS_EXP_MEST_REASON.Where(o => listId.Contains(o.ID)).ToList();
