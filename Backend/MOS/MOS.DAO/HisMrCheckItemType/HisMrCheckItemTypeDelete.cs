...
{
    partial class HisMrCheckItemTypeDelete : EntityBase
    {
        public HisMrCheckItemTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MR_CHECK_ITEM_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MR_CHECK_ITEM_TYPE> listIdNotFound = new List<HIS_MR_CHECK_ITEM_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MR_CHECK_ITEM_TYPE> listRaw = ctx.HIS_MR_CHECK_ITEM_TYPE.Where(o => listId.Contains(o.ID)).ToList();
