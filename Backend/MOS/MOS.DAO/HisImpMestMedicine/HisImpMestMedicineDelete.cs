...
{
    partial class HisImpMestMedicineDelete : EntityBase
    {
        public HisImpMestMedicineDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_MEDICINE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_MEDICINE> listIdNotFound = new List<HIS_IMP_MEST_MEDICINE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_MEDICINE> listRaw = ctx.HIS_IMP_MEST_MEDICINE.Where(o => listId.Contains(o.ID)).ToList();
