...
{
    partial class HisStorageConditionDelete : EntityBase
    {
        public HisStorageConditionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_STORAGE_CONDITION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_STORAGE_CONDITION> listIdNotFound = new List<HIS_STORAGE_CONDITION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_STORAGE_CONDITION> listRaw = ctx.HIS_STORAGE_CONDITION.Where(o => listId.Contains(o.ID)).ToList();
