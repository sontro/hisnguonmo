...
{
    partial class HisSuimIndexUnitDelete : EntityBase
    {
        public HisSuimIndexUnitDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SUIM_INDEX_UNIT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SUIM_INDEX_UNIT> listIdNotFound = new List<HIS_SUIM_INDEX_UNIT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SUIM_INDEX_UNIT> listRaw = ctx.HIS_SUIM_INDEX_UNIT.Where(o => listId.Contains(o.ID)).ToList();
