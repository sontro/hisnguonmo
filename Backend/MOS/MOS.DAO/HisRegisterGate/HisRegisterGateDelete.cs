...
{
    partial class HisRegisterGateDelete : EntityBase
    {
        public HisRegisterGateDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REGISTER_GATE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REGISTER_GATE> listIdNotFound = new List<HIS_REGISTER_GATE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REGISTER_GATE> listRaw = ctx.HIS_REGISTER_GATE.Where(o => listId.Contains(o.ID)).ToList();
