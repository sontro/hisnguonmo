...
{
    partial class HisSereServExtDelete : EntityBase
    {
        public HisSereServExtDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_EXT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_EXT> listIdNotFound = new List<HIS_SERE_SERV_EXT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_EXT> listRaw = ctx.HIS_SERE_SERV_EXT.Where(o => listId.Contains(o.ID)).ToList();
