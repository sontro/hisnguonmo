...
{
    partial class HisDiseaseRelationDelete : EntityBase
    {
        public HisDiseaseRelationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DISEASE_RELATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DISEASE_RELATION> listIdNotFound = new List<HIS_DISEASE_RELATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DISEASE_RELATION> listRaw = ctx.HIS_DISEASE_RELATION.Where(o => listId.Contains(o.ID)).ToList();
