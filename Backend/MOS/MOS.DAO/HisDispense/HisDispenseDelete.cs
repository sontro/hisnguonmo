...
{
    partial class HisDispenseDelete : EntityBase
    {
        public HisDispenseDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DISPENSE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DISPENSE> listIdNotFound = new List<HIS_DISPENSE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DISPENSE> listRaw = ctx.HIS_DISPENSE.Where(o => listId.Contains(o.ID)).ToList();
