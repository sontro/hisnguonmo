...
{
    partial class HisSurgRemuDetailDelete : EntityBase
    {
        public HisSurgRemuDetailDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SURG_REMU_DETAIL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SURG_REMU_DETAIL> listIdNotFound = new List<HIS_SURG_REMU_DETAIL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SURG_REMU_DETAIL> listRaw = ctx.HIS_SURG_REMU_DETAIL.Where(o => listId.Contains(o.ID)).ToList();
