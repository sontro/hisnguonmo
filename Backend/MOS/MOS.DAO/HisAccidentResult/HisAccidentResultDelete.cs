...
{
    partial class HisAccidentResultDelete : EntityBase
    {
        public HisAccidentResultDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_RESULT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_RESULT> listIdNotFound = new List<HIS_ACCIDENT_RESULT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_RESULT> listRaw = ctx.HIS_ACCIDENT_RESULT.Where(o => listId.Contains(o.ID)).ToList();
