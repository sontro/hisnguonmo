...
{
    partial class HisAntibioticNewRegDelete : EntityBase
    {
        public HisAntibioticNewRegDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTIBIOTIC_NEW_REG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTIBIOTIC_NEW_REG> listIdNotFound = new List<HIS_ANTIBIOTIC_NEW_REG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTIBIOTIC_NEW_REG> listRaw = ctx.HIS_ANTIBIOTIC_NEW_REG.Where(o => listId.Contains(o.ID)).ToList();
