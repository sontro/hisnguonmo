...
namespace MOS.DAO.HisBed
{
    ...
    {
        private HisBedCreate CreateWorker
        {
            get
            {
                return (HisBedCreate)Worker.Get<HisBedCreate>();
            }
        }
        private HisBedUpdate UpdateWorker
        {
            get
            {
                return (HisBedUpdate)Worker.Get<HisBedUpdate>();
            }
        }
        private HisBedDelete DeleteWorker
        {
            get
            {
                return (HisBedDelete)Worker.Get<HisBedDelete>();
            }
        }
        private HisBedTruncate TruncateWorker
        {
            get
            {
                return (HisBedTruncate)Worker.Get<HisBedTruncate>();
            }
        }
        ...
        private HisBedCheck CheckWorker
        {
            get
            {
                return (HisBedCheck)Worker.Get<HisBedCheck>();
            }
        }
