...
{
    partial class HisServiceReqMatyDelete : EntityBase
    {
        public HisServiceReqMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_REQ_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_REQ_MATY> listIdNotFound = new List<HIS_SERVICE_REQ_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_REQ_MATY> listRaw = ctx.HIS_SERVICE_REQ_MATY.Where(o => listId.Contains(o.ID)).ToList();
