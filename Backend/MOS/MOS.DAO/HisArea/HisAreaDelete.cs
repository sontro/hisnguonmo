...
{
    partial class HisAreaDelete : EntityBase
    {
        public HisAreaDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_AREA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_AREA> listIdNotFound = new List<HIS_AREA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_AREA> listRaw = ctx.HIS_AREA.Where(o => listId.Contains(o.ID)).ToList();
