...
{
    partial class HisTreatmentTypeDelete : EntityBase
    {
        public HisTreatmentTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_TYPE> listIdNotFound = new List<HIS_TREATMENT_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_TYPE> listRaw = ctx.HIS_TREATMENT_TYPE.Where(o => listId.Contains(o.ID)).ToList();
