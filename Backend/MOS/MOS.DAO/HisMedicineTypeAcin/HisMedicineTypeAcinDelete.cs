...
{
    partial class HisMedicineTypeAcinDelete : EntityBase
    {
        public HisMedicineTypeAcinDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_TYPE_ACIN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_TYPE_ACIN> listIdNotFound = new List<HIS_MEDICINE_TYPE_ACIN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_TYPE_ACIN> listRaw = ctx.HIS_MEDICINE_TYPE_ACIN.Where(o => listId.Contains(o.ID)).ToList();
