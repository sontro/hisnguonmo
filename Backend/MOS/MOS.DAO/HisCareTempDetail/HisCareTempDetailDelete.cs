...
{
    partial class HisCareTempDetailDelete : EntityBase
    {
        public HisCareTempDetailDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CARE_TEMP_DETAIL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CARE_TEMP_DETAIL> listIdNotFound = new List<HIS_CARE_TEMP_DETAIL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CARE_TEMP_DETAIL> listRaw = ctx.HIS_CARE_TEMP_DETAIL.Where(o => listId.Contains(o.ID)).ToList();
