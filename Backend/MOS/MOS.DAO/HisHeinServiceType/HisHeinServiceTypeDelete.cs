...
{
    partial class HisHeinServiceTypeDelete : EntityBase
    {
        public HisHeinServiceTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HEIN_SERVICE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HEIN_SERVICE_TYPE> listIdNotFound = new List<HIS_HEIN_SERVICE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HEIN_SERVICE_TYPE> listRaw = ctx.HIS_HEIN_SERVICE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
