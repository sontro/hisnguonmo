...
{
    partial class HisSereServBillDelete : EntityBase
    {
        public HisSereServBillDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_BILL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_BILL> listIdNotFound = new List<HIS_SERE_SERV_BILL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_BILL> listRaw = ctx.HIS_SERE_SERV_BILL.Where(o => listId.Contains(o.ID)).ToList();
