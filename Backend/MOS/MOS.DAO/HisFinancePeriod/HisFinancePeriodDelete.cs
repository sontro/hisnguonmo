...
{
    partial class HisFinancePeriodDelete : EntityBase
    {
        public HisFinancePeriodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_FINANCE_PERIOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_FINANCE_PERIOD> listIdNotFound = new List<HIS_FINANCE_PERIOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_FINANCE_PERIOD> listRaw = ctx.HIS_FINANCE_PERIOD.Where(o => listId.Contains(o.ID)).ToList();
