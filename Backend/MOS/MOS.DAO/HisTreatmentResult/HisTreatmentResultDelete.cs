...
{
    partial class HisTreatmentResultDelete : EntityBase
    {
        public HisTreatmentResultDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_RESULT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_RESULT> listIdNotFound = new List<HIS_TREATMENT_RESULT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_RESULT> listRaw = ctx.HIS_TREATMENT_RESULT.Where(o => listId.Contains(o.ID)).ToList();
