...
{
    partial class HisVaccinationVrplDelete : EntityBase
    {
        public HisVaccinationVrplDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINATION_VRPL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINATION_VRPL> listIdNotFound = new List<HIS_VACCINATION_VRPL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINATION_VRPL> listRaw = ctx.HIS_VACCINATION_VRPL.Where(o => listId.Contains(o.ID)).ToList();
