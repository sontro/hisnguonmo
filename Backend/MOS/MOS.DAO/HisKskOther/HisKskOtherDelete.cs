...
{
    partial class HisKskOtherDelete : EntityBase
    {
        public HisKskOtherDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_OTHER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_OTHER> listIdNotFound = new List<HIS_KSK_OTHER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_OTHER> listRaw = ctx.HIS_KSK_OTHER.Where(o => listId.Contains(o.ID)).ToList();
