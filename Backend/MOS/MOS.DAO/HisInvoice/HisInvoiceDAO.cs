...
namespace MOS.DAO.HisInvoice
{
    ...
    {
        private HisInvoiceCreate CreateWorker
        {
            get
            {
                return (HisInvoiceCreate)Worker.Get<HisInvoiceCreate>();
            }
        }
        private HisInvoiceUpdate UpdateWorker
        {
            get
            {
                return (HisInvoiceUpdate)Worker.Get<HisInvoiceUpdate>();
            }
        }
        private HisInvoiceDelete DeleteWorker
        {
            get
            {
                return (HisInvoiceDelete)Worker.Get<HisInvoiceDelete>();
            }
        }
        private HisInvoiceTruncate TruncateWorker
        {
            get
            {
                return (HisInvoiceTruncate)Worker.Get<HisInvoiceTruncate>();
            }
        }
        ...
        private HisInvoiceCheck CheckWorker
        {
            get
            {
                return (HisInvoiceCheck)Worker.Get<HisInvoiceCheck>();
            }
        }
