...
{
    partial class HisNextTreaIntrDelete : EntityBase
    {
        public HisNextTreaIntrDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_NEXT_TREA_INTR> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_NEXT_TREA_INTR> listIdNotFound = new List<HIS_NEXT_TREA_INTR>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_NEXT_TREA_INTR> listRaw = ctx.HIS_NEXT_TREA_INTR.Where(o => listId.Contains(o.ID)).ToList();
