...
{
    partial class HisDebateReasonDelete : EntityBase
    {
        public HisDebateReasonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEBATE_REASON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEBATE_REASON> listIdNotFound = new List<HIS_DEBATE_REASON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEBATE_REASON> listRaw = ctx.HIS_DEBATE_REASON.Where(o => listId.Contains(o.ID)).ToList();
