...
{
    partial class HisBedRoomDelete : EntityBase
    {
        public HisBedRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BED_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BED_ROOM> listIdNotFound = new List<HIS_BED_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BED_ROOM> listRaw = ctx.HIS_BED_ROOM.Where(o => listId.Contains(o.ID)).ToList();
