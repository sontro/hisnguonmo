...
{
    partial class HisVaexVaerDelete : EntityBase
    {
        public HisVaexVaerDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VAEX_VAER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VAEX_VAER> listIdNotFound = new List<HIS_VAEX_VAER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VAEX_VAER> listRaw = ctx.HIS_VAEX_VAER.Where(o => listId.Contains(o.ID)).ToList();
