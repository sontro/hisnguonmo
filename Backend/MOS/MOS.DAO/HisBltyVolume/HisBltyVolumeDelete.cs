...
{
    partial class HisBltyVolumeDelete : EntityBase
    {
        public HisBltyVolumeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BLTY_VOLUME> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BLTY_VOLUME> listIdNotFound = new List<HIS_BLTY_VOLUME>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BLTY_VOLUME> listRaw = ctx.HIS_BLTY_VOLUME.Where(o => listId.Contains(o.ID)).ToList();
