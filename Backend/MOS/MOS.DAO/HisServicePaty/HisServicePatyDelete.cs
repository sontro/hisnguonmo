...
{
    partial class HisServicePatyDelete : EntityBase
    {
        public HisServicePatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_PATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_PATY> listIdNotFound = new List<HIS_SERVICE_PATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_PATY> listRaw = ctx.HIS_SERVICE_PATY.Where(o => listId.Contains(o.ID)).ToList();
