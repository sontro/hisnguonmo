...
{
    partial class HisKskContractDelete : EntityBase
    {
        public HisKskContractDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_CONTRACT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_CONTRACT> listIdNotFound = new List<HIS_KSK_CONTRACT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_CONTRACT> listRaw = ctx.HIS_KSK_CONTRACT.Where(o => listId.Contains(o.ID)).ToList();
