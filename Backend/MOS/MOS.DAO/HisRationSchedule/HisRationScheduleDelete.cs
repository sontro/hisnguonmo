...
{
    partial class HisRationScheduleDelete : EntityBase
    {
        public HisRationScheduleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_RATION_SCHEDULE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_RATION_SCHEDULE> listIdNotFound = new List<HIS_RATION_SCHEDULE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_RATION_SCHEDULE> listRaw = ctx.HIS_RATION_SCHEDULE.Where(o => listId.Contains(o.ID)).ToList();
