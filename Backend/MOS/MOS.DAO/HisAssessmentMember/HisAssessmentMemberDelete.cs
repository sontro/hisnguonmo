...
{
    partial class HisAssessmentMemberDelete : EntityBase
    {
        public HisAssessmentMemberDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ASSESSMENT_MEMBER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ASSESSMENT_MEMBER> listIdNotFound = new List<HIS_ASSESSMENT_MEMBER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ASSESSMENT_MEMBER> listRaw = ctx.HIS_ASSESSMENT_MEMBER.Where(o => listId.Contains(o.ID)).ToList();
