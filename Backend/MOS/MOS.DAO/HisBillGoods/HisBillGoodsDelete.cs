...
{
    partial class HisBillGoodsDelete : EntityBase
    {
        public HisBillGoodsDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BILL_GOODS> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BILL_GOODS> listIdNotFound = new List<HIS_BILL_GOODS>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BILL_GOODS> listRaw = ctx.HIS_BILL_GOODS.Where(o => listId.Contains(o.ID)).ToList();
