...
{
    partial class HisPatientTypeRoomDelete : EntityBase
    {
        public HisPatientTypeRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PATIENT_TYPE_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PATIENT_TYPE_ROOM> listIdNotFound = new List<HIS_PATIENT_TYPE_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PATIENT_TYPE_ROOM> listRaw = ctx.HIS_PATIENT_TYPE_ROOM.Where(o => listId.Contains(o.ID)).ToList();
