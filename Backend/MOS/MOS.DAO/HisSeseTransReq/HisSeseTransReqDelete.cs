...
{
    partial class HisSeseTransReqDelete : EntityBase
    {
        public HisSeseTransReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SESE_TRANS_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SESE_TRANS_REQ> listIdNotFound = new List<HIS_SESE_TRANS_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SESE_TRANS_REQ> listRaw = ctx.HIS_SESE_TRANS_REQ.Where(o => listId.Contains(o.ID)).ToList();
