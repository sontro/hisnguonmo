...
{
    partial class HisHoreDhtyDelete : EntityBase
    {
        public HisHoreDhtyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HORE_DHTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HORE_DHTY> listIdNotFound = new List<HIS_HORE_DHTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HORE_DHTY> listRaw = ctx.HIS_HORE_DHTY.Where(o => listId.Contains(o.ID)).ToList();
