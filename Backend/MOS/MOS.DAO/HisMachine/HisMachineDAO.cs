...
namespace MOS.DAO.HisMachine
{
    ...
    {
        private HisMachineCreate CreateWorker
        {
            get
            {
                return (HisMachineCreate)Worker.Get<HisMachineCreate>();
            }
        }
        private HisMachineUpdate UpdateWorker
        {
            get
            {
                return (HisMachineUpdate)Worker.Get<HisMachineUpdate>();
            }
        }
        private HisMachineDelete DeleteWorker
        {
            get
            {
                return (HisMachineDelete)Worker.Get<HisMachineDelete>();
            }
        }
        private HisMachineTruncate TruncateWorker
        {
            get
            {
                return (HisMachineTruncate)Worker.Get<HisMachineTruncate>();
            }
        }
        ...
        private HisMachineCheck CheckWorker
        {
            get
            {
                return (HisMachineCheck)Worker.Get<HisMachineCheck>();
            }
        }
