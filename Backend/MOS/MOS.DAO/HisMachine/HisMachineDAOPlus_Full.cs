...
namespace MOS.DAO.HisMachine
{
    public partial class HisMachineDAO : EntityBase
    {
        ...
        public HIS_MACHINE GetByCode(string code, HisMachineSO search)
        {
        ...
        public V_HIS_MACHINE GetViewByCode(string code, HisMachineSO search)
        {
            V_HIS_MACHINE result = null;
        ...
        public Dictionary<string, HIS_MACHINE> GetDicByCode(HisMachineSO search, CommonParam param)
        {
            Dictionary<string, HIS_MACHINE> result = new Dictionary<string, HIS_MACHINE>();
            try
            {
