...
{
    partial class HisAssessmentObjectDelete : EntityBase
    {
        public HisAssessmentObjectDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ASSESSMENT_OBJECT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ASSESSMENT_OBJECT> listIdNotFound = new List<HIS_ASSESSMENT_OBJECT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ASSESSMENT_OBJECT> listRaw = ctx.HIS_ASSESSMENT_OBJECT.Where(o => listId.Contains(o.ID)).ToList();
