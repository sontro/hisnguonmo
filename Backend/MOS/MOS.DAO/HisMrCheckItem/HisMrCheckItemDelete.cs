...
{
    partial class HisMrCheckItemDelete : EntityBase
    {
        public HisMrCheckItemDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MR_CHECK_ITEM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MR_CHECK_ITEM> listIdNotFound = new List<HIS_MR_CHECK_ITEM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MR_CHECK_ITEM> listRaw = ctx.HIS_MR_CHECK_ITEM.Where(o => listId.Contains(o.ID)).ToList();
