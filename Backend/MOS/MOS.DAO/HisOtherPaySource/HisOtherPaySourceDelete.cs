...
{
    partial class HisOtherPaySourceDelete : EntityBase
    {
        public HisOtherPaySourceDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_OTHER_PAY_SOURCE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_OTHER_PAY_SOURCE> listIdNotFound = new List<HIS_OTHER_PAY_SOURCE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_OTHER_PAY_SOURCE> listRaw = ctx.HIS_OTHER_PAY_SOURCE.Where(o => listId.Contains(o.ID)).ToList();
