...
{
    partial class HisHeinApprovalDelete : EntityBase
    {
        public HisHeinApprovalDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HEIN_APPROVAL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HEIN_APPROVAL> listIdNotFound = new List<HIS_HEIN_APPROVAL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HEIN_APPROVAL> listRaw = ctx.HIS_HEIN_APPROVAL.Where(o => listId.Contains(o.ID)).ToList();
