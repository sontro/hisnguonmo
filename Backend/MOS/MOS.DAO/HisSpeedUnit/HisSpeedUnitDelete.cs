...
{
    partial class HisSpeedUnitDelete : EntityBase
    {
        public HisSpeedUnitDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SPEED_UNIT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SPEED_UNIT> listIdNotFound = new List<HIS_SPEED_UNIT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SPEED_UNIT> listRaw = ctx.HIS_SPEED_UNIT.Where(o => listId.Contains(o.ID)).ToList();
