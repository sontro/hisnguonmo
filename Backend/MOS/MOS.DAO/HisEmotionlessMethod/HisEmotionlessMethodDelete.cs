...
{
    partial class HisEmotionlessMethodDelete : EntityBase
    {
        public HisEmotionlessMethodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMOTIONLESS_METHOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMOTIONLESS_METHOD> listIdNotFound = new List<HIS_EMOTIONLESS_METHOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMOTIONLESS_METHOD> listRaw = ctx.HIS_EMOTIONLESS_METHOD.Where(o => listId.Contains(o.ID)).ToList();
