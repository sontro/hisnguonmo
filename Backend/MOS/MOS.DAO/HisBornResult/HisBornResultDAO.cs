...
namespace MOS.DAO.HisBornResult
{
    ...
    {
        private HisBornResultCreate CreateWorker
        {
            get
            {
                return (HisBornResultCreate)Worker.Get<HisBornResultCreate>();
            }
        }
        private HisBornResultUpdate UpdateWorker
        {
            get
            {
                return (HisBornResultUpdate)Worker.Get<HisBornResultUpdate>();
            }
        }
        private HisBornResultDelete DeleteWorker
        {
            get
            {
                return (HisBornResultDelete)Worker.Get<HisBornResultDelete>();
            }
        }
        private HisBornResultTruncate TruncateWorker
        {
            get
            {
                return (HisBornResultTruncate)Worker.Get<HisBornResultTruncate>();
            }
        }
        ...
        private HisBornResultCheck CheckWorker
        {
            get
            {
                return (HisBornResultCheck)Worker.Get<HisBornResultCheck>();
            }
        }
