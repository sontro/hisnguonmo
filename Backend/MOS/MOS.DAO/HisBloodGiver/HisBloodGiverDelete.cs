...
{
    partial class HisBloodGiverDelete : EntityBase
    {
        public HisBloodGiverDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BLOOD_GIVER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BLOOD_GIVER> listIdNotFound = new List<HIS_BLOOD_GIVER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BLOOD_GIVER> listRaw = ctx.HIS_BLOOD_GIVER.Where(o => listId.Contains(o.ID)).ToList();
