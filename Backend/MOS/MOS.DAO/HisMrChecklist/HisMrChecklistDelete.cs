...
{
    partial class HisMrChecklistDelete : EntityBase
    {
        public HisMrChecklistDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MR_CHECKLIST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MR_CHECKLIST> listIdNotFound = new List<HIS_MR_CHECKLIST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MR_CHECKLIST> listRaw = ctx.HIS_MR_CHECKLIST.Where(o => listId.Contains(o.ID)).ToList();
