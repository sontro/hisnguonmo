...
{
    partial class HisCaroAccountBookDelete : EntityBase
    {
        public HisCaroAccountBookDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CARO_ACCOUNT_BOOK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CARO_ACCOUNT_BOOK> listIdNotFound = new List<HIS_CARO_ACCOUNT_BOOK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CARO_ACCOUNT_BOOK> listRaw = ctx.HIS_CARO_ACCOUNT_BOOK.Where(o => listId.Contains(o.ID)).ToList();
