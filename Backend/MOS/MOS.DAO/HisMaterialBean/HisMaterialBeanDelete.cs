...
{
    partial class HisMaterialBeanDelete : EntityBase
    {
        public HisMaterialBeanDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MATERIAL_BEAN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MATERIAL_BEAN> listIdNotFound = new List<HIS_MATERIAL_BEAN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MATERIAL_BEAN> listRaw = ctx.HIS_MATERIAL_BEAN.Where(o => listId.Contains(o.ID)).ToList();
