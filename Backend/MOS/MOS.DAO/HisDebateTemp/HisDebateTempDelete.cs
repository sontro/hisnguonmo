...
{
    partial class HisDebateTempDelete : EntityBase
    {
        public HisDebateTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEBATE_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEBATE_TEMP> listIdNotFound = new List<HIS_DEBATE_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEBATE_TEMP> listRaw = ctx.HIS_DEBATE_TEMP.Where(o => listId.Contains(o.ID)).ToList();
