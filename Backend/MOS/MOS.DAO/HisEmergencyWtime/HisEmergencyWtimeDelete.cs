...
{
    partial class HisEmergencyWtimeDelete : EntityBase
    {
        public HisEmergencyWtimeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMERGENCY_WTIME> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMERGENCY_WTIME> listIdNotFound = new List<HIS_EMERGENCY_WTIME>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMERGENCY_WTIME> listRaw = ctx.HIS_EMERGENCY_WTIME.Where(o => listId.Contains(o.ID)).ToList();
