...
{
    partial class HisServiceRetyCatDelete : EntityBase
    {
        public HisServiceRetyCatDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_RETY_CAT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_RETY_CAT> listIdNotFound = new List<HIS_SERVICE_RETY_CAT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_RETY_CAT> listRaw = ctx.HIS_SERVICE_RETY_CAT.Where(o => listId.Contains(o.ID)).ToList();
