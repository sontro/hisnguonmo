...
{
    partial class HisMestInventoryDelete : EntityBase
    {
        public HisMestInventoryDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_INVENTORY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_INVENTORY> listIdNotFound = new List<HIS_MEST_INVENTORY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_INVENTORY> listRaw = ctx.HIS_MEST_INVENTORY.Where(o => listId.Contains(o.ID)).ToList();
