...
namespace MOS.DAO.HisGender
{
    ...
    {
        private HisGenderCreate CreateWorker
        {
            get
            {
                return (HisGenderCreate)Worker.Get<HisGenderCreate>();
            }
        }
        private HisGenderUpdate UpdateWorker
        {
            get
            {
                return (HisGenderUpdate)Worker.Get<HisGenderUpdate>();
            }
        }
        private HisGenderDelete DeleteWorker
        {
            get
            {
                return (HisGenderDelete)Worker.Get<HisGenderDelete>();
            }
        }
        private HisGenderTruncate TruncateWorker
        {
            get
            {
                return (HisGenderTruncate)Worker.Get<HisGenderTruncate>();
            }
        }
        ...
        private HisGenderCheck CheckWorker
        {
            get
            {
                return (HisGenderCheck)Worker.Get<HisGenderCheck>();
            }
        }
