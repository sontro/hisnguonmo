...
{
    partial class HisSuimSetySuinDelete : EntityBase
    {
        public HisSuimSetySuinDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SUIM_SETY_SUIN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SUIM_SETY_SUIN> listIdNotFound = new List<HIS_SUIM_SETY_SUIN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SUIM_SETY_SUIN> listRaw = ctx.HIS_SUIM_SETY_SUIN.Where(o => listId.Contains(o.ID)).ToList();
