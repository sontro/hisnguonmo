...
{
    partial class HisAcinInteractiveDelete : EntityBase
    {
        public HisAcinInteractiveDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACIN_INTERACTIVE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACIN_INTERACTIVE> listIdNotFound = new List<HIS_ACIN_INTERACTIVE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACIN_INTERACTIVE> listRaw = ctx.HIS_ACIN_INTERACTIVE.Where(o => listId.Contains(o.ID)).ToList();
