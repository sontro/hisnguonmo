...
{
    partial class HisExeServiceModuleDelete : EntityBase
    {
        public HisExeServiceModuleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXE_SERVICE_MODULE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXE_SERVICE_MODULE> listIdNotFound = new List<HIS_EXE_SERVICE_MODULE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXE_SERVICE_MODULE> listRaw = ctx.HIS_EXE_SERVICE_MODULE.Where(o => listId.Contains(o.ID)).ToList();
