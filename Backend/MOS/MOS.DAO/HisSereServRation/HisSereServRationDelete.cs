...
{
    partial class HisSereServRationDelete : EntityBase
    {
        public HisSereServRationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_RATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_RATION> listIdNotFound = new List<HIS_SERE_SERV_RATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_RATION> listRaw = ctx.HIS_SERE_SERV_RATION.Where(o => listId.Contains(o.ID)).ToList();
