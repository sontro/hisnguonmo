...
{
    partial class HisAntibioticMicrobiDelete : EntityBase
    {
        public HisAntibioticMicrobiDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTIBIOTIC_MICROBI> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTIBIOTIC_MICROBI> listIdNotFound = new List<HIS_ANTIBIOTIC_MICROBI>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTIBIOTIC_MICROBI> listRaw = ctx.HIS_ANTIBIOTIC_MICROBI.Where(o => listId.Contains(o.ID)).ToList();
