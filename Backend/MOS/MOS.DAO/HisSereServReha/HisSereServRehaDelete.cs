...
{
    partial class HisSereServRehaDelete : EntityBase
    {
        public HisSereServRehaDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_REHA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_REHA> listIdNotFound = new List<HIS_SERE_SERV_REHA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_REHA> listRaw = ctx.HIS_SERE_SERV_REHA.Where(o => listId.Contains(o.ID)).ToList();
