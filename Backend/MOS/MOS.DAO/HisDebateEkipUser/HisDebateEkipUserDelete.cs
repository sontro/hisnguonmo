...
{
    partial class HisDebateEkipUserDelete : EntityBase
    {
        public HisDebateEkipUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEBATE_EKIP_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEBATE_EKIP_USER> listIdNotFound = new List<HIS_DEBATE_EKIP_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEBATE_EKIP_USER> listRaw = ctx.HIS_DEBATE_EKIP_USER.Where(o => listId.Contains(o.ID)).ToList();
