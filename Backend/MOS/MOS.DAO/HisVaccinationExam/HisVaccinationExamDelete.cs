...
{
    partial class HisVaccinationExamDelete : EntityBase
    {
        public HisVaccinationExamDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINATION_EXAM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINATION_EXAM> listIdNotFound = new List<HIS_VACCINATION_EXAM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINATION_EXAM> listRaw = ctx.HIS_VACCINATION_EXAM.Where(o => listId.Contains(o.ID)).ToList();
