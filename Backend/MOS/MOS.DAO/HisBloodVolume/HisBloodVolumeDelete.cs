...
{
    partial class HisBloodVolumeDelete : EntityBase
    {
        public HisBloodVolumeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BLOOD_VOLUME> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BLOOD_VOLUME> listIdNotFound = new List<HIS_BLOOD_VOLUME>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BLOOD_VOLUME> listRaw = ctx.HIS_BLOOD_VOLUME.Where(o => listId.Contains(o.ID)).ToList();
