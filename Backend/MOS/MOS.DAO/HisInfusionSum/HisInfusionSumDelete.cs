...
{
    partial class HisInfusionSumDelete : EntityBase
    {
        public HisInfusionSumDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_INFUSION_SUM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_INFUSION_SUM> listIdNotFound = new List<HIS_INFUSION_SUM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_INFUSION_SUM> listRaw = ctx.HIS_INFUSION_SUM.Where(o => listId.Contains(o.ID)).ToList();
