...
namespace MOS.DAO.HisBloodType
{
    ...
    {
        private HisBloodTypeCreate CreateWorker
        {
            get
            {
                return (HisBloodTypeCreate)Worker.Get<HisBloodTypeCreate>();
            }
        }
        private HisBloodTypeUpdate UpdateWorker
        {
            get
            {
                return (HisBloodTypeUpdate)Worker.Get<HisBloodTypeUpdate>();
            }
        }
        private HisBloodTypeDelete DeleteWorker
        {
            get
            {
                return (HisBloodTypeDelete)Worker.Get<HisBloodTypeDelete>();
            }
        }
        private HisBloodTypeTruncate TruncateWorker
        {
            get
            {
                return (HisBloodTypeTruncate)Worker.Get<HisBloodTypeTruncate>();
            }
        }
        ...
        private HisBloodTypeCheck CheckWorker
        {
            get
            {
                return (HisBloodTypeCheck)Worker.Get<HisBloodTypeCheck>();
            }
        }
