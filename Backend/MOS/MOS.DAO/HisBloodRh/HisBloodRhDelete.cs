...
{
    partial class HisBloodRhDelete : EntityBase
    {
        public HisBloodRhDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BLOOD_RH> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BLOOD_RH> listIdNotFound = new List<HIS_BLOOD_RH>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BLOOD_RH> listRaw = ctx.HIS_BLOOD_RH.Where(o => listId.Contains(o.ID)).ToList();
