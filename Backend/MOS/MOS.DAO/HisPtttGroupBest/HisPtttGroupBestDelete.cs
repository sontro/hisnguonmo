...
{
    partial class HisPtttGroupBestDelete : EntityBase
    {
        public HisPtttGroupBestDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_GROUP_BEST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_GROUP_BEST> listIdNotFound = new List<HIS_PTTT_GROUP_BEST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_GROUP_BEST> listRaw = ctx.HIS_PTTT_GROUP_BEST.Where(o => listId.Contains(o.ID)).ToList();
