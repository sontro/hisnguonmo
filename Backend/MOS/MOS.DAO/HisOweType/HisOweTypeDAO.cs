...
namespace MOS.DAO.HisOweType
{
    ...
    {
        private HisOweTypeCreate CreateWorker
        {
            get
            {
                return (HisOweTypeCreate)Worker.Get<HisOweTypeCreate>();
            }
        }
        private HisOweTypeUpdate UpdateWorker
        {
            get
            {
                return (HisOweTypeUpdate)Worker.Get<HisOweTypeUpdate>();
            }
        }
        private HisOweTypeDelete DeleteWorker
        {
            get
            {
                return (HisOweTypeDelete)Worker.Get<HisOweTypeDelete>();
            }
        }
        private HisOweTypeTruncate TruncateWorker
        {
            get
            {
                return (HisOweTypeTruncate)Worker.Get<HisOweTypeTruncate>();
            }
        }
        ...
        private HisOweTypeCheck CheckWorker
        {
            get
            {
                return (HisOweTypeCheck)Worker.Get<HisOweTypeCheck>();
            }
        }
