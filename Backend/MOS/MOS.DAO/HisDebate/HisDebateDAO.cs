...
namespace MOS.DAO.HisDebate
{
    ...
    {
        private HisDebateCreate CreateWorker
        {
            get
            {
                return (HisDebateCreate)Worker.Get<HisDebateCreate>();
            }
        }
        private HisDebateUpdate UpdateWorker
        {
            get
            {
                return (HisDebateUpdate)Worker.Get<HisDebateUpdate>();
            }
        }
        private HisDebateDelete DeleteWorker
        {
            get
            {
                return (HisDebateDelete)Worker.Get<HisDebateDelete>();
            }
        }
        private HisDebateTruncate TruncateWorker
        {
            get
            {
                return (HisDebateTruncate)Worker.Get<HisDebateTruncate>();
            }
        }
        ...
        private HisDebateCheck CheckWorker
        {
            get
            {
                return (HisDebateCheck)Worker.Get<HisDebateCheck>();
            }
        }
