...
{
    partial class HisIcdCmDelete : EntityBase
    {
        public HisIcdCmDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ICD_CM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ICD_CM> listIdNotFound = new List<HIS_ICD_CM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ICD_CM> listRaw = ctx.HIS_ICD_CM.Where(o => listId.Contains(o.ID)).ToList();
