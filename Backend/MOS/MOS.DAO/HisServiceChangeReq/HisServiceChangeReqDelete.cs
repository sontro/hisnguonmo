...
{
    partial class HisServiceChangeReqDelete : EntityBase
    {
        public HisServiceChangeReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_CHANGE_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_CHANGE_REQ> listIdNotFound = new List<HIS_SERVICE_CHANGE_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_CHANGE_REQ> listRaw = ctx.HIS_SERVICE_CHANGE_REQ.Where(o => listId.Contains(o.ID)).ToList();
