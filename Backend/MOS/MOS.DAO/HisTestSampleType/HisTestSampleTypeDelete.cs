...
{
    partial class HisTestSampleTypeDelete : EntityBase
    {
        public HisTestSampleTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TEST_SAMPLE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TEST_SAMPLE_TYPE> listIdNotFound = new List<HIS_TEST_SAMPLE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TEST_SAMPLE_TYPE> listRaw = ctx.HIS_TEST_SAMPLE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
