...
namespace MOS.DAO.HisInfusion
{
    ...
    {
        private HisInfusionCreate CreateWorker
        {
            get
            {
                return (HisInfusionCreate)Worker.Get<HisInfusionCreate>();
            }
        }
        private HisInfusionUpdate UpdateWorker
        {
            get
            {
                return (HisInfusionUpdate)Worker.Get<HisInfusionUpdate>();
            }
        }
        private HisInfusionDelete DeleteWorker
        {
            get
            {
                return (HisInfusionDelete)Worker.Get<HisInfusionDelete>();
            }
        }
        private HisInfusionTruncate TruncateWorker
        {
            get
            {
                return (HisInfusionTruncate)Worker.Get<HisInfusionTruncate>();
            }
        }
        ...
        private HisInfusionCheck CheckWorker
        {
            get
            {
                return (HisInfusionCheck)Worker.Get<HisInfusionCheck>();
            }
        }
        ...
        public bool Delete(HIS_INFUSION data)
        {
            bool result = false;
            try
            {
        ...
        public bool DeleteList(List<HIS_INFUSION> listData)
        {
            bool result = false;
