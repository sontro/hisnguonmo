...
{
    partial class HisInfusionDelete : EntityBase
    {
        public HisInfusionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_INFUSION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_INFUSION> listIdNotFound = new List<HIS_INFUSION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_INFUSION> listRaw = ctx.HIS_INFUSION.Where(o => listId.Contains(o.ID)).ToList();
