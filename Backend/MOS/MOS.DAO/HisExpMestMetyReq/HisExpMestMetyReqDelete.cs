...
{
    partial class HisExpMestMetyReqDelete : EntityBase
    {
        public HisExpMestMetyReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_METY_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_METY_REQ> listIdNotFound = new List<HIS_EXP_MEST_METY_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_METY_REQ> listRaw = ctx.HIS_EXP_MEST_METY_REQ.Where(o => listId.Contains(o.ID)).ToList();
