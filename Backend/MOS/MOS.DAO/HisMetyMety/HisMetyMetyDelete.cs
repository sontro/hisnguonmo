...
{
    partial class HisMetyMetyDelete : EntityBase
    {
        public HisMetyMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_METY_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_METY_METY> listIdNotFound = new List<HIS_METY_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_METY_METY> listRaw = ctx.HIS_METY_METY.Where(o => listId.Contains(o.ID)).ToList();
