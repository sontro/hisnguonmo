...
{
    partial class HisMaterialMaterialDelete : EntityBase
    {
        public HisMaterialMaterialDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MATERIAL_MATERIAL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MATERIAL_MATERIAL> listIdNotFound = new List<HIS_MATERIAL_MATERIAL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MATERIAL_MATERIAL> listRaw = ctx.HIS_MATERIAL_MATERIAL.Where(o => listId.Contains(o.ID)).ToList();
