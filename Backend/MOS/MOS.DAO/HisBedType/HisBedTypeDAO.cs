...
namespace MOS.DAO.HisBedType
{
    ...
    {
        private HisBedTypeCreate CreateWorker
        {
            get
            {
                return (HisBedTypeCreate)Worker.Get<HisBedTypeCreate>();
            }
        }
        private HisBedTypeUpdate UpdateWorker
        {
            get
            {
                return (HisBedTypeUpdate)Worker.Get<HisBedTypeUpdate>();
            }
        }
        private HisBedTypeDelete DeleteWorker
        {
            get
            {
                return (HisBedTypeDelete)Worker.Get<HisBedTypeDelete>();
            }
        }
        private HisBedTypeTruncate TruncateWorker
        {
            get
            {
                return (HisBedTypeTruncate)Worker.Get<HisBedTypeTruncate>();
            }
        }
        ...
        private HisBedTypeCheck CheckWorker
        {
            get
            {
                return (HisBedTypeCheck)Worker.Get<HisBedTypeCheck>();
            }
        }
