...
{
    partial class HisAdrMedicineTypeDelete : EntityBase
    {
        public HisAdrMedicineTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ADR_MEDICINE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ADR_MEDICINE_TYPE> listIdNotFound = new List<HIS_ADR_MEDICINE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ADR_MEDICINE_TYPE> listRaw = ctx.HIS_ADR_MEDICINE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
