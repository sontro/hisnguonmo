...
{
    partial class HisMediContractMatyDelete : EntityBase
    {
        public HisMediContractMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_CONTRACT_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_CONTRACT_MATY> listIdNotFound = new List<HIS_MEDI_CONTRACT_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_CONTRACT_MATY> listRaw = ctx.HIS_MEDI_CONTRACT_MATY.Where(o => listId.Contains(o.ID)).ToList();
