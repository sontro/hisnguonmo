...
{
    partial class HisExamScheduleDelete : EntityBase
    {
        public HisExamScheduleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXAM_SCHEDULE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXAM_SCHEDULE> listIdNotFound = new List<HIS_EXAM_SCHEDULE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXAM_SCHEDULE> listRaw = ctx.HIS_EXAM_SCHEDULE.Where(o => listId.Contains(o.ID)).ToList();
