...
{
    partial class HisUserAccountBookDelete : EntityBase
    {
        public HisUserAccountBookDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_USER_ACCOUNT_BOOK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_USER_ACCOUNT_BOOK> listIdNotFound = new List<HIS_USER_ACCOUNT_BOOK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_USER_ACCOUNT_BOOK> listRaw = ctx.HIS_USER_ACCOUNT_BOOK.Where(o => listId.Contains(o.ID)).ToList();
