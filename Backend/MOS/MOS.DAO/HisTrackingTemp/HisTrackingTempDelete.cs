...
{
    partial class HisTrackingTempDelete : EntityBase
    {
        public HisTrackingTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRACKING_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRACKING_TEMP> listIdNotFound = new List<HIS_TRACKING_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRACKING_TEMP> listRaw = ctx.HIS_TRACKING_TEMP.Where(o => listId.Contains(o.ID)).ToList();
