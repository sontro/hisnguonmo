...
{
    partial class HisUserInvoiceBookDelete : EntityBase
    {
        public HisUserInvoiceBookDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_USER_INVOICE_BOOK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_USER_INVOICE_BOOK> listIdNotFound = new List<HIS_USER_INVOICE_BOOK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_USER_INVOICE_BOOK> listRaw = ctx.HIS_USER_INVOICE_BOOK.Where(o => listId.Contains(o.ID)).ToList();
