...
{
    partial class HisBillFundDelete : EntityBase
    {
        public HisBillFundDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BILL_FUND> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BILL_FUND> listIdNotFound = new List<HIS_BILL_FUND>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BILL_FUND> listRaw = ctx.HIS_BILL_FUND.Where(o => listId.Contains(o.ID)).ToList();
