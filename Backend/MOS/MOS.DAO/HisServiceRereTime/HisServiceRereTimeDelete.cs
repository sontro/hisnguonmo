...
{
    partial class HisServiceRereTimeDelete : EntityBase
    {
        public HisServiceRereTimeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_RERE_TIME> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_RERE_TIME> listIdNotFound = new List<HIS_SERVICE_RERE_TIME>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_RERE_TIME> listRaw = ctx.HIS_SERVICE_RERE_TIME.Where(o => listId.Contains(o.ID)).ToList();
