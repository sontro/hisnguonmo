...
{
    partial class HisEmteMedicineTypeDelete : EntityBase
    {
        public HisEmteMedicineTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMTE_MEDICINE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMTE_MEDICINE_TYPE> listIdNotFound = new List<HIS_EMTE_MEDICINE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMTE_MEDICINE_TYPE> listRaw = ctx.HIS_EMTE_MEDICINE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
