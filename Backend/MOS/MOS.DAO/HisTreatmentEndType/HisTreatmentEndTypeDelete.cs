...
{
    partial class HisTreatmentEndTypeDelete : EntityBase
    {
        public HisTreatmentEndTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_END_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_END_TYPE> listIdNotFound = new List<HIS_TREATMENT_END_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_END_TYPE> listRaw = ctx.HIS_TREATMENT_END_TYPE.Where(o => listId.Contains(o.ID)).ToList();
