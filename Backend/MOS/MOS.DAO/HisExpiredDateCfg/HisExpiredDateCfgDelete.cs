...
{
    partial class HisExpiredDateCfgDelete : EntityBase
    {
        public HisExpiredDateCfgDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXPIRED_DATE_CFG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXPIRED_DATE_CFG> listIdNotFound = new List<HIS_EXPIRED_DATE_CFG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXPIRED_DATE_CFG> listRaw = ctx.HIS_EXPIRED_DATE_CFG.Where(o => listId.Contains(o.ID)).ToList();
