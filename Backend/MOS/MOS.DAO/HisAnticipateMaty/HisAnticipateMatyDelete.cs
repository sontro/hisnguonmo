...
{
    partial class HisAnticipateMatyDelete : EntityBase
    {
        public HisAnticipateMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ANTICIPATE_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ANTICIPATE_MATY> listIdNotFound = new List<HIS_ANTICIPATE_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ANTICIPATE_MATY> listRaw = ctx.HIS_ANTICIPATE_MATY.Where(o => listId.Contains(o.ID)).ToList();
