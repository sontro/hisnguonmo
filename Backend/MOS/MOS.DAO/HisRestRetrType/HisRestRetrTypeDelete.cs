...
{
    partial class HisRestRetrTypeDelete : EntityBase
    {
        public HisRestRetrTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REST_RETR_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REST_RETR_TYPE> listIdNotFound = new List<HIS_REST_RETR_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REST_RETR_TYPE> listRaw = ctx.HIS_REST_RETR_TYPE.Where(o => listId.Contains(o.ID)).ToList();
