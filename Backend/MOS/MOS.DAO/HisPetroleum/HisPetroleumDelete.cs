...
{
    partial class HisPetroleumDelete : EntityBase
    {
        public HisPetroleumDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PETROLEUM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PETROLEUM> listIdNotFound = new List<HIS_PETROLEUM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PETROLEUM> listRaw = ctx.HIS_PETROLEUM.Where(o => listId.Contains(o.ID)).ToList();
