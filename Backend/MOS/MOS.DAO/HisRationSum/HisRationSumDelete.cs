...
{
    partial class HisRationSumDelete : EntityBase
    {
        public HisRationSumDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_RATION_SUM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_RATION_SUM> listIdNotFound = new List<HIS_RATION_SUM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_RATION_SUM> listRaw = ctx.HIS_RATION_SUM.Where(o => listId.Contains(o.ID)).ToList();
