...
{
    partial class HisSereServFileDelete : EntityBase
    {
        public HisSereServFileDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_FILE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_FILE> listIdNotFound = new List<HIS_SERE_SERV_FILE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_FILE> listRaw = ctx.HIS_SERE_SERV_FILE.Where(o => listId.Contains(o.ID)).ToList();
