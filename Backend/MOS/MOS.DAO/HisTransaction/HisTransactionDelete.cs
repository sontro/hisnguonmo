...
{
    partial class HisTransactionDelete : EntityBase
    {
        public HisTransactionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TRANSACTION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TRANSACTION> listIdNotFound = new List<HIS_TRANSACTION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TRANSACTION> listRaw = ctx.HIS_TRANSACTION.Where(o => listId.Contains(o.ID)).ToList();
