...
{
    partial class HisMedicalAssessmentDelete : EntityBase
    {
        public HisMedicalAssessmentDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICAL_ASSESSMENT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICAL_ASSESSMENT> listIdNotFound = new List<HIS_MEDICAL_ASSESSMENT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICAL_ASSESSMENT> listRaw = ctx.HIS_MEDICAL_ASSESSMENT.Where(o => listId.Contains(o.ID)).ToList();
