...
{
    partial class HisMediStockMetyDelete : EntityBase
    {
        public HisMediStockMetyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_STOCK_METY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_STOCK_METY> listIdNotFound = new List<HIS_MEDI_STOCK_METY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_STOCK_METY> listRaw = ctx.HIS_MEDI_STOCK_METY.Where(o => listId.Contains(o.ID)).ToList();
