...
{
    partial class HisMestPeriodBloodDelete : EntityBase
    {
        public HisMestPeriodBloodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PERIOD_BLOOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PERIOD_BLOOD> listIdNotFound = new List<HIS_MEST_PERIOD_BLOOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PERIOD_BLOOD> listRaw = ctx.HIS_MEST_PERIOD_BLOOD.Where(o => listId.Contains(o.ID)).ToList();
