...
{
    partial class HisMestPeriodMatyDelete : EntityBase
    {
        public HisMestPeriodMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PERIOD_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PERIOD_MATY> listIdNotFound = new List<HIS_MEST_PERIOD_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PERIOD_MATY> listRaw = ctx.HIS_MEST_PERIOD_MATY.Where(o => listId.Contains(o.ID)).ToList();
