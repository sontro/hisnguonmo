...
{
    partial class HisMestPatySubDelete : EntityBase
    {
        public HisMestPatySubDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PATY_SUB> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PATY_SUB> listIdNotFound = new List<HIS_MEST_PATY_SUB>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PATY_SUB> listRaw = ctx.HIS_MEST_PATY_SUB.Where(o => listId.Contains(o.ID)).ToList();
