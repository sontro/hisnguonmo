...
{
    partial class HisNumOrderIssueDelete : EntityBase
    {
        public HisNumOrderIssueDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_NUM_ORDER_ISSUE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_NUM_ORDER_ISSUE> listIdNotFound = new List<HIS_NUM_ORDER_ISSUE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_NUM_ORDER_ISSUE> listRaw = ctx.HIS_NUM_ORDER_ISSUE.Where(o => listId.Contains(o.ID)).ToList();
