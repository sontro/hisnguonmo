...
{
    partial class HisTestIndexRangeDelete : EntityBase
    {
        public HisTestIndexRangeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TEST_INDEX_RANGE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TEST_INDEX_RANGE> listIdNotFound = new List<HIS_TEST_INDEX_RANGE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TEST_INDEX_RANGE> listRaw = ctx.HIS_TEST_INDEX_RANGE.Where(o => listId.Contains(o.ID)).ToList();
