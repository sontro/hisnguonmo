...
{
    partial class HisImpMestProposeDelete : EntityBase
    {
        public HisImpMestProposeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_PROPOSE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_PROPOSE> listIdNotFound = new List<HIS_IMP_MEST_PROPOSE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_PROPOSE> listRaw = ctx.HIS_IMP_MEST_PROPOSE.Where(o => listId.Contains(o.ID)).ToList();
