...
{
    partial class HisHoreHandoverSttDelete : EntityBase
    {
        public HisHoreHandoverSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_HORE_HANDOVER_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_HORE_HANDOVER_STT> listIdNotFound = new List<HIS_HORE_HANDOVER_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_HORE_HANDOVER_STT> listRaw = ctx.HIS_HORE_HANDOVER_STT.Where(o => listId.Contains(o.ID)).ToList();
