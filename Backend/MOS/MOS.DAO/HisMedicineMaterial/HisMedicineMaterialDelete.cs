...
{
    partial class HisMedicineMaterialDelete : EntityBase
    {
        public HisMedicineMaterialDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_MATERIAL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_MATERIAL> listIdNotFound = new List<HIS_MEDICINE_MATERIAL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_MATERIAL> listRaw = ctx.HIS_MEDICINE_MATERIAL.Where(o => listId.Contains(o.ID)).ToList();
