...
{
    partial class HisTreatmentBedRoomDelete : EntityBase
    {
        public HisTreatmentBedRoomDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_TREATMENT_BED_ROOM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_TREATMENT_BED_ROOM> listIdNotFound = new List<HIS_TREATMENT_BED_ROOM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_TREATMENT_BED_ROOM> listRaw = ctx.HIS_TREATMENT_BED_ROOM.Where(o => listId.Contains(o.ID)).ToList();
