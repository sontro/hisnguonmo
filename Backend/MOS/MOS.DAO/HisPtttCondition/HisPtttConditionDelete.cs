...
{
    partial class HisPtttConditionDelete : EntityBase
    {
        public HisPtttConditionDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_CONDITION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_CONDITION> listIdNotFound = new List<HIS_PTTT_CONDITION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_CONDITION> listRaw = ctx.HIS_PTTT_CONDITION.Where(o => listId.Contains(o.ID)).ToList();
