...
{
    partial class HisPatientObservationDelete : EntityBase
    {
        public HisPatientObservationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PATIENT_OBSERVATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PATIENT_OBSERVATION> listIdNotFound = new List<HIS_PATIENT_OBSERVATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PATIENT_OBSERVATION> listRaw = ctx.HIS_PATIENT_OBSERVATION.Where(o => listId.Contains(o.ID)).ToList();
