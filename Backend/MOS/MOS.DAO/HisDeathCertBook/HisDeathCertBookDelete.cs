...
{
    partial class HisDeathCertBookDelete : EntityBase
    {
        public HisDeathCertBookDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEATH_CERT_BOOK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEATH_CERT_BOOK> listIdNotFound = new List<HIS_DEATH_CERT_BOOK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEATH_CERT_BOOK> listRaw = ctx.HIS_DEATH_CERT_BOOK.Where(o => listId.Contains(o.ID)).ToList();
