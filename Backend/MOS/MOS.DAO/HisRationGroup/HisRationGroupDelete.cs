...
{
    partial class HisRationGroupDelete : EntityBase
    {
        public HisRationGroupDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_RATION_GROUP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_RATION_GROUP> listIdNotFound = new List<HIS_RATION_GROUP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_RATION_GROUP> listRaw = ctx.HIS_RATION_GROUP.Where(o => listId.Contains(o.ID)).ToList();
