...
namespace MOS.DAO.HisBornType
{
    ...
    {
        private HisBornTypeCreate CreateWorker
        {
            get
            {
                return (HisBornTypeCreate)Worker.Get<HisBornTypeCreate>();
            }
        }
        private HisBornTypeUpdate UpdateWorker
        {
            get
            {
                return (HisBornTypeUpdate)Worker.Get<HisBornTypeUpdate>();
            }
        }
        private HisBornTypeDelete DeleteWorker
        {
            get
            {
                return (HisBornTypeDelete)Worker.Get<HisBornTypeDelete>();
            }
        }
        private HisBornTypeTruncate TruncateWorker
        {
            get
            {
                return (HisBornTypeTruncate)Worker.Get<HisBornTypeTruncate>();
            }
        }
        ...
        private HisBornTypeCheck CheckWorker
        {
            get
            {
                return (HisBornTypeCheck)Worker.Get<HisBornTypeCheck>();
            }
        }
        ...
        public bool Delete(HIS_BORN_TYPE data)
        {
            bool result = false;
            try
            {
        ...
        public bool DeleteList(List<HIS_BORN_TYPE> listData)
        {
            bool result = false;
