...
{
    partial class HisBornTypeDelete : EntityBase
    {
        public HisBornTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_BORN_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_BORN_TYPE> listIdNotFound = new List<HIS_BORN_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_BORN_TYPE> listRaw = ctx.HIS_BORN_TYPE.Where(o => listId.Contains(o.ID)).ToList();
