...
{
    partial class HisSaleProfitCfgDelete : EntityBase
    {
        public HisSaleProfitCfgDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SALE_PROFIT_CFG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SALE_PROFIT_CFG> listIdNotFound = new List<HIS_SALE_PROFIT_CFG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SALE_PROFIT_CFG> listRaw = ctx.HIS_SALE_PROFIT_CFG.Where(o => listId.Contains(o.ID)).ToList();
