...
{
    partial class HisMetyProductDelete : EntityBase
    {
        public HisMetyProductDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_METY_PRODUCT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_METY_PRODUCT> listIdNotFound = new List<HIS_METY_PRODUCT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_METY_PRODUCT> listRaw = ctx.HIS_METY_PRODUCT.Where(o => listId.Contains(o.ID)).ToList();
