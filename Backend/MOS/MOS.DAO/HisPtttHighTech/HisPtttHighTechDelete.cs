...
{
    partial class HisPtttHighTechDelete : EntityBase
    {
        public HisPtttHighTechDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_HIGH_TECH> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_HIGH_TECH> listIdNotFound = new List<HIS_PTTT_HIGH_TECH>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_HIGH_TECH> listRaw = ctx.HIS_PTTT_HIGH_TECH.Where(o => listId.Contains(o.ID)).ToList();
