...
{
    partial class HisMestInveUserDelete : EntityBase
    {
        public HisMestInveUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_INVE_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_INVE_USER> listIdNotFound = new List<HIS_MEST_INVE_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_INVE_USER> listRaw = ctx.HIS_MEST_INVE_USER.Where(o => listId.Contains(o.ID)).ToList();
