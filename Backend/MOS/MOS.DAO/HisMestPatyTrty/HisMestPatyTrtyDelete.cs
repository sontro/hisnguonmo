...
{
    partial class HisMestPatyTrtyDelete : EntityBase
    {
        public HisMestPatyTrtyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PATY_TRTY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PATY_TRTY> listIdNotFound = new List<HIS_MEST_PATY_TRTY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PATY_TRTY> listRaw = ctx.HIS_MEST_PATY_TRTY.Where(o => listId.Contains(o.ID)).ToList();
