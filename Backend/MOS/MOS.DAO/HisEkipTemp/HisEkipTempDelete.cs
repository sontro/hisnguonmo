...
{
    partial class HisEkipTempDelete : EntityBase
    {
        public HisEkipTempDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EKIP_TEMP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EKIP_TEMP> listIdNotFound = new List<HIS_EKIP_TEMP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EKIP_TEMP> listRaw = ctx.HIS_EKIP_TEMP.Where(o => listId.Contains(o.ID)).ToList();
