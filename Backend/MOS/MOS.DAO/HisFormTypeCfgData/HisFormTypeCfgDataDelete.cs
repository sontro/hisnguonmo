...
{
    partial class HisFormTypeCfgDataDelete : EntityBase
    {
        public HisFormTypeCfgDataDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_FORM_TYPE_CFG_DATA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_FORM_TYPE_CFG_DATA> listIdNotFound = new List<HIS_FORM_TYPE_CFG_DATA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_FORM_TYPE_CFG_DATA> listRaw = ctx.HIS_FORM_TYPE_CFG_DATA.Where(o => listId.Contains(o.ID)).ToList();
