...
{
    partial class HisCashierAddConfigDelete : EntityBase
    {
        public HisCashierAddConfigDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CASHIER_ADD_CONFIG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CASHIER_ADD_CONFIG> listIdNotFound = new List<HIS_CASHIER_ADD_CONFIG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CASHIER_ADD_CONFIG> listRaw = ctx.HIS_CASHIER_ADD_CONFIG.Where(o => listId.Contains(o.ID)).ToList();
