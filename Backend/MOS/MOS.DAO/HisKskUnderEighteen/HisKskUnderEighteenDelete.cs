...
{
    partial class HisKskUnderEighteenDelete : EntityBase
    {
        public HisKskUnderEighteenDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_UNDER_EIGHTEEN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_UNDER_EIGHTEEN> listIdNotFound = new List<HIS_KSK_UNDER_EIGHTEEN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_UNDER_EIGHTEEN> listRaw = ctx.HIS_KSK_UNDER_EIGHTEEN.Where(o => listId.Contains(o.ID)).ToList();
