...
{
    partial class HisMedicineBeanDelete : EntityBase
    {
        public HisMedicineBeanDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_BEAN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_BEAN> listIdNotFound = new List<HIS_MEDICINE_BEAN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_BEAN> listRaw = ctx.HIS_MEDICINE_BEAN.Where(o => listId.Contains(o.ID)).ToList();
