...
{
    partial class HisMediRecordBorrowDelete : EntityBase
    {
        public HisMediRecordBorrowDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDI_RECORD_BORROW> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDI_RECORD_BORROW> listIdNotFound = new List<HIS_MEDI_RECORD_BORROW>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDI_RECORD_BORROW> listRaw = ctx.HIS_MEDI_RECORD_BORROW.Where(o => listId.Contains(o.ID)).ToList();
