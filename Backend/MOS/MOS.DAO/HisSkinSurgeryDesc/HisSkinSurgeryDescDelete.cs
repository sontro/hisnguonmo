...
{
    partial class HisSkinSurgeryDescDelete : EntityBase
    {
        public HisSkinSurgeryDescDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SKIN_SURGERY_DESC> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SKIN_SURGERY_DESC> listIdNotFound = new List<HIS_SKIN_SURGERY_DESC>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SKIN_SURGERY_DESC> listRaw = ctx.HIS_SKIN_SURGERY_DESC.Where(o => listId.Contains(o.ID)).ToList();
