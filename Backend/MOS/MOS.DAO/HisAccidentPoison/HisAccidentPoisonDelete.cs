...
{
    partial class HisAccidentPoisonDelete : EntityBase
    {
        public HisAccidentPoisonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_POISON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_POISON> listIdNotFound = new List<HIS_ACCIDENT_POISON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_POISON> listRaw = ctx.HIS_ACCIDENT_POISON.Where(o => listId.Contains(o.ID)).ToList();
