...
namespace MOS.DAO.HisBaby
{
    ...
    {
        private HisBabyCreate CreateWorker
        {
            get
            {
                return (HisBabyCreate)Worker.Get<HisBabyCreate>();
            }
        }
        private HisBabyUpdate UpdateWorker
        {
            get
            {
                return (HisBabyUpdate)Worker.Get<HisBabyUpdate>();
            }
        }
        private HisBabyDelete DeleteWorker
        {
            get
            {
                return (HisBabyDelete)Worker.Get<HisBabyDelete>();
            }
        }
        private HisBabyTruncate TruncateWorker
        {
            get
            {
                return (HisBabyTruncate)Worker.Get<HisBabyTruncate>();
            }
        }
        ...
        private HisBabyCheck CheckWorker
        {
            get
            {
                return (HisBabyCheck)Worker.Get<HisBabyCheck>();
            }
        }
