...
{
    partial class HisKskOccupationalDelete : EntityBase
    {
        public HisKskOccupationalDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_OCCUPATIONAL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_OCCUPATIONAL> listIdNotFound = new List<HIS_KSK_OCCUPATIONAL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_OCCUPATIONAL> listRaw = ctx.HIS_KSK_OCCUPATIONAL.Where(o => listId.Contains(o.ID)).ToList();
