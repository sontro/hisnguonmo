...
{
    partial class HisImpMestBloodDelete : EntityBase
    {
        public HisImpMestBloodDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_BLOOD> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_BLOOD> listIdNotFound = new List<HIS_IMP_MEST_BLOOD>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_BLOOD> listRaw = ctx.HIS_IMP_MEST_BLOOD.Where(o => listId.Contains(o.ID)).ToList();
