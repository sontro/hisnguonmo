...
{
    partial class HisKskPeriodDriverDelete : EntityBase
    {
        public HisKskPeriodDriverDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_KSK_PERIOD_DRIVER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_KSK_PERIOD_DRIVER> listIdNotFound = new List<HIS_KSK_PERIOD_DRIVER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_KSK_PERIOD_DRIVER> listRaw = ctx.HIS_KSK_PERIOD_DRIVER.Where(o => listId.Contains(o.ID)).ToList();
