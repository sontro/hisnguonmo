...
{
    partial class HisExpMestBltyReqDelete : EntityBase
    {
        public HisExpMestBltyReqDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_BLTY_REQ> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_BLTY_REQ> listIdNotFound = new List<HIS_EXP_MEST_BLTY_REQ>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_BLTY_REQ> listRaw = ctx.HIS_EXP_MEST_BLTY_REQ.Where(o => listId.Contains(o.ID)).ToList();
