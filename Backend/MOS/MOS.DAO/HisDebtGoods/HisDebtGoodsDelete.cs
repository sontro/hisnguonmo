...
{
    partial class HisDebtGoodsDelete : EntityBase
    {
        public HisDebtGoodsDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEBT_GOODS> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEBT_GOODS> listIdNotFound = new List<HIS_DEBT_GOODS>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEBT_GOODS> listRaw = ctx.HIS_DEBT_GOODS.Where(o => listId.Contains(o.ID)).ToList();
