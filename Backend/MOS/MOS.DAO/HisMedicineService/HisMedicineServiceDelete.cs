...
{
    partial class HisMedicineServiceDelete : EntityBase
    {
        public HisMedicineServiceDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_SERVICE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_SERVICE> listIdNotFound = new List<HIS_MEDICINE_SERVICE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_SERVICE> listRaw = ctx.HIS_MEDICINE_SERVICE.Where(o => listId.Contains(o.ID)).ToList();
