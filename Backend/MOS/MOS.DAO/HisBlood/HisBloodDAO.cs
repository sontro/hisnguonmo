...
namespace MOS.DAO.HisBlood
{
    ...
    {
        private HisBloodCreate CreateWorker
        {
            get
            {
                return (HisBloodCreate)Worker.Get<HisBloodCreate>();
            }
        }
        private HisBloodUpdate UpdateWorker
        {
            get
            {
                return (HisBloodUpdate)Worker.Get<HisBloodUpdate>();
            }
        }
        private HisBloodDelete DeleteWorker
        {
            get
            {
                return (HisBloodDelete)Worker.Get<HisBloodDelete>();
            }
        }
        private HisBloodTruncate TruncateWorker
        {
            get
            {
                return (HisBloodTruncate)Worker.Get<HisBloodTruncate>();
            }
        }
        ...
        private HisBloodCheck CheckWorker
        {
            get
            {
                return (HisBloodCheck)Worker.Get<HisBloodCheck>();
            }
        }
