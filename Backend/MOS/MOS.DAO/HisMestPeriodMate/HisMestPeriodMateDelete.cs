...
{
    partial class HisMestPeriodMateDelete : EntityBase
    {
        public HisMestPeriodMateDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_PERIOD_MATE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_PERIOD_MATE> listIdNotFound = new List<HIS_MEST_PERIOD_MATE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_PERIOD_MATE> listRaw = ctx.HIS_MEST_PERIOD_MATE.Where(o => listId.Contains(o.ID)).ToList();
