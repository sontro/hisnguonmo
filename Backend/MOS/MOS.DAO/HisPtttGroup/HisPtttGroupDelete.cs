...
{
    partial class HisPtttGroupDelete : EntityBase
    {
        public HisPtttGroupDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PTTT_GROUP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PTTT_GROUP> listIdNotFound = new List<HIS_PTTT_GROUP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PTTT_GROUP> listRaw = ctx.HIS_PTTT_GROUP.Where(o => listId.Contains(o.ID)).ToList();
