...
{
    partial class HisCareTypeDelete : EntityBase
    {
        public HisCareTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_CARE_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_CARE_TYPE> listIdNotFound = new List<HIS_CARE_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_CARE_TYPE> listRaw = ctx.HIS_CARE_TYPE.Where(o => listId.Contains(o.ID)).ToList();
