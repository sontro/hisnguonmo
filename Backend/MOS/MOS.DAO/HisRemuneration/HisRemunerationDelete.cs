...
{
    partial class HisRemunerationDelete : EntityBase
    {
        public HisRemunerationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_REMUNERATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_REMUNERATION> listIdNotFound = new List<HIS_REMUNERATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_REMUNERATION> listRaw = ctx.HIS_REMUNERATION.Where(o => listId.Contains(o.ID)).ToList();
