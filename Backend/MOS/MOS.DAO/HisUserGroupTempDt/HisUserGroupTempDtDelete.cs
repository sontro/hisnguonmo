...
{
    partial class HisUserGroupTempDtDelete : EntityBase
    {
        public HisUserGroupTempDtDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_USER_GROUP_TEMP_DT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_USER_GROUP_TEMP_DT> listIdNotFound = new List<HIS_USER_GROUP_TEMP_DT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_USER_GROUP_TEMP_DT> listRaw = ctx.HIS_USER_GROUP_TEMP_DT.Where(o => listId.Contains(o.ID)).ToList();
