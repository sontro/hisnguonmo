...
{
    partial class HisServiceReqSttDelete : EntityBase
    {
        public HisServiceReqSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERVICE_REQ_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERVICE_REQ_STT> listIdNotFound = new List<HIS_SERVICE_REQ_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERVICE_REQ_STT> listRaw = ctx.HIS_SERVICE_REQ_STT.Where(o => listId.Contains(o.ID)).ToList();
