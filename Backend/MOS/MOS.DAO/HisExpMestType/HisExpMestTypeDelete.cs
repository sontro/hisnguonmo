...
{
    partial class HisExpMestTypeDelete : EntityBase
    {
        public HisExpMestTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_TYPE> listIdNotFound = new List<HIS_EXP_MEST_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_TYPE> listRaw = ctx.HIS_EXP_MEST_TYPE.Where(o => listId.Contains(o.ID)).ToList();
