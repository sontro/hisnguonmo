...
{
    partial class HisDepartmentTranDelete : EntityBase
    {
        public HisDepartmentTranDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_DEPARTMENT_TRAN> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_DEPARTMENT_TRAN> listIdNotFound = new List<HIS_DEPARTMENT_TRAN>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_DEPARTMENT_TRAN> listRaw = ctx.HIS_DEPARTMENT_TRAN.Where(o => listId.Contains(o.ID)).ToList();
