...
{
    partial class HisAccidentLocationDelete : EntityBase
    {
        public HisAccidentLocationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_ACCIDENT_LOCATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_ACCIDENT_LOCATION> listIdNotFound = new List<HIS_ACCIDENT_LOCATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_ACCIDENT_LOCATION> listRaw = ctx.HIS_ACCIDENT_LOCATION.Where(o => listId.Contains(o.ID)).ToList();
