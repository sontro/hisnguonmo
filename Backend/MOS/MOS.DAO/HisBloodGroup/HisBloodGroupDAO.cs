...
namespace MOS.DAO.HisBloodGroup
{
    ...
    {
        private HisBloodGroupCreate CreateWorker
        {
            get
            {
                return (HisBloodGroupCreate)Worker.Get<HisBloodGroupCreate>();
            }
        }
        private HisBloodGroupUpdate UpdateWorker
        {
            get
            {
                return (HisBloodGroupUpdate)Worker.Get<HisBloodGroupUpdate>();
            }
        }
        private HisBloodGroupDelete DeleteWorker
        {
            get
            {
                return (HisBloodGroupDelete)Worker.Get<HisBloodGroupDelete>();
            }
        }
        private HisBloodGroupTruncate TruncateWorker
        {
            get
            {
                return (HisBloodGroupTruncate)Worker.Get<HisBloodGroupTruncate>();
            }
        }
        ...
        private HisBloodGroupCheck CheckWorker
        {
            get
            {
                return (HisBloodGroupCheck)Worker.Get<HisBloodGroupCheck>();
            }
        }
