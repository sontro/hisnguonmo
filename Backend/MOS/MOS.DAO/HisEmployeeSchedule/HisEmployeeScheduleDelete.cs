...
{
    partial class HisEmployeeScheduleDelete : EntityBase
    {
        public HisEmployeeScheduleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EMPLOYEE_SCHEDULE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EMPLOYEE_SCHEDULE> listIdNotFound = new List<HIS_EMPLOYEE_SCHEDULE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EMPLOYEE_SCHEDULE> listRaw = ctx.HIS_EMPLOYEE_SCHEDULE.Where(o => listId.Contains(o.ID)).ToList();
