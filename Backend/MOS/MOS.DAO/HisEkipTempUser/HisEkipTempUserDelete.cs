...
{
    partial class HisEkipTempUserDelete : EntityBase
    {
        public HisEkipTempUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EKIP_TEMP_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EKIP_TEMP_USER> listIdNotFound = new List<HIS_EKIP_TEMP_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EKIP_TEMP_USER> listRaw = ctx.HIS_EKIP_TEMP_USER.Where(o => listId.Contains(o.ID)).ToList();
