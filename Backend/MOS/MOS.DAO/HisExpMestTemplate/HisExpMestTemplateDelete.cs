...
{
    partial class HisExpMestTemplateDelete : EntityBase
    {
        public HisExpMestTemplateDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST_TEMPLATE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST_TEMPLATE> listIdNotFound = new List<HIS_EXP_MEST_TEMPLATE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST_TEMPLATE> listRaw = ctx.HIS_EXP_MEST_TEMPLATE.Where(o => listId.Contains(o.ID)).ToList();
