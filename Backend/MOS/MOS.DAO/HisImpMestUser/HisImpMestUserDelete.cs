...
{
    partial class HisImpMestUserDelete : EntityBase
    {
        public HisImpMestUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_IMP_MEST_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_IMP_MEST_USER> listIdNotFound = new List<HIS_IMP_MEST_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_IMP_MEST_USER> listRaw = ctx.HIS_IMP_MEST_USER.Where(o => listId.Contains(o.ID)).ToList();
