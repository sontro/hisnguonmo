...
{
    partial class HisExpMestDelete : EntityBase
    {
        public HisExpMestDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_EXP_MEST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_EXP_MEST> listIdNotFound = new List<HIS_EXP_MEST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_EXP_MEST> listRaw = ctx.HIS_EXP_MEST.Where(o => listId.Contains(o.ID)).ToList();
