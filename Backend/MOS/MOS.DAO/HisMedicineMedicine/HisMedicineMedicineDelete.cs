...
{
    partial class HisMedicineMedicineDelete : EntityBase
    {
        public HisMedicineMedicineDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEDICINE_MEDICINE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEDICINE_MEDICINE> listIdNotFound = new List<HIS_MEDICINE_MEDICINE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEDICINE_MEDICINE> listRaw = ctx.HIS_MEDICINE_MEDICINE.Where(o => listId.Contains(o.ID)).ToList();
