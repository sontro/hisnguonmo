...
{
    partial class HisPatientClassifyDelete : EntityBase
    {
        public HisPatientClassifyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_PATIENT_CLASSIFY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_PATIENT_CLASSIFY> listIdNotFound = new List<HIS_PATIENT_CLASSIFY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_PATIENT_CLASSIFY> listRaw = ctx.HIS_PATIENT_CLASSIFY.Where(o => listId.Contains(o.ID)).ToList();
