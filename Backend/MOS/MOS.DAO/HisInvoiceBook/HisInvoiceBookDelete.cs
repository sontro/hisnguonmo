...
{
    partial class HisInvoiceBookDelete : EntityBase
    {
        public HisInvoiceBookDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_INVOICE_BOOK> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_INVOICE_BOOK> listIdNotFound = new List<HIS_INVOICE_BOOK>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_INVOICE_BOOK> listRaw = ctx.HIS_INVOICE_BOOK.Where(o => listId.Contains(o.ID)).ToList();
