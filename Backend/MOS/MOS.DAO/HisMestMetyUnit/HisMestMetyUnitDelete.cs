...
{
    partial class HisMestMetyUnitDelete : EntityBase
    {
        public HisMestMetyUnitDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_MEST_METY_UNIT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_MEST_METY_UNIT> listIdNotFound = new List<HIS_MEST_METY_UNIT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_MEST_METY_UNIT> listRaw = ctx.HIS_MEST_METY_UNIT.Where(o => listId.Contains(o.ID)).ToList();
