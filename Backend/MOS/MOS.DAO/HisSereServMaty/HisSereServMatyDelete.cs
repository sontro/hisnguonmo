...
{
    partial class HisSereServMatyDelete : EntityBase
    {
        public HisSereServMatyDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_SERE_SERV_MATY> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_SERE_SERV_MATY> listIdNotFound = new List<HIS_SERE_SERV_MATY>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_SERE_SERV_MATY> listRaw = ctx.HIS_SERE_SERV_MATY.Where(o => listId.Contains(o.ID)).ToList();
