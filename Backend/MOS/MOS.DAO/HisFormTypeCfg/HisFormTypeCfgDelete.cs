...
{
    partial class HisFormTypeCfgDelete : EntityBase
    {
        public HisFormTypeCfgDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_FORM_TYPE_CFG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_FORM_TYPE_CFG> listIdNotFound = new List<HIS_FORM_TYPE_CFG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_FORM_TYPE_CFG> listRaw = ctx.HIS_FORM_TYPE_CFG.Where(o => listId.Contains(o.ID)).ToList();
