...
{
    partial class HisWarningFeeCfgDelete : EntityBase
    {
        public HisWarningFeeCfgDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_WARNING_FEE_CFG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_WARNING_FEE_CFG> listIdNotFound = new List<HIS_WARNING_FEE_CFG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_WARNING_FEE_CFG> listRaw = ctx.HIS_WARNING_FEE_CFG.Where(o => listId.Contains(o.ID)).ToList();
