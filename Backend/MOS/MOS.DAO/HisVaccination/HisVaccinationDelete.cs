...
{
    partial class HisVaccinationDelete : EntityBase
    {
        public HisVaccinationDelete()
            : base()
        {
        ...
        public bool DeleteList(List<HIS_VACCINATION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<HIS_VACCINATION> listIdNotFound = new List<HIS_VACCINATION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<HIS_VACCINATION> listRaw = ctx.HIS_VACCINATION.Where(o => listId.Contains(o.ID)).ToList();
