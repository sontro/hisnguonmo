...
{
    public class HisExpMestMedicineViewFilter : FilterBase
    {
        ...
        public long? USE_TIME_TO_FROM { get; set; }
        public long? USE_TIME_TO_TO { get; set; }
        public long? TDL_PATIENT_ID { get; set; }


        public HisExpMestMedicineViewFilter()
            : base()
        {
        }
    }
