...
namespace MOS.Filter
{
    public class HisSereServFilter : FilterBase
    {
        ...
        public string TDL_TREATMENT_CODE_EXACT { get; set; }
        public string TDL_SERVICE_REQ_CODE_EXACT { get; set; }
        ...
        public bool? HAS_SERVICE_REQ_ID { get; set; }
        public bool? HAS_AMOUNT_TEMP__AND__IS_GREATER_ZERO { get; set; }
        ...
        public List<long> TDL_EXECUTE_BRANCH_IDs { get; set; }
