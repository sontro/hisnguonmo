...
{
    public class HisExpMestView5Filter : FilterBase
    {
        ...
        public List<long> CHMS_TYPE_IDs { get; set; }
        ...
        public bool? IS_NOT_FULL_BCS_REQ_AMOUNT { get; set; }
        public bool? IS_HAS_BCS_REQ_AMOUNT { get; set; }

        public HisExpMestView5Filter()
            : base()
        {
        }
    }
