...
{
    public class HisExpMestView2Filter : FilterBase
    {
        ...
        public bool? IS_SENT_ERX { get; set; }
        ...
        public string VIR_HEIN_CARD_PREFIX__EXACT { get; set; }
