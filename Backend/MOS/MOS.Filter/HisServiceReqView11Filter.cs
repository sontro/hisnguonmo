...
{
    public class HisServiceReqView11Filter : FilterBase
    {
        ...
        public bool? IS_HAS_EXP_MEST { get; set; }
        public bool? IS_REQUEST_EQUAL_EXECUTE { get; set; }
        public long? ROOM_ID_EQUAL_EXECUTE_OR_REQUEST_EQUAL_EXECUTE { get; set; }

        public HisServiceReqView11Filter()
            : base()
        {
        }
    }
