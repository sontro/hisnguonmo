...
namespace MOS.EFMODEL.DataModels
{
    ...
    public partial class V_HIS_TREATMENT_9
    {
        ...
        public Nullable<decimal> TREATMENT_TYPE_ID { get; set; }
        public Nullable<decimal> GIVE_DATE { get; set; }
        public Nullable<decimal> BORROW_APPOINTMENT_TIME { get; set; }
        public string PATIENT_PROGRAM_CODE { get; set; }
        public string PATIENT_PROGRAM_DESCRIPTION { get; set; }
