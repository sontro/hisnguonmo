...
{
    public class THisBcsMatyReqReq : INullable, IOracleCustomType
    {
        ...
        [OracleObjectMappingAttribute("PRE_EXP_MEST_MATY_REQ_ID")]
        ...
        public static THisBcsMatyReqReq Null
        {
            get
            {
                THisBcsMatyReqReq company = new THisBcsMatyReqReq();
        ...
        public void FromCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            OracleUdt.SetValue(con, pUdt, "PRE_EXP_MEST_MATY_REQ_ID", PRE_EXP_MEST_MATY_REQ_ID);
        ...
        public void ToCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            PRE_EXP_MEST_MATY_REQ_ID = (long)OracleUdt.GetValue(con, pUdt, "PRE_EXP_MEST_MATY_REQ_ID");
