...
{
    public class THisBcsMetyReqReq : INullable, IOracleCustomType
    {
        ...
        [OracleObjectMappingAttribute("PRE_EXP_MEST_METY_REQ_ID")]
        ...
        public static THisBcsMetyReqReq Null
        {
            get
            {
                THisBcsMetyReqReq company = new THisBcsMetyReqReq();
        ...
        public void FromCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            OracleUdt.SetValue(con, pUdt, "PRE_EXP_MEST_METY_REQ_ID", PRE_EXP_MEST_METY_REQ_ID);
        ...
        public void ToCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            PRE_EXP_MEST_METY_REQ_ID = (long)OracleUdt.GetValue(con, pUdt, "PRE_EXP_MEST_METY_REQ_ID");
