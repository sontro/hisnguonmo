...
{
    public class THisMestPeriodBlty : INullable, IOracleCustomType
    {
        ...
        [OracleObjectMappingAttribute("BLOOD_TYPE_ID")]
        ...
        public static THisMestPeriodBlty Null
        {
            get
            {
                THisMestPeriodBlty company = new THisMestPeriodBlty();
        ...
        public void FromCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            OracleUdt.SetValue(con, pUdt, "BLOOD_TYPE_ID", BLOOD_TYPE_ID);
        ...
        public void ToCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            BLOOD_TYPE_ID = (long)OracleUdt.GetValue(con, pUdt, "BLOOD_TYPE_ID");
