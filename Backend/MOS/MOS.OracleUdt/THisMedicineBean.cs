...
{
    public class THisMedicineBean : INullable, IOracleCustomType
    {
        ...
        [OracleObjectMappingAttribute("TDL_MEDICINE_IS_ACTIVE")]
        public Nullable<short> TDL_MEDICINE_IS_ACTIVE { get; set; }
        [OracleObjectMappingAttribute("TDL_MEDICINE_IMP_PRICE")]
        public decimal TDL_MEDICINE_IMP_PRICE { get; set; }
        [OracleObjectMappingAttribute("TDL_MEDICINE_IMP_VAT_RATIO")]
        public decimal TDL_MEDICINE_IMP_VAT_RATIO { get; set; }
        [OracleObjectMappingAttribute("TDL_MEDICINE_IMP_TIME")]
        public Nullable<long> TDL_MEDICINE_IMP_TIME { get; set; }
        [OracleObjectMappingAttribute("TDL_MEDICINE_EXPIRED_DATE")]
        ...
        public static THisMedicineBean Null
        {
            get
            {
                THisMedicineBean company = new THisMedicineBean();
        ...
        public void FromCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            OracleUdt.SetValue(con, pUdt, "TDL_MEDICINE_IS_ACTIVE", TDL_MEDICINE_IS_ACTIVE);
            OracleUdt.SetValue(con, pUdt, "TDL_MEDICINE_IMP_PRICE", TDL_MEDICINE_IMP_PRICE);
            OracleUdt.SetValue(con, pUdt, "TDL_MEDICINE_IMP_VAT_RATIO", TDL_MEDICINE_IMP_VAT_RATIO);
            OracleUdt.SetValue(con, pUdt, "TDL_MEDICINE_IMP_TIME", TDL_MEDICINE_IMP_TIME);
            OracleUdt.SetValue(con, pUdt, "TDL_MEDICINE_EXPIRED_DATE", TDL_MEDICINE_EXPIRED_DATE);
        ...
        public void ToCustomObject(Oracle.DataAccess.Client.OracleConnection con, IntPtr pUdt)
        {
            ...
            TDL_MEDICINE_IS_ACTIVE = (short?)OracleUdt.GetValue(con, pUdt, "TDL_MEDICINE_IS_ACTIVE");
            TDL_MEDICINE_IMP_PRICE = (decimal)OracleUdt.GetValue(con, pUdt, "TDL_MEDICINE_IMP_PRICE");
            TDL_MEDICINE_IMP_VAT_RATIO = (decimal)OracleUdt.GetValue(con, pUdt, "TDL_MEDICINE_IMP_VAT_RATIO");
            TDL_MEDICINE_IMP_TIME = (long?)OracleUdt.GetValue(con, pUdt, "TDL_MEDICINE_IMP_TIME");
            TDL_MEDICINE_EXPIRED_DATE = (long?)OracleUdt.GetValue(con, pUdt, "TDL_MEDICINE_EXPIRED_DATE");
