...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisVitaminAFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisVitaminAFilterQuery> param)
        {
            try
            {
                ApiResultObject<List<HIS_VITAMIN_A>> result = new ApiResultObject<List<HIS_VITAMIN_A>>(null);
                if (param != null)
                {
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_VITAMIN_A> param)
        {
            try
            {
