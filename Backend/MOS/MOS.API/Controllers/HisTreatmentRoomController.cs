...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisTreatmentRoomFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisTreatmentRoomFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_TREATMENT_ROOM> param)
        {
            try
            {
        ...
        public ApiResult CreateList(ApiParam<List<HIS_TREATMENT_ROOM>> param)
        {
            try
            {
                ApiResultObject<List<HIS_TREATMENT_ROOM>> result = new ApiResultObject<List<HIS_TREATMENT_ROOM>>(null);
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_TREATMENT_ROOM> param)
        {
            try
            {
                ApiResultObject<HIS_TREATMENT_ROOM> result = new ApiResultObject<HIS_TREATMENT_ROOM>(null);
