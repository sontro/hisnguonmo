...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisBloodTypeFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisBloodTypeFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_BLOOD_TYPE> param)
        {
            try
            {
        ...
        public ApiResult CreateList(ApiParam<List<HIS_BLOOD_TYPE>> param)
        {
            try
            {
                ApiResultObject<List<HIS_BLOOD_TYPE>> result = new ApiResultObject<List<HIS_BLOOD_TYPE>>(null);
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_BLOOD_TYPE> param)
        {
            try
            {
                ApiResultObject<HIS_BLOOD_TYPE> result = new ApiResultObject<HIS_BLOOD_TYPE>(null);
