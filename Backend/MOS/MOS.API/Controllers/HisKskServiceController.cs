...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisKskServiceFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisKskServiceFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_KSK_SERVICE> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_KSK_SERVICE> param)
        {
            try
            {
                ApiResultObject<HIS_KSK_SERVICE> result = new ApiResultObject<HIS_KSK_SERVICE>(null);
        ...
        public ApiResult CreateList(ApiParam<List<HIS_KSK_SERVICE>> param)
        {
            try
            {
                ApiResultObject<List<HIS_KSK_SERVICE>> result = new ApiResultObject<List<HIS_KSK_SERVICE>>(null);
        ...
        public ApiResult UpdateList(ApiParam<List<HIS_KSK_SERVICE>> param)
        {
            try
            {
                ApiResultObject<List<HIS_KSK_SERVICE>> result = new ApiResultObject<List<HIS_KSK_SERVICE>>(null);
