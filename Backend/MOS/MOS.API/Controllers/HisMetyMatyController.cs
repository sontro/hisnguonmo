...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisMetyMatyFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisMetyMatyFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_METY_MATY> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_METY_MATY> param)
        {
            try
            {
                ApiResultObject<HIS_METY_MATY> result = new ApiResultObject<HIS_METY_MATY>(null);
        ...
        public ApiResult CreateList(ApiParam<List<HIS_METY_MATY>> param)
        {
            try
            {
                ApiResultObject<List<HIS_METY_MATY>> result = new ApiResultObject<List<HIS_METY_MATY>>(null);
        ...
        public ApiResult UpdateList(ApiParam<List<HIS_METY_MATY>> param)
        {
            try
            {
                ApiResultObject<List<HIS_METY_MATY>> result = new ApiResultObject<List<HIS_METY_MATY>>(null);
