...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisRoomTimeFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisRoomTimeFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_ROOM_TIME> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_ROOM_TIME> param)
        {
            try
            {
                ApiResultObject<HIS_ROOM_TIME> result = new ApiResultObject<HIS_ROOM_TIME>(null);
        ...
        public ApiResult CreateList(ApiParam<List<HIS_ROOM_TIME>> param)
        {
            try
            {
                ApiResultObject<List<HIS_ROOM_TIME>> result = new ApiResultObject<List<HIS_ROOM_TIME>>(null);
        ...
        public ApiResult UpdateList(ApiParam<List<HIS_ROOM_TIME>> param)
        {
            try
            {
                ApiResultObject<List<HIS_ROOM_TIME>> result = new ApiResultObject<List<HIS_ROOM_TIME>>(null);
