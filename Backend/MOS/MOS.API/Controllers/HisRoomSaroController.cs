...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisRoomSaroFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisRoomSaroFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_ROOM_SARO> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_ROOM_SARO> param)
        {
            try
            {
                ApiResultObject<HIS_ROOM_SARO> result = new ApiResultObject<HIS_ROOM_SARO>(null);
        ...
        public ApiResult CreateList(ApiParam<List<HIS_ROOM_SARO>> param)
        {
            try
            {
                ApiResultObject<List<HIS_ROOM_SARO>> result = new ApiResultObject<List<HIS_ROOM_SARO>>(null);
        ...
        public ApiResult UpdateList(ApiParam<List<HIS_ROOM_SARO>> param)
        {
            try
            {
                ApiResultObject<List<HIS_ROOM_SARO>> result = new ApiResultObject<List<HIS_ROOM_SARO>>(null);
