...
namespace MOS.API.Controllers
{
    public partial class HisServiceReqController : BaseApiController
    {
        ...
        public ApiResult GetViewDynamic(ApiParam<HisServiceReqViewFilterQuery> param)
        {
            try
            {
                ApiResultObject<List<HisServiceReqViewDTO>> result = new ApiResultObject<List<HisServiceReqViewDTO>>(null);
                if (param != null)
                {
