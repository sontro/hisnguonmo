...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisBranchTimeFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisBranchTimeFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_BRANCH_TIME> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_BRANCH_TIME> param)
        {
            try
            {
                ApiResultObject<HIS_BRANCH_TIME> result = new ApiResultObject<HIS_BRANCH_TIME>(null);
        ...
        public ApiResult CreateList(ApiParam<List<HIS_BRANCH_TIME>> param)
        {
            try
            {
                ApiResultObject<List<HIS_BRANCH_TIME>> result = new ApiResultObject<List<HIS_BRANCH_TIME>>(null);
        ...
        public ApiResult UpdateList(ApiParam<List<HIS_BRANCH_TIME>> param)
        {
            try
            {
                ApiResultObject<List<HIS_BRANCH_TIME>> result = new ApiResultObject<List<HIS_BRANCH_TIME>>(null);
