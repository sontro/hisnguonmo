...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisServiceConditionFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisServiceConditionFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_SERVICE_CONDITION> param)
        {
            try
            {
        ...
        public ApiResult CreateList(ApiParam<List<HIS_SERVICE_CONDITION>> param)
        {
            try
            {
                ApiResultObject<List<HIS_SERVICE_CONDITION>> result = new ApiResultObject<List<HIS_SERVICE_CONDITION>>(null);
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_SERVICE_CONDITION> param)
        {
            try
            {
                ApiResultObject<HIS_SERVICE_CONDITION> result = new ApiResultObject<HIS_SERVICE_CONDITION>(null);
