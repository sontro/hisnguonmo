...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisEquipmentSetMatyFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisEquipmentSetMatyFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_EQUIPMENT_SET_MATY> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_EQUIPMENT_SET_MATY> param)
        {
            try
            {
                ApiResultObject<HIS_EQUIPMENT_SET_MATY> result = new ApiResultObject<HIS_EQUIPMENT_SET_MATY>(null);
        ...
        public ApiResult CreateList(ApiParam<List<HIS_EQUIPMENT_SET_MATY>> param)
        {
            try
            {
                ApiResultObject<List<HIS_EQUIPMENT_SET_MATY>> result = new ApiResultObject<List<HIS_EQUIPMENT_SET_MATY>>(null);
        ...
        public ApiResult UpdateList(ApiParam<List<HIS_EQUIPMENT_SET_MATY>> param)
        {
            try
            {
                ApiResultObject<List<HIS_EQUIPMENT_SET_MATY>> result = new ApiResultObject<List<HIS_EQUIPMENT_SET_MATY>>(null);
