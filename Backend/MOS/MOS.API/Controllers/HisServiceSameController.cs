...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisServiceSameFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisServiceSameFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HIS_SERVICE_SAME> param)
        {
            try
            {
        ...
        public ApiResult CreateList(ApiParam<List<HIS_SERVICE_SAME>> param)
        {
            try
            {
                ApiResultObject<List<HIS_SERVICE_SAME>> result = new ApiResultObject<List<HIS_SERVICE_SAME>>(null);
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HIS_SERVICE_SAME> param)
        {
            try
            {
                ApiResultObject<HIS_SERVICE_SAME> result = new ApiResultObject<HIS_SERVICE_SAME>(null);
