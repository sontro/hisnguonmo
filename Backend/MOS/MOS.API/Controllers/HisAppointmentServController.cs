...
namespace MOS.API.Controllers
{
    ...
    {
        [HttpGet]
        [ApiParamFilter(typeof(ApiParam<HisAppointmentServFilterQuery>), "param")]
        [ActionName("Get")]
        public ApiResult Get(ApiParam<HisAppointmentServFilterQuery> param)
        {
            try
            {
        ...
        [HttpPost]
        [ActionName("Create")]
        public ApiResult Create(ApiParam<HisAppointmentServSDO> param)
        {
            try
            {
                ApiResultObject<List<HIS_APPOINTMENT_SERV>> result = new ApiResultObject<List<HIS_APPOINTMENT_SERV>>(null);
        ...
        [HttpPost]
        [ActionName("Update")]
        public ApiResult Update(ApiParam<HisAppointmentServSDO> param)
        {
            try
            {
                ApiResultObject<List<HIS_APPOINTMENT_SERV>> result = new ApiResultObject<List<HIS_APPOINTMENT_SERV>>(null);
