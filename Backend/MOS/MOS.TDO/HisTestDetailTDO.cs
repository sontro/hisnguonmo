...
namespace MOS.TDO
{
    public class HisTestDetailTDO
    {
        ...
        public string ExecuteBranchName { get; set; }
        public string ExecuteBranchCode { get; set; }
        ...
        public List<HisTestDetailResultTDO> TestDatas { get; set; }
    }

    public class HisTestDetailResultTDO
    {
        ...
        public string TestIndexGroupCode { get; set; }

        public string TestIndexGroupName { get; set; }
    }
}
