...
namespace ACS.DAO.AcsApplicationRole
{
    ...
    {
        private AcsApplicationRoleCreate CreateWorker
        {
            get
            {
                return (AcsApplicationRoleCreate)Worker.Get<AcsApplicationRoleCreate>();
            }
        }
        private AcsApplicationRoleUpdate UpdateWorker
        {
            get
            {
                return (AcsApplicationRoleUpdate)Worker.Get<AcsApplicationRoleUpdate>();
            }
        }
        private AcsApplicationRoleDelete DeleteWorker
        {
            get
            {
                return (AcsApplicationRoleDelete)Worker.Get<AcsApplicationRoleDelete>();
            }
        }
        private AcsApplicationRoleTruncate TruncateWorker
        {
            get
            {
                return (AcsApplicationRoleTruncate)Worker.Get<AcsApplicationRoleTruncate>();
            }
        }
        private AcsApplicationRoleGet GetWorker
        {
            get
            {
                return (AcsApplicationRoleGet)Worker.Get<AcsApplicationRoleGet>();
            }
        }
        private AcsApplicationRoleCheck CheckWorker
        {
            get
            {
                return (AcsApplicationRoleCheck)Worker.Get<AcsApplicationRoleCheck>();
            }
        }
        ...
        public bool Truncate(ACS_APPLICATION_ROLE data)
        {
            bool result = false;
        ...
        public bool TruncateList(List<ACS_APPLICATION_ROLE> listData)
        {
            bool result = false;
        ...
        public List<ACS_APPLICATION_ROLE> Get(AcsApplicationRoleSO search, CommonParam param)
        {
            List<ACS_APPLICATION_ROLE> result = new List<ACS_APPLICATION_ROLE>();
        ...
        public ACS_APPLICATION_ROLE GetById(long id, AcsApplicationRoleSO search)
        {
