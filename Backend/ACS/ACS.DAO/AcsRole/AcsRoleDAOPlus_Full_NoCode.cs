...
namespace ACS.DAO.AcsRole
{
    ...
    {
        public List<V_ACS_ROLE> GetView(AcsRoleSO search, CommonParam param)
        {
            List<V_ACS_ROLE> result = new List<V_ACS_ROLE>();
        ...
        public V_ACS_ROLE GetViewById(long id, AcsRoleSO search)
        {
            V_ACS_ROLE result = null;
