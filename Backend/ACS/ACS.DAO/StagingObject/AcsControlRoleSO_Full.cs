...
namespace ACS.DAO.StagingObject
{
    public class AcsControlRoleSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_ACS_CONTROL_ROLE, bool>>> listVAcsControlRoleExpression = new List<System.Linq.Expressions.Expression<Func<V_ACS_CONTROL_ROLE, bool>>>();
    }
}
