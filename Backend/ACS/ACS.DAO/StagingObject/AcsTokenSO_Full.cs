...
namespace ACS.DAO.StagingObject
{
    public class AcsTokenSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_ACS_TOKEN, bool>>> listVAcsTokenExpression = new List<System.Linq.Expressions.Expression<Func<V_ACS_TOKEN, bool>>>();
    }
}
