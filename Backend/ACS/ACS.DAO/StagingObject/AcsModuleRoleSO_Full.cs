...
namespace ACS.DAO.StagingObject
{
    public class AcsModuleRoleSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_ACS_MODULE_ROLE, bool>>> listVAcsModuleRoleExpression = new List<System.Linq.Expressions.Expression<Func<V_ACS_MODULE_ROLE, bool>>>();
    }
}
