...
{
    partial class AcsActivityLogDelete : EntityBase
    {
        public AcsActivityLogDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_ACTIVITY_LOG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_ACTIVITY_LOG> listIdNotFound = new List<ACS_ACTIVITY_LOG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_ACTIVITY_LOG> listRaw = ctx.ACS_ACTIVITY_LOG.Where(o => listId.Contains(o.ID)).ToList();
