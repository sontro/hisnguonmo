...
namespace ACS.DAO.AcsApplication
{
    ...
    {
        private AcsApplicationCreate CreateWorker
        {
            get
            {
                return (AcsApplicationCreate)Worker.Get<AcsApplicationCreate>();
            }
        }
        private AcsApplicationUpdate UpdateWorker
        {
            get
            {
                return (AcsApplicationUpdate)Worker.Get<AcsApplicationUpdate>();
            }
        }
        private AcsApplicationDelete DeleteWorker
        {
            get
            {
                return (AcsApplicationDelete)Worker.Get<AcsApplicationDelete>();
            }
        }
        private AcsApplicationTruncate TruncateWorker
        {
            get
            {
                return (AcsApplicationTruncate)Worker.Get<AcsApplicationTruncate>();
            }
        }
        private AcsApplicationGet GetWorker
        {
            get
            {
                return (AcsApplicationGet)Worker.Get<AcsApplicationGet>();
            }
        }
        private AcsApplicationCheck CheckWorker
        {
            get
            {
                return (AcsApplicationCheck)Worker.Get<AcsApplicationCheck>();
            }
        }
        ...
        {
            List<ACS_APPLICATION> result = new List<ACS_APPLICATION>();
