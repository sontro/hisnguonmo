...
{
    partial class AcsUserTruncate : EntityBase
    {
        public AcsUserTruncate()
            : base()
        {
        ...
        public bool TruncateList(List<ACS_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_USER> listIdNotFound = new List<ACS_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_USER> listRaw = ctx.ACS_USER.Where(o => listId.Contains(o.ID)).ToList();
