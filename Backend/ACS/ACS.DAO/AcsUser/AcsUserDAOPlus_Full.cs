...
namespace ACS.DAO.AcsUser
{
    ...
    {
        public List<V_ACS_USER> GetView(AcsUserSO search, CommonParam param)
        {
            List<V_ACS_USER> result = new List<V_ACS_USER>();
        ...
        public ACS_USER GetByCode(string code, AcsUserSO search)
        {
        ...
        public V_ACS_USER GetViewById(long id, AcsUserSO search)
        {
            V_ACS_USER result = null;
        ...
        public V_ACS_USER GetViewByCode(string code, AcsUserSO search)
        {
            V_ACS_USER result = null;
        ...
        public Dictionary<string, ACS_USER> GetDicByCode(AcsUserSO search, CommonParam param)
        {
            Dictionary<string, ACS_USER> result = new Dictionary<string, ACS_USER>();
