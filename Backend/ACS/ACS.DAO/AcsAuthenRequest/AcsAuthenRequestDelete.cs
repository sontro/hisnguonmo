...
{
    partial class AcsAuthenRequestDelete : EntityBase
    {
        public AcsAuthenRequestDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_AUTHEN_REQUEST> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_AUTHEN_REQUEST> listIdNotFound = new List<ACS_AUTHEN_REQUEST>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_AUTHEN_REQUEST> listRaw = ctx.ACS_AUTHEN_REQUEST.Where(o => listId.Contains(o.ID)).ToList();
