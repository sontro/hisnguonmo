...
namespace ACS.DAO.AcsCredentialData
{
    ...
    {
        private AcsCredentialDataCreate CreateWorker
        {
            get
            {
                return (AcsCredentialDataCreate)Worker.Get<AcsCredentialDataCreate>();
            }
        }
        private AcsCredentialDataUpdate UpdateWorker
        {
            get
            {
                return (AcsCredentialDataUpdate)Worker.Get<AcsCredentialDataUpdate>();
            }
        }
        private AcsCredentialDataDelete DeleteWorker
        {
            get
            {
                return (AcsCredentialDataDelete)Worker.Get<AcsCredentialDataDelete>();
            }
        }
        private AcsCredentialDataTruncate TruncateWorker
        {
            get
            {
                return (AcsCredentialDataTruncate)Worker.Get<AcsCredentialDataTruncate>();
            }
        }
        private AcsCredentialDataGet GetWorker
        {
            get
            {
                return (AcsCredentialDataGet)Worker.Get<AcsCredentialDataGet>();
            }
        }
        private AcsCredentialDataCheck CheckWorker
        {
            get
            {
                return (AcsCredentialDataCheck)Worker.Get<AcsCredentialDataCheck>();
            }
        }
        ...
        {
            List<ACS_CREDENTIAL_DATA> result = new List<ACS_CREDENTIAL_DATA>();
