...
{
    partial class AcsAuthorSystemDelete : EntityBase
    {
        public AcsAuthorSystemDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_AUTHOR_SYSTEM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_AUTHOR_SYSTEM> listIdNotFound = new List<ACS_AUTHOR_SYSTEM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_AUTHOR_SYSTEM> listRaw = ctx.ACS_AUTHOR_SYSTEM.Where(o => listId.Contains(o.ID)).ToList();
