...
{
    partial class AcsModuleRoleDelete : EntityBase
    {
        public AcsModuleRoleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_MODULE_ROLE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_MODULE_ROLE> listIdNotFound = new List<ACS_MODULE_ROLE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_MODULE_ROLE> listRaw = ctx.ACS_MODULE_ROLE.Where(o => listId.Contains(o.ID)).ToList();
