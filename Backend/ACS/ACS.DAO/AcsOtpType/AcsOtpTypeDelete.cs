...
{
    partial class AcsOtpTypeDelete : EntityBase
    {
        public AcsOtpTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_OTP_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_OTP_TYPE> listIdNotFound = new List<ACS_OTP_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_OTP_TYPE> listRaw = ctx.ACS_OTP_TYPE.Where(o => listId.Contains(o.ID)).ToList();
