...
{
    partial class AcsAppOtpTypeDelete : EntityBase
    {
        public AcsAppOtpTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_APP_OTP_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_APP_OTP_TYPE> listIdNotFound = new List<ACS_APP_OTP_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_APP_OTP_TYPE> listRaw = ctx.ACS_APP_OTP_TYPE.Where(o => listId.Contains(o.ID)).ToList();
