...
{
    partial class AcsRoleUserDelete : EntityBase
    {
        public AcsRoleUserDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_ROLE_USER> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_ROLE_USER> listIdNotFound = new List<ACS_ROLE_USER>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_ROLE_USER> listRaw = ctx.ACS_ROLE_USER.Where(o => listId.Contains(o.ID)).ToList();
