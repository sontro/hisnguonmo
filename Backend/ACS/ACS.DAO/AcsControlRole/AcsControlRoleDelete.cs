...
{
    partial class AcsControlRoleDelete : EntityBase
    {
        public AcsControlRoleDelete()
            : base()
        {
        ...
        public bool DeleteList(List<ACS_CONTROL_ROLE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_CONTROL_ROLE> listIdNotFound = new List<ACS_CONTROL_ROLE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_CONTROL_ROLE> listRaw = ctx.ACS_CONTROL_ROLE.Where(o => listId.Contains(o.ID)).ToList();
