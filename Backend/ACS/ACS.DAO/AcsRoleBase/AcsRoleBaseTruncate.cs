...
{
    partial class AcsRoleBaseTruncate : EntityBase
    {
        public AcsRoleBaseTruncate()
            : base()
        {
        ...
        public bool TruncateList(List<ACS_ROLE_BASE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<ACS_ROLE_BASE> listIdNotFound = new List<ACS_ROLE_BASE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<ACS_ROLE_BASE> listRaw = ctx.ACS_ROLE_BASE.Where(o => listId.Contains(o.ID)).ToList();
