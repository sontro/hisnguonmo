...
{
    public class AcsRoleDataPriv : BaseDataPriv<ACS_EV_ACS_ROLE>
    {
        public AcsRoleDataPriv()
            : base(DataCodeConstant.ACS_ROLE)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_ROLE, bool>>> query)
        {
            string dataGrant = "";
            try
            {
