...
{
    public class AcsActionTypeDataPriv : BaseDataPriv<ACS_EV_ACS_ACTION_TYPE>
    {
        public AcsActionTypeDataPriv()
            : base(DataCodeConstant.ACS_ACTION_TYPE)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_ACTION_TYPE, bool>>> query)
        {
            string dataGrant = "";
            try
            {
