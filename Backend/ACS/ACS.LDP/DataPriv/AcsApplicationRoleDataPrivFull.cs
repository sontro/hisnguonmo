...
{
    public class AcsApplicationRoleDataPriv : BaseDataPriv<ACS_EV_ACS_APPLICATION_ROLE>
    {
        public AcsApplicationRoleDataPriv()
            : base(DataCodeConstant.ACS_APPLICATION_ROLE)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_APPLICATION_ROLE, bool>>> query)
        {
            string dataGrant = "";
            try
            {
        ...
        public void VerifyGetView(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_V_ACS_APPLICATION_ROLE, bool>>> query)
        {
            string dataGrant = "";
            try
            {
