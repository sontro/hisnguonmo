...
{
    public class AcsAppPrivDataPriv : BaseDataPriv<ACS_EV_ACS_APP_PRIV>
    {
        public AcsAppPrivDataPriv()
            : base(DataCodeConstant.ACS_APP_PRIV)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_APP_PRIV, bool>>> query)
        {
            string dataGrant = "";
            try
            {
