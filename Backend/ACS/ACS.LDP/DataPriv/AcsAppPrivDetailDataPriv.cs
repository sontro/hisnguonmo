...
{
    public class AcsAppPrivDetailDataPriv : BaseDataPriv<ACS_EV_ACS_APP_PRIV_DETAIL>
    {
        public AcsAppPrivDetailDataPriv()
            : base(DataCodeConstant.ACS_APP_PRIV_DETAIL)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_APP_PRIV_DETAIL, bool>>> query)
        {
            string dataGrant = "";
            try
            {
