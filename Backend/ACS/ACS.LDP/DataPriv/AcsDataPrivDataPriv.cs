...
{
    public class AcsDataPrivDataPriv : BaseDataPriv<ACS_EV_ACS_DATA_PRIV>
    {
        public AcsDataPrivDataPriv()
            : base(DataCodeConstant.ACS_DATA_PRIV)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_DATA_PRIV, bool>>> query)
        {
            string dataGrant = "";
            try
            {
