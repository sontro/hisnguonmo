...
{
    public class AcsDbLogDataPriv : BaseDataPriv<ACS_EV_ACS_DB_LOG>
    {
        public AcsDbLogDataPriv()
            : base(DataCodeConstant.ACS_DB_LOG)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_DB_LOG, bool>>> query)
        {
            string dataGrant = "";
            try
            {
