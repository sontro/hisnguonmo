...
{
    public class AcsApplicationDataPriv : BaseDataPriv<ACS_EV_ACS_APPLICATION>
    {
        public AcsApplicationDataPriv()
            : base(DataCodeConstant.ACS_APPLICATION)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_APPLICATION, bool>>> query)
        {
            string dataGrant = "";
            try
            {
