...
{
    public class AcsRoleBaseDataPriv : BaseDataPriv<ACS_EV_ACS_ROLE_BASE>
    {
        public AcsRoleBaseDataPriv()
            : base(DataCodeConstant.ACS_ROLE_BASE)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_ROLE_BASE, bool>>> query)
        {
            string dataGrant = "";
            try
            {
        ...
        public void VerifyGetView(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_V_ACS_ROLE_BASE, bool>>> query)
        {
            string dataGrant = "";
            try
            {
