...
{
    public class AcsDataPrivDetailDataPriv : BaseDataPriv<ACS_EV_ACS_DATA_PRIV_DETAIL>
    {
        public AcsDataPrivDetailDataPriv()
            : base(DataCodeConstant.ACS_DATA_PRIV_DETAIL)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_DATA_PRIV_DETAIL, bool>>> query)
        {
            string dataGrant = "";
            try
            {
