...
{
    public class AcsModuDataDagrDataPriv : BaseDataPriv<ACS_EV_ACS_MODU_DATA_DAGR>
    {
        public AcsModuDataDagrDataPriv()
            : base(DataCodeConstant.ACS_MODU_DATA_DAGR)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_MODU_DATA_DAGR, bool>>> query)
        {
            string dataGrant = "";
            try
            {
