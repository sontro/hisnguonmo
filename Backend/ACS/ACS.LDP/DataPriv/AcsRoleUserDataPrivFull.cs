...
{
    public class AcsRoleUserDataPriv : BaseDataPriv<ACS_EV_ACS_ROLE_USER>
    {
        public AcsRoleUserDataPriv()
            : base(DataCodeConstant.ACS_ROLE_USER)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_ROLE_USER, bool>>> query)
        {
            string dataGrant = "";
            try
            {
        ...
        public void VerifyGetView(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_V_ACS_ROLE_USER, bool>>> query)
        {
            string dataGrant = "";
            try
            {
