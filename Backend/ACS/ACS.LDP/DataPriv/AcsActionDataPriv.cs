...
{
    public class AcsActionDataPriv : BaseDataPriv<ACS_EV_ACS_ACTION>
    {
        public AcsActionDataPriv()
            : base(DataCodeConstant.ACS_ACTION)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_ACTION, bool>>> query)
        {
            string dataGrant = "";
            try
            {
