...
{
    public class AcsRoleDaprDataPriv : BaseDataPriv<ACS_EV_ACS_ROLE_DAPR>
    {
        public AcsRoleDaprDataPriv()
            : base(DataCodeConstant.ACS_ROLE_DAPR)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_ROLE_DAPR, bool>>> query)
        {
            string dataGrant = "";
            try
            {
