...
{
    public class AcsControlDataPriv : BaseDataPriv<ACS_EV_ACS_CONTROL>
    {
        public AcsControlDataPriv()
            : base(DataCodeConstant.ACS_CONTROL)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_CONTROL, bool>>> query)
        {
            string dataGrant = "";
            try
            {
