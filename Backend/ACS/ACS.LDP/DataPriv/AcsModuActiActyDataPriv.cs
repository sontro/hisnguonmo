...
{
    public class AcsModuActiActyDataPriv : BaseDataPriv<ACS_EV_ACS_MODU_ACTI_ACTY>
    {
        public AcsModuActiActyDataPriv()
            : base(DataCodeConstant.ACS_MODU_ACTI_ACTY)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_MODU_ACTI_ACTY, bool>>> query)
        {
            string dataGrant = "";
            try
            {
