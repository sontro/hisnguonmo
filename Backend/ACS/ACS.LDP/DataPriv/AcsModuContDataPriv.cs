...
{
    public class AcsModuContDataPriv : BaseDataPriv<ACS_EV_ACS_MODU_CONT>
    {
        public AcsModuContDataPriv()
            : base(DataCodeConstant.ACS_MODU_CONT)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_MODU_CONT, bool>>> query)
        {
            string dataGrant = "";
            try
            {
