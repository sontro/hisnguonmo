...
{
    public class AcsDataGrantDataPriv : BaseDataPriv<ACS_EV_ACS_DATA_GRANT>
    {
        public AcsDataGrantDataPriv()
            : base(DataCodeConstant.ACS_DATA_GRANT)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_DATA_GRANT, bool>>> query)
        {
            string dataGrant = "";
            try
            {
