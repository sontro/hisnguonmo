...
{
    public class AcsModuleDataPriv : BaseDataPriv<ACS_EV_ACS_MODULE>
    {
        public AcsModuleDataPriv()
            : base(DataCodeConstant.ACS_MODULE)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_MODULE, bool>>> query)
        {
            string dataGrant = "";
            try
            {
