...
{
    public class AcsDataDataPriv : BaseDataPriv<ACS_EV_ACS_DATA>
    {
        public AcsDataDataPriv()
            : base(DataCodeConstant.ACS_DATA)
        {
        }

        public void VerifyGet(string moduleCode, List<System.Linq.Expressions.Expression<Func<ACS_EV_ACS_DATA, bool>>> query)
        {
            string dataGrant = "";
            try
            {
