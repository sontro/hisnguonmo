...
{
    public partial class AcsRoleBaseManager : Inventec.Backend.MANAGER.ManagerBase
    {
        public AcsRoleBaseManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                AcsRoleBaseBO bo = new AcsRoleBaseBO();
