...
{
    public partial class AcsModuleGroupManager : Inventec.Backend.MANAGER.ManagerBase
    {
        public AcsModuleGroupManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                AcsModuleGroupBO bo = new AcsModuleGroupBO();
