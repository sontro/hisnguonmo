...
{
    public partial class AcsAppOtpTypeManager : Inventec.Backend.MANAGER.ManagerBase
    {
        public AcsAppOtpTypeManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                AcsAppOtpTypeBO bo = new AcsAppOtpTypeBO();
