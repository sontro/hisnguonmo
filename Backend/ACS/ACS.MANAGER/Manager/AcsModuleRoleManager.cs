...
{
    public partial class AcsModuleRoleManager : Inventec.Backend.MANAGER.ManagerBase
    {
        public AcsModuleRoleManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                AcsModuleRoleBO bo = new AcsModuleRoleBO();
