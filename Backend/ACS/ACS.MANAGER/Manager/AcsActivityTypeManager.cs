...
{
    public partial class AcsActivityTypeManager : Inventec.Backend.MANAGER.ManagerBase
    {
        public AcsActivityTypeManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                AcsActivityTypeBO bo = new AcsActivityTypeBO();
