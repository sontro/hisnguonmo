...
{
    public partial class AcsApplicationRoleManager : Inventec.Backend.MANAGER.ManagerBase
    {
        public AcsApplicationRoleManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                AcsApplicationRoleBO bo = new AcsApplicationRoleBO();
