...
{
    class AcsControlCheckVerifyValidData
    {
        internal static bool Verify(CommonParam param, ACS_CONTROL data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<ACS_CONTROL> datas)
        {
            bool result = true;
            try
            {
