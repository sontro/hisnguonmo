...
{
    class AcsOtpTypeCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    AcsOtpTypeFilterQuery filter = new AcsOtpTypeFilterQuery();
                    filter.IDs = ids;
                    List<ACS_OTP_TYPE> listData = new AcsOtpTypeBO().Get<List<ACS_OTP_TYPE>>(filter);
        ...
        private static bool Check(CommonParam param, ACS_OTP_TYPE raw)
        {
            bool result = true;
            if (raw == null)
            {
