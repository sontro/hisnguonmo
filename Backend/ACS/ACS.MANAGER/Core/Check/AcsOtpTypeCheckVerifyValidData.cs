...
{
    class AcsOtpTypeCheckVerifyValidData
    {
        internal static bool Verify(CommonParam param, ACS_OTP_TYPE data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<ACS_OTP_TYPE> datas)
        {
            bool result = true;
            try
            {
