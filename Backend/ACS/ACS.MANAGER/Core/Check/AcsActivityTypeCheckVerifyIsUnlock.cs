...
using ACS.MANAGER.Core.AcsActivityType.Get;
using Inventec.Core;
using System;
...
{
    class AcsActivityTypeCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    AcsActivityTypeFilterQuery filter = new AcsActivityTypeFilterQuery();
                    filter.IDs = ids;
                    List<ACS_ACTIVITY_TYPE> listData = new AcsActivityTypeBO().Get<List<ACS_ACTIVITY_TYPE>>(filter);
        ...
        private static bool Check(CommonParam param, ACS_ACTIVITY_TYPE raw)
        {
            bool result = true;
            if (raw == null)
            {
