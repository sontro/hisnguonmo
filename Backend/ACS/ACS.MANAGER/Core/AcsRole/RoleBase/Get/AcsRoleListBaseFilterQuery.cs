...
namespace ACS.MANAGER.Core.AcsRole.RoleBase.Get
{
    public class AcsRoleListBaseFilterQuery : AcsRoleBaseFilter
    {
        List<long> RoleIds { get; set; }

        public AcsRoleListBaseFilterQuery()
            : base()
        {
        ...
        internal AcsRoleBaseSO Query()
        {
            ...
            try
            {
                ...
                {
                    listExpression.Add(o => this.RoleIds.Contains(o.ROLE_ID));
                }
