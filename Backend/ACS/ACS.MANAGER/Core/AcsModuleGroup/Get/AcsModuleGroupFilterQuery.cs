...
{
    public class AcsModuleGroupFilterQuery : AcsModuleGroupFilter
    {
        public AcsModuleGroupFilterQuery()
            : base()
        {

        }

        internal List<System.Linq.Expressions.Expression<Func<ACS_MODULE_GROUP, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<ACS_MODULE_GROUP, bool>>>();
        ...
        internal AcsModuleGroupSO Query()
        {
            ...
            try
            {
                ...
                search.listAcsModuleGroupExpression.AddRange(listExpression);
                search.OrderField = OrderProcess.GetOrderField<ACS_MODULE_GROUP>(ORDER_FIELD);
                search.OrderDirection = OrderProcess.GetOrderDirection(ORDER_DIRECTION);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
                search.listAcsModuleGroupExpression.Clear();
                search.listAcsModuleGroupExpression.Add(o => o.ID == NEGATIVE_ID);
            }
            return search;
        }
    }
