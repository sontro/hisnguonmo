...
{
    public class AcsModuleRoleFilterQuery : AcsModuleRoleFilter
    {
        public AcsModuleRoleFilterQuery()
            : base()
        {

        }

        internal List<System.Linq.Expressions.Expression<Func<ACS_MODULE_ROLE, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<ACS_MODULE_ROLE, bool>>>();
        ...
        internal AcsModuleRoleSO Query()
        {
            ...
            try
            {
                ...
                search.listAcsModuleRoleExpression.AddRange(listExpression);
                search.OrderField = OrderProcess.GetOrderField<ACS_MODULE_ROLE>(ORDER_FIELD);
                search.OrderDirection = OrderProcess.GetOrderDirection(ORDER_DIRECTION);
            }
            catch (Exception ex)
            {
                LogSystem.Error(ex);
                search.listAcsModuleRoleExpression.Clear();
                search.listAcsModuleRoleExpression.Add(o => o.ID == NEGATIVE_ID);
            }
            return search;
        }
    }
