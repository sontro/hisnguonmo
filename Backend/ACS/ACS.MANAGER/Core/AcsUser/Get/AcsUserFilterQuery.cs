    ...
    public class AcsUserFilterQuery : AcsUserFilter
    {
        ...
        internal AcsUserSO Query()
        {
            ...
            try
            {
                ...
                {
                    listExpression.Add(o => this.LOGINNAME__OR__SUB_LOGINNAMEs.Contains(o.LOGINNAME));
                }
                ...
                {
                    listExpression.Add(o => ((o.LOGINNAME.ToLower() == this.LOGINNAME__OR__SUB_LOGINNAME.ToLower())));
                }
                if (!String.IsNullOrEmpty(this.EMAIL))
                {
                    listExpression.Add(o => ((o.EMAIL.ToLower() == this.EMAIL.ToLower())));
                }
                ...
                if (this.IS_NOT_PEOPLE.HasValue)
                {
                    if (this.IS_NOT_PEOPLE.Value)
                    {
                        listExpression.Add(x => x.LOGINNAME.Length != 10 || !x.LOGINNAME.StartsWith("0000"));
                    }
                    else
                    {
                        listExpression.Add(x => x.LOGINNAME.Length == 10 && x.LOGINNAME.StartsWith("0000"));
