...
{
    class AcsUserActivationRequiredBehaviorEv : BeanObjectBase, IAcsUserActivationRequired
    {
        ...
        internal AcsUserActivationRequiredBehaviorEv(CommonParam param, AcsUserActivationRequiredSDO data)
            : base(param)
        {
            entity = data;
        }
        ...
        /// </summary>
        /// <returns></returns>
        bool IAcsUserActivationRequired.Run()
        {
            bool result = false;
            try
            {
                ...
                if (user != null)
                {
                    if (user != null)
                    {
                        ...
                        {
                            double minuteAdd = GetActivationMinutePlus();//TODO
                            ...
                            else
                            {
                                ...
                                MessageUtil.SetMessage(param, LibraryMessage.Message.Enum.Core_AcsOtp_GuiYeuCauCapOtpThatBai);
                            }
