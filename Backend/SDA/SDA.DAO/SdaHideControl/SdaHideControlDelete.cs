...
{
    partial class SdaHideControlDelete : EntityBase
    {
        public SdaHideControlDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_HIDE_CONTROL> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_HIDE_CONTROL> listIdNotFound = new List<SDA_HIDE_CONTROL>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_HIDE_CONTROL> listRaw = ctx.SDA_HIDE_CONTROL.Where(o => listId.Contains(o.ID)).ToList();
