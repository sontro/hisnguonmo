...
namespace SDA.DAO.SdaProvince
{
    ...
    {
        private SdaProvinceCreate CreateWorker
        {
            get
            {
                return (SdaProvinceCreate)Worker.Get<SdaProvinceCreate>();
            }
        }
        private SdaProvinceUpdate UpdateWorker
        {
            get
            {
                return (SdaProvinceUpdate)Worker.Get<SdaProvinceUpdate>();
            }
        }
        private SdaProvinceDelete DeleteWorker
        {
            get
            {
                return (SdaProvinceDelete)Worker.Get<SdaProvinceDelete>();
            }
        }
        private SdaProvinceTruncate TruncateWorker
        {
            get
            {
                return (SdaProvinceTruncate)Worker.Get<SdaProvinceTruncate>();
            }
        }
        private SdaProvinceGet GetWorker
        {
            get
            {
                return (SdaProvinceGet)Worker.Get<SdaProvinceGet>();
            }
        }
        private SdaProvinceCheck CheckWorker
        {
            get
            {
                return (SdaProvinceCheck)Worker.Get<SdaProvinceCheck>();
            }
        }
        ...
        {
            List<SDA_PROVINCE> result = new List<SDA_PROVINCE>();
