...
namespace SDA.DAO.SdaCommune
{
    ...
    {
        private SdaCommuneCreate CreateWorker
        {
            get
            {
                return (SdaCommuneCreate)Worker.Get<SdaCommuneCreate>();
            }
        }
        private SdaCommuneUpdate UpdateWorker
        {
            get
            {
                return (SdaCommuneUpdate)Worker.Get<SdaCommuneUpdate>();
            }
        }
        private SdaCommuneDelete DeleteWorker
        {
            get
            {
                return (SdaCommuneDelete)Worker.Get<SdaCommuneDelete>();
            }
        }
        private SdaCommuneTruncate TruncateWorker
        {
            get
            {
                return (SdaCommuneTruncate)Worker.Get<SdaCommuneTruncate>();
            }
        }
        private SdaCommuneGet GetWorker
        {
            get
            {
                return (SdaCommuneGet)Worker.Get<SdaCommuneGet>();
            }
        }
        private SdaCommuneCheck CheckWorker
        {
            get
            {
                return (SdaCommuneCheck)Worker.Get<SdaCommuneCheck>();
            }
        }
        ...
        {
            List<SDA_COMMUNE> result = new List<SDA_COMMUNE>();
