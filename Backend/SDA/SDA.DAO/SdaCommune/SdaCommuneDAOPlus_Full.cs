...
{
    public partial class SdaCommuneDAO : EntityBase
    {
        public List<V_SDA_COMMUNE> GetView(SdaCommuneSO search, CommonParam param)
        {
            List<V_SDA_COMMUNE> result = new List<V_SDA_COMMUNE>();
        ...
        public SDA_COMMUNE GetByCode(string code, SdaCommuneSO search)
        {
            SDA_COMMUNE result = null;
        ...
        public V_SDA_COMMUNE GetViewById(long id, SdaCommuneSO search)
        {
            V_SDA_COMMUNE result = null;
        ...
        public V_SDA_COMMUNE GetViewByCode(string code, SdaCommuneSO search)
        {
            V_SDA_COMMUNE result = null;
        ...
        public Dictionary<string, SDA_COMMUNE> GetDicByCode(SdaCommuneSO search, CommonParam param)
        {
            Dictionary<string, SDA_COMMUNE> result = new Dictionary<string, SDA_COMMUNE>();
