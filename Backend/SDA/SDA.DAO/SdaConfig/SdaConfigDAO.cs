...
namespace SDA.DAO.SdaConfig
{
    ...
    {
        private SdaConfigCreate CreateWorker
        {
            get
            {
                return (SdaConfigCreate)Worker.Get<SdaConfigCreate>();
            }
        }
        private SdaConfigUpdate UpdateWorker
        {
            get
            {
                return (SdaConfigUpdate)Worker.Get<SdaConfigUpdate>();
            }
        }
        private SdaConfigDelete DeleteWorker
        {
            get
            {
                return (SdaConfigDelete)Worker.Get<SdaConfigDelete>();
            }
        }
        private SdaConfigTruncate TruncateWorker
        {
            get
            {
                return (SdaConfigTruncate)Worker.Get<SdaConfigTruncate>();
            }
        }
        private SdaConfigGet GetWorker
        {
            get
            {
                return (SdaConfigGet)Worker.Get<SdaConfigGet>();
            }
        }
        private SdaConfigCheck CheckWorker
        {
            get
            {
                return (SdaConfigCheck)Worker.Get<SdaConfigCheck>();
            }
        }
        ...
        {
            List<SDA_CONFIG> result = new List<SDA_CONFIG>();
