...
{
    partial class SdaCustomizeButtonDelete : EntityBase
    {
        public SdaCustomizeButtonDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_CUSTOMIZE_BUTTON> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_CUSTOMIZE_BUTTON> listIdNotFound = new List<SDA_CUSTOMIZE_BUTTON>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_CUSTOMIZE_BUTTON> listRaw = ctx.SDA_CUSTOMIZE_BUTTON.Where(o => listId.Contains(o.ID)).ToList();
