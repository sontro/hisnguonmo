...
{
    partial class SdaProvinceMapDelete : EntityBase
    {
        public SdaProvinceMapDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_PROVINCE_MAP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_PROVINCE_MAP> listIdNotFound = new List<SDA_PROVINCE_MAP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_PROVINCE_MAP> listRaw = ctx.SDA_PROVINCE_MAP.Where(o => listId.Contains(o.ID)).ToList();
