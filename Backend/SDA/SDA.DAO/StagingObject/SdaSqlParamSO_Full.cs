...
namespace SDA.DAO.StagingObject
{
    public class SdaSqlParamSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_SDA_SQL_PARAM, bool>>> listVSdaSqlParamExpression = new List<System.Linq.Expressions.Expression<Func<V_SDA_SQL_PARAM, bool>>>();
    }
}
