...
namespace SDA.DAO.StagingObject
{
    public class SdaProvinceMapSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_SDA_PROVINCE_MAP, bool>>> listVSdaProvinceMapExpression = new List<System.Linq.Expressions.Expression<Func<V_SDA_PROVINCE_MAP, bool>>>();
    }
}
