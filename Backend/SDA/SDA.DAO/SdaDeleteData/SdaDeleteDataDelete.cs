...
{
    partial class SdaDeleteDataDelete : EntityBase
    {
        public SdaDeleteDataDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_DELETE_DATA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_DELETE_DATA> listIdNotFound = new List<SDA_DELETE_DATA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_DELETE_DATA> listRaw = ctx.SDA_DELETE_DATA.Where(o => listId.Contains(o.ID)).ToList();
