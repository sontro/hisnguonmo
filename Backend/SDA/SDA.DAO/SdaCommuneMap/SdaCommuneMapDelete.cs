...
{
    partial class SdaCommuneMapDelete : EntityBase
    {
        public SdaCommuneMapDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_COMMUNE_MAP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_COMMUNE_MAP> listIdNotFound = new List<SDA_COMMUNE_MAP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_COMMUNE_MAP> listRaw = ctx.SDA_COMMUNE_MAP.Where(o => listId.Contains(o.ID)).ToList();
