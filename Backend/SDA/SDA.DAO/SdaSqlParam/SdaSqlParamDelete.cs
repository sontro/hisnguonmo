...
{
    partial class SdaSqlParamDelete : EntityBase
    {
        public SdaSqlParamDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_SQL_PARAM> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_SQL_PARAM> listIdNotFound = new List<SDA_SQL_PARAM>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_SQL_PARAM> listRaw = ctx.SDA_SQL_PARAM.Where(o => listId.Contains(o.ID)).ToList();
