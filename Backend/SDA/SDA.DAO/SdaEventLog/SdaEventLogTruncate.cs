...
{
    partial class SdaEventLogTruncate : EntityBase
    {
        public SdaEventLogTruncate()
            : base()
        {
        ...
        public bool TruncateList(List<SDA_EVENT_LOG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_EVENT_LOG> listIdNotFound = new List<SDA_EVENT_LOG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_EVENT_LOG> listRaw = ctx.SDA_EVENT_LOG.Where(o => listId.Contains(o.ID)).ToList();
