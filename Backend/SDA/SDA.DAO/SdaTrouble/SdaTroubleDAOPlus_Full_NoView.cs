...
namespace SDA.DAO.SdaTrouble
{
    ...
    {
        public SDA_TROUBLE GetByCode(string code, SdaTroubleSO search)
        {
        ...
        public Dictionary<string, SDA_TROUBLE> GetDicByCode(SdaTroubleSO search, CommonParam param)
        {
            Dictionary<string, SDA_TROUBLE> result = new Dictionary<string, SDA_TROUBLE>();
