...
namespace SDA.DAO.SdaTrouble
{
    ...
    {
        public List<V_SDA_TROUBLE> GetView(SdaTroubleSO search, CommonParam param)
        {
            List<V_SDA_TROUBLE> result = new List<V_SDA_TROUBLE>();
        ...
        public V_SDA_TROUBLE GetViewById(long id, SdaTroubleSO search)
        {
