...
{
    partial class SdaTroubleTruncate : EntityBase
    {
        public SdaTroubleTruncate()
            : base()
        {
        ...
        public bool TruncateList(List<SDA_TROUBLE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_TROUBLE> listIdNotFound = new List<SDA_TROUBLE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_TROUBLE> listRaw = ctx.SDA_TROUBLE.Where(o => listId.Contains(o.ID)).ToList();
