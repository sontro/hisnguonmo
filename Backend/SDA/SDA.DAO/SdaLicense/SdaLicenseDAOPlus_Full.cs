...
{
    public partial class SdaLicenseDAO : EntityBase
    {
        public List<V_SDA_LICENSE> GetView(SdaLicenseSO search, CommonParam param)
        {
            List<V_SDA_LICENSE> result = new List<V_SDA_LICENSE>();
        ...
        public V_SDA_LICENSE GetViewById(long id, SdaLicenseSO search)
        {
            V_SDA_LICENSE result = null;
        ...
        public V_SDA_LICENSE GetViewByCode(string code, SdaLicenseSO search)
        {
            V_SDA_LICENSE result = null;
        ...
        {
            Dictionary<string, SDA_LICENSE> result = new Dictionary<string, SDA_LICENSE>();
