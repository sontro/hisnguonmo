...
{
    partial class SdaDistrictMapDelete : EntityBase
    {
        public SdaDistrictMapDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_DISTRICT_MAP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_DISTRICT_MAP> listIdNotFound = new List<SDA_DISTRICT_MAP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_DISTRICT_MAP> listRaw = ctx.SDA_DISTRICT_MAP.Where(o => listId.Contains(o.ID)).ToList();
