...
namespace SDA.DAO.SdaGroupType
{
    ...
    {
        private SdaGroupTypeCreate CreateWorker
        {
            get
            {
                return (SdaGroupTypeCreate)Worker.Get<SdaGroupTypeCreate>();
            }
        }
        private SdaGroupTypeUpdate UpdateWorker
        {
            get
            {
                return (SdaGroupTypeUpdate)Worker.Get<SdaGroupTypeUpdate>();
            }
        }
        private SdaGroupTypeDelete DeleteWorker
        {
            get
            {
                return (SdaGroupTypeDelete)Worker.Get<SdaGroupTypeDelete>();
            }
        }
        private SdaGroupTypeTruncate TruncateWorker
        {
            get
            {
                return (SdaGroupTypeTruncate)Worker.Get<SdaGroupTypeTruncate>();
            }
        }
        private SdaGroupTypeGet GetWorker
        {
            get
            {
                return (SdaGroupTypeGet)Worker.Get<SdaGroupTypeGet>();
            }
        }
        private SdaGroupTypeCheck CheckWorker
        {
            get
            {
                return (SdaGroupTypeCheck)Worker.Get<SdaGroupTypeCheck>();
            }
        }
        ...
        public bool Truncate(SDA_GROUP_TYPE data)
        {
            bool result = false;
        ...
        public bool TruncateList(List<SDA_GROUP_TYPE> listData)
        {
            bool result = false;
        ...
        {
            List<SDA_GROUP_TYPE> result = new List<SDA_GROUP_TYPE>();
