...
{
    partial class SdaCustomizeUiDelete : EntityBase
    {
        public SdaCustomizeUiDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_CUSTOMIZE_UI> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_CUSTOMIZE_UI> listIdNotFound = new List<SDA_CUSTOMIZE_UI>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_CUSTOMIZE_UI> listRaw = ctx.SDA_CUSTOMIZE_UI.Where(o => listId.Contains(o.ID)).ToList();
