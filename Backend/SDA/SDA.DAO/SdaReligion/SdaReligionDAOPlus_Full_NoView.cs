...
namespace SDA.DAO.SdaReligion
{
    ...
    {
        public SDA_RELIGION GetByCode(string code, SdaReligionSO search)
        {
        ...
        public Dictionary<string, SDA_RELIGION> GetDicByCode(SdaReligionSO search, CommonParam param)
        {
            Dictionary<string, SDA_RELIGION> result = new Dictionary<string, SDA_RELIGION>();
