...
{
    partial class SdaReligionTruncate : EntityBase
    {
        public SdaReligionTruncate()
            : base()
        {
        ...
        public bool TruncateList(List<SDA_RELIGION> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_RELIGION> listIdNotFound = new List<SDA_RELIGION>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_RELIGION> listRaw = ctx.SDA_RELIGION.Where(o => listId.Contains(o.ID)).ToList();
