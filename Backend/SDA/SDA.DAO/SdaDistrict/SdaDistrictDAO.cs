...
namespace SDA.DAO.SdaDistrict
{
    ...
    {
        private SdaDistrictCreate CreateWorker
        {
            get
            {
                return (SdaDistrictCreate)Worker.Get<SdaDistrictCreate>();
            }
        }
        private SdaDistrictUpdate UpdateWorker
        {
            get
            {
                return (SdaDistrictUpdate)Worker.Get<SdaDistrictUpdate>();
            }
        }
        private SdaDistrictDelete DeleteWorker
        {
            get
            {
                return (SdaDistrictDelete)Worker.Get<SdaDistrictDelete>();
            }
        }
        private SdaDistrictTruncate TruncateWorker
        {
            get
            {
                return (SdaDistrictTruncate)Worker.Get<SdaDistrictTruncate>();
            }
        }
        private SdaDistrictGet GetWorker
        {
            get
            {
                return (SdaDistrictGet)Worker.Get<SdaDistrictGet>();
            }
        }
        private SdaDistrictCheck CheckWorker
        {
            get
            {
                return (SdaDistrictCheck)Worker.Get<SdaDistrictCheck>();
            }
        }
        ...
        public List<SDA_DISTRICT> Get(SdaDistrictSO search, CommonParam param)
        {
            List<SDA_DISTRICT> result = new List<SDA_DISTRICT>();
        ...
        public SDA_DISTRICT GetById(long id, SdaDistrictSO search)
        {
