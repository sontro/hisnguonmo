...
{
    partial class SdaTranslateDelete : EntityBase
    {
        public SdaTranslateDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_TRANSLATE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_TRANSLATE> listIdNotFound = new List<SDA_TRANSLATE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_TRANSLATE> listRaw = ctx.SDA_TRANSLATE.Where(o => listId.Contains(o.ID)).ToList();
