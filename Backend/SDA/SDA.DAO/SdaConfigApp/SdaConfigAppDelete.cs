...
{
    partial class SdaConfigAppDelete : EntityBase
    {
        public SdaConfigAppDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_CONFIG_APP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_CONFIG_APP> listIdNotFound = new List<SDA_CONFIG_APP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_CONFIG_APP> listRaw = ctx.SDA_CONFIG_APP.Where(o => listId.Contains(o.ID)).ToList();
