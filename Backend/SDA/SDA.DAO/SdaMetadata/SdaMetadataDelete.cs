...
{
    partial class SdaMetadataDelete : EntityBase
    {
        public SdaMetadataDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_METADATA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_METADATA> listIdNotFound = new List<SDA_METADATA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_METADATA> listRaw = ctx.SDA_METADATA.Where(o => listId.Contains(o.ID)).ToList();
