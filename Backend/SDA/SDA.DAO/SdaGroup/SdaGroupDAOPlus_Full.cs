...
namespace SDA.DAO.SdaGroup
{
    ...
    {
        public List<V_SDA_GROUP> GetView(SdaGroupSO search, CommonParam param)
        {
            List<V_SDA_GROUP> result = new List<V_SDA_GROUP>();
        ...
        public V_SDA_GROUP GetViewById(long id, SdaGroupSO search)
        {
