...
namespace SDA.DAO.SdaGroup
{
    ...
    {
        private SdaGroupCreate CreateWorker
        {
            get
            {
                return (SdaGroupCreate)Worker.Get<SdaGroupCreate>();
            }
        }
        private SdaGroupUpdate UpdateWorker
        {
            get
            {
                return (SdaGroupUpdate)Worker.Get<SdaGroupUpdate>();
            }
        }
        private SdaGroupDelete DeleteWorker
        {
            get
            {
                return (SdaGroupDelete)Worker.Get<SdaGroupDelete>();
            }
        }
        private SdaGroupTruncate TruncateWorker
        {
            get
            {
                return (SdaGroupTruncate)Worker.Get<SdaGroupTruncate>();
            }
        }
        private SdaGroupGet GetWorker
        {
            get
            {
                return (SdaGroupGet)Worker.Get<SdaGroupGet>();
            }
        }
        private SdaGroupCheck CheckWorker
        {
            get
            {
                return (SdaGroupCheck)Worker.Get<SdaGroupCheck>();
            }
        }
        ...
        public List<SDA_GROUP> Get(SdaGroupSO search, CommonParam param)
        {
            List<SDA_GROUP> result = new List<SDA_GROUP>();
        ...
        public SDA_GROUP GetById(long id, SdaGroupSO search)
        {
