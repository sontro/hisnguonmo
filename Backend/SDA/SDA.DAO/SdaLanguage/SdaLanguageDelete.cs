...
{
    partial class SdaLanguageDelete : EntityBase
    {
        public SdaLanguageDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SDA_LANGUAGE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SDA_LANGUAGE> listIdNotFound = new List<SDA_LANGUAGE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SDA_LANGUAGE> listRaw = ctx.SDA_LANGUAGE.Where(o => listId.Contains(o.ID)).ToList();
