...
using SDA.MANAGER.Core.SdaProvinceMap.Get;
using Inventec.Core;
using System;
...
{
    class SdaProvinceMapCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SdaProvinceMapFilterQuery filter = new SdaProvinceMapFilterQuery();
                    filter.IDs = ids;
                    List<SDA_PROVINCE_MAP> listData = new SdaProvinceMapBO().Get<List<SDA_PROVINCE_MAP>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_PROVINCE_MAP raw)
        {
            bool result = true;
            if (raw == null)
            {
