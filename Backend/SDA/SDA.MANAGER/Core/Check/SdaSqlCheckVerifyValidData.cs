...
{
    class SdaSqlCheckVerifyValidData
    {
        internal static bool Verify(CommonParam param, SDA_SQL data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<SDA_SQL> datas)
        {
            bool result = true;
            try
            {
