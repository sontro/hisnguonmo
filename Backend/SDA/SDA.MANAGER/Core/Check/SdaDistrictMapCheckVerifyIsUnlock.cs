...
using SDA.MANAGER.Core.SdaDistrictMap.Get;
using Inventec.Core;
using System;
...
{
    class SdaDistrictMapCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SdaDistrictMapFilterQuery filter = new SdaDistrictMapFilterQuery();
                    filter.IDs = ids;
                    List<SDA_DISTRICT_MAP> listData = new SdaDistrictMapBO().Get<List<SDA_DISTRICT_MAP>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_DISTRICT_MAP raw)
        {
            bool result = true;
            if (raw == null)
            {
