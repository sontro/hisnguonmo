...
{
    class SdaEthnicCheckVerifyValidData
    {
        internal static bool Verify(CommonParam param, SDA_ETHNIC data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<SDA_ETHNIC> datas)
        {
            bool result = true;
            try
            {
