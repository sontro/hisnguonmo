...
using SDA.MANAGER.Core.SdaTrouble.Get;
using Inventec.Core;
using System;
...
{
    class SdaTroubleCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SdaTroubleFilterQuery filter = new SdaTroubleFilterQuery();
                    filter.IDs = ids;
                    List<SDA_TROUBLE> listData = new SdaTroubleBO().Get<List<SDA_TROUBLE>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_TROUBLE raw)
        {
            bool result = true;
            if (raw == null)
            {
