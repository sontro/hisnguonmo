...
{
    class SdaReligionCheckVerifyValidData
    {
        internal static bool Verify(CommonParam param, SDA_RELIGION data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<SDA_RELIGION> datas)
        {
            bool result = true;
            try
            {
