...
using SDA.MANAGER.Core.SdaDeleteData.Get;
using Inventec.Core;
using System;
...
{
    class SdaDeleteDataCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SdaDeleteDataFilterQuery filter = new SdaDeleteDataFilterQuery();
                    filter.IDs = ids;
                    List<SDA_DELETE_DATA> listData = new SdaDeleteDataBO().Get<List<SDA_DELETE_DATA>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_DELETE_DATA raw)
        {
            bool result = true;
            if (raw == null)
            {
