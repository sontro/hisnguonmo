...
{
    class SdaGroupCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                if (ids != null && ids.Count > 0)
                {
                    ...
                    filter.IDs = ids;
                    List<SDA_GROUP> listData = new SdaGroupBO().Get<List<SDA_GROUP>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_GROUP raw)
        {
            bool result = true;
            if (raw == null)
            {
