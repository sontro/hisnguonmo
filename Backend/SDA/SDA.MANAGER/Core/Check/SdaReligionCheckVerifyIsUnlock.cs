...
using SDA.MANAGER.Core.SdaReligion.Get;
using Inventec.Core;
using System;
...
{
    class SdaReligionCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SdaReligionFilterQuery filter = new SdaReligionFilterQuery();
                    filter.IDs = ids;
                    List<SDA_RELIGION> listData = new SdaReligionBO().Get<List<SDA_RELIGION>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_RELIGION raw)
        {
            bool result = true;
            if (raw == null)
            {
