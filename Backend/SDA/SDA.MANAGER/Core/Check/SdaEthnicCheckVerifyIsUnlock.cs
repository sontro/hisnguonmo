...
using SDA.MANAGER.Core.SdaEthnic.Get;
using Inventec.Core;
using System;
...
{
    class SdaEthnicCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SdaEthnicFilterQuery filter = new SdaEthnicFilterQuery();
                    filter.IDs = ids;
                    List<SDA_ETHNIC> listData = new SdaEthnicBO().Get<List<SDA_ETHNIC>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_ETHNIC raw)
        {
            bool result = true;
            if (raw == null)
            {
