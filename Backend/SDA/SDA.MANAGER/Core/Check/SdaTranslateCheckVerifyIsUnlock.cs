...
using SDA.MANAGER.Core.SdaTranslate.Get;
using Inventec.Core;
using System;
...
{
    class SdaTranslateCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SdaTranslateFilterQuery filter = new SdaTranslateFilterQuery();
                    filter.IDs = ids;
                    List<SDA_TRANSLATE> listData = new SdaTranslateBO().Get<List<SDA_TRANSLATE>>(filter);
        ...
        private static bool Check(CommonParam param, SDA_TRANSLATE raw)
        {
            bool result = true;
            if (raw == null)
            {
