...
namespace SDA.MANAGER.Core.SdaEventLog
{
    partial class SdaEventLogBO : BusinessObjectBase
    {
        ...
        internal T Get<T>(object data)
        {
            ...
            try
            {
                IDelegacyT delegacy = new SdaEventLogGet(param, data);
        ...
        internal bool Update(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaEventLogUpdate(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool ChangeLock(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaEventLogChangeLock(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool Delete(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaEventLogDelete(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
