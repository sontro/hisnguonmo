    ...
    class SdaModuleFieldUpdateBehaviorEv : BeanObjectBase, ISdaModuleFieldUpdate
    {
        ...
        bool ISdaModuleFieldUpdate.Run()
        {
            ...
            try
            {
                ...
                if (result) { SdaModuleFieldEventLogUpdate.Log(current, entity); }
            }
            catch (Exception ex)
            {
        ...
        bool Check()
        {
            ...
            try
            {
                ...
                result = result && SdaModuleFieldCheckVerifyExistsCode.Verify(param, entity.MODULE_FIELD_CODE, entity.ID);
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
