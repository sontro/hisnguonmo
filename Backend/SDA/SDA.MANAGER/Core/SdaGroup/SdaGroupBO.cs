...
namespace SDA.MANAGER.Core.SdaGroup
{
    partial class SdaGroupBO : BusinessObjectBase
    {
        ...
        internal T Get<T>(object data)
        {
            ...
            try
            {
                IDelegacyT delegacy = new SdaGroupGet(param, data);
        ...
        internal bool Create(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaGroupCreate(param, data);
        ...
        internal bool Update(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaGroupUpdate(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool ChangeLock(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaGroupChangeLock(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool Delete(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaGroupDelete(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
