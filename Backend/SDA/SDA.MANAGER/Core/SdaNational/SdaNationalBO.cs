...
namespace SDA.MANAGER.Core.SdaNational
{
    partial class SdaNationalBO : BusinessObjectBase
    {
        ...
        internal T Get<T>(object data)
        {
            ...
            try
            {
                IDelegacyT delegacy = new SdaNationalGet(param, data);
        ...
        internal bool Create(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaNationalCreate(param, data);
        ...
        internal bool Update(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaNationalUpdate(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool ChangeLock(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaNationalChangeLock(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool Delete(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaNationalDelete(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
