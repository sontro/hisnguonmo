...
namespace SDA.MANAGER.Core.SdaLicense
{
    partial class SdaLicenseBO : BusinessObjectBase
    {
        ...
        internal T Get<T>(object data)
        {
            ...
            try
            {
                IDelegacyT delegacy = new SdaLicenseGet(param, data);
        ...
        internal bool Create(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaLicenseCreate(param, data);
        ...
        internal bool Update(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaLicenseUpdate(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool ChangeLock(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaLicenseChangeLock(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
        ...
        internal bool Delete(object data)
        {
            ...
            try
            {
                IDelegacy delegacy = new SdaLicenseDelete(param, data);
                result = delegacy.Execute();
            }
            catch (Exception ex)
            {
