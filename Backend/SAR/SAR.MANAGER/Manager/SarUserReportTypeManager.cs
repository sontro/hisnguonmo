...
{
    public partial class SarUserReportTypeManager : ManagerBase
    {
        public SarUserReportTypeManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                SarUserReportTypeBO bo = new SarUserReportTypeBO();
        ...
        public bool DeleteList(object data)
        {
            bool result = false;
            try
            {
