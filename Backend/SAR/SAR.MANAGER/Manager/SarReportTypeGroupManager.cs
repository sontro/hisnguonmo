...
{
    public partial class SarReportTypeGroupManager : ManagerBase
    {
        public SarReportTypeGroupManager(CommonParam param)
            : base(param)
        {
        ...
        public T Get<T>(object data)
        {
            ...
            try
            {
                ...
                SarReportTypeGroupBO bo = new SarReportTypeGroupBO();
