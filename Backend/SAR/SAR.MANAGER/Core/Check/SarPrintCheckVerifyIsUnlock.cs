...
using SAR.MANAGER.Core.SarPrint.Get;
using Inventec.Core;
using System;
...
{
    class SarPrintCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SarPrintFilterQuery filter = new SarPrintFilterQuery();
                    filter.IDs = ids;
                    List<SAR_PRINT> listData = new SarPrintBO().Get<List<SAR_PRINT>>(filter);
        ...
        private static bool Check(CommonParam param, SAR_PRINT raw)
        {
            bool result = true;
            if (raw == null)
            {
