...
{
    class SarPrintCheckVerifyValidData
    {
        internal static bool Verify(CommonParam param, SAR_PRINT data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<SAR_PRINT> datas)
        {
            bool result = true;
            try
            {
