...
{
    class SarFormTypeCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SarFormTypeFilterQuery filter = new SarFormTypeFilterQuery();
                    filter.IDs = ids;
                    List<SAR_FORM_TYPE> listData = new SarFormTypeBO().Get<List<SAR_FORM_TYPE>>(filter);
        ...
        private static bool Check(CommonParam param, SAR_FORM_TYPE raw)
        {
            bool result = true;
            if (raw == null)
            {
