...
using SAR.MANAGER.Core.SarForm.Get;
using Inventec.Core;
using System;
...
{
    class SarFormCheckVerifyIsUnlock
    {
        ...
        internal static bool Verify(CommonParam param, SAR_FORM data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<long> ids)
        {
            ...
            try
            {
                ...
                {
                    SarFormFilterQuery filter = new SarFormFilterQuery();
                    filter.IDs = ids;
                    List<SAR_FORM> listData = new SarFormBO().Get<List<SAR_FORM>>(filter);
        ...
        internal static bool Verify(CommonParam param, List<SAR_FORM> datas)
        {
            bool result = true;
            try
            {
        ...
        private static bool Check(CommonParam param, SAR_FORM raw)
        {
            bool result = true;
            if (raw == null)
            {
