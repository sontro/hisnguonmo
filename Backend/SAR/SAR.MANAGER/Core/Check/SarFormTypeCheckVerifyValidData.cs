...
{
    class SarFormTypeCheckVerifyValidData
    {
        internal static bool Verify(CommonParam param, SAR_FORM_TYPE data)
        {
            bool result = true;
            try
            {
        ...
        internal static bool Verify(CommonParam param, List<SAR_FORM_TYPE> datas)
        {
            bool result = true;
            try
            {
