            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(this.KEY_WORD))
                {
                    ...
                    listExpression.Add(o =>
                        ...
                        o.EXTENSION_RECEIVE.ToLower().Contains(this.KEY_WORD.Trim()) ||
                        o.TUTORIAL.ToLower().Contains(this.KEY_WORD.Trim()) ||
                        o.REPORT_TYPE_CODE.ToLower().Contains(this.KEY_WORD.Trim()) ||
                        o.REPORT_TYPE_NAME.ToLower().Contains(this.KEY_WORD.Trim()) ||
                        o.REPORT_TEMPLATE_CODE.ToLower().Contains(this.KEY_WORD.Trim()) ||
                        o.REPORT_TEMPLATE_NAME.ToLower().Contains(this.KEY_WORD.Trim()));
                }
                #endregion
