...
{
    partial class SarReportSttDelete : EntityBase
    {
        public SarReportSttDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_REPORT_STT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_REPORT_STT> listIdNotFound = new List<SAR_REPORT_STT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_REPORT_STT> listRaw = ctx.SAR_REPORT_STT.Where(o => listId.Contains(o.ID)).ToList();
