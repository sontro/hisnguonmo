...
{
    partial class SarReportDelete : EntityBase
    {
        public SarReportDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_REPORT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_REPORT> listIdNotFound = new List<SAR_REPORT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_REPORT> listRaw = ctx.SAR_REPORT.Where(o => listId.Contains(o.ID)).ToList();
