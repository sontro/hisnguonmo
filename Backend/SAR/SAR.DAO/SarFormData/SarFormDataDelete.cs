...
{
    partial class SarFormDataDelete : EntityBase
    {
        public SarFormDataDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_FORM_DATA> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_FORM_DATA> listIdNotFound = new List<SAR_FORM_DATA>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_FORM_DATA> listRaw = ctx.SAR_FORM_DATA.Where(o => listId.Contains(o.ID)).ToList();
