...
{
    partial class SarRetyFofiDelete : EntityBase
    {
        public SarRetyFofiDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_RETY_FOFI> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_RETY_FOFI> listIdNotFound = new List<SAR_RETY_FOFI>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_RETY_FOFI> listRaw = ctx.SAR_RETY_FOFI.Where(o => listId.Contains(o.ID)).ToList();
