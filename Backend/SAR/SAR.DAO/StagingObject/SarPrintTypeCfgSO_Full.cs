...
namespace SAR.DAO.StagingObject
{
    public class SarPrintTypeCfgSO : StagingObjectBase
    {
        ...
        public List<System.Linq.Expressions.Expression<Func<V_SAR_PRINT_TYPE_CFG, bool>>> listVSarPrintTypeCfgExpression = new List<System.Linq.Expressions.Expression<Func<V_SAR_PRINT_TYPE_CFG, bool>>>();
    }
}
