...
{
    partial class SarFormTypeDelete : EntityBase
    {
        public SarFormTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_FORM_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_FORM_TYPE> listIdNotFound = new List<SAR_FORM_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_FORM_TYPE> listRaw = ctx.SAR_FORM_TYPE.Where(o => listId.Contains(o.ID)).ToList();
