...
{
    partial class SarPrintTypeCfgDelete : EntityBase
    {
        public SarPrintTypeCfgDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_PRINT_TYPE_CFG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_PRINT_TYPE_CFG> listIdNotFound = new List<SAR_PRINT_TYPE_CFG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_PRINT_TYPE_CFG> listRaw = ctx.SAR_PRINT_TYPE_CFG.Where(o => listId.Contains(o.ID)).ToList();
