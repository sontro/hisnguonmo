...
{
    partial class SarReportTemplateDelete : EntityBase
    {
        public SarReportTemplateDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_REPORT_TEMPLATE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_REPORT_TEMPLATE> listIdNotFound = new List<SAR_REPORT_TEMPLATE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_REPORT_TEMPLATE> listRaw = ctx.SAR_REPORT_TEMPLATE.Where(o => listId.Contains(o.ID)).ToList();
