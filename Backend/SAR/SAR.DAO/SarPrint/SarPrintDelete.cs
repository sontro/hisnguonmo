...
{
    partial class SarPrintDelete : EntityBase
    {
        public SarPrintDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_PRINT> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_PRINT> listIdNotFound = new List<SAR_PRINT>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_PRINT> listRaw = ctx.SAR_PRINT.Where(o => listId.Contains(o.ID)).ToList();
