...
{
    partial class SarReportTypeGroupDelete : EntityBase
    {
        public SarReportTypeGroupDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_REPORT_TYPE_GROUP> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_REPORT_TYPE_GROUP> listIdNotFound = new List<SAR_REPORT_TYPE_GROUP>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_REPORT_TYPE_GROUP> listRaw = ctx.SAR_REPORT_TYPE_GROUP.Where(o => listId.Contains(o.ID)).ToList();
