...
{
    partial class SarReportTypeDelete : EntityBase
    {
        public SarReportTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_REPORT_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_REPORT_TYPE> listIdNotFound = new List<SAR_REPORT_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_REPORT_TYPE> listRaw = ctx.SAR_REPORT_TYPE.Where(o => listId.Contains(o.ID)).ToList();
