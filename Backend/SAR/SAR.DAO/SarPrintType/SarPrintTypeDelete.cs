...
{
    partial class SarPrintTypeDelete : EntityBase
    {
        public SarPrintTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_PRINT_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_PRINT_TYPE> listIdNotFound = new List<SAR_PRINT_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_PRINT_TYPE> listRaw = ctx.SAR_PRINT_TYPE.Where(o => listId.Contains(o.ID)).ToList();
