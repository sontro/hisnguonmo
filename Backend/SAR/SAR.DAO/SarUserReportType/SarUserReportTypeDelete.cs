...
{
    partial class SarUserReportTypeDelete : EntityBase
    {
        public SarUserReportTypeDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_USER_REPORT_TYPE> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_USER_REPORT_TYPE> listIdNotFound = new List<SAR_USER_REPORT_TYPE>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_USER_REPORT_TYPE> listRaw = ctx.SAR_USER_REPORT_TYPE.Where(o => listId.Contains(o.ID)).ToList();
