...
{
    partial class SarPrintLogDelete : EntityBase
    {
        public SarPrintLogDelete()
            : base()
        {
        ...
        public bool DeleteList(List<SAR_PRINT_LOG> listData)
        {
            ...
            try
            {
                ...
                if (valid)
                {
                    List<SAR_PRINT_LOG> listIdNotFound = new List<SAR_PRINT_LOG>();
                    ...
                    else
                    {
                        ...
                        {
                            List<SAR_PRINT_LOG> listRaw = ctx.SAR_PRINT_LOG.Where(o => listId.Contains(o.ID)).ToList();
